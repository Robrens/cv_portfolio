...
var to = (t, e) => {
  for (var n in e) Zp(t, n, { get: e[n], enumerable: !0 });
};
var Qo = {};
to(Qo, {
  CommandManager: () => Nr,
  ...
  NodeView: () => k0,
  PasteRule: () => qo,
  ResizableNodeView: () => Go,
  ResizableNodeview: () => h0,
  Tracker: () => v0,
  callOrReturn: () => J,
  canInsertNode: () => Wl,
  combineTransactionSteps: () => zo,
  commands: () => Al,
  createAtomBlockMarkdownSpec: () => df,
  createBlockMarkdownSpec: () => Ht,
  createChainableState: () => Er,
  createDocument: () => Io,
  createElement: () => u0,
  createInlineMarkdownSpec: () => uf,
  createMappablePosition: () => _u,
  createNodeFromContent: () => zn,
  createStyleTag: () => af,
  decodeHtmlEntities: () => p0,
  defaultBlockAt: () => $n,
  deleteProps: () => Cl,
  elementFromString: () => Ln,
  encodeHtmlEntities: () => m0,
  escapeForRegEx: () => jl,
  extensions: () => qu,
  findChildren: () => sn,
  ...
  generateText: () => Nb,
  getAttributes: () => Wo,
  getAttributesFromExtensions: () => Il,
  getChangedRanges: () => jo,
  getDebugJSON: () => zu,
  getExtensionField: () => $,
  getHTMLFromFragment: () => Rr,
  getMarkAttributes: () => Ol,
  getMarkRange: () => Bo,
  getMarkType: () => rt,
  getMarksBetween: () => Dr,
  getNodeAtPosition: () => zl,
  getNodeAttributes: () => Lu,
  getNodeType: () => oe,
  getRenderedAttributes: () => on,
  getSchema: () => _o,
  getSchemaByResolvedExtensions: () => Pl,
  getSchemaTypeByName: () => Pn,
  getSchemaTypeNameByName: () => Or,
  getSplittedAttributes: () => Mr,
  getStyleProperty: () => Ul,
  getText: () => Bl,
  getTextBetween: () => Ll,
  getTextContentFromNodes: () => Hu,
  getTextSerializersFromSchema: () => Vo,
  getUpdatedPosition: () => Fu,
  h: () => u0,
  injectExtensionAttributesToParseRule: () => vl,
  inputRulesPlugin: () => Wu,
  isActive: () => Uo,
  isAndroid: () => Ar,
  isAtEndOfNode: () => Hl,
  ...
  objectIncludes: () => Tr,
  parseAttributes: () => Xo,
  parseIndentedBlocks: () => Lr,
  pasteRulesPlugin: () => Ku,
  posToDOMRect: () => _l,
  removeDuplicates: () => Bu,
  renderNestedMarkdownContent: () => Vn,
  resolveExtensions: () => Fo,
  resolveFocusPosition: () => El,
  rewriteUnknownContent: () => Db,
  selectionToInsertionEnd: () => Ru,
  serializeAttributes: () => Yo,
  sortExtensions: () => Bn,
  splitExtensions: () => rn,
  textInputRule: () => c0,
  textPasteRule: () => C0,
  textblockTypeInputRule: () => _n,
  updateMarkViewAttributes: () => Kl,
  wrappingInputRule: () => Ge,
});
function we(t) {
  this.content = t;
}
we.prototype = {
  ...
  update: function (t, e, n) {
    var r = n && n != t ? this.remove(n) : this,
      o = r.find(t),
      i = r.content.slice();
    return (o == -1 ? i.push(n || t, e) : ((i[o + 1] = e), n && (i[o] = n)), new we(i));
  },
  remove: function (t) {
    var e = this.find(t);
    if (e == -1) return this;
  ...
  addBefore: function (t, e, n) {
    var r = this.remove(e),
      o = r.content.slice(),
      i = r.find(t);
    return (o.splice(i == -1 ? o.length : i, 0, e, n), new we(o));
  },
  forEach: function (t) {
...
function dc(t, e, n) {
  for (let r = 0; ; r++) {
    ...
    if (o.content.size || i.content.size) {
      let s = dc(o.content, i.content, n + 1);
      if (s != null) return s;
    }
    n += o.nodeSize;
  }
...
function uc(t, e, n, r) {
  for (let o = t.childCount, i = e.childCount; ;) {
    ...
    if (s.content.size || l.content.size) {
      let c = uc(s.content, l.content, n - 1, r - 1);
      if (c) return c;
    }
    ((n -= a), (r -= a));
  }
...
var C = class t {
            ...
            : l.isLeaf
              ? o
                ...
                : l.type.spec.leafText
                  ...
                  : ''
              : '';
          (l.isBlock && ((l.isLeaf && c) || l.isTextblock) && r && (s ? (s = !1) : (i += r)),
            (i += c));
        },
        0,
      ),
  ...
  append(e) {
    ...
    let n = this.lastChild,
      ...
      i = 0;
    for (
      n.isText && n.sameMarkup(r) && ((o[o.length - 1] = n.withText(n.text + r.text)), (i = 1));
      i < e.content.length;
      i++
    )
      o.push(e.content[i]);
  ...
  findDiffEnd(e, n = this.size, r = e.size) {
    return uc(this, e, n, r);
  }
  findIndex(e) {
    if (e == 0) return no(0, e);
    if (e == this.size) return no(this.content.length, e);
    if (e > this.size || e < 0) throw new RangeError(`Position ${e} outside of fragment (${this})`);
    for (let n = 0, r = 0; ; n++) {
      let o = this.child(n),
        i = r + o.nodeSize;
      if (i >= e) return i == e ? no(n + 1, i) : no(n, r);
      r = i;
    }
  }
  toString() {
  ...
  static fromJSON(e, n) {
    ...
    return t.fromArray(n.map(e.nodeFromJSON));
  }
  static fromArray(e) {
...
function io(t, e) {
  ...
  if (n) {
    ...
    for (let r = 0; r < t.length; r++) if (!io(t[r], e[r])) return !1;
  } else {
    for (let r in t) if (!(r in e) || !io(t[r], e[r])) return !1;
  ...
  addToSet(e) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (this.type.excludes(i.type)) n || (n = e.slice(0, o));
        ...
        (!r && i.type.rank > this.type.rank && (n || (n = e.slice(0, o)), n.push(this), (r = !0)),
          n && n.push(i));
      }
    }
...
var At = class extends Error {},
  E = class t {
    ...
    insertAt(e, n) {
      let r = hc(this.content, e + this.openStart, n, this.openStart + 1, this.openEnd + 1);
      return r && new t(r, this.openStart, this.openEnd);
    }
    removeBetween(e, n) {
      return new t(
        fc(this.content, e + this.openStart, n + this.openStart),
        this.openStart,
        this.openEnd,
      );
    }
...
function fc(t, e, n) {
  ...
  return t.replaceChild(r, i.copy(fc(i.content, e - o - 1, n - o - 1)));
}
function hc(t, e, n, r, o, i) {
  ...
  let c = hc(a.content, e - l - 1, n, s == 0 ? r - 1 : 0, s == t.childCount - 1 ? o - 1 : 0, a);
  return c && t.replaceChild(s, a.copy(c));
}
function em(t, e, n) {
  if (n.openStart > t.depth) throw new At('Inserted content deeper than insertion position');
  if (t.depth - n.openStart != e.depth - n.openEnd) throw new At('Inconsistent open depths');
  return pc(t, e, n, 0);
}
function pc(t, e, n, r) {
  let o = t.index(r),
  ...
  if (o == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      let s = t.parent,
        l = s.content;
      return Wt(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
    } else {
      let { start: s, end: l } = tm(n, t);
      return Wt(i, gc(t, s, l, e, r));
    }
  else return Wt(i, so(t, e, r));
}
function mc(t, e) {
...
function Zn(t, e, n, r) {
  ...
  t && ((i = t.index(n)), t.depth > n ? i++ : t.textOffset && (Vt(t.nodeAfter, r), i++));
  for (let l = i; l < s; l++) Vt(o.child(l), r);
  e && e.depth == n && e.textOffset && Vt(e.nodeBefore, r);
}
function Wt(t, e) {
  return (t.type.checkContent(e), t.copy(e));
}
function gc(t, e, n, r, o) {
  let i = t.depth > o && as(t, e, o + 1),
    s = r.depth > o && as(n, r, o + 1),
    l = [];
  return (
    Zn(null, t, o, l),
    i && s && e.index(o) == n.index(o)
      ? (mc(i, s), Vt(Wt(i, gc(t, e, n, r, o + 1)), l))
      : (i && Vt(Wt(i, so(t, e, o + 1)), l), Zn(e, n, o, l), s && Vt(Wt(s, so(n, r, o + 1)), l)),
    Zn(r, null, o, l),
    new C(l)
  );
}
function so(t, e, n) {
  ...
  if ((Zn(null, t, n, r), t.depth > n)) {
    let o = as(t, e, n + 1);
    Vt(Wt(o, so(t, e, n + 1)), r);
  }
  return (Zn(e, null, n, r), new C(r));
}
function tm(t, e) {
...
var tr = class t {
    ...
    blockRange(e = this, n) {
      ...
      for (
        let r = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0);
        r >= 0;
        r--
      )
        if (e.pos <= this.end(r) && (!n || n(this.node(r)))) return new Et(this, e, r);
      return null;
    }
    sameParent(e) {
    ...
    static resolve(e, n) {
      ...
      for (let s = e; ;) {
        let { index: l, offset: a } = s.content.findIndex(i),
          c = i - a;
        if ((r.push(s, l, o + a), !c || ((s = s.child(l)), s.isText))) break;
        ((i = c - 1), (o += a + 1));
      }
      return new t(n, r, i);
    }
    static resolveCached(e, n) {
      ...
      else tc.set(e, (r = new cs()));
      let o = (r.elts[r.i] = t.resolve(e, n));
      return ((r.i = (r.i + 1) % nm), o);
    }
  },
  cs = class {
    constructor() {
  ...
  ne = class t {
    constructor(e, n, r, o = G.none) {
      ((this.type = e), (this.attrs = n), (this.marks = o), (this.content = r || C.empty));
    }
    get children() {
    ...
    hasMarkup(e, n, r) {
      return (
        this.type == e &&
        io(this.attrs, n || e.defaultAttrs || rm) &&
    ...
    canReplace(e, n, r = C.empty, o = 0, i = r.childCount) {
      ...
      for (let a = o; a < i; a++) if (!this.type.allowsMarks(r.child(a).marks)) return !1;
      return !0;
    }
    ...
    static fromJSON(e, n) {
      ...
      let o = C.fromJSON(e, n.content),
        i = e.nodeType(n.type).create(n.attrs, o, r);
      return (i.type.checkAttrs(i.attrs), i);
    }
  };
ne.prototype.text = void 0;
var ds = class t extends ne {
  constructor(e, n, r, o) {
    if ((super(e, n, null, o), !r)) throw new RangeError('Empty text nodes are not allowed');
    this.text = r;
  }
  toString() {
    return this.type.spec.toDebugString
      ? this.type.spec.toDebugString(this)
      : yc(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
var Nt = class t {
  ...
  fillBefore(e, n = !1, r = 0) {
    ...
    function i(s, l) {
      ...
      if (a && (!n || a.validEnd)) return C.from(l.map((c) => c.createAndFill()));
    ...
    for (; r.length;) {
      ...
      for (let s = 0; s < i.next.length; s++) {
        ...
        !l.isLeaf &&
          ...
          !(l.name in n) &&
          (!o.type || a.validEnd) &&
          (r.push({ match: l.contentMatch, type: l, via: o }), (n[l.name] = !0));
      }
    }
    return null;
  }
  ...
  toString() {
    ...
    function n(r) {
      e.push(r);
      for (let o = 0; o < r.next.length; o++) e.indexOf(r.next[o].next) == -1 && n(r.next[o].next);
    }
    return (
      n(this),
      e.map((r, o) => {
  ...
  function n(r) {
    ...
    r.forEach((s) => {
      t[s].forEach(({ term: l, to: a }) => {
        if (!l) return;
        let c;
        for (let d = 0; d < o.length; d++) o[d][0] == l && (c = o[d][1]);
        rc(t, a).forEach((d) => {
          (c || o.push([l, (c = [])]), c.indexOf(d) == -1 && c.push(d));
        });
      });
    });
    let i = (e[r.join(',')] = new Nt(r.indexOf(t.length - 1) > -1));
...
function Cc(t, e) {
  let n = Object.create(null);
  if (e) for (let r in e) n[r] = new fs(t, r, e[r]);
  return n;
}
var nr = class t {
  constructor(e, n, r) {
    ((this.name = e),
      ...
      (this.defaultAttrs = xc(this.attrs)),
  ...
  create(e = null, n, r) {
    ...
    return new ne(this, this.computeAttrs(e), C.from(n), G.setFrom(r));
  }
  createChecked(e = null, n, r) {
    return (
      (n = C.from(n)),
      this.checkContent(n),
      new ne(this, this.computeAttrs(e), n, G.setFrom(r))
    );
  }
  createAndFill(e = null, n, r) {
    ...
    let o = this.contentMatch.matchFragment(n),
      i = o && o.fillBefore(C.empty, !0);
    return i ? new ne(this, e, n.append(i), G.setFrom(r)) : null;
  }
  validContent(e) {
...
var fs = class {
    constructor(e, n, r) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
        ...
        (this.validate = typeof r.validate == 'string' ? fm(e, n, r.validate) : r.validate));
    }
    get isRequired() {
  ...
  xn = class t {
    constructor(e, n, r, o) {
      ((this.name = e),
        ...
        (this.schema = r),
        (this.spec = o),
        (this.attrs = Cc(e, o.attrs)),
        (this.excluded = null));
      let i = xc(this.attrs);
      this.instance = i ? new G(this, i) : null;
    }
    create(e = null) {
      return !e && this.instance ? this.instance : new G(this, kc(this.attrs, e));
    }
    static compile(e, n) {
      let r = Object.create(null),
        o = 0;
  ...
  jt = class {
    constructor(e) {
      ...
      ((n.nodes = ss.from(e.nodes)),
        (n.marks = ss.from(e.marks || {})),
        (this.nodes = nr.compile(this.spec.nodes, this)),
        (this.marks = xn.compile(this.spec.marks, this)));
      let r = Object.create(null);
      for (let o in this.nodes) {
        ...
        let i = this.nodes[o],
          ...
          l = i.spec.marks;
        if (
          ((i.contentMatch = r[s] || (r[s] = Nt.parse(s, this.nodes))),
        ...
        i.markSet =
          l == '_' ? null : l ? oc(this, l.split(' ')) : l == '' || !i.inlineContent ? [] : null;
      }
      for (let o in this.marks) {
        let i = this.marks[o],
          s = i.spec.excludes;
        i.excluded = s == null ? [i] : s == '' ? [] : oc(this, s.split(' '));
      }
      ((this.nodeFromJSON = (o) => ne.fromJSON(this, o)),
    ...
    text(e, n) {
      ...
      return new ds(r, r.defaultAttrs, e, G.setFrom(n));
    }
    mark(e, n) {
...
var Ae = class t {
    ...
    static schemaRules(e) {
      ...
      for (let o in e.marks) {
        ...
        i &&
          i.forEach((s) => {
            (r((s = sc(s))), s.mark || s.ignore || s.clearMark || (s.mark = o));
          });
      }
      for (let o in e.nodes) {
        ...
        i &&
          i.forEach((s) => {
            (r((s = sc(s))), s.node || s.ignore || s.mark || (s.node = o));
          });
      }
      return n;
    }
  ...
  mm = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  Mc = { ol: !0, ul: !0 },
  rr = 1,
  hs = 2,
  er = 4;
...
var wn = class {
    constructor(e, n, r, o, i, s) {
      ((this.type = e),
        ...
        (this.match = i || (s & er ? null : e.contentMatch)));
    }
    findWrapping(e) {
      if (!this.match) {
        if (!this.type) return [];
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (n = n.append(this.match.fillBefore(C.empty, !0))),
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode && !vc.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  lo = class {
    constructor(e, n, r) {
      ...
      let o = n.topNode,
        i,
        s = ic(null, n.preserveWhitespace, 0) | (r ? er : 0);
      (o
        ? (i = new wn(o.type, o.attrs, G.none, !0, n.topMatch || o.type.contentMatch, s))
        : r
          ? (i = new wn(null, null, G.none, !0, null, s))
          : (i = new wn(e.schema.topNodeType, null, G.none, !0, null, s)),
        (this.nodes = [i]),
    ...
    addTextNode(e, n) {
      let r = e.nodeValue,
        o = this.top,
        i = o.options & hs ? 'full' : this.localPreserveWS || (o.options & rr) > 0,
...
`,
            ...
            for (let a = 0; a < l.length; a++)
              (a && this.insertNode(s.linebreakReplacement.create(), n, !0),
                l[a] && this.insertNode(s.text(l[a]), n, !/\S/.test(l[a])));
            r = '';
          } else r = r.replace(/\r?\n|\r/g, ' ');
        else if (
          ((r = r.replace(/[ \t\r\n\u000c]+/g, ' ')),
    ...
    addElement(e, n, r) {
      ...
      let s = e.nodeName.toLowerCase(),
        l;
      Mc.hasOwnProperty(s) && this.parser.normalizeLists && gm(e);
      let a =
        (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
        (l = this.parser.matchTag(e, this, r));
      e: if (a ? a.ignore : mm.hasOwnProperty(s)) (this.findInside(e), this.ignoreFallback(e, n));
        ...
        let c,
          d = this.needsBlock;
        if (vc.hasOwnProperty(s))
          (i.content.length && i.content[0].isInline && this.open && (this.open--, (i = this.top)),
            (c = !0),
...
`),
    ...
    addAll(e, n, r, o) {
      let i = r || 0;
      for (
        let s = r ? e.childNodes[r] : e.firstChild, l = o == null ? null : e.childNodes[o];
        s != l;
        s = s.nextSibling, ++i
      )
    ...
    findPlace(e, n, r) {
      ...
      for (let s = this.open, l = 0; s >= 0; s--) {
        let a = this.nodes[s],
          c = a.findWrapping(e);
        if (c && (!o || o.length > c.length + l) && ((o = c), (i = a), !c.length)) break;
        if (a.solid) {
          if (r) break;
          l += 2;
        }
      ...
      if (!o) return null;
      this.sync(i);
      for (let s = 0; s < o.length; s++) n = this.enterInner(o[s], null, n, !1);
      return n;
    }
    insertNode(e, n, r) {
      ...
      if (o) {
        ...
        for (let l of o.concat(e.marks))
          (i.type ? i.type.allowsMarkType(l.type) : lc(l.type, e.type)) && (s = l.addToSet(s));
    ...
    enterInner(e, n, r, o = !1, i) {
      ...
      let l = ic(e, i, s.options);
      s.options & er && s.content.length == 0 && (l |= er);
      let a = G.none;
      return (
        (r = r.filter((c) =>
          (s.type ? s.type.allowsMarkType(c.type) : lc(c.type, e)) ? ((a = c.addToSet(a)), !1) : !0,
        )),
        this.nodes.push(new wn(e, n, a, o, null, l)),
        this.open++,
        r
      );
    }
    ...
    sync(e) {
      for (let n = this.open; n >= 0; n--) {
        ...
        this.localPreserveWS && (this.nodes[n].options |= rr);
      }
      return !1;
    }
    get currentPos() {
...
var Ze = class t {
  ...
  serializeFragment(e, n = {}, r) {
    r || (r = ro(n).createDocumentFragment());
    let o = r,
      i = [];
    return (
      e.forEach((s) => {
  ...
  serializeNodeInner(e, n) {
    if (e.isText) return ro(n).createTextNode(e.text);
    let { dom: r, contentDOM: o } = oo(ro(n), this.nodes[e.type.name](e), null, e.attrs);
    if (o) {
  ...
  serializeMark(e, n, r = {}) {
    ...
    return o && oo(ro(r), o(e, n), null, e.attrs);
  }
  static renderSpec(e, n, r = null, o) {
    return typeof n == 'string' ? { dom: e.createTextNode(n) } : oo(e, n, r, o);
  }
  static fromSchema(e) {
    return (
      e.cached.domSerializer ||
      (e.cached.domSerializer = new t(this.nodesFromSchema(e), this.marksFromSchema(e)))
    );
  }
...
function bm(t) {
  let e = cc.get(t);
  return (e === void 0 && cc.set(t, (e = wm(t))), e);
}
function wm(t) {
  let e = null;
  function n(r) {
...
function oo(t, e, n, r) {
  ...
  let o = e[0],
    i;
  if (typeof o != 'string') throw new RangeError('Invalid array passed to renderSpec');
  if (r && (i = bm(r)) && i.indexOf(e) > -1)
    throw new RangeError(
  ...
  for (let u = d; u < e.length; u++) {
    ...
    if (f === 0) {
      ...
      let { dom: h, contentDOM: p } = oo(t, f, n, r);
...
var Oc = 1,
  ...
  sr = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (Oc | ao)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Rc | ao)) > 0;
    }
    get deletedAcross() {
  ...
  ht = class t {
    ...
    recover(e) {
      let n = 0,
        r = Tc(e);
      if (!this.inverted)
        for (let o = 0; o < r; o++) n += this.ranges[o * 3 + 2] - this.ranges[o * 3 + 1];
      return this.ranges[r * 3] + n + km(e);
    }
    mapResult(e, n = 1) {
      ...
      for (let l = 0; l < this.ranges.length; l += 3) {
        ...
        if (e <= u) {
          let f = c ? (e == a ? -1 : e == u ? 1 : n) : n,
            h = a + o + (f < 0 ? 0 : d);
          if (r) return h;
          let p = e == (n < 0 ? a : u) ? null : xm(l / 3, e - a),
            m = e == a ? Rc : e == u ? Oc : ao;
          return ((n < 0 ? e != a : e != u) && (m |= Dc), new sr(h, m, p));
        }
        o += d - c;
      }
      return r ? e + o : new sr(e + o, 0, null);
    }
    touches(e, n) {
      let r = 0,
        o = Tc(n),
...
var lr = class t {
  ...
  ue = class {
    ...
    static jsonID(e, n) {
      if (e in ps) throw new RangeError('Duplicate use of step JSON ID ' + e);
...
function ws(t, e, n) {
  ...
  for (let o = 0; o < t.childCount; o++) {
    let i = t.child(o);
    (i.content.size && (i = i.copy(ws(i.content, e, i))),
      i.isInline && (i = e(i, n, o)),
      r.push(i));
  }
  return C.fromArray(r);
}
var ar = class t extends ue {
  constructor(e, n, r) {
...
ue.jsonID('addMark', ar);
var pt = class t extends ue {
  constructor(e, n, r) {
    (super(), (this.from = e), (this.to = n), (this.mark = r));
  }
  apply(e) {
    let n = e.slice(this.from, this.to),
      r = new E(
        ws(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
        n.openStart,
        n.openEnd,
      );
...
ue.jsonID('removeMark', pt);
var cr = class t extends ue {
  constructor(e, n) {
    (super(), (this.pos = e), (this.mark = n));
  }
  apply(e) {
    let n = e.nodeAt(this.pos);
    if (!n) return he.fail("No node at mark step's position");
    let r = n.type.create(n.attrs, null, this.mark.addToSet(n.marks));
    return he.fromReplace(e, this.pos, this.pos + 1, new E(C.from(r), 0, n.isLeaf ? 0 : 1));
  }
  invert(e) {
    let n = e.nodeAt(this.pos);
    if (n) {
      ...
      if (r.length == n.marks.length) {
        for (let o = 0; o < n.marks.length; o++)
          if (!n.marks[o].isInSet(r)) return new t(this.pos, n.marks[o]);
...
ue.jsonID('addNodeMark', cr);
var kn = class t extends ue {
  constructor(e, n) {
    (super(), (this.pos = e), (this.mark = n));
  }
  apply(e) {
  ...
  invert(e) {
    let n = e.nodeAt(this.pos);
    return !n || !this.mark.isInSet(n.marks) ? this : new cr(this.pos, this.mark);
  }
  map(e) {
    let n = e.mapResult(this.pos, 1);
    return n.deletedAfter ? null : new t(n.pos, this.mark);
...
ue.jsonID('removeNodeMark', kn);
var pe = class t extends ue {
  constructor(e, n, r, o = !1) {
    (super(), (this.from = e), (this.to = n), (this.slice = r), (this.structure = o));
  }
  apply(e) {
    return this.structure && ys(e, this.from, this.to)
  ...
  map(e) {
    let n = e.mapResult(this.to, -1),
      r = this.from == this.to && t.MAP_BIAS < 0 ? n : e.mapResult(this.from, 1);
    return r.deletedAcross && n.deletedAcross
      ? null
      : new t(r.pos, Math.max(r.pos, n.pos), this.slice, this.structure);
  }
  merge(e) {
...
var le = class t extends ue {
  ...
  apply(e) {
    ...
    if (n.openStart || n.openEnd) return he.fail('Gap is not a flat range');
  ...
  map(e) {
    ...
    return (n.deletedAcross && r.deletedAcross) || o < n.pos || i > r.pos
      ? null
      : new t(n.pos, r.pos, o, i, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
  ...
  static fromJSON(e, n) {
    ...
    return new t(n.from, n.to, n.gapFrom, n.gapTo, E.fromJSON(e, n.slice), n.insert, !!n.structure);
  }
};
  ...
  (t.doc.nodesBetween(e, n, (a, c, d) => {
    ...
    if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < u.length; m++)
        u[m].isInSet(p) ||
          (s && s.to == f && s.mark.eq(u[m]) ? (s.to = h) : o.push((s = new pt(f, h, u[m]))));
      l && l.to == f ? (l.to = h) : i.push((l = new ar(f, h, r)));
    }
  }),
...
function Cm(t, e, n, r) {
  ...
  (t.doc.nodesBetween(e, n, (s, l) => {
    ...
    o.forEach((s) => t.step(new pt(s.from, s.to, s.style))));
}
function xs(t, e, n, r = n.contentMatch, o = !0) {
  ...
  for (let a = 0; a < i.childCount; a++) {
    ...
    if (!u) s.push(new pe(l, d, E.empty));
      ...
      for (let f = 0; f < c.marks.length; f++)
        n.allowsMarkType(c.marks[f].type) || t.step(new pt(l, d, c.marks[f]));
      if (o && c.isText && n.whitespace != 'pre') {
        let f,
          h = /\r?\n|\r/g,
          p;
        for (; (f = h.exec(c.text));)
          (p || (p = new E(C.from(n.schema.text(' ', n.allowedMarks(c.marks))), 0, 0)),
            s.push(new pe(l + f.index, l + f.index + f[0].length, p)));
      }
    }
    l = d;
  }
...
function mt(t) {
  ...
  for (let r = t.depth, o = 0, i = 0; ; --r) {
    ...
    if (r == 0 || s.type.spec.isolating || !vm(s, l, a)) break;
...
function Mm(t, e, n) {
  ...
  for (let p = i, m = !1; p > n; p--)
    m || r.index(p) > 0 ? ((m = !0), (d = C.from(r.node(p).copy(d))), u++) : a--;
  let f = C.empty,
    h = 0;
  for (let p = i, m = !1; p > n; p--)
    m || o.after(p + 1) < o.end(p) ? ((m = !0), (f = C.from(o.node(p).copy(f))), h++) : c++;
  t.step(new le(a, c, s, l, new E(d.append(f), u, h), d.size - u, !0));
}
function Cn(t, e, n = null, r = t) {
  let o = Tm(t, e),
    i = o && Am(r, e);
  return i ? o.map(Ac).concat({ type: e, attrs: n }).concat(i.map(Ac)) : null;
}
function Ac(t) {
...
function Em(t, e, n) {
  ...
  let o = e.start,
    i = e.end;
  t.step(new le(o, i, o, i, new E(r, 0, 0), n.length, !0));
}
function Nm(t, e, n, r, o) {
  ...
  t.doc.nodesBetween(e, n, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && Om(t.doc, t.mapping.slice(i).map(l), r)) {
      let c = null;
      ...
      (c === !1 && Pc(t, s, l, i), xs(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null));
      let d = t.mapping.slice(i),
        u = d.map(l, 1),
        f = d.map(l + s.nodeSize, 1);
      return (
        t.step(new le(u, f, u + 1, f - 1, new E(C.from(r.create(a, null, s.marks)), 0, 0), 1, !0)),
        c === !0 && Ic(t, s, l, i),
        !1
      );
    }
...
function Rm(t, e, n, r, o) {
  ...
  t.step(new le(e, e + i.nodeSize, e + 1, e + i.nodeSize - 1, new E(C.from(s), 0, 0), 1, !0));
}
function Re(t, e, n = 1, r) {
  let o = t.resolve(e),
    i = o.depth - n,
...
function Ut(t, e, n = -1) {
  ...
  for (let o = r.depth; ; o--) {
    ...
    if (
      ...
      i && !i.isTextblock && Lc(i, s) && r.node(o).canReplace(l, l + 1))
    )
      return e;
    if (o == 0) break;
...
function Pm(t, e, n) {
  ...
  if (r === !1) {
    ...
    Pc(t, d.node(), d.before(), l);
  }
  s.inlineContent && xs(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
  let a = t.mapping.slice(l),
    c = a.map(e - n);
  if ((t.step(new pe(c, a.map(e + n, -1), E.empty, !0)), r === !0)) {
    let d = t.doc.resolve(c);
    Ic(t, d.node(), d.before(), t.steps.length);
  }
  return t;
}
function Lm(t, e, n) {
...
function dr(t, e, n = e, r = E.empty) {
  if (e == n && !r.size) return null;
  let o = t.resolve(e),
    i = t.resolve(n);
  return Bc(o, i, r) ? new pe(e, n, r) : new bs(o, i, r).fit();
}
function Bc(t, e, n) {
  return (
    !n.openStart &&
...
var bs = class {
  constructor(e, n, r) {
    ...
    for (let o = 0; o <= e.depth; o++) {
      let i = e.node(o);
      this.frontier.push({ type: i.type, match: i.contentMatchAt(e.indexAfter(o)) });
    }
    for (let o = e.depth; o > 0; o--) this.placed = C.from(e.node(o).copy(this.placed));
  }
  get depth() {
    ...
    for (let n = 1; n <= 2; n++)
      for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let o,
          i = null;
        r
          ? ((i = ms(this.unplaced.content, r - 1).firstChild), (o = i.content))
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            n == 1 &&
            (s
              ? c.matchType(s.type) || (u = c.fillBefore(C.from(s), !1))
  ...
  openMore() {
    ...
    return !o.childCount || o.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new E(e, n + 1, Math.max(r, o.size + n >= e.size - r ? n + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: n, openEnd: r } = this.unplaced,
      o = ms(e, n);
    if (o.childCount <= 1 && n > 0) {
      ...
      this.unplaced = new E(or(e, n - 1, 1), n - 1, i ? n - 1 : r);
    } else this.unplaced = new E(or(e, n, 1), n, r);
  }
  placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: o, wrap: i }) {
    ...
    for (; c < l.childCount;) {
      ...
      (c++,
        (c > 1 || a == 0 || m.content.size) &&
          ((u = g),
          d.push(zc(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1))));
    }
    let p = c == l.childCount;
    (p || (h = -1),
      (this.placed = ir(this.placed, n, C.from(d))),
    ...
    this.unplaced = p
      ? e == 0
        ? E.empty
        : new E(or(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
      : new E(or(s.content, e, c), s.openStart, s.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !gs(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  close(e) {
    ...
    (n.fit.childCount && (this.placed = ir(this.placed, n.depth, n.fit)), (e = n.move));
  ...
  openFrontierNode(e, n = null, r) {
    ...
    ((o.match = o.match.matchType(e)),
      (this.placed = ir(this.placed, this.depth, C.from(e.create(n, r)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let n = this.frontier.pop().match.fillBefore(C.empty, !0);
    n.childCount && (this.placed = ir(this.placed, this.frontier.length, n));
  }
};
function or(t, e, n) {
  return e == 0
    ? t.cutByIndex(n, t.childCount)
    : t.replaceChild(0, t.firstChild.copy(or(t.firstChild.content, e - 1, n)));
}
function ir(t, e, n) {
  return e == 0
    ? t.append(n)
    : t.replaceChild(t.childCount - 1, t.lastChild.copy(ir(t.lastChild.content, e - 1, n)));
}
function ms(t, e) {
...
function zc(t, e, n) {
  ...
  let r = t.content;
  return (
    e > 1 && (r = r.replaceChild(0, zc(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))),
    e > 0 &&
      ((r = t.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 && (r = r.append(t.type.contentMatch.matchFragment(r).fillBefore(C.empty, !0)))),
    t.copy(r)
  );
}
function gs(t, e, n, r, o) {
  ...
  return l && !Bm(n, i.content, s) ? l : null;
}
function Bm(t, e, n) {
...
function Hm(t, e, n, r) {
  ...
  let o = t.doc.resolve(e),
    i = t.doc.resolve(n);
  if (Bc(o, i, r)) return t.step(new pe(e, n, r));
  let s = $c(o, i);
      ...
      for (let m = 0; m < s.length; m++) {
        ...
        if (w.canReplaceWith(b, b, p.type, p.marks))
          return t.replace(
            o.before(g),
            y ? i.after(g) : n,
            new E(Hc(r.content, 0, r.openStart, h), h, r.openEnd),
          );
      }
  }
...
function Hc(t, e, n, r, o) {
  if (e < n) {
    let i = t.firstChild;
    t = t.replaceChild(0, i.copy(Hc(i.content, e + 1, n, r, i)));
  }
  if (e > r) {
...
function Fm(t, e, n) {
  ...
  if (
    ...
    let s = r.sharedDepth(n),
      l = !1;
    for (let a = r.depth; a > s; a--) r.node(a).type.spec.isolating && (l = !0);
    for (let a = o.depth; a > s; a--) o.node(a).type.spec.isolating && (l = !0);
    if (!l) {
      for (let a = r.depth; a > 0 && e == r.start(a); a--) e = r.before(a);
      for (let a = o.depth; a > 0 && n == o.start(a); a--) n = o.before(a);
...
var co = class t extends ue {
  constructor(e, n, r) {
    (super(), (this.pos = e), (this.attr = n), (this.value = r));
  }
  apply(e) {
    let n = e.nodeAt(this.pos);
    if (!n) return he.fail("No node at attribute step's position");
    let r = Object.create(null);
    for (let i in n.attrs) r[i] = n.attrs[i];
    r[this.attr] = this.value;
    let o = n.type.create(r, null, n.marks);
    return he.fromReplace(e, this.pos, this.pos + 1, new E(C.from(o), 0, n.isLeaf ? 0 : 1));
  }
  getMap() {
    return ht.empty;
  }
...
var Ot = class {
  ...
  step(e) {
    ...
    if (n.failed) throw new Sn(n.failed);
    return this;
  }
  maybeStep(e) {
  ...
  replaceRange(e, n, r) {
    return (Hm(this, e, n, r), this);
  }
  replaceRangeWith(e, n, r) {
    return ($m(this, e, n, r), this);
  }
  deleteRange(e, n) {
    return (Fm(this, e, n), this);
  }
  lift(e, n) {
    return (Mm(this, e, n), this);
  }
  join(e, n = 1) {
    return (Pm(this, e, n), this);
  }
  wrap(e, n) {
    return (Em(this, e, n), this);
  }
  setBlockType(e, n = e, r, o = null) {
    return (Nm(this, e, n, r, o), this);
  }
  setNodeMarkup(e, n, r = null, o) {
    return (Rm(this, e, n, r, o), this);
  }
  setNodeAttribute(e, n, r) {
    return (this.step(new co(e, n, r)), this);
  }
  setDocAttribute(e, n) {
    return (this.step(new uo(e, n)), this);
  }
  addNodeMark(e, n) {
  ...
  removeNodeMark(e, n) {
    ...
    if (n instanceof G) n.isInSet(r.marks) && this.step(new kn(e, n));
    else {
      let o = r.marks,
        i,
        s = [];
      for (; (i = n.isInSet(o));) (s.push(new kn(e, i)), (o = i.removeFromSet(o)));
  ...
  addMark(e, n, r) {
    return (Sm(this, e, n, r), this);
  }
  removeMark(e, n, r) {
    return (Cm(this, e, n, r), this);
  }
...
var ks = Object.create(null),
  z = class {
    constructor(e, n, r) {
      ((this.$anchor = e), (this.$head = n), (this.ranges = r || [new qt(e.min(n), e.max(n))]));
    }
    get anchor() {
    ...
    replace(e, n = E.empty) {
      ...
      for (let l = 0; l < s.length; l++) {
        ...
        (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? E.empty : n),
          l == 0 && Vc(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, n) {
      ...
      for (let i = 0; i < o.length; i++) {
        let { $from: s, $to: l } = o[i],
          ...
          c = a.map(s.pos),
          d = a.map(l.pos);
        i ? e.deleteRange(c, d) : (e.replaceRangeWith(c, d, n), Vc(e, r, n.isInline ? -1 : 1));
      }
    }
    static findFrom(e, n, r = !1) {
      let o = e.parent.inlineContent ? new I(e) : vn(e.node(0), e.parent, e.pos, e.index(), n, r);
      if (o) return o;
      for (let i = e.depth - 1; i >= 0; i--) {
        let s =
          n < 0
            ? vn(e.node(0), e.node(i), e.before(i + 1), e.index(i), n, r)
            : vn(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, n, r);
        if (s) return s;
      }
      return null;
    }
    static near(e, n = 1) {
      return this.findFrom(e, n) || this.findFrom(e, -n) || new xe(e.node(0));
    }
    static atStart(e) {
      return vn(e, e, 0, 0, 1) || new xe(e);
    }
    static atEnd(e) {
      return vn(e, e, e.content.size, e.childCount, -1) || new xe(e);
    }
    static fromJSON(e, n) {
    ...
    static jsonID(e, n) {
      if (e in ks) throw new RangeError('Duplicate use of selection JSON ID ' + e);
      return ((ks[e] = n), (n.prototype.jsonID = e), n);
    }
    getBookmark() {
...
var I = class t extends z {
  ...
  static between(e, n, r) {
    ...
    if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
      let i = z.findFrom(n, r, !0) || z.findFrom(n, -r, !0);
      if (i) n = i.$head;
...
var Cs = class t {
    ...
    map(e) {
      ...
      return n ? new po(r, r) : new t(r);
    }
    resolve(e) {
      let n = e.resolve(this.anchor),
        r = n.nodeAfter;
      return r && L.isSelectable(r) ? new L(n) : z.near(n);
    }
  },
  xe = class t extends z {
    constructor(e) {
...
function vn(t, e, n, r, o, i = !1) {
  if (e.inlineContent) return I.create(t, n);
  for (let s = r - (o > 0 ? 0 : 1); o > 0 ? s < e.childCount : s >= 0; s += o) {
    let l = e.child(s);
    if (l.isAtom) {
      if (!i && L.isSelectable(l)) return L.create(t, n - (o < 0 ? l.nodeSize : 0));
    } else {
      let a = vn(t, l, n + o, o < 0 ? l.childCount : 0, o, i);
      if (a) return a;
    }
    n += l.nodeSize * o;
  }
...
function Vc(t, e, n) {
  ...
  (i.forEach((l, a, c, d) => {
    ...
    t.setSelection(z.near(t.doc.resolve(s), n)));
}
var Wc = 1,
  ho = 2,
  jc = 4,
  mo = class extends Ot {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | Wc) & ~ho),
        (this.storedMarks = null),
        this
      );
    }
    get selectionSet() {
      return (this.updated & Wc) > 0;
    }
    setStoredMarks(e) {
    ...
    ensureMarks(e) {
      return (
        G.sameSet(this.storedMarks || this.selection.$from.marks(), e) || this.setStoredMarks(e),
        this
      );
    }
    addStoredMark(e) {
    ...
    replaceSelectionWith(e, n = !0) {
      ...
      return (
        n &&
          (e = e.mark(
            this.storedMarks || (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || G.none),
          )),
...
var Kt = class {
    constructor(e, n, r) {
      ((this.name = e), (this.init = Uc(n.init, r)), (this.apply = Uc(n.apply, r)));
    }
  },
  Vm = [
    new Kt('doc', {
        ...
        n &&
          n.forEach((r) => {
            ...
            (this.plugins.push(r),
              ...
              r.spec.state && this.fields.push(new Kt(r.key, r.spec.state, r)));
          }));
    }
  },
  fr = class t {
      ...
      for (;;) {
        ...
        for (let s = 0; s < this.config.plugins.length; s++) {
          ...
          if (l.spec.appendTransaction) {
            let a = o ? o[s].n : 0,
              c = o ? o[s].state : this,
              d = a < n.length && l.spec.appendTransaction.call(l, a ? n.slice(a) : n, c, r);
    ...
    static create(e) {
      let n = new ur(e.doc ? e.doc.type.schema : e.schema, e.plugins),
        r = new t(n);
      for (let o = 0; o < n.fields.length; o++) r[n.fields[o].name] = n.fields[o].init(e, r);
      return r;
    }
    reconfigure(e) {
      let n = new ur(this.schema, e.plugins),
        r = n.fields,
        o = new t(n);
    ...
    static fromJSON(e, n, r) {
      ...
      let o = new ur(e.schema, e.plugins),
        i = new t(o);
      return (
        o.fields.forEach((s) => {
          if (s.name == 'doc') i.doc = ne.fromJSON(e.schema, n.doc);
          else if (s.name == 'selection') i.selection = z.fromJSON(i.doc, n.selection);
...
function Kc(t, e, n) {
  for (let r in t) {
    let o = t[r];
    (o instanceof Function ? (o = o.bind(e)) : r == 'handleDOMEvents' && (o = Kc(o, e, {})),
      (n[r] = o));
  }
  return n;
}
var B = class {
    constructor(e) {
      ((this.spec = e),
        (this.props = {}),
        e.props && Kc(e.props, this, this.props),
        (this.key = e.key ? e.key.key : qc('plugin')));
    }
    getState(e) {
      return e[this.key];
    }
...
var Gc = (t, e) => (t.selection.empty ? !1 : (e && e(t.tr.deleteSelection().scrollIntoView()), !0));
function Xc(t, e) {
...
var Ms = (t, e, n) => {
    ...
    let i = o.nodeBefore;
    if (id(t, o, e, -1)) return !0;
    if (r.parent.content.size == 0 && (Mn(i, 'end') || L.isSelectable(i)))
      for (let s = r.depth; ; s--) {
        let l = dr(t.doc, r.before(s), r.after(s), E.empty);
        if (l && l.slice.size < l.to - l.from) {
          if (e) {
            let a = t.tr.step(l);
            (a.setSelection(
              Mn(i, 'end')
                ? z.findFrom(a.doc.resolve(a.mapping.map(o.pos, -1)), -1)
...
function Zc(t, e, n) {
  ...
  let c = dr(t.doc, i, a, E.empty);
  if (!c || c.from != i || (c instanceof pe && c.slice.size >= a - i)) return !1;
  if (n) {
    let d = t.tr.step(c);
    (d.setSelection(I.create(d.doc, i)), n(d.scrollIntoView()));
  }
  return !0;
}
function Mn(t, e, n = !1) {
...
var Ts = (t, e, n) => {
  ...
  return !s || !L.isSelectable(s)
    ? !1
    : (e && e(t.tr.setSelection(L.create(t.doc, i.pos - s.nodeSize)).scrollIntoView()), !0);
};
function As(t) {
...
var Es = (t, e, n) => {
    ...
    let i = o.nodeAfter;
    if (id(t, o, e, 1)) return !0;
    if (r.parent.content.size == 0 && (Mn(i, 'start') || L.isSelectable(i))) {
      let s = dr(t.doc, r.before(), r.after(), E.empty);
      if (s && s.slice.size < s.to - s.from) {
        if (e) {
          let l = t.tr.step(s);
          (l.setSelection(
            Mn(i, 'start')
              ? z.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1)
  ...
  Ns = (t, e, n) => {
    ...
    return !s || !L.isSelectable(s)
      ? !1
      : (e && e(t.tr.setSelection(L.create(t.doc, i.pos)).scrollIntoView()), !0);
  };
function Os(t) {
  if (!t.parent.type.spec.isolating)
    for (let e = t.depth - 1; e >= 0; e--) {
...
var td = (t, e) => {
    let n = t.selection,
      ...
      o;
    if (r) {
      if (n.node.isTextblock || !Le(t.doc, n.from)) return !1;
      o = n.from;
    } else if (((o = Ut(t.doc, n.from, -1)), o == null)) return !1;
    if (e) {
      let i = t.tr.join(o);
      (r && i.setSelection(L.create(i.doc, o - t.doc.resolve(o).nodeBefore.nodeSize)),
        e(i.scrollIntoView()));
    }
    return !0;
  },
  nd = (t, e) => {
    let n = t.selection,
      r;
    if (n instanceof L) {
      if (n.node.isTextblock || !Le(t.doc, n.to)) return !1;
      r = n.to;
    } else if (((r = Ut(t.doc, n.to, 1)), r == null)) return !1;
...
var Is = (t, e) => {
  ...
  Ps = (t, e) => {
    let n = t.selection,
      { $from: r, $to: o } = n;
    if (n instanceof xe || r.parent.inlineContent || o.parent.inlineContent) return !1;
    let i = Ds(o.parent.contentMatchAt(o.indexAfter()));
  ...
  Ls = (t, e) => {
    ...
    if (n.depth > 1 && n.after() != n.end(-1)) {
      let i = n.before();
      if (Re(t.doc, i)) return (e && e(t.tr.split(i).scrollIntoView()), !0);
    }
    let r = n.blockRange(),
      o = r && mt(r);
...
function Wm(t) {
  return (e, n) => {
    ...
    if (e.selection instanceof L && e.selection.node.isBlock)
      return !r.parentOffset || !Re(e.doc, r.pos)
        ? !1
    ...
    for (let h = r.depth; ; h--)
      if (r.node(h).isBlock) {
        ((a = r.end(h) == r.pos + (r.depth - h)),
          ...
          (l = Ds(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1)))));
    ...
    let d = e.tr;
    (e.selection instanceof I || e.selection instanceof xe) && d.deleteSelection();
    let u = d.mapping.map(r.pos),
      f = Re(d.doc, u, i.length, i);
    if ((f || ((i[0] = l ? { type: l } : null), (f = Re(d.doc, u, i.length, i))), !f)) return !1;
...
var od = (t, e) => {
    let { $from: n, to: r } = t.selection,
      o,
      i = n.sharedDepth(r);
    return i == 0 ? !1 : ((o = n.before(i)), e && e(t.tr.setSelection(L.create(t.doc, o))), !0);
  },
  Um = (t, e) => (e && e(t.tr.setSelection(new xe(t.doc))), !0);
function Km(t, e, n) {
  let r = e.nodeBefore,
    o = e.nodeAfter,
    i = e.index();
  return !r || !o || !r.type.compatibleContent(o.type)
    ...
    : !r.content.size && e.parent.canReplace(i - 1, i)
      ...
      : !e.parent.canReplace(i, i + 1) || !(o.isTextblock || Le(t.doc, e.pos))
        ? !1
  ...
  if (
    ...
    if (n) {
      let h = e.pos + i.nodeSize,
        p = C.empty;
      for (let y = s.length - 1; y >= 0; y--) p = C.from(s[y].create(null, p));
      p = C.from(o.copy(p));
      let m = t.tr.step(new le(e.pos - 1, h, e.pos, h, new E(p, 1, 0), s.length, !0)),
        g = m.doc.resolve(h + 2 * s.length);
      (g.nodeAfter && g.nodeAfter.type == o.type && Le(m.doc, g.pos) && m.join(g.pos),
        n(m.scrollIntoView()));
    }
    return !0;
  }
  let d = i.type.spec.isolating || (r > 0 && a) ? null : z.findFrom(e, 1),
    u = d && d.$from.blockRange(d.$to),
    f = u && mt(u);
  if (f != null && f >= e.depth) return (n && n(t.tr.lift(u, f).scrollIntoView()), !0);
  if (c && Mn(i, 'start', !0) && Mn(o, 'end')) {
    let h = o,
      p = [];
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (n) {
        let y = C.empty;
        for (let b = p.length - 1; b >= 0; b--) y = C.from(p[b].copy(y));
        let w = t.tr.step(
          new le(
            e.pos - p.length,
            e.pos + i.nodeSize,
...
function sd(t) {
  return function (e, n) {
    ...
    return o.node(i).isTextblock
      ? (n && n(e.tr.setSelection(I.create(e.doc, t < 0 ? o.start(i) : o.end(i)))), !0)
      : !1;
  };
}
var Bs = sd(-1),
...
function ad(t, e = null) {
  return function (n, r) {
    ...
    if (!s) return !1;
    let l = r ? n.tr : null;
    return Jm(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function Jm(t, e, n, r = null) {
  let o = !1,
    i = e,
    s = e.$from.doc;
  if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(n) && e.startIndex == 0) {
    ...
    ((i = new Et(a, a, e.depth)),
      e.endIndex < e.parent.childCount &&
        (e = new Et(e.$from, s.resolve(e.$to.end(e.depth)), e.depth)),
      (o = !0));
  }
  let l = Cn(i, n, r, e);
  return l ? (t && Gm(t, e, l, o, n), !0) : !1;
}
function Gm(t, e, n, r, o) {
  let i = C.empty;
  for (let d = n.length - 1; d >= 0; d--) i = C.from(n[d].type.create(n[d].attrs, i));
  t.step(new le(e.start - (r ? 2 : 0), e.end, e.start, e.end, new E(i, 0, 0), n.length, !0));
  let s = 0;
  ...
  for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
    (!f && Re(t.doc, a, l) && (t.split(a, l), (a += 2 * l)), (a += c.child(d).nodeSize));
  return t;
}
function cd(t) {
  return function (e, n) {
    ...
    return i ? (n ? (r.node(i.depth - 1).type == t ? Xm(e, n, t, i) : Ym(e, n, i)) : !0) : !1;
  };
}
function Xm(t, e, n, r) {
  let o = t.tr,
    ...
    s = r.$to.end(r.depth);
  i < s &&
    (o.step(new le(i - 1, s, i, s, new E(C.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)),
    (r = new Et(o.doc.resolve(r.$from.pos), o.doc.resolve(s), r.depth)));
  let l = mt(r);
  if (l == null) return !1;
  o.lift(r, l);
  let a = o.doc.resolve(o.mapping.map(i, -1) - 1);
  return (
    Le(o.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && o.join(a.pos),
    e(o.scrollIntoView()),
    !0
  );
}
function Ym(t, e, n) {
  ...
  let l = n.startIndex == 0,
    ...
    c = i.node(-1),
    d = i.index(-1);
  if (!c.canReplace(d + (l ? 0 : 1), d + 1, s.content.append(a ? C.empty : C.from(o)))) return !1;
  let u = i.pos,
    f = u + s.nodeSize;
  return (
    r.step(
      new le(
        ...
        f - 1,
        new E(
          (l ? C.empty : C.from(o.copy(C.empty))).append(a ? C.empty : C.from(o.copy(C.empty))),
          l ? 0 : 1,
          a ? 0 : 1,
        ),
        l ? 0 : 1,
  ...
  return function (e, n) {
    ...
    if (n) {
      let c = a.lastChild && a.lastChild.type == l.type,
        d = C.from(c ? t.create() : null),
        u = new E(C.from(t.create(null, C.from(l.type.create(null, d)))), c ? 3 : 1, 0),
        f = i.start,
        h = i.end;
      n(e.tr.step(new le(f - (c ? 3 : 1), h, f, h, u, 1, !0)).scrollIntoView());
    }
    return !0;
  };
}
...
var me = function (t) {
  ...
  en = function (t, e, n, r) {
    return n && (ud(t, e, n, r, -1) || ud(t, e, n, r, 1));
  },
...
function ud(t, e, n, r, o) {
  for (var i; ;) {
    ...
    if (e == (o < 0 ? 0 : ze(t))) {
      let s = t.parentNode;
      if (!s || s.nodeType != 1 || xr(t) || Zm.test(t.nodeName) || t.contentEditable == 'false')
        return !1;
      ((e = me(t) + (o < 0 ? 0 : 1)), (t = s));
    } else if (t.nodeType == 1) {
      let s = t.childNodes[e + (o < 0 ? -1 : 0)];
      if (s.nodeType == 1 && s.contentEditable == 'false')
        if (!((i = s.pmViewDesc) === null || i === void 0) && i.ignoreForSelection) e += o;
        else return !1;
      else ((t = s), (e = o < 0 ? ze(t) : 0));
    } else return !1;
  }
}
function ze(t) {
...
function eg(t, e) {
  for (;;) {
    ...
    if (t.nodeType == 1 && e > 0) {
      ...
      ((t = t.childNodes[e - 1]), (e = ze(t)));
    } else if (t.parentNode && !xr(t)) ((e = me(t)), (t = t.parentNode));
    else return null;
  }
}
function tg(t, e) {
  for (;;) {
    ...
    } else if (t.parentNode && !xr(t)) ((e = me(t) + 1), (t = t.parentNode));
    else return null;
  }
}
function ng(t, e, n) {
  for (let r = e == 0, o = e == ze(t); r || o;) {
    if (t == n) return !0;
    let i = me(t);
...
function og(t, e, n) {
  if (t.caretPositionFromPoint)
    try {
      ...
      if (r) return { node: r.offsetNode, offset: Math.min(ze(r.offsetNode), r.offset) };
    } catch {}
  if (t.caretRangeFromPoint) {
    let r = t.caretRangeFromPoint(e, n);
    if (r) return { node: r.startContainer, offset: Math.min(ze(r.startContainer), r.startOffset) };
  }
}
var et = typeof navigator < 'u' ? navigator : null,
  fd = typeof document < 'u' ? document : null,
  zt = (et && et.userAgent) || '',
  qs = /Edge\/(\d+)/.exec(zt),
  jd = /MSIE \d/.exec(zt),
  Js = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(zt),
  Ee = !!(jd || Js || qs),
  Lt = jd ? document.documentMode : Js ? +Js[1] : qs ? +qs[1] : 0,
  He = !Ee && /gecko\/(\d+)/i.test(zt);
He && +(/Firefox\/(\d+)/.exec(zt) || [0, 0])[1];
var Gs = !Ee && /Chrome\/(\d+)/.exec(zt),
  ge = !!Gs,
  Ud = Gs ? +Gs[1] : 0,
  Se = !Ee && !!et && /Apple Computer/.test(et.vendor),
  Rn = Se && (/Mobile\/\w+/.test(zt) || (!!et && et.maxTouchPoints > 2)),
  Be = Rn || (et ? /Mac/.test(et.platform) : !1),
  Kd = et ? /Win/.test(et.platform) : !1,
  bt = /Android \d/.test(zt),
  kr = !!fd && 'webkitFontSmoothing' in fd.documentElement.style,
  ig = kr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function sg(t) {
...
function hd(t, e, n) {
  ...
  for (let s = n || t.dom; s;) {
    ...
    let l = s,
      ...
      u = 0;
    if (
      (e.top < c.top + gt(r, 'top')
        ? (u = -(c.top - e.top + gt(o, 'top')))
        : e.bottom > c.bottom - gt(r, 'bottom') &&
          (u =
            e.bottom - e.top > c.bottom - c.top
              ? e.top + gt(o, 'top') - c.top
              : e.bottom - c.bottom + gt(o, 'bottom')),
      e.left < c.left + gt(r, 'left')
        ? (d = -(c.left - e.left + gt(o, 'left')))
        : e.right > c.right - gt(r, 'right') && (d = e.right - c.right + gt(o, 'right')),
      d || u)
    )
    ...
    s = f == 'absolute' ? s.offsetParent : On(s);
  }
}
function ag(t) {
  ...
  return { refDOM: r, refTop: o, stack: qd(t.dom) };
}
function qd(t) {
  let e = [],
    n = t.ownerDocument;
...
function cg({ refDOM: t, refTop: e, stack: n }) {
...
function Gd(t, e) {
  ...
  for (let d = t.firstChild, u = 0; d; d = d.nextSibling, u++) {
    ...
    else if (d.nodeType == 3) f = yt(d).getClientRects();
    else continue;
      ...
      if (p.top <= s && p.bottom >= l) {
        ...
        if (m < r) {
          ((n = d),
            ...
            d.nodeType == 1 && m && (i = u + (e.left >= (p.left + p.right) / 2 ? 1 : 0)));
          continue;
        }
      } else
        p.top > e.top &&
    ...
    if (
      ...
      (l.node.isBlock &&
        ...
        ((!s && a.left > r.left) || a.top > r.top
          ? (o = l.posBefore)
          : ((!s && a.right < r.left) || a.bottom < r.top) && (o = l.posAfter),
        (s = !0)),
...
function mg(t, e) {
  ...
  if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
    ...
    if (!dl(e, c) || ((s = Xd(t.dom, e, c)), !s)) return null;
  }
  if (Se) for (let c = s; r && c; c = On(c)) c.draggable && (r = void 0);
  if (((s = fg(s, e)), r)) {
    if (
      He &&
      r.nodeType == 1 &&
...
function Yd(t, e, n) {
  let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
    s = kr || He;
  if (r.nodeType == 3)
    if (s && (gg.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
      let a = Dt(yt(r, o, o), n);
      if (He && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
        let c = Dt(yt(r, o - 1, o - 1), -1);
        if (c.top == a.top) {
          let d = Dt(yt(r, o, o + 1), -1);
          if (d.top != a.top) return hr(d, d.left < c.left);
        }
      }
      return a;
    } else {
        ...
        n < 0 && !o
          ...
          : n >= 0 && o == r.nodeValue.length
            ...
            : n < 0
              ? a--
              : c++,
        hr(Dt(yt(r, a, c), d), d < 0)
      );
    }
  if (!t.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
    if (i == null && o && (n < 0 || o == ze(r))) {
      let a = r.childNodes[o - 1];
      if (a.nodeType == 1) return _s(a.getBoundingClientRect(), !1);
    }
    if (i == null && o < ze(r)) {
      let a = r.childNodes[o];
      if (a.nodeType == 1) return _s(a.getBoundingClientRect(), !0);
    }
...
function yg(t, e, n) {
  ...
  return Qd(t, e, () => {
    ...
    for (let l = i.firstChild; l; l = l.nextSibling) {
      ...
      else if (l.nodeType == 3) a = yt(l, 0, l.nodeValue.length).getClientRects();
      else continue;
...
function wg(t, e, n) {
  ...
  let o = r.parentOffset,
    ...
    l = t.domSelection();
  return l
    ? !bg.test(r.parent.textContent) || !l.modify
      ? n == 'left' || n == 'backward'
        ? i
        : s
      : Qd(t, e, () => {
...
function xg(t, e, n) {
  return md == e && gd == n
    ? yd
    : ((md = e), (gd = n), (yd = n == 'up' || n == 'down' ? yg(t, e, n) : wg(t, e, n)));
}
var $e = 0,
  bd = 1,
  Gt = 2,
  ...
  tn = class {
    ...
    domFromPos(e, n) {
      ...
      for (let i; r && !(i = this.children[r - 1]).size && i instanceof yo && i.side >= 0; r--);
      if (n <= 0) {
        let i,
          s = !0;
        for (
          ;
          (i = r ? this.children[r - 1] : null), !(!i || i.dom.parentNode == this.contentDOM);
          r--, s = !1
        );
        ...
        return i && s && !i.border && !i.domAtom
          ? i.domFromPos(0, n)
          : { node: this.contentDOM, offset: i ? me(i.dom) : this.contentDOM.childNodes.length };
      }
    }
    parseRange(e, n, r = 0) {
    ...
    setSelection(e, n, r, o = !1) {
      ...
      for (let h = 0, p = 0; h < this.children.length; h++) {
        let m = this.children[h],
          g = p + m.size;
        if (i > p && s < g) return m.setSelection(e - p - m.border, n - p - m.border, r, o);
        p = g;
      }
...
`
      ...
      if (He && d.focusNode && d.focusNode != a.node && d.focusNode.nodeType == 1) {
        let h = d.focusNode.childNodes[d.focusOffset];
        h && h.contentEditable == 'false' && (o = !0);
      }
      if (
        !(o || (u && Se)) &&
        en(l.node, l.offset, d.anchorNode, d.anchorOffset) &&
        en(a.node, a.offset, d.focusNode, d.focusOffset)
      )
        return;
      let f = !1;
      if ((c.extend || e == n) && !(u && He)) {
      ...
      for (let r = 0, o = 0; o < this.children.length; o++) {
        ...
        if (r == s ? e <= s && n >= r : e < s && n > r) {
          let l = r + i.border,
            a = s - i.border;
          if (e >= l && n <= a) {
            ((this.dirty = e == r || n == s ? Gt : bd),
              e == l && n == a && (i.contentLost || i.dom.parentNode != this.contentDOM)
                ? (i.dirty = tt)
                : i.markDirty(e - l, n - l));
            return;
          } else
  ...
  yo = class extends tn {
    ...
    matchesWidget(e) {
      return this.dirty == $e && e.type.eq(this.widget.type);
    }
    parseRule() {
      return { ignore: !0 };
    }
  ...
  Dn = class t extends tn {
    ...
    static create(e, n, r, o) {
      let i = o.nodeViews[n.type.name],
        s = i && i(n, o, r);
      return (
        (!s || !s.dom) && (s = Ze.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
        new t(e, n, s.dom, s.contentDOM || s.dom, s)
      );
    }
    parseRule() {
      return this.dirty & tt || this.mark.type.spec.reparseInView
        ? null
    ...
    markDirty(e, n) {
      if ((super.markDirty(e, n), this.dirty != $e)) {
        let r = this.parent;
        for (; !r.node;) r = r.parent;
        (r.dirty < this.dirty && (r.dirty = this.dirty), (this.dirty = $e));
      }
    }
    slice(e, n, r) {
      let o = t.create(this.parent, this.mark, !0, r),
        i = this.children,
        s = this.size;
      (n < s && (i = el(i, n, s, r)), e > 0 && (i = el(i, 0, e, r)));
  ...
  Bt = class t extends tn {
    ...
    matchesNode(e, n, r) {
      return this.dirty == $e && e.eq(this.node) && xo(n, this.outerDeco) && r.eq(this.innerDeco);
    }
    get size() {
    ...
    updateChildren(e, n) {
      let r = this.node.inlineContent,
        ...
        s = i && i.pos > -1 ? i : null,
        l = i && i.pos < 0,
        a = new Zs(this, s && s.node, e);
      (vg(
        this.node,
        this.innerDeco,
        (c, d, u) => {
          (c.spec.marks
            ? a.syncToMarks(c.spec.marks, r, e, d)
            : c.type.side >= 0 &&
              !u &&
              a.syncToMarks(d == this.node.childCount ? G.none : this.node.child(d).marks, r, e, d),
            a.placeWidget(c, e, o));
        },
        (c, d, u, f) => {
        ...
        a.destroyRest(),
        (a.changed || this.dirty == Gt) &&
          (s && this.protectLocalComposition(e, s),
          Zd(this.contentDOM, this.children, e),
          Rn && Mg(this.dom)));
    }
    localCompositionInfo(e, n) {
      let { from: r, to: o } = e.state.selection;
      if (!(e.state.selection instanceof I) || r < n || o > n + this.node.content.size) return null;
      let i = e.input.compositionNode;
      if (!i || !this.dom.contains(i.parentNode)) return null;
      if (this.node.inlineContent) {
        let s = i.nodeValue,
          l = Tg(this.node.content, s, r - n, o - n);
    ...
    protectLocalComposition(e, { node: n, pos: r, text: o }) {
      ...
      let s = new Xs(this, i, n, o);
      (e.input.compositionNodes.push(s),
        (this.children = el(this.children, r, r + o.length, e, s)));
    }
    update(e, n, r, o) {
      return this.dirty == tt || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, n, r, o), !0);
    }
    updateInner(e, n, r, o) {
    ...
    updateOuterDeco(e) {
      if (xo(e, this.outerDeco)) return;
      let n = this.nodeDOM.nodeType != 1,
        r = this.dom;
      ((this.dom = eu(
        this.dom,
        this.nodeDOM,
        Qs(this.outerDeco, this.node, n),
        Qs(e, this.node, n),
      )),
...
function wd(t, e, n, r, o) {
  tu(r, e, t);
  let i = new Bt(void 0, t, e, n, r, r, r, o, 0);
  return (i.contentDOM && i.updateChildren(o, 0), i);
}
var bo = class t extends Bt {
    ...
    update(e, n, r, o) {
      return this.dirty == tt || (this.dirty != $e && !this.inParent()) || !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(n),
          (this.dirty != $e || e.text != this.node.text) &&
  ...
  wo = class extends tn {
    ...
    matchesHack(e) {
      return this.dirty == $e && this.dom.nodeName == e;
    }
    get domAtom() {
      return !0;
    }
...
function Zd(t, e, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    if (s instanceof Dn) {
      ...
      (Zd(s.contentDOM, s.children, n), (r = a ? a.nextSibling : t.firstChild));
    }
  }
  for (; r;) ((r = xd(r)), (o = !0));
...
pr.prototype = Object.create(null);
var Xt = [new pr()];
function Qs(t, e, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    if (s) {
      s.nodeName && o.push((r = new pr(s.nodeName)));
      for (let l in s) {
        let a = s[l];
        a != null &&
          (n && o.length == 1 && o.push((r = new pr(e.isInline ? 'span' : 'div'))),
          l == 'class'
...
function kg(t, e, n) {
  ...
  if (e.class != n.class) {
    ...
    for (let i = 0; i < r.length; i++) o.indexOf(r[i]) == -1 && t.classList.remove(r[i]);
    for (let i = 0; i < o.length; i++) r.indexOf(o[i]) == -1 && t.classList.add(o[i]);
...
function tu(t, e, n) {
  return eu(t, t, Xt, Qs(e, n, t.nodeType != 1));
}
function xo(t, e) {
  if (t.length != e.length) return !1;
...
var Zs = class {
  constructor(e, n, r) {
    ((this.lock = n),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = Sg(e.node.content, e)));
  }
  destroyBetween(e, n) {
    if (e != n) {
  ...
  syncToMarks(e, n, r, o) {
    ...
    for (; s < e.length;) {
      ...
      if (a > -1)
        ...
        let d = Dn.create(this.top, e[s], n, r);
  ...
  updateNodeAt(e, n, r, o, i) {
    ...
    return (
      s.dirty == tt && s.dom == s.contentDOM && (s.dirty = Gt),
      s.update(e, n, r, i) ? (this.destroyBetween(this.index, o), this.index++, !0) : !1
    );
  }
      ...
      if (a instanceof Bt) {
        ...
        if (!f && (u = this.recreateWrapper(a, e, n, r, o, s)))
          return (
            ...
            u.contentDOM && ((u.dirty = Gt), u.updateChildren(o, s + 1), (u.dirty = $e)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      n = this.top;
    for (; e instanceof Dn;) ((n = e), (e = n.children[n.children.length - 1]));
    (!e ||
      !(e instanceof bo) ||
      /\n$/.test(e.node.text) ||
      (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
      ((Se || ge) && e && e.dom.contentEditable == 'false' && this.addHackNode('IMG', n),
  ...
  e: for (; o > 0;) {
    ...
    for (;;)
      if (r) {
        ...
        if (c instanceof Dn) ((n = c), (r = c.children.length));
        else {
          ((l = c), r--);
          break;
        }
...
function ul(t, e = null) {
  ...
  if (To(n)) {
    ...
    if (
      ...
      L.isSelectable(u) &&
      o.parent &&
      !(u.isInline && ng(n.focusNode, n.focusOffset, o.dom))
    ) {
      let f = o.posBefore;
    ...
    if (n instanceof t.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
      ...
      for (let h = 0; h < n.rangeCount; h++) {
        ...
        ((u = Math.min(u, t.docView.posFromDOM(p.startContainer, p.startOffset, 1))),
...
function nu(t) {
  return t.editable
    ? t.hasFocus()
    : ou(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function wt(t, e = !1) {
  ...
  if ((ru(t, n), !!nu(t))) {
    if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && ge) {
      ...
      if (
        r.anchorNode &&
        o.anchorNode &&
        en(r.anchorNode, r.anchorOffset, o.anchorNode, o.anchorOffset)
      ) {
        ((t.input.mouseDown.delayedSelectionSync = !0), t.domObserver.setCurSelection());
        return;
      }
    }
    if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) Eg(t);
    else {
      ...
      (kd &&
        !(n instanceof I) &&
        (n.$from.parent.inlineContent || (i = Sd(t, n.from)),
        !n.empty && !n.$from.parent.inlineContent && (s = Sd(t, n.to))),
        ...
        n.visible
          ...
          : (t.dom.classList.add('ProseMirror-hideselection'),
            'onselectionchange' in document && Ag(t)));
    }
...
function Sd(t, e) {
  ...
  if (Se && o && o.contentEditable == 'false') return Vs(o);
...
function Vs(t) {
  return (
    ...
    Se && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
    t
  );
}
function Cd(t) {
  ...
  e.addEventListener(
    ...
    (t.input.hideSelectionGuard = () => {
      (n.anchorNode != r || n.anchorOffset != o) &&
        (e.removeEventListener('selectionchange', t.input.hideSelectionGuard),
        setTimeout(() => {
          (!nu(t) || t.state.selection.visible) &&
            t.dom.classList.remove('ProseMirror-hideselection');
        }, 20));
    }),
  );
...
function Eg(t) {
  ...
  (r ? e.collapse(n.parentNode, me(n) + 1) : e.collapse(n, 0),
    !r && !t.state.selection.visible && Ee && Lt <= 11 && ((n.disabled = !0), (n.disabled = !1)));
}
function ru(t, e) {
  if (e instanceof L) {
...
function fl(t, e, n, r) {
  return t.someProp('createSelectionBetween', (o) => o(t, e, n)) || I.between(e, n, r);
}
function Md(t) {
  return t.editable && !t.hasFocus() ? !1 : ou(t);
}
function ou(t) {
    ...
    if (n.indexOf('s') > -1) {
      ...
      if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
        ...
        return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
          ? L.isSelectable(i)
            ? It(t, new L(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
            : kr
              ? It(t, new I(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
  else {
    if (r instanceof L && r.node.isInline) return It(t, new I(e > 0 ? r.$to : r.$from));
    {
      let o = tl(t.state, e);
      return o ? It(t, o) : !1;
    }
...
function Og(t) {
  ...
  let o,
    i,
    s = !1;
  for (He && n.nodeType == 1 && r < ko(n) && mr(n.childNodes[r], -1) && (s = !0); ;)
    if (r > 0) {
      ...
      if (iu(n)) break;
      {
        ...
        for (; l && mr(l, -1);) ((o = n.parentNode), (i = me(l)), (l = l.previousSibling));
        if (l) ((n = l), (r = ko(n)));
        else {
...
function Rg(t) {
  ...
  for (;;)
    if (r < o) {
      ...
      {
        let l = n.nextSibling;
        for (; l && mr(l, 1);) ((i = l.parentNode), (s = me(l) + 1), (l = l.nextSibling));
        if (l) ((n = l), (r = 0), (o = ko(n)));
        else {
          if (((n = n.parentNode), n == t.dom)) break;
          r = o = 0;
...
function Dg(t, e) {
  for (; t && e == t.childNodes.length && !xr(t);) ((e = me(t) + 1), (t = t.parentNode));
...
function Ig(t, e) {
  for (; t && !e && !xr(t);) ((e = me(t)), (t = t.parentNode));
  for (; t && e;) {
...
function nl(t, e, n) {
  if (e.nodeType != 3) {
    let i, s;
    (s = Dg(e, n)) ? ((e = s), (n = 0)) : (i = Ig(e, n)) && ((e = i), (n = i.nodeValue.length));
  }
...
function Ad(t, e) {
  ...
  if (!(ge || Kd) && n.parent.inlineContent) {
...
function Ed(t, e, n) {
  let r = t.state.selection;
  if ((r instanceof I && !r.empty) || n.indexOf('s') > -1 || (Be && n.indexOf('m') > -1)) return !1;
  let { $from: o, $to: i } = r;
  ...
  if (!o.parent.inlineContent) {
    let s = e < 0 ? o : i,
      l = r instanceof xe ? z.near(s, e) : z.findFrom(s, e);
    return l ? It(t, l) : !1;
  }
  return !1;
}
function Nd(t, e) {
  if (!(t.state.selection instanceof I)) return !0;
  ...
  if (i && !i.isText) {
    let s = t.state.tr;
    return (
      e < 0 ? s.delete(n.pos - i.nodeSize, n.pos) : s.delete(n.pos, n.pos + i.nodeSize),
      t.dispatch(s),
      !0
    );
  }
...
function Pg(t) {
  if (!Se || t.state.selection.$head.parentOffset > 0) return !1;
...
function Bg(t, e) {
  let n = e.keyCode,
    r = Lg(e);
  if (n == 8 || (Be && n == 72 && r == 'c')) return Nd(t, -1) || An(t, -1);
  if ((n == 46 && !e.shiftKey) || (Be && n == 68 && r == 'c')) return Nd(t, 1) || An(t, 1);
  if (n == 13 || n == 27) return !0;
  if (n == 37 || (Be && n == 66 && r == 'c')) {
    let o = n == 37 ? (Ad(t, t.state.selection.from) == 'ltr' ? -1 : 1) : -1;
    return Td(t, o, r) || An(t, o);
  } else if (n == 39 || (Be && n == 70 && r == 'c')) {
    let o = n == 39 ? (Ad(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1;
    return Td(t, o, r) || An(t, o);
  } else {
    if (n == 38 || (Be && n == 80 && r == 'c')) return Ed(t, -1, r) || An(t, -1);
    if (n == 40 || (Be && n == 78 && r == 'c')) return Pg(t) || Ed(t, 1, r) || An(t, 1);
    if (r == (Be ? 'm' : 'c') && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
  }
  return !1;
}
function hl(t, e) {
  ...
  let c = a.firstChild,
    d,
    u = 0;
  for (; c && c.nodeType == 1 && (d = cu[c.nodeName.toLowerCase()]);) {
  ...
  c &&
    c.nodeType == 1 &&
    c.setAttribute('data-pm-slice', `${o} ${i}${u ? ` -${u}` : ''} ${JSON.stringify(n)}`);
  let f =
...
`,
  ...
  if (
    ...
    l = Vg(Rd(l, +d[1], +d[2]), d[4]);
  else if (((l = E.maxOpen(Hg(l.content, o), !0)), l.openStart || l.openEnd)) {
    let u = 0,
      f = 0;
    for (
    ...
    if (
      (t.forEach((l) => {
        ...
        let a = o.findWrapping(l.type),
          c;
        if (!a) return (s = null);
        if ((c = s.length && i.length && lu(a, i, l, s[s.length - 1], 0))) s[s.length - 1] = c;
        else {
          s.length && (s[s.length - 1] = au(s[s.length - 1], i.length));
          let d = su(l, a);
...
function lu(t, e, n, r, o) {
  if (o < t.length && o < e.length && t[o] == e[o]) {
    let i = lu(t, e, n, r.lastChild, o + 1);
    ...
    if (r.contentMatchAt(r.childCount).matchType(o == t.length - 1 ? n.type : t[o + 1]))
      return r.copy(r.content.append(C.from(su(n, t, o + 1))));
  }
}
function au(t, e) {
  if (e == 0) return t;
  let n = t.content.replaceChild(t.childCount - 1, au(t.lastChild, e - 1)),
    r = t.contentMatchAt(t.childCount).fillBefore(C.empty, !0);
      ...
      (l =
        e < 0
          ? s
              ...
              .fillBefore(l, i <= o)
              .append(l)
          : l.append(s.contentMatchAt(s.childCount).fillBefore(C.empty, !0))),
    t.replaceChild(e < 0 ? 0 : t.childCount - 1, s.copy(l))
  );
}
function Rd(t, e, n) {
  return (
    e < t.openStart && (t = new E(rl(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
    n < t.openEnd && (t = new E(rl(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
    t
  );
}
var cu = {
...
function $g(t) {
  ...
  return e
    ? (Ws ||
        (Ws = e.defaultPolicy || e.createPolicy('ProseMirrorClipboard', { createHTML: (n) => n })),
      Ws.createHTML(t))
    : t;
}
function Fg(t) {
  ...
  let n = du().createElement('div'),
    r = /<([a-z][^>\s]+)/i.exec(t),
    o;
  if (
    ((o = r && cu[r[1].toLowerCase()]) &&
      (t =
        o.map((i) => '<' + i + '>').join('') +
        t +
        o
  ...
  for (let e in ve) {
    ...
    t.dom.addEventListener(
      ...
      (t.input.eventHandlers[e] = (r) => {
        Kg(t, r) && !ml(t, r) && (t.editable || !(r.type in Me)) && n(t, r);
      }),
      Wg[e] ? { passive: !0 } : void 0,
    );
  }
  (Se && t.dom.addEventListener('input', () => null), il(t));
}
function Pt(t, e) {
  ...
  t.someProp('handleDOMEvents', (e) => {
    for (let n in e)
      t.input.eventHandlers[n] ||
        t.dom.addEventListener(n, (t.input.eventHandlers[n] = (r) => ml(t, r)));
  });
}
function ml(t, e) {
...
function qg(t, e) {
  !ml(t, e) && ve[e.type] && (t.editable || !(e.type in Me)) && ve[e.type](t, e);
}
Me.keydown = (t, e) => {
  let n = e;
  if (
    ...
    if (
      ...
      Rn && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      let r = Date.now();
      ((t.input.lastIOSEnter = r),
        (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          t.input.lastIOSEnter == r &&
            (t.someProp('handleKeyDown', (o) => o(t, Jt(13, 'Enter'))), (t.input.lastIOSEnter = 0));
        }, 200)));
    } else
      t.someProp('handleKeyDown', (r) => r(t, n)) || Bg(t, n) ? n.preventDefault() : Pt(t, 'key');
};
Me.keyup = (t, e) => {
...
Me.keypress = (t, e) => {
  let n = e;
  if (fu(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Be && n.metaKey)) return;
  ...
  if (!(r instanceof I) || !r.$from.sameParent(r.$to)) {
    ...
    (!/[\r\n]/.test(o) &&
      !t.someProp('handleTextInput', (s) => s(t, r.$from.pos, r.$to.pos, o, i)) &&
      t.dispatch(i()),
      n.preventDefault());
  }
};
...
function Gg(t, e) {
  ...
  let n = t.state.doc.resolve(e),
    r = n.nodeAfter;
  return r && r.isAtom && L.isSelectable(r) ? (Nn(t, new L(n), 'pointer'), !0) : !1;
}
function Xg(t, e) {
  if (e == -1) return !1;
  let n = t.state.selection,
  ...
  for (let s = i.depth + 1; s > 0; s--) {
    ...
    if (L.isSelectable(l)) {
      r && n.$from.depth > 0 && s >= n.$from.depth && i.before(n.$from.depth + 1) == n.$from.pos
        ? (o = i.before(n.$from.depth))
        : (o = i.before(s));
      break;
    }
  }
  return o != null ? (Nn(t, L.create(t.state.doc, o), 'pointer'), !0) : !1;
}
function Yg(t, e, n, r, o) {
  return (
    gl(t, 'handleClickOn', e, n, r) ||
...
function Qg(t, e, n, r) {
  return (
    gl(t, 'handleDoubleClickOn', e, n, r) || t.someProp('handleDoubleClick', (o) => o(t, e, r))
  );
}
function Zg(t, e, n, r) {
  return (
    gl(t, 'handleTripleClickOn', e, n, r) ||
...
function ey(t, e, n) {
  ...
  let r = t.state.doc;
  if (e == -1) return r.inlineContent ? (Nn(t, I.create(r, 0, r.content.size), 'pointer'), !0) : !1;
  let o = r.resolve(e);
  for (let i = o.depth + 1; i > 0; i--) {
    let s = i > o.depth ? o.nodeAfter : o.node(i),
      l = o.before(i);
    if (s.inlineContent) Nn(t, I.create(r, l + 1, l + 1 + s.content.size), 'pointer');
    else if (L.isSelectable(s)) Nn(t, L.create(r, l), 'pointer');
    else continue;
    return !0;
  }
}
...
ve.mousedown = (t, e) => {
  ...
  (o - t.input.lastClick.time < 500 &&
    Jg(n, t.input.lastClick) &&
    !n[uu] &&
    t.input.lastClick.button == n.button &&
    (t.input.lastClick.type == 'singleClick'
      ? (i = 'doubleClick')
      : t.input.lastClick.type == 'doubleClick' && (i = 'tripleClick')),
    (t.input.lastClick = { time: o, x: n.clientX, y: n.clientY, type: i, button: n.button }));
  let s = t.posAtCoords(Ao(n));
  s &&
    (i == 'singleClick'
      ? (t.input.mouseDown && t.input.mouseDown.done(), (t.input.mouseDown = new sl(t, s, n, !!r)))
      : (i == 'doubleClick' ? Qg : Zg)(t, s.pos, s.inside, n)
        ? n.preventDefault()
        : Pt(t, 'pointer'));
};
var sl = class {
  constructor(e, n, r, o) {
    ...
    (this.view.root.removeEventListener('mouseup', this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => wt(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let n = this.pos;
    (this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(Ao(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !n
        ? Pt(this.view, 'pointer')
        : Yg(this.view, n.pos, n.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
            ...
            ? (Nn(this.view, z.near(this.view.state.doc.resolve(n.pos)), 'pointer'),
              e.preventDefault())
            : Pt(this.view, 'pointer'));
  }
  move(e) {
...
ve.touchstart = (t) => {
  ((t.input.lastTouch = Date.now()), yl(t), Pt(t, 'pointer'));
};
ve.touchmove = (t) => {
  ((t.input.lastTouch = Date.now()), Pt(t, 'pointer'));
};
ve.contextmenu = (t) => yl(t);
function fu(t, e) {
  return t.composing
    ? !0
    : Se && Math.abs(e.timeStamp - t.input.compositionEndedAt) < 500
      ? ((t.input.compositionEndedAt = -2e8), !0)
      : !1;
}
var ty = bt ? 5e3 : -1;
Me.compositionstart = Me.compositionupdate = (t) => {
  if (!t.composing) {
    t.domObserver.flush();
    let { state: e } = t,
      n = e.selection.$to;
    if (
      e.selection instanceof I &&
      (e.storedMarks ||
        (!n.textOffset &&
          n.parentOffset &&
      ...
      (gr(t, !e.selection.empty),
      He && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
    ) {
      let r = t.domSelectionRange();
...
function hu(t, e) {
  (clearTimeout(t.input.composingTimeout),
    e > -1 && (t.input.composingTimeout = setTimeout(() => gr(t), e)));
}
function pu(t) {
  for (
    t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = oy()));
...
function ry(t) {
  ...
  let n = eg(e.focusNode, e.focusOffset),
    r = tg(e.focusNode, e.focusOffset);
  if (n && r && n != r) {
    let o = r.pmViewDesc,
...
function gr(t, e = !1) {
  if (!(bt && t.domObserver.flushingSoon >= 0)) {
    if ((t.domObserver.forceFlush(), pu(t), e || (t.docView && t.docView.dirty))) {
      let n = ul(t),
        r = t.state.selection;
      return (
        n && !n.eq(r)
...
var yr = (Ee && Lt < 15) || (Rn && ig < 604);
ve.copy = Me.cut = (t, e) => {
  let n = e,
    r = t.state.selection,
    o = n.type == 'cut';
  if (r.empty) return;
  let i = yr ? null : n.clipboardData,
    s = r.content(),
    { dom: l, text: a } = hl(t, s);
  (i
    ? (n.preventDefault(),
...
function ly(t, e) {
  ...
  setTimeout(() => {
    (t.focus(),
      ...
      n ? br(t, r.value, null, o, e) : br(t, r.textContent, r.innerHTML, o, e));
  }, 50);
}
function br(t, e, n, r, o) {
  let i = pl(t, e, n, r, t.state.selection.$from);
  if (t.someProp('handlePaste', (a) => a(t, o, i || E.empty))) return !0;
  if (!i) return !1;
  let s = sy(i),
    l = s ? t.state.tr.replaceSelectionWith(s, r) : t.state.tr.replaceSelection(i);
...
Me.paste = (t, e) => {
  let n = e;
  if (t.composing && !bt) return;
  let r = yr ? null : n.clipboardData,
    o = t.input.shiftKey && t.input.lastKeyCode != 45;
  r && br(t, mu(r), r.getData('text/html'), o, n) ? n.preventDefault() : ly(t, n);
};
var So = class {
    constructor(e, n, r) {
...
ve.dragstart = (t, e) => {
  ...
  let o = t.state.selection,
    i = o.empty ? null : t.posAtCoords(Ao(n)),
    s;
  if (!(i && i.pos >= o.from && i.pos <= (o instanceof L ? o.to - 1 : o.to))) {
    if (r && r.mightDrag) s = L.create(t.state.doc, r.mightDrag.pos);
    else if (n.target && n.target.nodeType == 1) {
      let u = t.docView.nearestDesc(n.target, !0);
      u && u.node.type.spec.draggable && u != t.docView && (s = L.create(t.state.doc, u.posBefore));
    }
  }
  let l = (s || t.state.selection).content(),
    { dom: a, text: c, slice: d } = hl(t, l);
  ((!n.dataTransfer.files.length || !ge || Ud > 120) && n.dataTransfer.clearData(),
    n.dataTransfer.setData(yr ? 'Text' : 'text/html', a.innerHTML),
    (n.dataTransfer.effectAllowed = 'copyMove'),
    yr || n.dataTransfer.setData('text/plain', c),
    (t.dragging = new So(d, gu(t, n), s)));
};
ve.dragend = (t) => {
  let e = t.dragging;
  window.setTimeout(() => {
...
Me.dragover = Me.dragenter = (t, e) => e.preventDefault();
Me.drop = (t, e) => {
  try {
    cy(t, e, t.dragging);
  } finally {
...
function cy(t, e, n) {
  ...
  i
    ...
    : (i = pl(t, mu(e.dataTransfer), yr ? null : e.dataTransfer.getData('text/html'), !1, o));
  let s = !!(n && gu(t, e));
  ...
  if (!i) return;
  e.preventDefault();
  let l = i ? fo(t.state.doc, o.pos, i) : o.pos;
  l == null && (l = o.pos);
  let a = t.state.tr;
  if (s) {
    let { node: h } = n;
  ...
  let c = a.mapping.map(l),
    ...
    u = a.doc;
  if ((d ? a.replaceRangeWith(c, c, i.content.firstChild) : a.replaceRange(c, c, i), a.doc.eq(u)))
    return;
  ...
  if (
    ...
    (a.mapping.maps[a.mapping.maps.length - 1].forEach((p, m, g, y) => (h = y)),
      a.setSelection(fl(t, f, a.doc.resolve(h))));
  }
...
ve.beforeinput = (t, e) => {
  if (ge && bt && e.inputType == 'deleteContentBackward') {
    t.domObserver.flushSoon();
    let { domChangeCount: r } = t.input;
    setTimeout(() => {
      if (
        t.input.domChangeCount != r ||
        (t.dom.blur(), t.focus(), t.someProp('handleKeyDown', (i) => i(t, Jt(8, 'Backspace'))))
      )
        return;
...
var Co = class t {
    constructor(e, n) {
      ((this.toDOM = e), (this.spec = n || Qt), (this.side = this.spec.side || 0));
    }
    map(e, n, r, o) {
      let { pos: i, deleted: s } = e.mapResult(n.from + o, this.side < 0 ? -1 : 1);
      return s ? null : new re(i - r, i - r, this);
    }
    valid() {
      return !0;
    }
      ...
      return (
        ...
        (e instanceof t &&
          ((this.spec.key && this.spec.key == e.spec.key) ||
            (this.toDOM == e.toDOM && wr(this.spec, e.spec))))
      );
    }
    destroy(e) {
  ...
  Yt = class t {
    constructor(e, n) {
      ((this.attrs = e), (this.spec = n || Qt));
    }
    map(e, n, r, o) {
      let i = e.map(n.from + o, this.spec.inclusiveStart ? -1 : 1) - r,
        s = e.map(n.to + o, this.spec.inclusiveEnd ? 1 : -1) - r;
      return i >= s ? null : new re(i, s, this);
    }
    valid(e, n) {
      return n.from < n.to;
    }
    eq(e) {
      return this == e || (e instanceof t && wr(this.attrs, e.attrs) && wr(this.spec, e.spec));
    }
    static is(e) {
  ...
  ll = class t {
    ...
    map(e, n, r, o) {
      ...
      return s.deleted || s.pos <= i.pos ? null : new re(i.pos - r, s.pos - r, this);
    }
    valid(e, n) {
  ...
  re = class t {
    ...
    static widget(e, n, r) {
      return new t(e, e, new Co(n, r));
    }
    static inline(e, n, r, o) {
      return new t(e, n, new Yt(r, o));
    }
    static node(e, n, r, o) {
      return new t(e, n, new ll(r, o));
    }
    get spec() {
  ...
  Z = class t {
    ...
    static create(e, n) {
      return n.length ? Mo(n, e, 0, Qt) : ke;
    }
    find(e, n, r) {
      let o = [];
    ...
    map(e, n, r) {
      return this == ke || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Qt);
    }
    mapInner(e, n, r, o, i) {
      let s;
      ...
      return this.children.length
        ? dy(this.children, s || [], e, n, r, o, i)
        : s
          ? new t(s.sort(Zt), En)
          : ke;
    }
    add(e, n) {
      return n.length ? (this == ke ? t.create(e, n) : this.addInner(e, n, 0)) : this;
    }
    addInner(e, n, r) {
      let o,
        i = 0;
      e.forEach((l, a) => {
        let c = a + r,
          d;
        if ((d = bu(n, l, c))) {
          for (o || (o = this.children.slice()); i < o.length && o[i] < a;) i += 3;
          (o[i] == a
            ? (o[i + 2] = o[i + 2].addInner(l, d, c + 1))
            : o.splice(i, 0, a, a + l.nodeSize, Mo(d, l, c + 1, Qt)),
            (i += 3));
        }
      });
      let s = yu(i ? wu(n) : n, -r);
      for (let l = 0; l < s.length; l++) s[l].type.valid(e, s[l]) || s.splice(l--, 1);
      return new t(s.length ? this.local.concat(s).sort(Zt) : this.local, o || this.children);
    }
    remove(e) {
    ...
    removeInner(e, n) {
      ...
      return r == this.children && o == this.local ? this : o.length || r.length ? new t(o, r) : ke;
    }
    forChild(e, n) {
      ...
      for (let l = 0; l < this.local.length; l++) {
        let a = this.local[l];
        if (a.from < s && a.to > i && a.type instanceof Yt) {
      ...
      if (o) {
        let l = new t(o.sort(Zt), En);
        return r ? new vo([l, r]) : l;
      }
      return r || ke;
    }
    eq(e) {
    ...
    localsInner(e) {
      if (this == ke) return En;
      if (e.inlineContent || !this.local.some(Yt.is)) return this.local;
      let n = [];
...
var ke = Z.empty,
  vo = class t {
    ...
    map(e, n) {
      let r = this.members.map((o) => o.map(e, n, Qt));
      return t.from(r);
    }
    forChild(e, n) {
      ...
      for (let o = 0; o < this.members.length; o++) {
        ...
        i != ke && (i instanceof t ? (r = r.concat(i.members)) : r.push(i));
      }
      return t.from(r);
    }
    eq(e) {
    ...
    static from(e) {
      switch (e.length) {
        ...
        default:
          return new t(
            e.every((n) => n instanceof Z)
              ? e
              : e.reduce((n, r) => n.concat(r instanceof Z ? r : r.members), []),
          );
      }
    }
    forEachSet(e) {
  ...
  for (let c = 0, d = i; c < n.maps.length; c++) {
    ...
    (n.maps[c].forEach((f, h, p, m) => {
      ...
      for (let y = 0; y < l.length; y += 3) {
        ...
        let b = l[y] + d - u;
        h >= b ? (l[y + 1] = f <= b ? -2 : -1) : f >= d && g && ((l[y] += g), (l[y + 1] += g));
      }
      u += g;
    }),
      (d = n.maps[c].map(d, -1)));
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (g && m == u && m + g.nodeSize == h) {
        ...
        y != ke ? ((l[c] = u), (l[c + 1] = h), (l[c + 2] = y)) : ((l[c + 1] = -2), (a = !0));
      } else a = !0;
    }
  if (a) {
    let c = uy(l, t, e, n, o, i, s),
      d = Mo(c, r, 0, s);
    e = d.local;
...
function yu(t, e) {
  ...
  for (let r = 0; r < t.length; r++) {
    let o = t[r];
    n.push(new re(o.from + e, o.to + e, o.type));
  }
  return n;
}
function uy(t, e, n, r, o, i, s) {
  function l(a, c) {
  ...
  for (let a = 0; a < t.length; a += 3) t[a + 1] == -1 && l(t[a + 2], e[a] + i + 1);
  return n;
}
function bu(t, e, n) {
...
function Mo(t, e, n, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      ...
      d != ke && o.push(a, a + l.nodeSize, d);
    }
  });
  let s = yu(i ? wu(t) : t, -n).sort(Zt);
  for (let l = 0; l < s.length; l++)
    s[l].type.valid(e, s[l]) || (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
  return s.length || o.length ? new Z(s, o) : ke;
}
function Zt(t, e) {
      ...
      for (let o = n + 1; o < e.length; o++) {
        ...
        if (i.from == r.from) {
          i.to != r.to &&
            ...
            Id(e, o + 1, i.copy(r.to, i.to)));
          continue;
        } else {
          i.from < r.to &&
            (e == t && (e = t.slice()),
            (e[n] = r.copy(r.from, i.from)),
            Id(e, o, r.copy(i.from, r.to)));
          break;
        }
      }
  }
...
function js(t) {
  ...
  return (
    ...
    t.cursorWrapper && e.push(Z.create(t.state.doc, [t.cursorWrapper.deco])),
    vo.from(e)
  );
}
var fy = {
  ...
  cl = class {
          ...
          new window.MutationObserver((r) => {
            ...
            r.some(
              (o) =>
                ...
                (o.type == 'characterData' && o.oldValue.length > o.target.nodeValue.length),
            )
              ? this.flushSoon()
              : Se &&
                  e.composing &&
                  r.some((o) => o.type == 'childList' && o.target.nodeName == 'TR')
    ...
    onSelectionChange() {
      if (Md(this.view)) {
        ...
        if (Ee && Lt <= 11 && !this.view.state.selection.empty) {
          let e = this.view.domSelectionRange();
          if (e.focusNode && en(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset))
    ...
    ignoreSelectionChange(e) {
      ...
      let n = new Set(),
        r;
      for (let i = e.focusNode; i; i = On(i)) n.add(i);
      for (let i = e.anchorNode; i; i = On(i))
        if (n.has(i)) {
          r = i;
          break;
        }
      let o = r && this.view.docView.nearestDesc(r);
      if (o && o.ignoreMutation({ type: 'selection', target: r.nodeType == 3 ? r.parentNode : r }))
    ...
    flush() {
      ...
      if (
        ...
        if (d.length == 2) {
          ...
          for (let f of d) {
            let h = f.parentNode;
            h && h.nodeName == 'LI' && (!u || gy(e, u) != h) && f.remove();
          }
        }
      }
      let c = null;
      ...
      c.eq(z.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0), wt(e), this.currentSelection.set(r), e.scrollToSelection())
        : (i > -1 || o) &&
          (i > -1 && (e.docView.markDirty(i, s), py(e)),
          e.input.badSafariComposition && ((e.input.badSafariComposition = !1), yy(e, a)),
    ...
    registerMutation(e, n) {
      ...
      if (e.type == 'childList') {
        ...
        let o = e.previousSibling,
          i = e.nextSibling;
        if (Ee && Lt <= 11 && e.addedNodes.length)
          for (let d = 0; d < e.addedNodes.length; d++) {
            let { previousSibling: u, nextSibling: f } = e.addedNodes[d];
            ((!u || Array.prototype.indexOf.call(e.addedNodes, u) < 0) && (o = u),
        ...
        let s = o && o.parentNode == e.target ? me(o) + 1 : 0,
          ...
          a = i && i.parentNode == e.target ? me(i) : e.target.childNodes.length,
...
function py(t) {
  if (
    ...
    if (((t.requiresGeckoHackNode = He), Ld)) return;
    (console.warn(
...
function Bd(t, e) {
  ...
  return (
    en(s.node, s.offset, o, i) && ([n, r, o, i] = [o, i, n, r]),
...
function yy(t, e) {
  ...
  for (let i of e)
    if (((n = i.parentNode) === null || n === void 0 ? void 0 : n.nodeName) == 'TR') {
      let s = i.nextSibling;
      for (; s && s.nodeName != 'TD' && s.nodeName != 'TH';) s = s.nextSibling;
      if (s) {
        let l = s;
        for (;;) {
          let a = l.firstChild;
        ...
        (l.insertBefore(i, l.firstChild), r == i && t.domSelection().collapse(i, o));
      } else i.parentNode.removeChild(i);
    }
}
function by(t, e, n) {
  let { node: r, fromOffset: o, toOffset: i, from: s, to: l } = t.docView.parseRange(e, n),
  ...
  if (
    (d &&
      ...
      To(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
  ...
  let u = t.state.doc,
    f = t.someProp('domParser') || Ae.fromSchema(t.state.schema),
    h = u.resolve(s),
    p = null,
    m = f.parse(r, {
      topNode: h.parent,
...
function wy(t) {
  ...
  if (t.nodeName == 'BR' && t.parentNode) {
    if (Se && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
      let n = document.createElement('div');
      return (n.appendChild(document.createElement('li')), { skip: n });
    } else if (t.parentNode.lastChild == t || (Se && /^(tr|table)$/i.test(t.parentNode.nodeName)))
      return { ignore: !0 };
...
function ky(t, e, n, r, o) {
  let i = t.input.compositionPendingChanges || (t.composing ? t.input.compositionID : 0);
  if (((t.input.compositionPendingChanges = 0), e < 0)) {
    let S = t.input.lastSelectionTime > Date.now() - 50 ? t.input.lastSelectionOrigin : null,
      P = ul(t, S);
    if (P && !t.state.selection.eq(P)) {
      if (
        ...
        t.someProp('handleKeyDown', (v) => v(t, Jt(13, 'Enter')))
      )
        return;
      let A = t.state.tr.setSelection(P);
      (S == 'pointer' ? A.setMeta('pointer', !0) : S == 'key' && A.scrollIntoView(),
        i && A.setMeta('composition', i),
        t.dispatch(A));
    }
    return;
  }
  ...
  let p = vy(u.content, c.doc.content, c.from, f, h);
  if (
    (p && t.input.domChangeCount++,
    ((Rn && t.input.lastIOSEnter > Date.now() - 225) || bt) &&
      o.some((S) => S.nodeType == 1 && !xy.test(S.nodeName)) &&
      (!p || p.endA >= p.endB) &&
      t.someProp('handleKeyDown', (S) => S(t, Jt(13, 'Enter'))))
  ) {
  ...
  if (!p)
    if (
      ...
      if (c.sel) {
        let S = zd(t, t.state.doc, c.sel);
        if (S && !S.eq(t.state.selection)) {
          let P = t.state.tr.setSelection(S);
  ...
  (t.state.selection.from < t.state.selection.to &&
    p.start == p.endB &&
    t.state.selection instanceof I &&
    ...
    Ee &&
      ...
      p.endA == p.start &&
      p.start > c.from &&
      c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == ' \xA0' &&
  ...
  if (
    ((Rn &&
      ...
      (!w || o.some((S) => S.nodeName == 'DIV' || S.nodeName == 'P'))) ||
      (!w &&
  ...
  if (
    ...
    Cy(d, p.start, p.endA, m, g) &&
    t.someProp('handleKeyDown', (S) => S(t, Jt(8, 'Backspace')))
  ) {
    bt && ge && t.domObserver.suppressSelectionUpdates();
    return;
  }
    ...
    bt &&
      ...
      setTimeout(() => {
        t.someProp('handleKeyDown', function (S) {
          return S(t, Jt(13, 'Enter'));
        });
      }, 20)));
  let b = p.start,
    x = p.endA,
    k = (S) => {
      let P = S || t.state.tr.replace(b, x, c.doc.slice(p.start - c.from, p.endB - c.from));
      if (c.sel) {
        let A = zd(t, P.doc, c.sel);
        A &&
          !(
            (ge &&
              t.composing &&
              ...
              (A.head == b || A.head == P.mapping.map(x) - 1)) ||
            (Ee && A.empty && A.head == b)
          ) &&
          P.setSelection(A);
      }
      return (i && P.setMeta('composition', i), P.scrollIntoView());
    },
    M;
  if (w)
    if (m.pos == g.pos) {
      Ee &&
        Lt <= 11 &&
        m.parentOffset == 0 &&
        (t.domObserver.suppressSelectionUpdates(), setTimeout(() => wt(t), 20));
      let S = k(t.state.tr.delete(b, x)),
        P = d.resolve(p.start).marksAcross(d.resolve(p.endA));
      (P && S.ensureMarks(P), t.dispatch(S));
    } else if (
      p.endA == p.endB &&
      (M = Sy(
      ...
      let S = m.parent.textBetween(m.parentOffset, g.parentOffset),
        P = () => k(t.state.tr.insertText(S, b, x));
      t.someProp('handleTextInput', (A) => A(t, b, x, S, P)) || t.dispatch(P());
    } else t.dispatch(k());
  else t.dispatch(k());
}
function zd(t, e, n) {
  return Math.max(n.anchor, n.head) > e.content.size
    ? null
    : fl(t, e.resolve(n.anchor), e.resolve(n.head));
}
function Sy(t, e) {
...
function vy(t, e, n, r, o) {
  ...
  if (s < i && t.size < e.size) {
    let a = r <= i && r >= s ? i - r : 0;
    ((i -= a),
      i && i < e.size && Hd(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (l = i + (l - s)),
      (s = i));
  } else if (l < i) {
    let a = r <= i && r >= l ? i - r : 0;
    ((i -= a),
      i && i < t.size && Hd(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (s = i + (s - l)),
      (l = i));
  }
  ...
  In = class {
    constructor(e, n) {
      ((this._root = null),
        ...
        (this.editable = _d(this)),
        Fd(this),
        (this.nodeViews = Vd(this)),
        (this.docView = wd(this.state.doc, $d(this), js(this), this.dom, this)),
        (this.domObserver = new cl(this, (r, o, i, s) => ky(this, r, o, i, s))),
    ...
    update(e) {
      ...
      let n = this._props;
      ((this._props = e),
        e.plugins && (e.plugins.forEach(Wd), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, n) {
      ...
      let o = this.state,
        i = !1,
        s = !1;
      (e.storedMarks && this.composing && (pu(this), (s = !0)), (this.state = e));
      ...
      if (l || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
        let h = Vd(this);
        Ey(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
      }
      ((l || n.handleDOMEvents != this._props.handleDOMEvents) && il(this),
        (this.editable = _d(this)),
        Fd(this));
      let a = js(this),
        c = $d(this),
      ...
      let f = d == 'preserve' && s && this.dom.style.overflowAnchor == null && ag(this);
      if (s) {
        ...
        if (u) {
          ...
          (this.composing && (this.input.compositionNode = ry(this)),
            (i || !this.docView.update(e.doc, c, a, this)) &&
              ...
              (this.docView = wd(e.doc, c, a, this.dom, this))),
      ...
      if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
        if (!this.someProp('handleScrollToSelection', (n) => n(this)))
          if (this.state.selection instanceof L) {
            ...
            n.nodeType == 1 && hd(this, n.getBoundingClientRect(), e);
          } else hd(this, this.coordsAtPos(this.state.selection.head, 1), e);
      }
    }
    destroyPluginViews() {
      let e;
    ...
    updateDraggedNode(e, n) {
      ...
      this.dragging = new So(e.slice, e.move, o < 0 ? void 0 : L.create(this.state.doc, o));
    }
    someProp(e, n) {
    ...
    focus() {
      (this.domObserver.stop(), this.editable && dg(this.dom), wt(this), this.domObserver.start());
    }
    get root() {
      let e = this._root;
      if (e == null) {
    ...
    endOfTextblock(e, n) {
      return xg(this, n || this.state, e);
    }
    pasteHTML(e, n) {
      return br(this, '', e, !1, n || new ClipboardEvent('paste'));
    }
    pasteText(e, n) {
      return br(this, e, null, !0, n || new ClipboardEvent('paste'));
    }
    ...
    destroy() {
      this.docView &&
        ...
        this.mounted
          ? (this.docView.update(this.state.doc, [], js(this), this), (this.dom.textContent = ''))
...
In.prototype.dispatch = function (t) {
...
function $d(t) {
  ...
  return (
    ...
    [re.node(0, t.state.doc.content.size, e)]
  );
}
function Fd(t) {
  if (t.markCursor) {
    ...
    ((e.className = 'ProseMirror-separator'),
      ...
      (t.cursorWrapper = {
        dom: e,
        deco: re.widget(t.state.selection.from, e, { raw: !0, marks: t.markCursor }),
      }));
...
function Vd(t) {
  let e = Object.create(null);
  function n(r) {
    for (let o in r) Object.prototype.hasOwnProperty.call(e, o) || (e[o] = r[o]);
  }
...
var xt = {
  ...
  Ny = typeof navigator < 'u' && /Mac/.test(navigator.platform),
  Oy =
    typeof navigator < 'u' &&
...
var ae;
for (ae = 65; ae <= 90; ae++)
  ((xt[ae] = String.fromCharCode(ae + 32)), (No[ae] = String.fromCharCode(ae)));
var ae;
for (Eo in xt) No.hasOwnProperty(Eo) || (No[Eo] = xt[Eo]);
var Eo;
function xu(t) {
  var e =
      (Ny && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
      (Oy && t.shiftKey && t.key && t.key.length == 1) ||
      t.key == 'Unidentified',
    n = (!e && t.key) || (t.shiftKey ? No : xt)[t.keyCode] || t.key || 'Unidentified';
  return (
    n == 'Esc' && (n = 'Escape'),
    n == 'Del' && (n = 'Delete'),
    n == 'Left' && (n = 'ArrowLeft'),
...
var Ry = typeof navigator < 'u' && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  Dy = typeof navigator < 'u' && /Win/.test(navigator.platform);
function Iy(t) {
  let e = t.split(/-(?!$)/),
    n = e[e.length - 1];
  n == 'Space' && (n = ' ');
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(a)) Ry ? (s = !0) : (o = !0);
...
function ku(t) {
  return new B({ props: { handleKeyDown: Sr(t) } });
}
function Sr(t) {
  let e = Py(t);
  return function (n, r) {
...
var Ly = Object.defineProperty,
  Tl = (t, e) => {
    for (var n in e) Ly(t, n, { get: e[n], enumerable: !0 });
  };
function Er(t) {
...
var Nr = class {
    ...
    createChain(t, e = !0) {
      let { rawCommands: n, editor: r, state: o } = this,
        ...
        a = t || o.tr,
        c = () => (
          !l && e && !a.getMeta('preventDispatch') && !this.hasCustomState && i.dispatch(a),
          s.every((u) => u === !0)
        ),
        d = {
          ...Object.fromEntries(
    ...
    buildProps(t, e = !0) {
      let { rawCommands: n, editor: r, state: o } = this,
        ...
        s = {
          ...
          editor: r,
          view: i,
          state: Er({ state: o, transaction: t }),
          dispatch: e ? () => {} : void 0,
          chain: () => this.createChain(t, e),
          can: () => this.createCan(t),
          get commands() {
            return Object.fromEntries(Object.entries(n).map(([l, a]) => [l, (...c) => a(...c)(s)]));
          },
        };
      return s;
    }
...
Tl(Al, {
  ...
  scrollIntoView: () => bb,
  selectAll: () => wb,
  selectNodeBackward: () => xb,
  selectNodeForward: () => kb,
  selectParentNode: () => Sb,
  selectTextblockEnd: () => Cb,
  selectTextblockStart: () => vb,
  setContent: () => Mb,
  setMark: () => Pb,
  setMeta: () => Lb,
  setNode: () => Bb,
...
var By =
    ...
    ({ editor: t, view: e }) => (
      requestAnimationFrame(() => {
        var n;
        t.isDestroyed ||
          (e.dom.blur(), (n = window?.getSelection()) == null || n.removeAllRanges());
      }),
      !0
    ),
  zy =
          ...
          o.forEach(({ $from: i, $to: s }) => {
            t.doc.nodesBetween(i.pos, s.pos, (l, a) => {
              ...
              if (l.type.isTextblock) {
                let { defaultType: m } = u.parent.contentMatchAt(u.index());
  ...
  _y =
    ...
    ({ editor: n, tr: r }) => {
      ...
      return (r.insert(s, i.content), r.setSelection(new I(r.doc.resolve(Math.max(s - 1, 0)))), !0);
    },
  Vy =
    () =>
    ({ tr: t, dispatch: e }) => {
...
var Wy =
  ...
  Uy = (t) => (t.content ? /^text(\*|\+)/.test(t.content) : !1),
  Su = (t, e, n) => {
    if (
      !t.parent.isInline ||
    ...
    return Uy(r) ? (n === 'left' ? t.start() - 1 : t.end() + 1) : t.pos;
  },
  Ky = (t, e, n) => {
    let r = Su(t, n, 'left'),
      o = Su(e, n, 'right');
  ...
  qy =
    ...
    ({ state: t, dispatch: e }) => {
      ...
      let { from: o, to: i } = Ky(n, r, t.schema);
      return (e && (t.tr.deleteRange(o, i).scrollIntoView(), e(t.tr)), !0);
    },
  Jy =
    () =>
    ({ commands: t }) =>
...
function Tr(t, e, n = { strict: !0 }) {
  let r = Object.keys(e);
  return r.length
    ? r.every((o) => (n.strict ? e[o] === t[o] : Lo(e[o]) ? e[o].test(t[o]) : e[o] === t[o]))
    : !0;
}
function Eu(t, e, n = {}) {
  return t.find(
    (r) => r.type === e && Tr(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n),
  );
}
function Cu(t, e, n = {}) {
  return !!Eu(t, e, n);
...
function Bo(t, e, n) {
  ...
  if (!Eu([...r.node.marks], e, n)) return;
  let i = r.index,
    s = t.start() + r.offset,
    l = i + 1,
    a = s + r.node.nodeSize;
  for (; i > 0 && Cu([...t.parent.child(i - 1).marks], e, n);)
    ((i -= 1), (s -= t.parent.child(i).nodeSize));
  for (; l < t.parent.childCount && Cu([...t.parent.child(l).marks], e, n);)
...
function El(t, e = null) {
  ...
  let o = n.from,
    i = r.to;
  return e === 'all'
    ? I.create(t, nt(0, o, i), nt(t.content.size, o, i))
    : I.create(t, nt(e, o, i), nt(e, o, i));
}
function Ar() {
...
var Qy =
    ...
    ({ editor: n, view: r, tr: o, dispatch: i }) => {
      ...
      let s = () => {
        ((nn() || Ar()) && r.dom.focus(),
          Nu() && !nn() && !Ar() && r.dom.focus({ preventScroll: !0 }),
          requestAnimationFrame(() => {
      ...
      if (i && t === null && !Hn(n.state.selection)) return (s(), !0);
      let l = El(o.doc, t) || n.state.selection,
        a = n.state.selection.eq(l);
      return (
        i && (a || o.setSelection(l), a && o.storedMarks && o.setStoredMarks(o.storedMarks), s()),
        !0
      );
    },
  Zy = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
  eb =
    (t, e) =>
    ({ tr: n, commands: r }) =>
...
function zn(t, e, n) {
  if (t instanceof ne || t instanceof C) return t;
  n = { slice: !0, parseOptions: {}, ...n };
  let r = typeof t == 'object' && t !== null,
    o = typeof t == 'string';
  if (r)
    try {
      if (Array.isArray(t) && t.length > 0) return C.fromArray(t.map((l) => e.nodeFromJSON(l)));
      ...
      return (
        console.warn('[tiptap warn]: Invalid content.', 'Passed value:', t, 'Error:', i),
        zn('', e, n)
      );
    }
  if (o) {
    if (n.errorOnInvalidContent) {
      ...
      if (
        (n.slice
          ? Ae.fromSchema(a).parseSlice(Ln(t), n.parseOptions)
          : Ae.fromSchema(a).parse(Ln(t), n.parseOptions),
    ...
    let i = Ae.fromSchema(e);
    return n.slice ? i.parseSlice(Ln(t), n.parseOptions).content : i.parse(Ln(t), n.parseOptions);
  }
  return zn('', e, n);
}
function Ru(t, e, n) {
...
var tb = (t) => !('type' in t),
    ...
    ({ tr: r, dispatch: o, editor: i }) => {
      ...
      if (o) {
        ...
        if (!n.errorOnInvalidContent && !i.options.enableContentCheck && i.options.emitContentError)
          try {
            zn(e, i.schema, { parseOptions: c, errorOnInvalidContent: !0 });
          } catch (g) {
            a(g);
          }
        try {
        ...
        if (f) {
          ...
          let g = r.doc.resolve(d),
            ...
            x = y.content.size > 0;
          (w && b && x && h && (d = Math.max(0, d - 1)), r.replaceWith(d, u, m));
        }
        (n.updateSelection && Ru(r, r.steps.length - 1, -1),
          n.applyInputRules && r.setMeta('applyInputRules', { from: d, text: m }),
          n.applyPasteRules && r.setMeta('applyPasteRules', { from: d, text: m }));
      }
      return !0;
    },
  rb =
  ...
  lb =
    ...
    ({ state: t, dispatch: e, tr: n }) => {
      try {
        let r = Ut(t.doc, t.selection.$from.pos, -1);
...
function ub(t) {
  ...
  for (let l = 0; l < e.length - 1; l += 1) {
    ...
    else if (/^mod$/i.test(a)) nn() || Nl() ? (s = !0) : (o = !0);
    else throw new Error(`Unrecognized modifier name: ${a}`);
  }
  return (
    r && (n = `Alt-${n}`),
...
function qe(t, e, n = {}) {
  ...
  let a = o - r,
    c = l
      ...
      .filter((u) => Tr(u.node.attrs, n, { strict: !1 }));
...
var yb =
    ...
    ({ tr: n, state: r, dispatch: o }) => {
      let i = null,
        s = null,
        l = Or(typeof t == 'string' ? t : t.name, r.schema);
      if (!l) return !1;
      (l === 'node' && (i = oe(t, r.schema)), l === 'mark' && (s = rt(t, r.schema)));
      let a = !1;
      return (
        n.selection.ranges.forEach((c) => {
          r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
            (i && i === d.type && ((a = !0), o && n.setNodeMarkup(u, void 0, Cl(d.attrs, e))),
              s &&
                d.marks.length &&
                d.marks.forEach((f) => {
                  s === f.type &&
                    ((a = !0), o && n.addMark(u, u + d.nodeSize, s.create(Cl(f.attrs, e))));
                }));
          });
        }),
        a
  ...
  vb =
    ...
    ({ state: t, dispatch: e }) =>
      Bs(t, e);
function Io(t, e, n = {}, r = {}) {
  return zn(t, e, { slice: !1, parseOptions: n, errorOnInvalidContent: r.errorOnInvalidContent });
}
var Mb =
  ...
  ({ editor: o, tr: i, dispatch: s, commands: l }) => {
    ...
    if (r.preserveWhitespace !== 'full') {
      let c = Io(t, o.schema, r, { errorOnInvalidContent: e ?? o.options.enableContentCheck });
...
function Je(t) {
  return (e) => Ho(e.$from, t);
}
function $(t, e, n) {
  return t.config[e] === void 0 && t.parent
    ? $(t.parent, e, n)
    : typeof t.config[e] == 'function'
      ? t.config[e].bind({ ...n, parent: t.parent ? $(t.parent, e, n) : null })
      : t.config[e];
}
function $o(t) {
  return t
...
function J(t, e = void 0, ...n) {
  return Dl(t) ? (e ? t.bind(e)(...n) : t(...n)) : t;
}
function Du(t = {}) {
...
function Il(t) {
  let e = [],
    { nodeExtensions: n, markExtensions: r } = rn(t),
    o = [...n, ...r],
    i = {
      default: null,
      validate: void 0,
    ...
    s = n.filter((c) => c.name !== 'text').map((c) => c.name),
    l = r.map((c) => c.name),
    a = [...s, ...l];
  return (
    t.forEach((c) => {
      let d = { name: c.name, options: c.options, storage: c.storage, extensions: o },
        u = $(c, 'addGlobalAttributes', d);
      if (!u) return;
      u().forEach((h) => {
        let p;
        (Array.isArray(h.types)
          ...
          p.forEach((m) => {
            Object.entries(h.attributes).forEach(([g, y]) => {
              e.push({ type: m, name: g, attribute: { ...i, ...y } });
            });
          }));
      });
    }),
  ...
  return 'style' in t
    ...
    : {
        ...
        getAttrs: (n) => {
          ...
          if (r === !1) return !1;
          let o = e.reduce((i, s) => {
            let l = s.attribute.parseHTML ? s.attribute.parseHTML(n) : Iu(n.getAttribute(s.name));
...
function Mu(t) {
  return Object.fromEntries(
    Object.entries(t).filter(([e, n]) => (e === 'attrs' && Du(n) ? !1 : n != null)),
  );
}
function Tu(t) {
  var e, n;
...
function Pl(t, e) {
  var n;
  let r = Il(t),
    { nodeExtensions: o, markExtensions: i } = rn(t),
    s = (n = o.find((c) => $(c, 'topNode'))) == null ? void 0 : n.name,
    l = Object.fromEntries(
      o.map((c) => {
        let d = r.filter((y) => y.type === c.name),
          u = { name: c.name, options: c.options, storage: c.storage, editor: e },
          f = t.reduce((y, w) => {
            let b = $(w, 'extendNodeSchema', u);
            return { ...y, ...(b ? b(c) : {}) };
          }, {}),
          h = Mu({
            ...f,
            content: J($(c, 'content', u)),
            marks: J($(c, 'marks', u)),
            group: J($(c, 'group', u)),
            inline: J($(c, 'inline', u)),
            atom: J($(c, 'atom', u)),
            selectable: J($(c, 'selectable', u)),
            draggable: J($(c, 'draggable', u)),
            code: J($(c, 'code', u)),
            whitespace: J($(c, 'whitespace', u)),
            linebreakReplacement: J($(c, 'linebreakReplacement', u)),
            defining: J($(c, 'defining', u)),
            isolating: J($(c, 'isolating', u)),
            attrs: Object.fromEntries(d.map(Tu)),
          }),
          p = J($(c, 'parseHTML', u));
        p && (h.parseDOM = p.map((y) => vl(y, d)));
        let m = $(c, 'renderHTML', u);
        m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: on(y, d) }));
        let g = $(c, 'renderText', u);
    ...
    a = Object.fromEntries(
      i.map((c) => {
        let d = r.filter((g) => g.type === c.name),
          u = { name: c.name, options: c.options, storage: c.storage, editor: e },
          f = t.reduce((g, y) => {
            let w = $(y, 'extendMarkSchema', u);
            return { ...g, ...(w ? w(c) : {}) };
          }, {}),
          h = Mu({
            ...f,
            inclusive: J($(c, 'inclusive', u)),
            excludes: J($(c, 'excludes', u)),
            group: J($(c, 'group', u)),
            spanning: J($(c, 'spanning', u)),
            code: J($(c, 'code', u)),
            attrs: Object.fromEntries(d.map(Tu)),
          }),
          p = J($(c, 'parseHTML', u));
        p && (h.parseDOM = p.map((g) => vl(g, d)));
        let m = $(c, 'renderHTML', u);
        return (m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: on(g, d) })), [c.name, h]);
      }),
    );
...
function Ab(t, e) {
  let n = _o(e),
    r = ne.fromJSON(n, t);
  return Rr(r.content, n);
}
function Eb(t, e) {
  let n = _o(e),
    r = Ln(t);
  return Ae.fromSchema(n).parse(r).toJSON();
}
function Ll(t, e, n) {
  let { from: r, to: o } = e,
    {
...
`,
    ...
    i = _o(e),
    s = ne.fromJSON(i, t);
  return Bl(s, { blockSeparator: r, textSerializers: { ...Vo(i), ...o } });
}
function Lu(t, e) {
  let n = oe(e, t.schema),
...
function Wo(t, e) {
  let n = Or(typeof e == 'string' ? e : e.name, t.schema);
  return n === 'node' ? Lu(t, e) : n === 'mark' ? Ol(t, e) : {};
}
function Bu(t, e = JSON.stringify) {
  let n = {};
  return t.filter((r) => {
    let o = e(r);
...
function zu(t, e = 0) {
  ...
  return (
    ...
    t.content.childCount &&
      ...
      t.forEach((c, d) => {
        var u;
        (u = a.content) == null || u.push(zu(c, e + d + r));
      })),
  ...
  return (
    t === e
      ...
      : n.nodesBetween(t, e, (o, i) => {
          !o ||
            o?.nodeSize === void 0 ||
            r.push(...o.marks.map((s) => ({ from: i, to: i + o.nodeSize, mark: s })));
        }),
    r
  );
}
...
function Po(t, e, n = {}) {
  ...
  if (
    (o.forEach(({ $from: u, $to: f }) => {
      ...
      t.doc.nodesBetween(h, p, (m, g) => {
        if (i && m.inlineContent && !m.type.allowsMarkType(i)) return !1;
        if (!m.isText && !m.marks.length) return;
        let y = Math.max(h, g),
          w = Math.min(p, g + m.nodeSize),
          b = w - y;
        ((s += b), l.push(...m.marks.map((x) => ({ mark: x, from: y, to: w }))));
      });
    }),
    s === 0)
  )
  ...
  let a = l
      ...
      .filter((u) => Tr(u.mark.attrs, n, { strict: !1 }))
...
function Uo(t, e, n = {}) {
  if (!e) return qe(t, null, n) || Po(t, null, n);
  let r = Or(e, t.schema);
  return r === 'node' ? qe(t, e, n) : r === 'mark' ? Po(t, e, n) : !1;
}
var Hl = (t, e) => {
    let { $from: n, $to: r, $anchor: o } = t.selection;
    if (e) {
      let i = Je((l) => l.type.name === e)(t.selection);
      if (!i) return !1;
...
function ln(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
  var r;
  if (n) {
  ...
  if (e) {
    ...
    return (
      t.content.forEach((i) => {
        o !== !1 && (ln(i, { ignoreWhitespace: n, checkChildren: e }) || (o = !1));
      }),
      o
    );
  }
...
function Rb({ selection: t, pos: e, nodeSize: n, selectedOnTextSelection: r = !1 }) {
  let { from: o, to: i } = t;
  return !!((o <= e && i >= e + n) || (r && Hn(t) && o > e && i < e + n));
}
var Fl = class $u {
  constructor(e) {
    this.position = e;
...
function Fu(t, e) {
  ...
  return { position: new Fl(n.pos), mapResult: n };
}
function _u(t) {
  return new Fl(t);
}
function _l(t, e, n) {
  let o = t.state.doc.content.size,
    ...
    h = f - u,
    p = d - c,
    y = { top: c, bottom: d, left: u, right: f, width: h, height: p, x: u, y: c };
  return { ...y, toJSON: () => y };
}
function Vu({ json: t, validMarks: e, validNodes: n, options: r, rewrittenContent: o = [] }) {
  return (
    t.marks &&
      ...
      (t.marks = t.marks.filter((i) => {
        ...
        return e.has(s)
          ? !0
          : (o.push({ original: JSON.parse(JSON.stringify(i)), unsupported: s }), !1);
      })),
    t.content &&
      ...
      (t.content = t.content
        .map(
          (i) =>
            Vu({ json: i, validMarks: e, validNodes: n, options: r, rewrittenContent: o }).json,
        )
        .filter((i) => i != null)),
    t.type && !n.has(t.type)
      ? (o.push({ original: JSON.parse(JSON.stringify(t)), unsupported: t.type }),
        t.content && Array.isArray(t.content) && r?.fallbackToParagraph !== !1
...
function Ib(t, e, n) {
  ...
  let { selection: o } = e,
    i = null;
  if ((Hn(o) && (i = o.$cursor), i)) {
    let l = (r = t.storedMarks) != null ? r : i.marks();
    return (
      i.parent.type.allowsMarkType(n) && (!!n.isInSet(l) || !l.some((c) => c.type.excludes(n)))
    );
  }
  let { ranges: s } = o;
      ...
      t.doc.nodesBetween(l.pos, a.pos, (d, u, f) => {
        ...
        if (d.isInline) {
          let h = !f || f.type.allowsMarkType(n),
            p = !!n.isInSet(d.marks) || !d.marks.some((m) => m.type.excludes(n));
          c = h && p;
        }
        return !c;
      }),
          ...
          l.forEach((c) => {
            ...
            r.doc.nodesBetween(d, u, (f, h) => {
              ...
              f.marks.find((y) => y.type === a)
                ? f.marks.forEach((y) => {
                    a === y.type && n.addMark(p, m, a.create({ ...y.attrs, ...e }));
                  })
  ...
  Bb =
    ...
    ({ state: n, dispatch: r, chain: o }) => {
      let i = oe(t, n.schema),
        s;
      return (
        n.selection.$anchor.sameParent(n.selection.$head) && (s = n.selection.$anchor.parent.attrs),
        i.isTextblock
          ? o()
              .command(({ commands: l }) => (Hs(i, { ...s, ...e })(n) ? !0 : l.clearNodes()))
              .command(({ state: l }) => Hs(i, { ...s, ...e })(l, r))
              .run()
...
var _b =
    ...
    ({ tr: e, state: n, dispatch: r, editor: o }) => {
      let { selection: i, doc: s } = e,
        ...
        d = Mr(c, l.node().type.name, l.node().attrs);
      if (i instanceof L && i.node.isBlock)
        return !l.parentOffset || !Re(s, l.pos)
          ? !1
          : (r && (t && Au(n, o.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()),
            !0);
      if (!l.parent.isBlock) return !1;
      let u = a.parentOffset === a.parent.content.size,
        f = l.depth === 0 ? void 0 : $n(l.node(-1).contentMatchAt(l.indexAfter(-1))),
        h = u && f ? [{ type: f, attrs: d }] : void 0,
        p = Re(e.doc, e.mapping.map(l.pos), 1, h);
      if (
        (!h &&
          !p &&
          Re(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) &&
          ((p = !0), (h = f ? [{ type: f, attrs: d }] : void 0)),
        r)
      ) {
        if (
          p &&
          (i instanceof I && e.deleteSelection(),
        ...
        (t && Au(n, o.extensionManager.splittableMarks), e.scrollIntoView());
      }
      return p;
    },
  Vb =
    ...
    ({ tr: n, state: r, dispatch: o, editor: i }) => {
      ...
      if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
        ...
        if (o) {
          ...
          for (let P = a.depth - w; P >= a.depth - 3; P -= 1) y = C.from(a.node(P).copy(y));
          let b =
              a.indexAfter(-1) < a.node(-2).childCount
                ...
                : a.indexAfter(-2) < a.node(-3).childCount
                  ? 2
                  : 3,
            x = { ...Mr(f, a.node().type.name, a.node().attrs), ...e },
            k = ((s = l.contentMatch.defaultType) == null ? void 0 : s.createAndFill(x)) || void 0;
          y = y.append(C.from(l.createAndFill(null, k) || void 0));
          let M = a.before(a.depth - (w - 1));
          n.replace(M, a.after(-b), new E(y, 4 - w, 0));
          let S = -1;
          (n.doc.nodesBetween(M, n.doc.content.size, (P, A) => {
            if (S > -1) return !1;
            P.isTextblock && P.content.size === 0 && (S = A + 1);
          }),
            S > -1 && n.setSelection(I.near(n.doc.resolve(S))),
            n.scrollIntoView());
        }
        return !0;
      }
      let h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
        p = { ...Mr(f, u.type.name, u.attrs), ...e },
        m = { ...Mr(f, a.node().type.name, a.node().attrs), ...e };
      ...
      let g = h
        ...
        : [{ type: l, attrs: p }];
      if (!Re(n.doc, a.pos, 2)) return !1;
      if (o) {
        let { selection: y, storedMarks: w } = r,
          { splittableMarks: b } = i.extensionManager,
          x = w || (y.$to.parentOffset && y.$from.marks());
        if ((n.split(a.pos, 2, g).scrollIntoView(), !x || !o)) return !0;
        let k = x.filter((M) => b.includes(M.type.name));
        n.ensureMarks(k);
      }
      return !0;
    },
  kl = (t, e) => {
    let n = Je((s) => s.type === e)(t.selection);
    if (!n) return !0;
    let r = t.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
    if (r === void 0) return !0;
    let o = t.doc.nodeAt(r);
    return (n.node.type === o?.type && Le(t.doc, n.pos) && t.join(n.pos), !0);
  },
  Sl = (t, e) => {
    let n = Je((s) => s.type === e)(t.selection);
    if (!n) return !0;
    ...
    if (r === void 0) return !0;
    let o = t.doc.nodeAt(r);
    return (n.node.type === o?.type && Le(t.doc, r) && t.join(r), !0);
  };
function Wb(t) {
  let e = t.doc,
    n = e.firstChild;
  ...
  return I.between(r, o);
}
var jb =
    (t, e, n, r = {}) =>
    ({ editor: o, tr: i, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
      let { extensions: u, splittableMarks: f } = o.extensionManager,
        ...
        { $from: y, $to: w } = m,
        b = y.blockRange(w),
        x = g || (m.$to.parentOffset && m.$from.marks());
      if (!b) return !1;
      let k = Je((D) => Do(D.type.name, u))(m),
        M = m.from === 0 && m.to === s.doc.content.size,
        S = s.doc.content.content,
        P = S.length === 1 ? S[0] : null,
        A = M && P && Do(P.type.name, u) ? { node: P, pos: 0, depth: 0 } : null,
        v = k ?? A,
        R = !!k && b.depth >= 1 && b.depth - k.depth <= 1,
        j = !!A;
      if ((R || j) && v) {
        if (v.node.type === h)
          return M && j
            ? a()
                .command(({ tr: D, dispatch: O }) => {
                  let H = Wb(D);
                  return H ? (D.setSelection(H), O && O(D), !0) : !1;
                })
                .liftListItem(p)
                .run()
            : c.liftListItem(p);
        if (Do(v.node.type.name, u) && h.validContent(v.node.content))
          return a()
      ...
      return !n || !x || !l
        ...
        : a()
            .command(() => {
              let D = d().wrapInList(h, r),
                O = x.filter((H) => f.includes(H.type.name));
              return (i.ensureMarks(O), D ? !0 : c.clearNodes());
            })
            .wrapInList(h, r)
            .command(() => kl(i, h))
            .command(() => Sl(i, h))
  ...
  Ub =
    ...
    ({ state: r, commands: o }) => {
      let { extendEmptyMarkRange: i = !1 } = n,
        s = rt(t, r.schema);
      return Po(r, s, e) ? o.unsetMark(s, { extendEmptyMarkRange: i }) : o.setMark(s, e);
    },
  Kb =
    (t, e, n = {}) =>
    ({ state: r, commands: o }) => {
  ...
  Xb =
    ...
    ({ tr: n, state: r, dispatch: o }) => {
      ...
      if (d && s) {
        let { from: f, to: h } = l,
          p = (i = c.marks().find((g) => g.type === a)) == null ? void 0 : i.attrs,
          m = Bo(c, a, p);
            ...
            : r.doc.nodesBetween(d, u, (g, y) => {
                (y < d &&
                  ...
                  y >= d &&
                    ...
                    (i &&
                      i === g.type &&
                      ((a = !0), o && n.setNodeMarkup(y, void 0, { ...g.attrs, ...e })),
                    s &&
                      g.marks.length &&
                      g.marks.forEach((w) => {
                        if (s === w.type && ((a = !0), o)) {
                          let b = Math.max(y, d),
                            x = Math.min(y + g.nodeSize, u);
                          n.addMark(b, x, s.create({ ...w.attrs, ...e }));
                        }
                      })));
              }),
            h &&
              (f !== void 0 && o && n.setNodeMarkup(f, void 0, { ...h.attrs, ...e }),
              s &&
                h.marks.length &&
                h.marks.forEach((g) => {
                  s === g.type && o && n.addMark(p, m, s.create({ ...g.attrs, ...e }));
                })));
        }),
        a
      );
...
function Oo(t) {
  ...
  return (
    s.forEach((f) => {
      ...
      if (!h) return;
      let p = a.state.tr,
        m = Er({ state: a.state, transaction: p }),
        g = { from: r - (h[0].length - i.length), to: o },
        { commands: y, chain: w, can: b } = new Nr({ editor: n, state: m });
      f.handler({ state: m, range: g, match: h, commands: y, chain: w, can: b }) === null ||
        !p.steps.length ||
        (f.undoable && p.setMeta(l, { transform: p, from: r, to: o, text: i }),
        a.dispatch(p),
        (d = !0));
    }),
    d
    ...
    r = new B({
        ...
        apply(o, i, s) {
          ...
          return (
            !!a &&
              setTimeout(() => {
                let { text: d } = a;
                typeof d == 'string' ? (d = d) : (d = Rr(C.from(d), s.schema));
                let { from: u } = a,
                  f = u + d.length;
                Oo({ editor: e, from: u, to: f, text: d, rules: n, plugin: r });
              }),
      ...
      props: {
        handleTextInput(o, i, s, l) {
          return Oo({ editor: e, from: i, to: s, text: l, rules: n, plugin: r });
        },
        handleDOMEvents: {
          compositionend: (o) => (
            setTimeout(() => {
              let { $cursor: i } = o.state.selection;
              i && Oo({ editor: e, from: i.pos, to: i.pos, text: '', rules: n, plugin: r });
            }),
            !1
          ),
        },
  ...
  return (
    Cr(t) &&
      ...
      Object.keys(e).forEach((r) => {
        Cr(e[r]) && Cr(t[r]) ? (n[r] = Vl(t[r], e[r])) : (n[r] = e[r]);
      }),
    n
  );
}
var Ko = class {
    ...
    get options() {
      return { ...(J($(this, 'addOptions', { name: this.name })) || {}) };
    }
    get storage() {
      return { ...(J($(this, 'addStorage', { name: this.name, options: this.options })) || {}) };
    }
    configure(t = {}) {
      let e = this.extend({ ...this.config, addOptions: () => Vl(this.options, t) });
...
function i0(t) {
  let { editor: e, state: n, from: r, to: o, rule: i, pasteEvent: s, dropEvent: l } = t,
    { commands: a, chain: c, can: d } = new Nr({ editor: e, state: n }),
    u = [];
  return (
    n.doc.nodesBetween(r, o, (h, p) => {
      ...
      if (
        ...
        return;
      let x =
          (b = (w = (y = h.content) == null ? void 0 : y.size) != null ? w : h.nodeSize) != null
            ? b
            : 0,
        k = Math.max(r, p),
        M = Math.min(o, p + x);
      if (k >= M) return;
      let S = h.isText ? h.text || '' : h.textBetween(k - p, M - p, void 0, '\uFFFC');
      o0(S, i.find, s).forEach((A) => {
        if (A.index === void 0) return;
        let v = k + A.index + 1,
          R = v + A[0].length,
          j = { from: n.tr.mapping.map(v), to: n.tr.mapping.map(R) },
          D = i.handler({
            state: n,
            range: j,
            match: A,
      ...
      new B({
        view(u) {
          let f = (p) => {
              var m;
              ((r =
                (m = u.dom.parentElement) != null && m.contains(p.target)
                  ? u.dom.parentElement
                  : null),
                r && (Ro = e));
            },
        ...
        appendTransaction: (u, f, h) => {
          ...
          if (w) {
            let { text: k } = y;
            typeof k == 'string' ? (k = k) : (k = Rr(C.from(k), h.schema));
            let { from: M } = y,
              S = M + k.length,
              P = s0(k);
            return a({ rule: d, state: h, from: M, to: { b: S }, pasteEvt: P });
          }
          let b = f.doc.content.findDiffStart(h.doc.content),
            x = f.doc.content.findDiffEnd(h.doc.content);
          if (!(!Uu(b) || !x || b === x.b))
            return a({ rule: d, state: h, from: b, to: x, pasteEvt: s });
        },
      }),
  );
}
var Jo = class {
  constructor(t, e) {
    ((this.splittableMarks = []),
      ...
      (this.extensions = Fo(t)),
      (this.schema = Pl(this.extensions, e)),
  ...
  get plugins() {
    let { editor: t } = this;
    return Bn([...this.extensions].reverse()).flatMap((r) => {
      let o = {
          name: r.name,
          options: r.options,
          storage: this.editor.extensionStorage[r.name],
          editor: t,
          type: Pn(r.name, this.schema),
        },
        i = [],
        s = $(r, 'addKeyboardShortcuts', o),
        l = {};
      if (
        (r.type === 'mark' &&
          $(r, 'exitable', o) &&
          (l.ArrowRight = () => te.handleExit({ editor: t, mark: r })),
        s)
      ) {
      ...
      let a = ku(l);
      i.push(a);
      let c = $(r, 'addInputRules', o);
      if (Ml(r, t.options.enableInputRules) && c) {
        let f = c();
        if (f && f.length) {
          let h = Wu({ editor: t, rules: f }),
            p = Array.isArray(h) ? h : [h];
          i.push(...p);
        }
      }
      let d = $(r, 'addPasteRules', o);
      if (Ml(r, t.options.enablePasteRules) && d) {
        let f = d();
        if (f && f.length) {
          let h = Ku({ editor: t, rules: f });
          i.push(...h);
        }
      }
      let u = $(r, 'addProseMirrorPlugins', o);
      if (u) {
        let f = u();
        i.push(...f);
      }
  ...
  get nodeViews() {
    let { editor: t } = this,
      { nodeExtensions: e } = rn(this.extensions);
    return Object.fromEntries(
      e
        .filter((n) => !!$(n, 'addNodeView'))
        .map((n) => {
  ...
  dispatchTransaction(t) {
    let { editor: e } = this;
    return Bn([...this.extensions].reverse()).reduceRight((r, o) => {
      let i = {
          name: o.name,
          options: o.options,
          storage: this.editor.extensionStorage[o.name],
          editor: e,
          type: Pn(o.name, this.schema),
        },
        s = $(o, 'dispatchTransaction', i);
      return s
        ? (l) => {
  ...
  transformPastedHTML(t) {
    let { editor: e } = this;
    return Bn([...this.extensions]).reduce(
      (r, o) => {
        let i = {
            name: o.name,
            options: o.options,
  ...
  get markViews() {
    let { editor: t } = this,
      { markExtensions: e } = rn(this.extensions);
    return Object.fromEntries(
      e
        .filter((n) => !!$(n, 'addMarkView'))
        .map((n) => {
  ...
  setupExtensions() {
    ...
    ((this.editor.extensionStorage = Object.fromEntries(t.map((e) => [e.name, e.storage]))),
      t.forEach((e) => {
        ...
        e.type === 'mark' &&
          ((n = J($(e, 'keepOnSplit', r))) == null || n) &&
          this.splittableMarks.push(e.name);
        let o = $(e, 'onBeforeCreate', r),
          i = $(e, 'onCreate', r),
          s = $(e, 'onUpdate', r),
          l = $(e, 'onSelectionUpdate', r),
          a = $(e, 'onTransaction', r),
          c = $(e, 'onFocus', r),
          d = $(e, 'onBlur', r),
          u = $(e, 'onDestroy', r);
...
var U = class Ju extends Ko {
    ...
    onUpdate({ transaction: t, appendedTransactions: e }) {
      ...
      let i = () => {
        ...
        if (
          (c =
            (a =
              (l = (s = this.editor.options.coreExtensionOptions) == null ? void 0 : s.delete) ==
              null
                ? void 0
            ...
            let y = f.slice(p).map(h.from, -1),
              ...
              k =
                y > 0
                  ...
                  : !1,
              M = (g = d.doc.nodeAt(w)) == null ? void 0 : g.marks.some((S) => S.eq(h.mark));
            this.editor.emit('delete', {
              type: 'mark',
              mark: h.mark,
              from: h.from,
              to: h.to,
              deletedRange: { from: b, to: x },
  ...
  Zu = U.create({
    ...
    addProseMirrorPlugins() {
      return [
        new B({ key: new _('editable'), props: { editable: () => this.editor.options.editable } }),
      ];
    },
  }),
  ef = new _('focusEvents'),
  tf = U.create({
    name: 'focusEvents',
    addProseMirrorPlugins() {
      let { editor: t } = this;
            ...
            () =>
              s.command(({ tr: l }) => {
                let { selection: a, doc: c } = l,
                  ...
                  y = m && p.parent.childCount === 1 ? g === u.pos : z.atStart(c).from === f;
                return !d ||
                  !h.type.isTextblock ||
        ...
        new B({
          ...
          appendTransaction: (t, e, n) => {
            ...
            let { empty: i, from: s, to: l } = e.selection,
              ...
              c = z.atEnd(e.doc).to;
            if (i || !(s === a && l === c) || !ln(n.doc)) return;
            let f = n.tr,
              h = Er({ state: n, transaction: f }),
              { commands: p } = new Nr({ editor: this.editor, state: h });
      ...
      return [
        new B({
          ...
          props: {
            attributes: () => {
              var t;
              return !this.editor.isEditable && this.options.value === void 0
                ? {}
                : { tabindex: (t = this.options.value) != null ? t : '0' };
            },
          },
        }),
      ];
  ...
  sf = U.create({
    ...
    addGlobalAttributes() {
      ...
      let { nodeExtensions: t } = rn(this.extensions);
      return [
        {
    ...
    get children() {
      ...
      return (
        this.node.content.forEach((n, r) => {
          ...
          let c = new vr(a, this.editor, o, o || s ? n : null);
    ...
    querySelectorAll(e, n = {}, r = !1) {
      ...
      return (
        this.children.forEach((s) => {
          (r && o.length > 0) ||
            (s.node.type.name === e && i.every((a) => n[a] === s.node.attrs[a]) && o.push(s),
...
var a0 = class extends t0 {
  constructor(t = {}) {
    (super(),
      ...
      (this.utils = { getUpdatedPosition: Fu, createMappablePosition: _u }),
      this.setOptions(t),
      ...
      this.on('drop', ({ event: r, slice: o, moved: i }) => this.options.onDrop(r, o, i)),
      this.on('paste', ({ event: r, slice: o }) => this.options.onPaste(r, o)),
      this.on('delete', this.options.onDelete));
    let e = this.createDoc(),
      n = El(e, this.options.autofocus);
    ((this.editorState = fr.create({ doc: e, schema: this.schema, selection: n || void 0 })),
  ...
  injectCSS() {
    this.options.injectCSS &&
      typeof document < 'u' &&
      (this.css = af(l0, this.options.injectNonce));
  }
  setOptions(t = {}) {
  ...
  registerPlugin(t, e) {
    let n = Dl(e) ? e(t, [...this.state.plugins]) : [...this.state.plugins, t],
  ...
  createExtensionManager() {
    ...
    let i = [
      ...(this.options.enableCoreExtensions
        ? [
            ...
            of.configure({
              value:
                (r = (n = this.options.coreExtensionOptions) == null ? void 0 : n.tabindex) == null
                  ? void 0
                  : r.value,
            }),
            Qu,
            rf,
            Yu,
            sf.configure({ direction: this.options.textDirection }),
          ].filter((s) =>
    ...
    this.extensionManager = new Jo(i, this);
  }
  createCommandManager() {
    this.commandManager = new Nr({ editor: this });
  }
  createSchema() {
  ...
  createDoc() {
    let t;
    try {
      t = Io(this.options.content, this.schema, this.options.parseOptions, {
  ...
  createView(t) {
    let { editorProps: e, enableExtensionDispatchTransaction: n } = this.options,
  ...
  dispatchTransaction(t) {
    ...
    let { state: e, transactions: n } = this.state.applyTransaction(t),
      ...
      o = n.includes(t),
      i = this.state;
    if ((this.emit('beforeTransaction', { editor: this, transaction: t, nextState: e }), !o))
      return;
    ...
    let s = n.findLast((c) => c.getMeta('focus') || c.getMeta('blur')),
      l = s?.getMeta('focus'),
      a = s?.getMeta('blur');
    (l && this.emit('focus', { editor: this, event: l.event, transaction: s }),
      a && this.emit('blur', { editor: this, event: a.event, transaction: s }),
      !(t.getMeta('preventUpdate') || !n.some((c) => c.docChanged) || i.doc.eq(e.doc)) &&
        this.emit('update', { editor: this, transaction: t, appendedTransactions: n.slice(1) }));
  }
  getAttributes(t) {
    return Wo(this.state, t);
  }
  isActive(t, e) {
    let n = typeof t == 'string' ? t : null,
      r = typeof t == 'string' ? e : t;
    return Uo(this.state, n, r);
  }
  getJSON() {
...
`,
    ...
    return Bl(this.state.doc, { blockSeparator: e, textSerializers: { ...Vo(this.schema), ...n } });
  }
  get isEmpty() {
    return ln(this.state.doc);
  }
  destroy() {
    this.destroyed ||
      ((this.destroyed = !0),
  ...
  $pos(t) {
    let e = this.state.doc.resolve(t),
      n = t > 0 && e.nodeAfter && !e.nodeAfter.isText ? e.nodeAfter : null;
    return new lf(e, this, !1, n);
  }
  get $doc() {
    return this.$pos(0);
  }
...
function De(t) {
  return new Fn({
    ...
    handler: ({ state: e, range: n, match: r }) => {
      let o = J(t.getAttributes, void 0, r);
...
function Ge(t) {
  return new Fn({
    ...
    handler: ({ state: e, range: n, match: r, chain: o }) => {
      let i = J(t.getAttributes, void 0, r) || {},
  ...
  Go = class {
    constructor(t) {
      ...
      ((this.node = t.node),
        ...
        (e = t.options) != null && e.min && (this.minSize = { ...this.minSize, ...t.options.min }),
        (n = t.options) != null && n.max && (this.maxSize = t.options.max),
        (r = t?.options) != null && r.directions && (this.directions = t.options.directions),
        (o = t.options) != null &&
    ...
    handleEditorUpdate() {
      ...
      t !== this.lastEditableState &&
        ...
        t ? t && this.handleMap.size === 0 && this.attachHandles() : this.removeHandles());
    }
    update(t, e, n) {
    ...
    createContainer() {
      ...
      return (
        ...
        (t.style.display = this.node.type.isInline ? 'inline-flex' : 'flex'),
        this.classNames.container && (t.className = this.classNames.container),
    ...
    positionHandle(t, e) {
      ...
      (n && (t.style.top = '0'),
        ...
        o && (t.style.left = '0'),
        i && (t.style.right = '0'),
        (e === 'top' || e === 'bottom') && ((t.style.left = '0'), (t.style.right = '0')),
        (e === 'left' || e === 'right') && ((t.style.top = '0'), (t.style.bottom = '0')));
    }
    attachHandles() {
      this.directions.forEach((t) => {
        let e;
        (this.createCustomHandle ? (e = this.createCustomHandle(t)) : (e = this.createHandle(t)),
          ...
          e.addEventListener('mousedown', (n) => this.handleResizeStart(n, t)),
    ...
    applyInitialSize() {
      ...
      (t
        ...
        e
          ? ((this.element.style.height = `${e}px`), (this.initialHeight = e))
    ...
    handleResize(t, e) {
      ...
      let n = this.preserveAspectRatio || this.isShiftKeyPressed,
        { width: r, height: o } = this.calculateNewDimensions(this.activeHandle, t, e),
    ...
    calculateNewDimensions(t, e, n) {
      ...
      return (
        ...
        (t === 'right' || t === 'left') && (r = this.startWidth + (i ? e : -e)),
        (t === 'top' || t === 'bottom') && (o = this.startHeight + (l ? n : -n)),
    ...
    applyConstraints(t, e, n) {
      ...
      if (!n) {
        ...
        return (
          ...
          (o = this.maxSize) != null && o.height && (d = Math.min(this.maxSize.height, d)),
          { width: c, height: d }
        );
      }
      let l = t,
...
function Ul(t, e) {
  ...
  for (let i = r.length - 1; i >= 0; i -= 1) {
    let s = r[i],
      l = s.indexOf(':');
    if (l === -1) continue;
    if (s.slice(0, l).trim().toLowerCase() === o) return s.slice(l + 1).trim();
  }
  return null;
}
function p0(t) {
...
function Xo(t) {
  ...
  Array.from(r.matchAll(s)).forEach(([, c, d]) => {
    var u;
    let f = parseInt(((u = d.match(/__QUOTED_(\d+)__/)) == null ? void 0 : u[1]) || '0', 10),
      h = n[f];
    h && (e[c] = h.slice(1, -1));
  });
  let a = r
...
function df(t) {
  let {
      nodeName: e,
      name: n,
      parseAttributes: r = Xo,
      serializeAttributes: o = Yo,
      defaultAttributes: i = {},
  ...
  return {
    ...
    markdownTokenizer: {
      ...
      tokenize(d, u, f) {
        ...
        let m = p[1] || '',
          g = r(m);
        if (!s.find((w) => !(w in g))) return { type: e, raw: p[0], attributes: g };
      },
    },
    renderMarkdown: (d) => {
      let u = c(d.attrs || {}),
...
function Ht(t) {
  let {
      ...
      name: n,
      getContent: r,
      parseAttributes: o = Xo,
      serializeAttributes: i = Yo,
      defaultAttributes: s = {},
      content: l = 'block',
      allowedAttributes: a,
    } = t,
  ...
  return {
    parseMarkdown: (u, f) => {
      ...
      if (r) {
        ...
        l === 'block' ? (h = f.parseChildren(u.tokens || [])) : (h = f.parseInline(u.tokens || []));
    ...
    markdownTokenizer: {
      ...
      tokenize(u, f, h) {
        ...
        for (S.lastIndex = 0; ;) {
          ...
          let v = A.index,
            R = A[1];
          if (!((p = A[2]) != null && p.endsWith(':::'))) {
            if (R) x += 1;
            else if (((x -= 1), x === 0)) {
              let j = P.slice(0, v);
              M = j.trim();
              let D = u.slice(0, k + v + A[0].length),
                O = [];
              if (M)
                if (l === 'block')
                  for (
                    O = h.blockTokens(j),
                      O.forEach((H) => {
                        H.text &&
                          ...
                          (H.tokens = h.inlineTokens(H.text));
                      });
                    O.length > 0;
                  ) {
                    let H = O[O.length - 1];
                    if (H.type === 'paragraph' && (!H.text || H.text.trim() === '')) O.pop();
                    else break;
                  }
                else O = h.inlineTokens(M);
              return { type: e, raw: D, attributes: b, content: M, tokens: O };
            }
          }
        }
      },
...
`;
    ...
    for (d += 1; d < l.length;) {
      let k = l[d];
      if (k.trim() === '') {
        let S = l.slice(d + 1).findIndex((v) => v.trim() !== '');
        if (S === -1) break;
        if (
          (((o = (r = l[d + 1 + S].match(/^(\s*)/)) == null ? void 0 : r[1]) == null
            ? void 0
            : o.length) || 0) > m
        ) {
          (y.push(k),
...
`),
      ...
      if (
        (((s = (i = k.match(/^(\s*)/)) == null ? void 0 : i[1]) == null ? void 0 : s.length) || 0) >
        m
      )
        (y.push(k),
          (c = `${c}${k}
`),
    ...
    let w,
      b = y.slice(1);
    if (b.length > 0) {
      let k = b.map((M) => M.slice(m + u)).join(`
`);
      k.trim() && (e.customNestedParser ? (w = e.customNestedParser(k)) : (w = n.blockTokens(k)));
    }
    let x = e.createToken(p, w);
    a.push(x);
  }
  ...
  return (
    s &&
      ...
      s.forEach((c, d) => {
        var u, f;
        let h =
          (f = (u = e.renderChild) == null ? void 0 : u.call(e, c, d + 1)) != null
            ? f
            : e.renderChildren([c]);
        if (h != null) {
          let p = h
...
var x0 = class {
        ...
        : typeof this.options.ignoreMutation == 'function'
          ...
          : t.type === 'selection' ||
              (this.dom.contains(t.target) &&
                ...
                [...Array.from(t.addedNodes), ...Array.from(t.removedNodes)].every(
  ...
  k0 = class {
    ...
    onDragStart(t) {
      ...
      if (!this.dom || ((n = this.contentDOM) != null && n.contains(c)) || !d) return;
      let u = 0,
        f = 0;
      if (this.dom !== d) {
        let w = this.dom.getBoundingClientRect(),
          b = d.getBoundingClientRect(),
          x = (o = t.offsetX) != null ? o : (r = t.nativeEvent) == null ? void 0 : r.offsetX,
          k = (s = t.offsetY) != null ? s : (i = t.nativeEvent) == null ? void 0 : i.offsetY;
        ((u = b.x - w.x + x), (f = b.y - w.y + k));
      }
      let h = this.dom.cloneNode(!0);
      try {
        let w = this.dom.getBoundingClientRect();
        ((h.style.width = `${Math.round(w.width)}px`),
          (h.style.height = `${Math.round(w.height)}px`),
    ...
    stopEvent(t) {
      ...
      let n = t.target;
      if (!(this.dom.contains(n) && !((e = this.contentDOM) != null && e.contains(n)))) return !1;
...
function Te(t) {
  return new qo({
    ...
    handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
      let i = J(t.getAttributes, void 0, r, o);
      ...
      if (l) {
        ...
        if (
          Dr(n.from, n.to, e.doc)
            .filter((m) => m.mark.type.excluded.find((y) => y === t.type && y !== m.mark.type))
        ...
        (f < n.to && s.delete(f, n.to),
          ...
          (r.index !== void 0 && r.input !== void 0 && r.index + r[0].length >= r.input.length) ||
...
function S0(t) {
  return new qo({
    ...
    handler({ match: e, chain: n, range: r, pasteEvent: o }) {
      let i = J(t.getAttributes, void 0, e, o),
        s = J(t.getContent, void 0, i);
      if (i === !1 || i === null) return null;
      let l = { type: t.type.name, attrs: i };
      (s && (l.content = s), e.input && n().deleteRange(r).insertContentAt(r.from, l));
    },
  });
}
function C0(t) {
...
var v0 = class {
  ...
  map(t) {
    let e = !1;
    return {
      position: this.transaction.steps.slice(this.currentStep).reduce((r, o) => {
  ...
  dragover(e) {
    ...
    if (n && !i) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = fo(this.editorView.state.doc, s, this.editorView.dragging.slice);
        l != null && (s = l);
      }
...
var de = class t extends z {
  constructor(e) {
    super(e, e);
  }
  map(e, n) {
    let r = e.resolve(n.map(this.head));
    return t.valid(r) ? new t(r) : z.near(r);
  }
  content() {
    return E.empty;
  }
  ...
  getBookmark() {
    return new Jl(this.anchor);
  }
  static valid(e) {
    let n = e.parent;
    if (n.inlineContent || !M0(e) || !T0(e)) return !1;
...
var Jl = class t {
  ...
  resolve(e) {
    ...
    return de.valid(n) ? new de(n) : z.near(n);
  }
};
function pf(t) {
...
function M0(t) {
  for (let e = t.depth; e >= 0; e--) {
    ...
    for (let o = r.child(n - 1); ; o = o.lastChild) {
      if ((o.childCount == 0 && !o.inlineContent) || pf(o.type)) return !0;
  ...
  return new B({
    props: {
      ...
      createSelectionBetween(t, e, n) {
        return e.pos == n.pos && de.valid(n) ? new de(n) : null;
      },
      handleClick: E0,
      handleKeyDown: A0,
...
function Zo(t, e) {
  ...
  return function (r, o, i) {
    ...
    return c ? (o && o(r.tr.setSelection(new de(c))), !0) : !1;
  };
}
function E0(t, e, n) {
  if (!t || !t.editable) return !1;
  let r = t.state.doc.resolve(e);
  if (!de.valid(r)) return !1;
  let o = t.posAtCoords({ left: n.clientX, top: n.clientY });
  return o && o.inside > -1 && L.isSelectable(t.state.doc.nodeAt(o.inside))
    ? !1
    : (t.dispatch(t.state.tr.setSelection(new de(r))), !0);
}
function N0(t, e) {
  if (e.inputType != 'insertCompositionText' || !(t.state.selection instanceof de)) return !1;
  let { $from: n } = t.state.selection,
    r = n.parent.contentMatchAt(n.index()).findWrapping(t.state.schema.nodes.text);
  if (!r) return !1;
  let o = C.empty;
  for (let s = r.length - 1; s >= 0; s--) o = C.from(r[s].createAndFill(null, o));
...
function O0(t) {
  ...
  return (
    ...
    Z.create(t.doc, [re.widget(t.selection.head, e, { key: 'gapcursor' })])
  );
}
var ei = 200,
  ye = function () {};
ye.prototype.append = function (e) {
  return e.length
    ? ((e = ye.from(e)),
      (!this.length && e) ||
        (e.length < ei && this.leafAppend(e)) ||
        (this.length < ei && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
};
...
ye.prototype.slice = function (e, n) {
  return (
    ...
    e >= n ? ye.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, n))
  );
};
...
ye.from = function (e) {
  return e instanceof ye ? e : e && e.length ? new gf(e) : ye.empty;
};
var gf = (function (t) {
  function e(r) {
  ...
  return (
    ...
    (e.prototype.forEachInner = function (o, i, s, l) {
      for (var a = i; a < s; a++) if (o(this.values[a], l + a) === !1) return !1;
    }),
    (e.prototype.forEachInvertedInner = function (o, i, s, l) {
      for (var a = i - 1; a >= s; a--) if (o(this.values[a], l + a) === !1) return !1;
    }),
    (e.prototype.leafAppend = function (o) {
      if (this.length + o.length <= ei) return new e(this.values.concat(o.flatten()));
    }),
    (e.prototype.leafPrepend = function (o) {
      if (this.length + o.length <= ei) return new e(o.flatten().concat(this.values));
    }),
...
var R0 = (function (t) {
    ...
    return (
      ...
      (e.prototype.forEachInner = function (r, o, i, s) {
        ...
        if (
          (o < l && this.left.forEachInner(r, o, Math.min(i, l), s) === !1) ||
          (i > l &&
            this.right.forEachInner(r, Math.max(o - l, 0), Math.min(this.length, i) - l, s + l) ===
              !1)
        )
          return !1;
      }),
      (e.prototype.forEachInvertedInner = function (r, o, i, s) {
        var l = this.left.length;
        if (
          (o > l && this.right.forEachInvertedInner(r, o - l, Math.max(i, l) - l, s + l) === !1) ||
          (i < l && this.left.forEachInvertedInner(r, Math.min(o, l), i, s) === !1)
        )
          return !1;
      }),
  ...
  cn = class t {
          ...
          (u, f) => {
            ...
            if (o) {
              ...
              (h &&
                ...
                c.push(new ot(p, void 0, void 0, c.length + d.length))),
                i--,
                p && o.appendMap(p, i));
    ...
    addTransform(e, n, r, o) {
      ...
      for (let d = 0; d < e.steps.length; d++) {
        let u = e.steps[d].invert(e.docs[d]),
          f = new ot(e.mapping.maps[d], u, n),
          h;
        ((h = a && a.merge(f)) && ((f = h), d ? i.pop() : (l = l.slice(0, l.length - 1))),
          i.push(f),
          n && (s++, (n = void 0)),
          o || (a = f));
      }
      let c = s - r.depth;
      return (c > P0 && ((l = I0(l, c)), (s -= c)), new t(l.append(i), s));
    }
    remapping(e, n) {
      let r = new lr();
      return (
    ...
    addMaps(e) {
      return this.eventCount == 0
        ? this
        : new t(this.items.append(e.map((n) => new ot(n))), this.eventCount);
    }
    rebased(e, n) {
      ...
      this.items.forEach((f) => {
        ...
        } else r.push(new ot(p));
      }, o);
      let c = [];
      for (let f = n; f < s; f++) c.push(new ot(i.maps[f]));
      let d = this.items.slice(0, o).append(c).append(r),
        u = new t(d, l);
      return (u.emptyItemCount() > D0 && (u = u.compress(this.items.length - r.length)), u);
    }
    emptyItemCount() {
      let e = 0;
      return (
    ...
    compress(e = this.items.length) {
      ...
      return (
        ...
        new t(Gl.from(o.reverse()), i)
      );
    }
  };
cn.empty = new cn(Gl.empty, 0);
function I0(t, e) {
  let n;
  return (
    t.forEach((r, o) => {
...
function L0(t, e, n, r) {
  ...
  n.getMeta(H0) && (t = new it(t.done, t.undone, null, 0, -1));
  let s = n.getMeta('appendedTransaction');
  if (n.steps.length == 0) return t;
  if (s && s.getMeta(an))
    return s.getMeta(an).redo
      ? new it(
          t.done.addTransform(n, void 0, r, ti(e)),
          t.undone,
          yf(n.mapping.maps),
          t.prevTime,
          t.prevComposition,
      ...
      : new it(
          t.done,
          t.undone.addTransform(n, void 0, r, ti(e)),
          null,
          t.prevTime,
          t.prevComposition,
        );
  if (n.getMeta('addToHistory') !== !1 && !(s && s.getMeta('addToHistory') === !1)) {
    let l = n.getMeta('composition'),
      a =
        ...
        (!s &&
          t.prevComposition != l &&
          (t.prevTime < (n.time || 0) - r.newGroupDelay || !B0(n, t.prevRanges))),
      c = s ? Xl(t.prevRanges, n.mapping) : yf(n.mapping.maps);
    return new it(
      t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, ti(e)),
      cn.empty,
      c,
      n.time,
      l ?? t.prevComposition,
...
function B0(t, e) {
  ...
  return (
    t.mapping.maps[0].forEach((r, o) => {
      for (let i = 0; i < e.length; i += 2) r <= e[i + 1] && o >= e[i] && (n = !0);
    }),
    n
  );
}
...
function z0(t, e, n) {
  let r = ti(e),
    o = an.get(e).spec.config,
    i = (n ? t.undone : t.done).popEvent(e, r);
  if (!i) return null;
  let s = i.selection.resolve(i.transform.doc),
    l = (n ? t.done : t.undone).addTransform(i.transform, e.selection.getBookmark(), o, r),
    a = new it(n ? l : i.remaining, n ? i.remaining : l, null, 0, -1);
  return i.transform.setSelection(s).setMeta(an, { redo: n, historyState: a });
}
var Yl = !1,
  bf = null;
function ti(t) {
...
var an = new _('history'),
  H0 = new _('closeHistory');
function wf(t = {}) {
  return (
    ...
    new B({
      ...
      state: {
        init() {
          return new it(cn.empty, cn.empty, null, 0, -1);
        },
        apply(e, n, r) {
          return L0(n, r, e, t);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, n) {
            let r = n.inputType,
              o = r == 'historyUndo' ? Ql : r == 'historyRedo' ? Zl : null;
...
var OC = U.create({
        ...
        new B({
          ...
          appendTransaction: (e, n, r) => {
            ...
            let o = this.options.limit,
              i = this.options.autoTrim;
            if (o == null || o === 0 || i === !1) {
              t = !0;
              return;
            }
            let s = this.storage.characters({ node: r.doc });
            if (s > o) {
              let l = s - o,
                a = 0,
                c = l;
          ...
          filterTransaction: (e, n) => {
            ...
            if ((o > r && i > r && i > o) || !e.getMeta('paste')) return !1;
          ...
          props: {
            decorations: ({ doc: t, selection: e }) => {
              let { isEditable: n, isFocused: r } = this.editor,
                { anchor: o } = e,
                i = [];
              if (!n || !r) return Z.create(t, []);
              let s = 0;
              this.options.mode === 'deepest' &&
                t.descendants((a, c) => {
                  if (a.isText) return;
                  if (!(o >= c && o <= c + a.nodeSize - 1)) return !1;
                  s += 1;
                });
              let l = 0;
              return (
                t.descendants((a, c) => {
                  if (a.isText || !(o >= c && o <= c + a.nodeSize - 1)) return !1;
                  if (
                    ((l += 1),
                    (this.options.mode === 'deepest' && s - l > 0) ||
                      (this.options.mode === 'shallowest' && l > 1))
                  )
                    return this.options.mode === 'deepest';
                  i.push(re.node(c, c + a.nodeSize, { class: this.options.className }));
                }),
                Z.create(t, i)
              );
            },
  ...
  vf = U.create({
    ...
    extendNodeSchema(t) {
      ...
      return { allowGapCursor: (e = J($(t, 'allowGapCursor', n))) != null ? e : null };
    },
  });
function xf(t) {
  let {
  ...
  return (
    s && d.push(c),
    re.node(o, o + i.nodeSize, {
      class: d.join(' '),
      [r]: typeof n == 'function' ? n({ editor: e, node: i, pos: o, hasAnchor: l }) : n,
    })
  );
}
function $0(t) {
  let e = getComputedStyle(t),
    n = `${e.overflow} ${e.overflowY} ${e.overflowX}`;
...
function V0({ doc: t, view: e, scrollContainer: n }) {
  let r = e.dom.getBoundingClientRect(),
    o = n ? _0(n) : { top: 0, bottom: window.innerHeight },
    i = Math.max(r.top, o.top),
    s = Math.min(r.bottom, o.bottom);
  if (i >= s) return { top: 0, bottom: t.content.size };
  let a =
      getComputedStyle(e.dom).direction === 'rtl' ? Math.max(r.right - 2, r.left + 2) : r.left + 2,
    c = e.posAtCoords({ left: a, top: i + 2 }),
    d = e.posAtCoords({ left: a, top: s - 2 });
  return { top: c ? c.pos : 0, bottom: d ? d.pos : t.content.size };
}
function W0(t, e) {
  let n = null;
  return {
...
var Br = new _('tiptap__placeholder'),
  ea = U.create({
    name: 'placeholder',
    addOptions() {
      return {
    ...
    addProseMirrorPlugins() {
      let t = this.options.dataAttribute ? `data-${j0(this.options.dataAttribute)}` : `data-${kf}`;
      return [
        new B({
          state: {
            init() {
            ...
            apply(e, n) {
              let r = e.getMeta(Br);
              return r?.positions
                ? { topPos: r.positions.top, bottomPos: r.positions.bottom }
                : e.docChanged
                  ? {
                      topPos: n.topPos !== null ? e.mapping.map(n.topPos) : null,
                      bottomPos: n.bottomPos !== null ? e.mapping.map(n.bottomPos) : null,
                    }
                  : n;
            },
          },
          ...
          view(e) {
            let n = F0(e.dom),
              r = () => {
                let l = V0({ view: e, doc: e.state.doc, scrollContainer: n }),
                  a = Br.getState(e.state);
                if (a.topPos === l.top && a.bottomPos === l.bottom) return;
                let c = e.state.tr
                  .setMeta(Br, { positions: l })
                  .setMeta('tiptap__viewportUpdate', !0);
                e.dispatch(c);
              },
              { call: o, cancel: i } = W0(r, 250),
              s = n;
            return (
              s.addEventListener('scroll', o, { passive: !0 }),
              r(),
              {
                update(l, a) {
                ...
                destroy: () => {
                  (i(), s.removeEventListener('scroll', o));
                },
              }
            );
          },
          props: {
            decorations: ({ doc: e, selection: n }) => {
              ...
              if (this.options.showOnlyCurrent && !this.options.includeChildren) {
                ...
                let d = Br.getState(this.editor.state),
                  u = (r = d.topPos) != null ? r : 0,
                  f = (o = d.bottomPos) != null ? o : e.content.size;
                e.nodesBetween(u, f, (h, p) => {
                  let m = s >= p && s <= p + h.nodeSize,
                    g = !h.isLeaf && ln(h);
          ...
          props: {
            decorations(n) {
              return n.selection.empty ||
                ...
                ? null
                : Z.create(n.doc, [
                    re.inline(n.selection.from, n.selection.to, { class: e.className }),
                  ]);
            },
          },
        }),
    ...
    addProseMirrorPlugins() {
      ...
      let e = new _(this.name),
        ...
        r = Object.entries(this.editor.schema.nodes)
          .map(([, o]) => o)
          .filter((o) => (this.options.notAfter || []).concat(n).includes(o.name));
      return [
        new B({
          key: e,
          appendTransaction: (o, i, s) => {
            let { doc: l, tr: a, schema: c } = s,
              ...
              u = l.content.size,
              f = c.nodes[n];
            if (!o.some((h) => h.getMeta(U0)) && d) return a.insert(u, f.create());
          },
          state: {
            init: (o, i) => {
              let s = i.tr.doc.lastChild;
              return !Sf({ node: s, types: r });
            },
            apply: (o, i) => {
              if (!o.docChanged || o.getMeta('__uniqueIDTransaction')) return i;
...
var K0 = /^\s*>\s$/,
  q0 = V.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
      return Wn('blockquote', { ...N(this.options.HTMLAttributes, t), children: Wn('slot', {}) });
    },
    parseMarkdown: (t, e) => {
      var n;
    ...
    renderMarkdown: (t, e) => {
      ...
      return (
        t.content.forEach((o, i) => {
          var s, l;
          let d = (
            (l = (s = e.renderChild) == null ? void 0 : s.call(e, o, i)) != null
              ? l
              : e.renderChildren([o])
          )
            .split(
...
`)
    ...
    addInputRules() {
      return [Ge({ find: K0, type: this.type })];
    },
  }),
  Tf = q0;
var J0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
  G0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
  X0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
  Y0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
  Q0 = te.create({
    name: 'bold',
    addOptions() {
      return { HTMLAttributes: {} };
    ...
    renderHTML({ HTMLAttributes: t }) {
      return Wn('strong', { ...N(this.options.HTMLAttributes, t), children: Wn('slot', {}) });
    },
    ...
    addInputRules() {
      return [De({ find: J0, type: this.type }), De({ find: X0, type: this.type })];
    },
    addPasteRules() {
      return [Te({ find: G0, type: this.type }), Te({ find: Y0, type: this.type })];
    },
  }),
  Af = Q0;
var Z0 = /(^|[^`])`([^`]+)`(?!`)$/,
  ...
  tw = te.create({
    ...
    addInputRules() {
      return [De({ find: Z0, type: this.type })];
    },
    addPasteRules() {
      return [Te({ find: ew, type: this.type })];
    },
  }),
  Ef = tw;
var ta = 4,
      ...
      return {
        language: {
          ...
          parseHTML: (t) => {
            ...
            if (!n) return null;
            let i = [...(((e = t.firstElementChild) == null ? void 0 : e.classList) || [])]
    ...
    addKeyboardShortcuts() {
      return {
        ...
        Tab: ({ editor: t }) => {
          ...
          let n = (e = this.options.tabSize) != null ? e : ta,
            { state: r } = t,
            { selection: o } = r,
            { $from: i, empty: s } = o;
...
`),
                  ...
                  let w = ((a = h[p].match(/^ */)) == null ? void 0 : a[0]) || '',
                    b = Math.min(w.length, n);
                  if (b === 0) return !0;
                  let x = d;
                  for (let M = 0; M < p; M += 1) x += h[M].length + 1;
                  return (l.delete(x, x + b), c - x <= b && l.setSelection(I.create(l.doc, x)), !0);
                })
              : t.commands.command(({ tr: l }) => {
                  let { from: a, to: c } = o,
                    f = r.doc
...
`,
                      ...
                      .map((h) => {
                        var p;
                        let m = ((p = h.match(/^ */)) == null ? void 0 : p[0]) || '',
...
`);
        ...
        ArrowDown: ({ editor: t }) => {
          ...
          return l === void 0
            ? !1
            : r.nodeAt(l)
              ? t.commands.command(({ tr: c }) => (c.setSelection(z.near(r.resolve(l))), !0))
              : t.commands.exitCode();
        },
      };
    },
    addInputRules() {
      return [
        _n({ find: nw, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
        _n({ find: rw, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
      ];
    },
    addProseMirrorPlugins() {
      return [
...
`,
              ...
              return (
                s.replaceSelectionWith(this.type.create({ language: i }, a)),
                s.selection.$from.parent.type !== this.type &&
                  s.setSelection(I.near(s.doc.resolve(Math.max(0, s.selection.from - 2)))),
                s.setMeta('paste', !0),
                t.dispatch(s),
                !0
              );
...
var Of = V.create({
  ...
  inline: !1,
  addNodeView() {
    return ({ editor: t, node: e, getPos: n, HTMLAttributes: r, decorations: o, extension: i }) => {
      let s = document.createElement('div');
      (s.setAttribute('data-config', JSON.stringify(e.attrs.config)),
        s.setAttribute('data-id', e.attrs.id),
        s.setAttribute('data-type', 'customBlock'));
      let l = document.createElement('div');
      if (
        ((l.className = 'fi-fo-rich-editor-custom-block-header fi-not-prose'),
        s.appendChild(l),
        t.isEditable &&
        ...
        ((c.className = 'fi-fo-rich-editor-custom-block-edit-btn-ctn'), l.appendChild(c));
        let d = document.createElement('button');
        ((d.className = 'fi-icon-btn'),
          (d.type = 'button'),
          (d.innerHTML = i.options.editCustomBlockButtonIconHtml),
          d.addEventListener('click', () =>
            i.options.editCustomBlockUsing(e.attrs.id, e.attrs.config),
          ),
          c.appendChild(d));
      }
      ...
      if (
        ...
        let c = document.createElement('div');
        ((c.className = 'fi-fo-rich-editor-custom-block-delete-btn-ctn'), l.appendChild(c));
        let d = document.createElement('button');
        ((d.className = 'fi-icon-btn'),
          (d.type = 'button'),
      ...
      if (e.attrs.preview) {
        let c = document.createElement('div'),
          d = ['fi-fo-rich-editor-custom-block-preview'];
        (e.attrs.shouldApplyProseStylingToPreview || d.push('fi-not-prose'),
          (c.className = d.join(' ')),
          (c.innerHTML = new TextDecoder().decode(
            Uint8Array.from(atob(e.attrs.preview), (u) => u.charCodeAt(0)),
          )),
          s.appendChild(c));
      }
      return { dom: s };
  ...
  addAttributes() {
    return {
      config: {
        ...
        renderHTML: (t) => (t.config ? { 'data-config': JSON.stringify(t.config) } : {}),
      },
      id: {
        default: null,
      ...
      label: { default: null, parseHTML: (t) => t.getAttribute('data-label'), rendered: !1 },
      preview: { default: null, parseHTML: (t) => t.getAttribute('data-preview'), rendered: !1 },
      shouldApplyProseStylingToPreview: { default: !1, rendered: !1 },
    };
  },
  parseHTML() {
        ...
        this.editor.commands.command(({ tr: t, state: e }) => {
          ...
          return (
            e.doc.nodesBetween(i - 1, i, (a, c) => {
              if (a.type.name === this.name) return ((n = !0), (s = a), (l = c), !1);
            }),
            n
          );
        }),
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new B({
        props: {
          handleDrop(e, n) {
            if (!n || (n.preventDefault(), !n.dataTransfer.getData('customBlock'))) return !1;
            let r = n.dataTransfer.getData('customBlock');
            return (t(r, e.posAtCoords({ left: n.clientX, top: n.clientY }).pos), !1);
          },
        },
      }),
    ];
...
var ri = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
  iw = (t, e, n) => {
    for (let r = t.depth; r > 0; r -= 1) {
      let o = t.node(r),
        i = e(o),
        s = ri(t.start(r), n);
      if (i && s) return { pos: r > 0 ? t.before(r) : 0, start: t.start(r), depth: r, node: o };
    }
  },
  Rf = (t, e) => {
    ...
    if (
      ...
      return !1;
    let d = Je((y) => y.type === i.nodes.details)(s);
    if (!d) return !1;
    let u = sn(d.node, (y) => y.type === i.nodes.detailsContent);
    if (!u.length || ri(d.start + u[0].pos + 1, t)) return !1;
  ...
  Df = V.create({
    ...
    addOptions() {
      return {
        ...
        HTMLAttributes: {},
        renderToggleButton: ({ element: t, isOpen: e }) => {
          t.setAttribute('aria-label', e ? 'Collapse details content' : 'Expand details content');
        },
      };
    },
    addAttributes() {
    ...
    addNodeView() {
      return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
        let o = document.createElement('div'),
          i = N(this.options.HTMLAttributes, r, { 'data-type': this.name });
        Object.entries(i).forEach(([d, u]) => o.setAttribute(d, u));
        let s = document.createElement('button');
        s.type = 'button';
        let l = (d) => {
          this.options.renderToggleButton({ element: s, ...d });
        };
        o.append(s);
        let a = document.createElement('div');
        o.append(a);
        let c = (d) => {
          let { setToValue: u, node: f = n } = d || {};
          if (u !== void 0)
            if (u) {
              if (o.classList.contains(this.options.openClassName)) return;
          ...
          let h = o.classList.contains(this.options.openClassName);
          l({ isOpen: h, node: f });
          let p = new Event('toggleDetailsContent'),
            m = a.querySelector(':scope > div[data-type="detailsContent"]');
          m?.dispatchEvent(p);
        };
        return (
          l({ isOpen: !!n.attrs.open, node: n }),
          n.attrs.open && setTimeout(() => c()),
          s.addEventListener('click', () => {
            ...
            if (t.isEditable && typeof e == 'function') {
              let { from: d, to: u } = t.state.selection;
              t.chain()
                .command(({ tr: f }) => {
                  let h = e();
                  if (!h) return !1;
                  ...
                  return p?.type !== this.type
                    ? !1
                    : (f.setNodeMarkup(h, void 0, { open: !p.attrs.open }), !0);
                })
                .setTextSelection({ from: d, to: u })
          ...
          }),
          {
            ...
            contentDOM: a,
            ignoreMutation(d) {
              if (d.type === 'selection') return !1;
              let u = d.target,
                f = o.contains(u);
              return s.contains(u) || !f || o === u;
            },
            update: (d) =>
              d.type !== this.type
                ? !1
                : (d.attrs.open !== void 0
                    ? c({ setToValue: d.attrs.open, node: d })
                    : l({ isOpen: o.classList.contains(this.options.openClassName), node: d }),
                  !0),
          }
        );
      };
      ...
      return {
        setDetails:
          ...
          ({ state: t, chain: e }) => {
            ...
            if (!r.nodes.detailsContent.contentMatch.matchFragment(a.content)) return !1;
            let d = ((n = a.toJSON()) == null ? void 0 : n.content) || [];
            return e()
              .insertContentAt(
                { from: l.start, to: l.end },
                {
                  type: this.name,
                  content: [{ type: 'detailsSummary' }, { type: 'detailsContent', content: d }],
                },
              )
        ...
        unsetDetails:
          ...
          ({ state: t, chain: e }) => {
            let { selection: n, schema: r } = t,
              o = Je((y) => y.type === this.type)(n);
            if (!o) return !1;
            let i = sn(o.node, (y) => y.type === r.nodes.detailsSummary),
              s = sn(o.node, (y) => y.type === r.nodes.detailsContent);
            ...
            let l = i[0],
              ...
              g = [p?.create(null, l.node.content).toJSON(), ...h];
            return e()
              .insertContentAt(f, g)
    ...
    addKeyboardShortcuts() {
      return {
        ...
        ArrowRight: ({ editor: t }) => Rf(t, 'right'),
        ArrowDown: ({ editor: t }) => Rf(t, 'down'),
      };
    },
    addProseMirrorPlugins() {
      return [
        new B({
          key: new _('detailsSelection'),
          appendTransaction: (t, e, n) => {
            ...
            if (ri(a.pos, r)) return;
            let d = iw(a, (y) => y.type === o, r);
            if (!d) return;
            let u = sn(d.node, (y) => y.type === n.schema.nodes.detailsSummary);
            if (!u.length) return;
            let f = u[0],
              p =
                (e.selection.from < n.selection.from ? 'forward' : 'backward') === 'forward'
                  ? d.start + f.pos
  ...
  If = V.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
      return ['div', N(this.options.HTMLAttributes, t, { 'data-type': this.name }), 0];
    },
    addNodeView() {
      return ({ HTMLAttributes: t }) => {
        let e = document.createElement('div'),
          n = N(this.options.HTMLAttributes, t, { 'data-type': this.name, hidden: 'hidden' });
        return (
      ...
      return {
        Enter: ({ editor: t }) => {
          ...
          let w = o.indexAfter(-3),
            b = $n(y.contentMatchAt(w));
          if (!b || !y.canReplaceWith(w, w, b)) return !1;
          let x = b.createAndFill();
          if (!x) return !1;
          let { tr: k } = e,
            M = o.after(-2);
          k.replaceWith(M, M, x);
          let S = k.doc.resolve(M),
            P = z.near(S, 1);
          k.setSelection(P);
          let A = m,
            v = m + p.nodeSize;
          return (k.delete(A, v), k.scrollIntoView(), n.dispatch(k), !0);
        },
      };
    },
...
var Bf = V.create({
  ...
  parseHTML() {
    return [{ tag: 'div', getAttrs: (t) => t.classList.contains('grid-layout') && null }];
  },
  renderHTML({ HTMLAttributes: t }) {
  ...
  addCommands() {
    return {
      insertGrid:
        ({ columns: t = [1, 1], fromBreakpoint: e, coordinates: n = null } = {}) =>
        ({ tr: r, dispatch: o, editor: i }) => {
          let s = i.schema.nodes.gridColumn,
            l = Array.isArray(t) && t.length ? t : [1, 1],
            a = [];
          for (let u = 0; u < l.length; u += 1)
            a.push(s.createAndFill({ 'data-col-span': Number(l[u] ?? 1) || 1 }));
          let c = l.map((u) => Number(u) || 1).reduce((u, f) => u + f, 0),
            d = i.schema.nodes.grid.createChecked({ 'data-cols': c, 'data-from-breakpoint': e }, a);
          if (o) {
            ...
            [null, void 0].includes(n?.from)
              ? r
                  ...
                  .scrollIntoView()
                  .setSelection(I.near(r.doc.resolve(u)))
              : r
                  .replaceRangeWith(n.from, n.to, d)
                  .scrollIntoView()
                  .setSelection(I.near(r.doc.resolve(n.from)));
          }
          return !0;
        },
    };
  ...
  addAttributes() {
    return {
      'data-col-span': {
        ...
        renderHTML: (t) => ({ 'data-col-span': t['data-col-span'] ?? 1 }),
      },
      style: {
        default: null,
        parseHTML: (t) => t.getAttribute('style'),
        renderHTML: (t) => ({ style: `grid-column: span ${t['data-col-span'] ?? 1};` }),
      },
    };
  },
  parseHTML() {
    return [{ tag: 'div', getAttrs: (t) => t.classList.contains('grid-layout-col') && null }];
  },
  renderHTML({ HTMLAttributes: t }) {
    return ['div', N(this.options.HTMLAttributes, t), 0];
  },
              ...
              () =>
                t.command(() => {
                  ...
                  let { keepMarks: s } = this.options,
                    ...
                    a = i || (o.$to.parentOffset && o.$from.marks());
                  return e()
                    .insertContent({ type: this.name })
                    .command(({ tr: c, dispatch: d }) => {
                      if (d && a && s) {
                        let u = a.filter((f) => l.includes(f.type.name));
                        c.ensureMarks(u);
                      }
                      return !0;
                    })
...
var aw = V.create({
    ...
    renderMarkdown: (t, e) => {
      var n;
      let r = (n = t.attrs) != null && n.level ? parseInt(t.attrs.level, 10) : 1,
        o = '#'.repeat(r);
...
var cw = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
  ...
  uw = te.create({
    ...
    addInputRules() {
      return [De({ find: cw, type: this.type })];
    },
    addPasteRules() {
      return [Te({ find: dw, type: this.type })];
    },
  }),
  Ff = uw;
var fw = V.create({
    ...
    addCommands() {
      return {
        setHorizontalRule:
          () =>
          ({ chain: t, state: e }) => {
            if (!Wl(e, e.schema.nodes[this.name])) return !1;
            let { selection: n } = e,
              { $to: r } = n,
              o = t();
            return (
                  ...
                  if (l) {
                    ...
                    if (a.nodeAfter)
                      a.nodeAfter.isTextblock
                        ? s.setSelection(I.create(s.doc, a.pos + 1))
                        : a.nodeAfter.isBlock
                          ? s.setSelection(L.create(s.doc, a.pos))
                          : s.setSelection(I.create(s.doc, a.pos));
                    else {
                      let d =
                          i.schema.nodes[this.options.nextNodeType] ||
                          a.parent.type.contentMatch.defaultType,
                        u = d?.create();
                      u && (s.insert(c, u), s.setSelection(I.create(s.doc, c + 1)));
                    }
                    s.scrollIntoView();
                  }
                  return !0;
    ...
    addInputRules() {
      return [Pr({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })];
    },
  }),
  _f = fw;
var hw = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
  ...
  yw = te.create({
    ...
    addInputRules() {
      return [De({ find: hw, type: this.type }), De({ find: mw, type: this.type })];
    },
    addPasteRules() {
      return [Te({ find: pw, type: this.type }), Te({ find: gw, type: this.type })];
    },
  }),
  Vf = yw;
var bw = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
  ww = V.create({
    ...
    parseMarkdown: (t, e) => e.createNode('image', { src: t.href, title: t.title, alt: t.text }),
    renderMarkdown: (t) => {
      var e, n, r, o, i, s;
      let l = (n = (e = t.attrs) == null ? void 0 : e.src) != null ? n : '',
        a = (o = (r = t.attrs) == null ? void 0 : r.alt) != null ? o : '',
        c = (s = (i = t.attrs) == null ? void 0 : i.title) != null ? s : '';
      return c ? `![${a}](${l} "${c}")` : `![${a}](${l})`;
    },
    addNodeView() {
            ...
            onCommit: (u, f) => {
              ...
              h !== void 0 &&
                this.editor
                  .chain()
                  .setNodeSelection(h)
                  .updateAttributes(this.name, { width: u, height: f })
                  .run();
            },
            onUpdate: (u, f, h) => u.type === o.type,
            options: { directions: t, min: { width: e, height: n }, preserveAspectRatio: r === !0 },
          }),
          d = c.dom;
        return (
...
var jf = Wf.extend({
  addAttributes() {
    return {
      ...
      width: {
        default: null,
        parseHTML: (t) => t.getAttribute('width') || t.style.width || null,
        renderHTML: (t) => (t.width ? { width: t.width, style: `width: ${t.width}` } : {}),
      },
      height: {
        default: null,
        parseHTML: (t) => t.getAttribute('height') || t.style.height || null,
        renderHTML: (t) => (t.height ? { height: t.height, style: `height: ${t.height}` } : {}),
      },
    };
  },
});
...
Ne.prototype = {
  ...
  tr(t, e, n, r) {
    r = r || Ne.groups;
    let o;
    return (e && e.j ? (o = e) : ((o = new Ne(e)), n && r && dn(e, n, r)), this.jr.push([t, o]), o);
  },
  ts(t, e, n, r) {
    let o = this,
      i = t.length;
    ...
    if (
      ...
      if (r)
        if (s.t && typeof s.t == 'string') {
          let a = Object.assign(Mw(s.t, r), n);
          dn(i, a, r);
        } else n && dn(i, n, r);
      s.t = i;
    }
...
var K = (t, e, n, r, o) => t.ta(e, n, r, o),
  ie = (t, e, n, r, o) => t.tr(e, n, r, o),
  Kf = (t, e, n, r, o) => t.ts(e, n, r, o),
  T = (t, e, n, r, o) => t.tt(e, n, r, o),
  Ct = 'WORD',
  fa = 'UWORD',
  Qf = 'ASCIINUMERICAL',
  Zf = 'ALPHANUMERICAL',
  ...
  hi = 'CLOSEANGLEBRACKET',
  pi = 'FULLWIDTHLEFTPAREN',
  mi = 'FULLWIDTHRIGHTPAREN',
  gi = 'LEFTCORNERBRACKET',
  yi = 'RIGHTCORNERBRACKET',
  bi = 'LEFTWHITECORNERBRACKET',
  wi = 'RIGHTWHITECORNERBRACKET',
  xi = 'FULLWIDTHLESSTHAN',
  ki = 'FULLWIDTHGREATERTHAN',
  Si = 'AMPERSAND',
  Ci = 'APOSTROPHE',
  vi = 'ASTERISK',
  Ft = 'AT',
  ...
  nh = Object.freeze({
    ...
    EQUALS: Ni,
    EXCLAMATION: wa,
    FULLWIDTHGREATERTHAN: ki,
    FULLWIDTHLEFTPAREN: pi,
    FULLWIDTHLESSTHAN: xi,
    FULLWIDTHMIDDLEDOT: eh,
    FULLWIDTHRIGHTPAREN: mi,
    HYPHEN: _e,
    LEFTCORNERBRACKET: gi,
    ...
    QUERY: Wr,
    QUOTE: xa,
    RIGHTCORNERBRACKET: yi,
    RIGHTWHITECORNERBRACKET: wi,
    SCHEME: li,
    SEMI: ka,
    SLASH: lt,
    SLASH_SCHEME: jn,
...
function Ew(t = []) {
  ...
  (oi == null && (oi = Jf(xw)),
    ...
    T(n, '\\', Mi),
    T(n, '\u30FB', eh));
  let r = ie(n, St, ga, { [aa]: !0 });
  ie(r, St, r);
  let o = ie(r, kt, Qf, { [$r]: !0 }),
    i = ie(r, zr, Zf, { [Hr]: !0 }),
    s = ie(n, kt, Ct, { [ca]: !0 });
  (ie(s, St, o), ie(s, kt, s), ie(o, St, o), ie(o, kt, o));
  let l = ie(n, zr, fa, { [da]: !0 });
  (ie(l, kt), ie(l, St, i), ie(l, zr, l), ie(i, St, i), ie(i, kt), ie(i, zr, i));
  let a = T(n, ia, ya, { [na]: !0 }),
    c = T(n, qf, ma, { [na]: !0 }),
    d = ie(n, oa, ma, { [na]: !0 });
  (T(n, sa, d),
    T(c, ia, a),
    ...
    ie(d, oa, d),
    T(d, sa, d));
  let u = ie(n, ra, th, { [Yf]: !0 });
  (T(u, '#'), ie(u, ra, u), T(u, Tw, u));
  let f = T(u, Aw);
  (T(f, '#'), ie(f, ra, u));
  let h = [
      [kt, s],
  ...
  for (let m = 0; m < oi.length; m++) $t(n, oi[m], ha, Ct, h);
  for (let m = 0; m < ii.length; m++) $t(n, ii[m], pa, fa, p);
  (dn(ha, { tld: !0, ascii: !0 }, e),
    dn(pa, { utld: !0, alpha: !0 }, e),
    $t(n, 'file', li, Ct, h),
    $t(n, 'mailto', li, Ct, h),
    $t(n, 'http', jn, Ct, h),
    $t(n, 'https', jn, Ct, h),
    $t(n, 'ftp', jn, Ct, h),
    $t(n, 'ftps', jn, Ct, h),
    dn(li, { scheme: !0, ascii: !0 }, e),
    dn(jn, { slashscheme: !0, ascii: !0 }, e),
  ...
  return (
    Kf(n, 'localhost', Ur, { ascii: !0 }),
    (n.jd = new Ne(Pi)),
    { start: n, tokens: Object.assign({ groups: e }, nh) }
  );
}
function rh(t, e) {
  let n = Nw(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
    r = n.length,
    o = [],
    i = 0,
    s = 0;
  for (; s < r;) {
    ...
    for (; s < r && (a = l.go(n[s]));)
      ((l = a),
        l.accepts() ? ((u = 0), (f = 0), (d = l)) : u >= 0 && ((u += n[s].length), f++),
        (c += n[s].length),
        (i += n[s].length),
        s++);
    ((i -= u), (s -= f), (c -= u), o.push({ t: d.t, v: e.slice(i - c, i), s: i - c, e: i }));
  }
  return o;
}
function Nw(t) {
  ...
  for (; r < n;) {
    let o = t.charCodeAt(r),
      i,
      s =
        o < 55296 || o > 56319 || r + 1 === n || (i = t.charCodeAt(r + 1)) < 56320 || i > 57343
          ? t[r]
          : t.slice(r, r + 2);
    (e.push(s), (r += s.length));
  }
...
function $t(t, e, n, r, o) {
  ...
  for (let l = 0; l < s - 1; l++) {
    let a = e[l];
    (t.j[a] ? (i = t.j[a]) : ((i = new Ne(r)), (i.jr = o.slice()), (t.j[a] = i)), (t = i));
  }
  return ((i = new Ne(n)), (i.jr = o.slice()), (t.j[e[s - 1]] = i), i);
}
function Jf(t) {
  let e = [],
    n = [],
...
function Sa(t, e = null) {
  let n = Object.assign({}, Kr);
  t && (n = Object.assign(n, t instanceof Sa ? t.o : t));
  let r = n.ignoreTags,
    o = [];
...
Sa.prototype = {
  ...
  get(t, e, n) {
    ...
    return (
      o &&
      (typeof o == 'object'
        ? ((o = n.t in o ? o[n.t] : Kr[t]), typeof o == 'function' && r && (o = o(e, n)))
...
var Ow = Li('email', {
  ...
  si = Li('url', {
    isLink: !0,
    toHref(t = Kr.defaultProtocol) {
      return this.hasProtocol() ? this.v : `${t}://${this.v}`;
    },
    hasProtocol() {
      let t = this.tk;
      return t.length >= 2 && t[0].t !== Ur && t[1].t === un;
    },
  });
var Fe = (t) => new Ne(t);
function Dw({ groups: t }) {
  let e = t.domain.concat([Si, vi, Ft, Mi, Ti, Ai, Ei, Ni, _e, ga, Vr, Oi, Ri, Di, lt, Pi, jr, Ii]),
    n = [
      Ci,
      un,
      ba,
    ...
    r = [Si, Ci, vi, Mi, Ti, Ai, Ei, Ni, _e, Fr, _r, Vr, Oi, Ri, Di, Wr, lt, Pi, jr, Ii],
    o = Fe(),
    i = T(o, jr);
  ...
  let c = T(s, Ft);
  (T(i, Ft, c), T(l, Ft, c), T(a, Ft, c));
  let d = T(i, st);
  (K(d, r, i), K(d, t.domain, i));
  let u = Fe();
  (K(c, t.domain, u), K(u, t.domain, u));
  let f = T(u, st);
  K(f, t.domain, u);
  let h = Fe(Ow);
  (K(f, t.tld, h), K(f, t.utld, h), T(c, Ur, h));
  let p = T(u, _e);
  (T(p, _e, p), K(p, t.domain, u), K(h, t.domain, u), T(h, st, f), T(h, _e, p));
  let m = T(s, _e),
    g = T(s, st);
  (T(m, _e, m), K(m, t.domain, s), K(g, r, i), K(g, t.domain, s));
  let y = Fe(si);
  (K(g, t.tld, y),
    K(g, t.utld, y),
    K(y, t.domain, s),
  ...
  let x = Fe(si),
    k = Fe();
  (K(x, e, x), K(x, n, k), K(k, e, x), K(k, n, k), T(y, lt, x), T(b, lt, x));
  let M = T(l, un),
    S = T(a, un),
    P = T(S, lt),
    A = T(P, lt);
  ...
  return (T(o, Ur, y), T(o, ya, Rw), { start: o, tokens: nh });
}
function Iw(t, e, n) {
  let r = n.length,
    o = 0,
  ...
  for (; o < r;) {
    ...
    if (f < 0) ((o -= d), o < r && (s.push(n[o]), o++));
      ...
      (s.length > 0 && (i.push(la(Xf, e, s)), (s = [])), (o -= f), (d -= f));
      let h = u.t,
        p = n.slice(o - d, o);
      i.push(la(h, e, p));
    }
  }
  return (s.length > 0 && i.push(la(Xf, e, s)), i);
}
function la(t, e, n) {
  let r = n[0].s,
    o = n[n.length - 1].e,
...
var Pw = (typeof console < 'u' && console && console.warn) || (() => {}),
  Lw =
...
function Ca(t, e = !1) {
  if (
    (ee.initialized &&
      Pw(`linkifyjs: already initialized - will not register custom scheme "${t}" ${Lw}`),
...
function Bw() {
  ee.scanner = Ew(ee.customSchemes);
  for (let t = 0; t < ee.tokenQueue.length; t++) ee.tokenQueue[t][1]({ scanner: ee.scanner });
  ee.parser = Dw(ee.scanner.tokens);
  for (let t = 0; t < ee.pluginQueue.length; t++)
    ee.pluginQueue[t][1]({ scanner: ee.scanner, parser: ee.parser });
  return ((ee.initialized = !0), ee);
}
function Bi(t) {
  return (ee.initialized || Bw(), Iw(ee.parser.start, t, rh(ee.scanner.start, t)));
}
Bi.scan = rh;
function zi(t, e = null, n = null) {
  ...
  return new B({
    ...
    appendTransaction: (e, n, r) => {
      ...
      let { tr: s } = r,
        l = zo(n.doc, [...e]);
      if (
        (jo(l).forEach(({ newRange: c }) => {
          let d = Rl(r.doc, c, (h) => h.isTextblock),
            u,
            f;
          if (d.length > 1)
          ...
          if (u && f) {
            let h = f.split(zw).filter(Boolean);
            if (h.length <= 0) return !1;
            let p = h[h.length - 1],
              m = u.pos + f.lastIndexOf(p);
            if (!p) return !1;
            let g = Bi(p).map((y) => y.toObject(t.defaultProtocol));
            if (!Fw(g)) return !1;
            g.filter((y) => y.isLink)
              ...
              .forEach((y) => {
                Dr(y.from, y.to, r.doc).some((w) => w.mark.type === t.type) ||
  ...
  return new B({
    ...
    props: {
      handlePaste: (e, n, r) => {
        ...
        let c = zi(a, { defaultProtocol: t.defaultProtocol }).find(
...
var jw = te.create({
    ...
    addOptions() {
      return {
        ...
        shouldAutoLink: (t) => {
          ...
          let o = (t.includes('@') ? t.split('@').pop() : t).split(/[/?#:]/)[0];
    ...
    renderMarkdown: (t, e) => {
      var n, r, o, i;
      let s = (r = (n = t.attrs) == null ? void 0 : n.href) != null ? r : '',
        l = (i = (o = t.attrs) == null ? void 0 : o.title) != null ? i : '',
              ...
              o.length &&
                o.forEach((i) => {
                  this.options.shouldAutoLink(i.value) &&
                    e.push({ text: i.value, data: { href: i.href }, index: i.start });
                });
            }
            return e;
          },
...
var Uw = Object.defineProperty,
  Kw = (t, e) => {
    for (var n in e) Uw(t, n, { get: e[n], enumerable: !0 });
  },
  qw = 'listItem',
  lh = 'textStyle',
  ah = /^\s*([-+*])\s$/,
...
`,
          ...
          ({ commands: t, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  ...
                  .updateAttributes(qw, this.editor.getAttributes(lh))
                  .run()
    ...
    addInputRules() {
      let t = Ge({ find: ah, type: this.type });
      return (
        (this.options.keepMarks || this.options.keepAttributes) &&
          (t = Ge({
            ...
            getAttributes: () => this.editor.getAttributes(lh),
            editor: this.editor,
          })),
        [t]
      );
    ...
    parseMarkdown: (t, e) => {
      ...
      if (t.tokens && t.tokens.length > 0) {
        if (Jw(t))
          return {
            type: 'listItem',
            content: [{ type: 'paragraph', content: Gw(t.text || '', e) }],
          };
        if (t.tokens.some((s) => s.type === 'paragraph')) o = r(t.tokens);
        else {
          let s = t.tokens[0];
          if (s && s.type === 'text' && s.tokens && s.tokens.length > 0) {
            if (
              ((o = [{ type: 'paragraph', content: e.parseInline(s.tokens) }]), t.tokens.length > 1)
            ) {
      ...
      return (
        o.length === 0 && (o = [{ type: 'paragraph', content: [] }]),
        { type: 'listItem', content: o }
      );
    },
        ...
        (r) => {
          ...
          return r.parentType === 'bulletList'
            ...
            : r.parentType === 'orderedList'
              ? `${(((i = (o = r.meta) == null ? void 0 : o.parentAttrs) == null ? void 0 : i.start) || 1) + r.index}. `
              : '- ';
        },
        n,
      ),
...
var qr = (t, e) => {
    let { $from: n } = e.selection,
      ...
      s = n.pos,
      l = null;
    for (; i > 0 && l === null;) ((o = n.node(i)), o.type === r ? (l = i) : ((i -= 1), (s -= 1)));
    return l === null ? null : { $pos: e.doc.resolve(s), depth: l };
  },
  Na = (t, e) => {
    let n = qr(t, e);
    if (!n) return !1;
    let [, r] = zl(e, t, n.$pos.pos + 4);
    return r;
  },
  fh = (t, e, n) => {
  ...
  Ma = (t, e, n) => {
    ...
    if (!qe(t.state, e) && fh(t.state, e, n)) {
    ...
    if (!qe(t.state, e) || !$l(t.state)) return !1;
    let r = qr(e, t.state);
    if (!r) return !1;
    let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
      s = ph(e, t.state, i);
    return hh(e, t.state) && !s ? t.commands.joinItemBackward() : t.chain().liftListItem(e).run();
  },
  mh = (t, e) => {
    let n = Na(t, e),
      r = qr(t, e);
  ...
  Ta = (t, e) => {
    if (!qe(t.state, e) || !Hl(t.state, e)) return !1;
        ...
        Delete: ({ editor: t }) => {
          ...
          return (
            this.options.listTypes.forEach(({ itemName: n }) => {
              t.state.schema.nodes[n] !== void 0 && Ta(t, n) && (e = !0);
            }),
            e
          );
        },
        ...
        Backspace: ({ editor: t }) => {
          ...
          return (
            this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
              t.state.schema.nodes[n] !== void 0 && Ma(t, n, r) && (e = !0);
            }),
            e
          );
        },
...
function nx(t) {
  ...
  for (; n < t.length;) {
    ...
    for (; u < t.length;) {
      let p = t[u];
      if (p.match(ch)) break;
      if (p.trim() === '') (f.push(p), d.push(''), (h = !0), (u += 1));
      else if (p.match(Zw)) (f.push(p), d.push(p.slice(c + 2)), (u += 1));
      else {
        if (h) break;
        (f.push(p), d.push(p), (u += 1));
      }
    }
    (e.push({
      indent: c,
...
function yh(t, e, n) {
  ...
  for (; o < t.length;) {
    let i = t[o];
    if (i.indent === e) {
      let { paragraphLines: s, blockLines: l } = tx(i.contentLines),
        a = s
          .join(
            `
`,
...
`),
      ...
      (r.push({ type: 'list_item', raw: i.raw, tokens: c }), (o = u));
    } else o += 1;
  }
  return r;
}
...
var ox = 'listItem',
  ...
  Oa = V.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
      let { start: e, ...n } = t;
      return e === 1
        ? ['ol', N(this.options.HTMLAttributes, n), 0]
        : ['ol', N(this.options.HTMLAttributes, t), 0];
    },
    markdownTokenName: 'list',
    parseMarkdown: (t, e) => {
      if (t.type !== 'list' || !t.ordered) return [];
      let n = t.start || 1,
        r = t.items ? rx(t.items, e) : [];
      return n !== 1
...
`),
        ...
        toggleOrderedList:
          ...
          ({ commands: t, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  .toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
                  .updateAttributes(ox, this.editor.getAttributes(dh))
                  .run()
              : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks),
      };
    },
      ...
      return (
        (this.options.keepMarks || this.options.keepAttributes) &&
          (t = Ge({
            ...
            keepMarks: this.options.keepMarks,
            keepAttributes: this.options.keepAttributes,
            getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(dh) }),
            joinPredicate: (e, n) => n.childCount + n.attrs.start === +e[1],
            editor: this.editor,
          })),
        [t]
      ...
      return ({ node: t, HTMLAttributes: e, getPos: n, editor: r }) => {
        ...
        return {
          ...
          update: (u) => {
            ...
            ((o.dataset.checked = u.attrs.checked), (l.checked = u.attrs.checked), c(u));
            ...
            return (
              d.forEach((g) => {
                p.has(g) || (g in m ? o.setAttribute(g, m[g]) : o.removeAttribute(g));
              }),
              Object.entries(h).forEach(([g, y]) => {
                y == null
                  ? g in m
                    ? o.setAttribute(g, m[g])
                    : o.removeAttribute(g)
                  : o.setAttribute(g, y);
              }),
              (d = p),
  ...
  lx = V.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
      return ['ul', N(this.options.HTMLAttributes, t, { 'data-type': this.name }), 0];
    },
...
`,
    ...
    markdownTokenizer: {
      ...
      start(t) {
        var e;
        let n = (e = t.match(/^\s*[-+*]\s+\[([ xX])\]\s+/)) == null ? void 0 : e.index;
        return n !== void 0 ? n : -1;
      },
      tokenize(t, e, n) {
        let r = (i) => {
            ...
            return s ? [{ type: 'taskList', raw: s.raw, items: s.items }] : n.blockTokens(i);
          },
          o = Lr(
            t,
            {
  ...
  gM = U.create({
    ...
    addExtensions() {
      let t = [];
      return (
        this.options.bulletList !== !1 && t.push(Aa.configure(this.options.bulletList)),
        this.options.listItem !== !1 && t.push(Ea.configure(this.options.listItem)),
        this.options.listKeymap !== !1 && t.push(Qw.configure(this.options.listKeymap)),
        this.options.orderedList !== !1 && t.push(Oa.configure(this.options.orderedList)),
        this.options.taskItem !== !1 && t.push(sx.configure(this.options.taskItem)),
        this.options.taskList !== !1 && t.push(lx.configure(this.options.taskList)),
        t
      );
    },
  });
var Un = (t, e, n = {}) => {
    t.dom
      .closest('form')
      ?.dispatchEvent(new CustomEvent(e, { composed: !0, cancelable: !0, detail: n }));
  },
  Ra = ({
    files: t,
    acceptedTypes: e,
  ...
  ax = ({
    ...
    let c = (d) =>
      r().callSchemaComponentMethod(o, 'getUploadedFileAttachmentTemporaryUrl', { attachment: d });
    return new B({
      key: new _('localFiles'),
      props: {
        handleDrop(d, u) {
            ...
            return (
              d.dom.dispatchEvent(
                new CustomEvent('rich-editor-file-validation-message', {
                  bubbles: !0,
                  detail: { key: o, livewireId: r().id, validationMessage: h },
                }),
              ),
              !1
            );
          if (!f.length) return !1;
          (Un(d, 'form-processing-started', { message: a }),
            u.preventDefault(),
            u.stopPropagation());
          ...
          return (
            f.forEach((m, g) => {
              ...
              let y = Da();
              r().upload(`componentFileAttachments.${l}.${y}`, m, () => {
                c(y).then((w) => {
                  w &&
                    (t
                      .chain()
                      .insertContentAt(p?.pos ?? 0, { type: 'image', attrs: { id: y, src: w } })
                      .run(),
                    t.setEditable(!0),
                    d.dom.dispatchEvent(
                    ...
                    g === f.length - 1 && Un(d, 'form-processing-finished'));
                });
              });
            }),
            !0
        ...
        handlePaste(d, u) {
          let f = u.clipboardData?.files?.length ? Array.from(u.clipboardData.files) : [],
          ...
          if (f.length && !h) {
            ...
            return m
              ? (d.dom.dispatchEvent(
                  new CustomEvent('rich-editor-file-validation-message', {
                    bubbles: !0,
                    detail: { key: o, livewireId: r().id, validationMessage: m },
                  }),
                ),
                !1)
              : (u.preventDefault(),
                ...
                f.forEach((g, y) => {
                  ...
                  let w = Da();
                  r().upload(`componentFileAttachments.${l}.${w}`, g, () => {
                    c(w).then((b) => {
                      b &&
                        (t
                          .chain()
                          .insertContentAt(t.state.selection.anchor, {
                            type: 'image',
                            attrs: { id: w, src: b },
                          })
                          .run(),
                        ...
                        y === f.length - 1 && Un(d, 'form-processing-finished'));
                    });
                  });
                }),
                !0);
          ...
          if (p) {
            let g = new DOMParser().parseFromString(p, 'text/html'),
              y = g.querySelectorAll('img[src]');
            if (y.length) {
              u.stopPropagation();
              let { from: w, to: b } = t.state.selection;
              return (
                Un(d, 'form-processing-started', { message: a }),
                t.setEditable(!1),
                d.dom.dispatchEvent(
                ...
                (async () => {
                  for (let S of y) {
                    ...
                    try {
                      ...
                      for (let ce = 0; ce < Y.length; ce++) F[ce] = Y.charCodeAt(ce);
                      A = new Blob([F], { type: X });
                    } catch {
                      continue;
                    }
                    let v = A.type.split('/')[1]?.split('+')[0] || 'png',
                      R = new File([A], `image.${v}`, { type: A.type });
                    if (
                      Ra({
                        files: [R],
                        acceptedTypes: e,
                    ...
                    O && (S.setAttribute('src', O), S.setAttribute('data-id', D));
                  }
                  for (let S of Array.from(g.querySelectorAll('img[src]'))) {
                    let P = g.createElement('p');
                    (S.replaceWith(P), P.appendChild(S));
                  }
                  let x = g.body.innerHTML;
                  t.view.someProp('transformPastedHTML', (S) => {
                    x = S(x);
                  });
                  let k = document.createElement('div');
                  k.innerHTML = x;
                  let M = Ae.fromSchema(t.state.schema).parseSlice(k, { preserveWhitespace: !1 });
                  (t.view.dispatch(t.state.tr.replaceRange(w, b, M)),
                    t.setEditable(!0),
                    d.dom.dispatchEvent(
                      new CustomEvent('rich-editor-uploaded-file', {
                        bubbles: !0,
  ...
  bh = U.create({
    ...
    addProseMirrorPlugins() {
      return [ax({ editor: this.editor, ...this.options })];
    },
  });
function cx(t) {
  var e;
  ...
  let b = m + g.index,
    x = b + g[0].length;
  return (
    a && d.test(p.slice(x - 1, x + 1)) && ((g[0] += ' '), (x += 1)),
    b < l.pos && x >= l.pos
      ? { range: { from: b, to: x }, query: g[0].slice(n.length), text: g[0] }
      : null
  );
}
function dx(t) {
...
function fx({
  ...
  render: h = () => ({}),
  allow: p = () => !0,
  findSuggestionMatch: m = cx,
  shouldShow: g,
  shouldResetDismissed: y,
}) {
  let w,
    b = h?.(),
    x = r && !o,
    k = () => {
      let v = e.state.selection.$anchor.pos,
        R = e.view.coordsAtPos(v),
        { top: j, right: D, bottom: O, left: H } = R;
      try {
        return new DOMRect(H, j, D - H, O - j);
      } catch {
        return null;
      }
    },
    M = (v, R) =>
      R
        ? () => {
            let j = t.getState(e.state),
              D = j?.decorationId,
              O = v.dom.querySelector(`[data-decoration-id="${D}"]`);
            return O?.getBoundingClientRect() || null;
          }
        : k,
    S = ({ match: v, dismissedRange: R, state: j, transaction: D }) =>
      y?.({ editor: e, state: j, range: R, match: v, transaction: D, allowSpaces: x })
        ? !1
        : x
          ? v.range.from === R.from
          : v.range.from === R.from && !dx(D);
  function P(v, R) {
    var j;
    try {
      let O = t.getState(v.state),
        H = O?.decorationId
          ? v.dom.querySelector(`[data-decoration-id="${O.decorationId}"]`)
          : null,
        W = {
          editor: e,
          ...
          text: O?.text || null,
          items: [],
          command: (X) => u({ editor: e, range: O?.range || { from: 0, to: 0 }, props: X }),
          decorationNode: H,
          clientRect: M(v, H),
        };
      (j = b?.onExit) == null || j.call(b, W);
    } catch {}
    let D = v.state.tr.setMeta(R, { exit: !0 });
    v.dispatch(D);
  }
  let A = new B({
    key: t,
    view() {
      return {
        update: async (v, R) => {
          var j, D, O, H, W, X, Y;
          let F = (j = this.key) == null ? void 0 : j.getState(R),
            ce = (D = this.key) == null ? void 0 : D.getState(v.state),
            fe = F.active && ce.active && F.range.from !== ce.range.from,
            q = !F.active && ce.active,
            ft = F.active && !ce.active,
            Ke = !q && !ft && F.query !== ce.query,
            Qn = q || (fe && Ke),
            eo = Ke || fe,
            is = ft || (fe && Ke);
          if (!Qn && !eo && !is) return;
          let bn = is && !Qn ? F : ce,
            ec = v.dom.querySelector(`[data-decoration-id="${bn.decorationId}"]`);
          ((w = {
            editor: e,
            range: bn.range,
            query: bn.query,
            text: bn.text,
            items: [],
            command: (Qp) => u({ editor: e, range: bn.range, props: Qp }),
            decorationNode: ec,
            clientRect: M(v, ec),
          }),
            Qn && ((O = b?.onBeforeStart) == null || O.call(b, w)),
            eo && ((H = b?.onBeforeUpdate) == null || H.call(b, w)),
            (eo || Qn) && (w.items = await f({ editor: e, query: bn.query })),
            is && ((W = b?.onExit) == null || W.call(b, w)),
            eo && ((X = b?.onUpdate) == null || X.call(b, w)),
            Qn && ((Y = b?.onStart) == null || Y.call(b, w)));
        },
        destroy: () => {
          var v;
          w && ((v = b?.onExit) == null || v.call(b, w));
        },
      };
    },
    state: {
      ...
      apply(v, R, j, D) {
        ...
        if (ce && ce.exit)
          return (
            ...
            (F.query = null),
            (F.text = null),
            (F.dismissedRange = R.active ? { ...R.range } : R.dismissedRange),
            F
          );
        if (
          ((F.composing = H),
          v.docChanged &&
            F.dismissedRange !== null &&
            (F.dismissedRange = {
              from: v.mapping.map(F.dismissedRange.from),
              to: v.mapping.map(F.dismissedRange.to),
            }),
          O && (X || e.view.composing))
        ) {
          (Y < R.range.from || Y > R.range.to) && !H && !R.composing && (F.active = !1);
          let fe = m({
              char: n,
              allowSpaces: r,
              allowToIncludeChar: o,
          ...
          fe &&
          p({ editor: e, state: D, range: fe.range, isActive: R.active }) &&
          (!g || g({ editor: e, range: fe.range, query: fe.query, text: fe.text, transaction: v }))
            ? (F.dismissedRange !== null &&
                !S({ match: fe, dismissedRange: F.dismissedRange, state: D, transaction: v }) &&
                (F.dismissedRange = null),
              F.dismissedRange === null
                ? ((F.active = !0),
                  (F.decorationId = R.decorationId ? R.decorationId : q),
                  (F.range = fe.range),
                  (F.query = fe.query),
                  (F.text = fe.text))
                : (F.active = !1))
            : (fe || (F.dismissedRange = null), (F.active = !1));
        } else F.active = !1;
        return (
          F.active ||
            ((F.decorationId = null),
    ...
    props: {
      handleKeyDown(v, R) {
        var j, D;
        let { active: O, range: H } = A.getState(v.state);
        if (!O) return !1;
        if (R.key === 'Escape' || R.key === 'Esc') {
          let X = A.getState(v.state);
          return (
            (j = b?.onKeyDown) == null || j.call(b, { view: v, event: R, range: X.range }),
            P(v, t),
            !0
          );
        }
        return (
          ((D = b?.onKeyDown) == null ? void 0 : D.call(b, { view: v, event: R, range: H })) || !1
        );
      },
      decorations(v) {
        let { active: R, range: j, decorationId: D, query: O } = A.getState(v);
        if (!R) return null;
        let H = !O?.length,
          W = [a];
        return (
...
var Hi = fx;
var hx = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
    let r = new _();
    return {
      editor: t,
      char: '{{',
      ...
      command: ({ editor: o, range: i, props: s }) => {
        (o.view.state.selection.$to.nodeAfter?.text?.startsWith(' ') && (i.to += 1),
          o
            .chain()
            .focus()
            .insertContentAt(i, [
            ...
            .run(),
          o.view.dom.ownerDocument.defaultView?.getSelection()?.collapseToEnd());
      },
  ...
  wh = V.create({
    ...
    priority: 101,
    addStorage() {
      return { mergeTags: [], suggestions: [], getSuggestionFromChar: () => null };
    },
    addOptions() {
      return {
        HTMLAttributes: {},
    ...
    renderHTML({ node: t, HTMLAttributes: e }) {
      let n = this.editor?.extensionStorage?.[this.name]?.getSuggestionFromChar('{{'),
        r = { ...this.options };
      r.HTMLAttributes = N({ 'data-type': this.name }, this.options.HTMLAttributes, e);
      let o = this.options.renderHTML({ options: r, node: t, suggestion: n });
      return typeof o == 'string'
        ? ['span', N({ 'data-type': this.name }, this.options.HTMLAttributes, e), o]
        : o;
    },
    renderText({ node: t }) {
      let e = {
    ...
    addProseMirrorPlugins() {
      return [
        ...this.storage.suggestions.map(Hi),
        new B({
          props: {
            handleDrop(t, e) {
              if (!e || (e.preventDefault(), !e.dataTransfer.getData('mergeTag'))) return !1;
              let n = e.dataTransfer.getData('mergeTag');
              return (
                t.dispatch(
                  t.state.tr.insert(
                    t.posAtCoords({ left: e.clientX, top: e.clientY }).pos,
                    t.state.schema.nodes.mergeTag.create({ id: n }),
                  ),
                ),
                !1
              );
    ...
    onBeforeCreate() {
      ((this.storage.suggestions = (
        ...
        hx({ editor: this.editor, overrideSuggestionOptions: t, extensionName: this.name }),
      )),
        (this.storage.getSuggestionFromChar = (t) => {
          let e = this.storage.suggestions.find((n) => n.char === t);
          return e || (this.storage.suggestions.length ? this.storage.suggestions[0] : null);
        }));
    },
  });
var Ia = ['top', 'right', 'bottom', 'left'],
  xh = ['start', 'end'],
  Pa = Ia.reduce((t, e) => t.concat(e, e + '-' + xh[0], e + '-' + xh[1]), []),
  Ve = Math.min,
  be = Math.max,
  Xr = Math.round;
var Xe = (t) => ({ x: t, y: t }),
  px = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' };
function $i(t, e, n) {
  return be(t, Ve(e, n));
}
function at(t, e) {
    ...
    s =
      o === 'x'
        ...
        : r === 'start'
          ? 'bottom'
          : 'top';
  return (e.reference[i] > e.floating[i] && (s = Gr(s)), [s, Gr(s)]);
}
function Ch(t) {
  let e = Gr(t);
  return [Jr(t), e, Jr(e)];
...
function Gr(t) {
  let e = Ie(t);
  return px[e] + t.slice(e.length);
}
function bx(t) {
  return { top: 0, right: 0, bottom: 0, left: 0, ...t };
}
function Vi(t) {
  return typeof t != 'number' ? bx(t) : { top: t, right: t, bottom: t, left: t };
}
function vt(t) {
...
async function Eh(t, e) {
  ...
  let { x: r, y: o, platform: i, rects: s, elements: l, strategy: a } = t,
    ...
    x = (await (i.isElement == null ? void 0 : i.isElement(b)))
  ...
  return {
    top: (y.top - k.top + p.top) / x.y,
    bottom: (k.bottom - y.bottom + p.bottom) / x.y,
    left: (y.left - k.left + p.left) / x.x,
    right: (k.right - y.right + p.right) / x.x,
  };
}
var wx = 50,
  Nh = async (t, e, n) => {
    let { placement: r = 'bottom', strategy: o = 'absolute', middleware: i = [], platform: s } = n,
      l = s.detectOverflow ? s : { ...s, detectOverflow: Eh },
        ...
        M &&
          ...
          typeof M == 'object' &&
            ...
            M.rects &&
              (c =
                M.rects === !0
                  ? await s.getElementRects({ reference: t, floating: e, strategy: o })
                  : M.rects),
            ({ x: d, y: u } = Mh(c, f, a))),
          (m = -1)));
    }
  ...
  Oh = (t) => ({
    ...
    options: t,
    async fn(e) {
      let { x: n, y: r, placement: o, rects: i, platform: s, elements: l, middlewareData: a } = e,
        { element: c, padding: d = 0 } = at(t, e) || {};
      if (c == null) return {};
      let u = Vi(d),
        f = { x: n, y: r },
        h = _i(o),
      ...
      let P = x / 2 - k / 2,
        ...
        W =
          ...
          We(o) != null &&
          O !== H &&
          i.reference[p] / 2 - (O < j ? v : R) - m[p] / 2 < 0,
        X = W ? (O < j ? O - j : O - D) : 0;
      return {
        [h]: f[h] + X,
        data: { [h]: H, centerOffset: O - H - X, ...(W && { alignmentOffset: X }) },
        reset: W,
      };
    },
  });
function xx(t, e, n) {
  return (
    t
      ? [...n.filter((o) => We(o) === t), ...n.filter((o) => We(o) !== t)]
      : n.filter((o) => Ie(o) === o)
  ).filter((o) => (t ? We(o) === t || (e ? Jr(o) !== o : !1) : !0));
}
var Rh = function (t) {
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          var n, r, o;
          let { rects: i, middlewareData: s, placement: l, platform: a, elements: c } = e,
            {
              crossAxis: d = !1,
              alignment: u,
              allowedPlacements: f = Pa,
              autoAlignment: h = !0,
              ...p
            } = at(t, e),
            m = u !== void 0 || f === Pa ? xx(u || null, h, f) : f,
            g = await a.detectOverflow(e, p),
            y = ((n = s.autoPlacement) == null ? void 0 : n.index) || 0,
            w = m[y];
          if (w == null) return {};
          let b = Ba(w, i, await (a.isRTL == null ? void 0 : a.isRTL(c.floating)));
          if (l !== w) return { reset: { placement: m[0] } };
          let x = [g[Ie(w)], g[b[0]], g[b[1]]],
            k = [
              ...(((r = s.autoPlacement) == null ? void 0 : r.overflows) || []),
              { placement: w, overflows: x },
            ],
            M = m[y + 1];
          if (M) return { data: { index: y + 1, overflows: k }, reset: { placement: M } };
          let S = k
              .map((v) => {
                let R = We(v.placement);
                return [
                  v.placement,
                  R && d ? v.overflows.slice(0, 2).reduce((j, D) => j + D, 0) : v.overflows[0],
                  v.overflows,
                ];
              })
              .sort((v, R) => v[1] - R[1]),
            A =
              ((o = S.filter((v) => v[2].slice(0, We(v[0]) ? 2 : 3).every((R) => R <= 0))[0]) ==
              null
                ? void 0
                : o[0]) || S[0][0];
          return A !== l ? { data: { index: y + 1, overflows: k }, reset: { placement: A } } : {};
        },
      }
    );
  },
      ...
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          let y = Ie(o),
            ...
            k = f || (b || !m ? [Gr(l)] : Ch(l)),
            M = p !== 'none';
          !f && M && k.push(...vh(l, m, p, x));
          let S = [l, ...k],
            P = await a.detectOverflow(e, g),
            A = [],
            v = ((r = i.flip) == null ? void 0 : r.overflows) || [];
          if ((d && A.push(P[y]), u)) {
            let O = Ba(o, s, x);
            A.push(P[O[0]], P[O[1]]);
          }
          if (((v = [...v, { placement: o, overflows: A }]), !A.every((O) => O <= 0))) {
            var R, j;
            let O = (((R = i.flip) == null ? void 0 : R.index) || 0) + 1,
              H = S[O];
            if (
              H &&
              (!(u === 'alignment' ? w !== Ye(H) : !1) ||
                v.every((Y) => (Ye(Y.placement) === w ? Y.overflows[0] > 0 : !0)))
            )
              return { data: { index: O, overflows: v }, reset: { placement: H } };
            let W =
              (j = v
                .filter((X) => X.overflows[0] <= 0)
                .sort((X, Y) => X.overflows[1] - Y.overflows[1])[0]) == null
                ? void 0
                : j.placement;
            if (!W)
              switch (h) {
                case 'bestFit': {
                  ...
                  let X =
                    (D = v
                      ...
                      .map((Y) => [
                        Y.placement,
                        Y.overflows.filter((F) => F > 0).reduce((F, ce) => F + ce, 0),
                      ])
                      .sort((Y, F) => Y[1] - F[1])[0]) == null
                      ? void 0
                      : D[0];
                  X && (W = X);
                  break;
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn(e) {
        let { rects: n, platform: r } = e,
          { strategy: o = 'referenceHidden', ...i } = at(t, e);
        switch (o) {
          case 'referenceHidden': {
            let s = await r.detectOverflow(e, { ...i, elementContext: 'reference' }),
              l = Th(s, n.reference);
            return { data: { referenceHiddenOffsets: l, referenceHidden: Ah(l) } };
          }
          case 'escaped': {
            let s = await r.detectOverflow(e, { ...i, altBoundary: !0 }),
              l = Th(s, n.floating);
            return { data: { escapedOffsets: l, escaped: Ah(l) } };
          }
          default:
            return {};
        }
...
function Ph(t) {
  let e = Ve(...t.map((i) => i.left)),
    n = Ve(...t.map((i) => i.top)),
    r = be(...t.map((i) => i.right)),
    o = be(...t.map((i) => i.bottom));
...
var Lh = function (t) {
    return (
      t === void 0 && (t = {}),
      {
        ...
        options: t,
        async fn(e) {
          let { placement: n, elements: r, rects: o, platform: i, strategy: s } = e,
            { padding: l = 2, x: a, y: c } = at(t, e),
            d = Array.from(
            ...
            if (u.length >= 2) {
              if (Ye(n) === 'y') {
                let v = u[0],
                  ...
                  X = W - H,
                  Y = O - D;
                return { top: D, bottom: O, left: H, right: W, width: X, height: Y, x: H, y: D };
              }
              let g = Ie(n) === 'left',
                y = be(...u.map((v) => v.right)),
                w = Ve(...u.map((v) => v.left)),
                b = u.filter((v) => (g ? v.left === w : v.right === y)),
                x = b[0].top,
                ...
                P = S - M,
                A = k - x;
              return { top: x, bottom: k, left: M, right: S, width: P, height: A, x: M, y: x };
            }
            return f;
          }
  ...
  zh = function (t) {
    return (
      t === void 0 && (t = {}),
      {
        ...
        options: t,
        async fn(e) {
          let { x: n, y: r, placement: o, platform: i } = e,
            {
              mainAxis: s = !0,
              crossAxis: l = !1,
              limiter: a = {
          ...
          return { ...g, data: { x: g.x - n, y: g.y - r, enabled: { [h]: s, [f]: l } } };
        },
      }
    );
  };
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn(e) {
        ...
        u === 'top' || u === 'bottom'
          ? ((g = u),
            (y =
              f === ((await (s.isRTL == null ? void 0 : s.isRTL(l.floating))) ? 'start' : 'end')
                ? 'left'
                : 'right'))
        ...
        let w = m - d.top - d.bottom,
          ...
          P = k;
        if (
          ((n = e.middlewareData.shift) != null && n.enabled.x && (P = b),
          (r = e.middlewareData.shift) != null && r.enabled.y && (S = w),
          M && !f)
        ) {
          let v = be(d.left, 0),
            R = be(d.right, 0),
            ...
            D = be(d.bottom, 0);
          h
            ? (P = p - 2 * (v !== 0 || R !== 0 ? v + R : be(d.left, d.right)))
            : (S = m - 2 * (j !== 0 || D !== 0 ? j + D : be(d.top, d.bottom)));
        }
        await a({ ...e, availableWidth: P, availableHeight: S });
        let A = await s.getDimensions(l.floating);
        return p !== A.width || m !== A.height ? { reset: { rects: !0 } } : {};
      },
    }
  );
};
...
function ct(t) {
  var e;
  return (e = (Fh(t) ? t.ownerDocument : t.document) || window.document) == null
    ? void 0
    : e.documentElement;
}
function Fh(t) {
  return ji() ? t instanceof Node || t instanceof Oe(t).Node : !1;
}
function je(t) {
  return ji() ? t instanceof Element || t instanceof Oe(t).Element : !1;
}
function dt(t) {
  return ji() ? t instanceof HTMLElement || t instanceof Oe(t).HTMLElement : !1;
}
function $h(t) {
  return !ji() || typeof ShadowRoot > 'u'
    ? !1
    : t instanceof ShadowRoot || t instanceof Oe(t).ShadowRoot;
}
function Kn(t) {
  let { overflow: e, overflowX: n, overflowY: r, display: o } = Ue(t);
  return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && o !== 'inline' && o !== 'contents';
}
function _h(t) {
  return /^(table|td|th)$/.test(pn(t));
}
function Yr(t) {
  try {
...
var vx = /transform|translate|scale|rotate|perspective|filter/,
  Mx = /paint|layout|strict|content/,
  hn = (t) => !!t && t !== 'none',
  za;
function Ui(t) {
  let e = je(t) ? Ue(t) : t;
  return (
    ...
    hn(e.rotate) ||
    hn(e.perspective) ||
    (!Ki() && (hn(e.backdropFilter) || hn(e.filter))) ||
    vx.test(e.willChange || '') ||
    Mx.test(e.contain || '')
  );
}
function Vh(t) {
...
function Ki() {
  return (
    za == null &&
      (za = typeof CSS < 'u' && CSS.supports && CSS.supports('-webkit-backdrop-filter', 'none')),
    za
  );
}
function mn(t) {
  return /^(html|body|#document)$/.test(pn(t));
}
function Ue(t) {
...
function Mt(t) {
  if (pn(t) === 'html') return t;
  let e = t.assignedSlot || t.parentNode || ($h(t) && t.host) || ct(t);
  return $h(e) ? e.host : e;
}
function Wh(t) {
  let e = Mt(t);
  return mn(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : dt(e) && Kn(e) ? e : Wh(e);
}
function Wi(t, e, n) {
  var r;
  ...
  if (i) {
    let l = qi(s);
    return e.concat(s, s.visualViewport || [], Kn(o) ? o : [], l && n ? Wi(l) : []);
  } else return e.concat(o, Wi(o, [], n));
}
function qi(t) {
...
function qn(t) {
  ...
  let n = e.getBoundingClientRect(),
    { width: r, height: o, $: i } = qh(e),
    s = (i ? Xr(n.width) : n.width) / r,
    l = (i ? Xr(n.height) : n.height) / o;
  return (
...
function Zr(t, e, n, r) {
  ...
  let o = t.getBoundingClientRect(),
    i = Jh(t),
    s = Xe(1);
  e && (r ? je(r) && (s = qn(r)) : (s = qn(t)));
  let l = Ax(i, n, r) ? Gh(i) : Xe(0),
    a = (o.left + l.x) / s.x,
    c = (o.top + l.y) / s.y,
    d = o.width / s.x,
    u = o.height / s.y;
  if (i) {
    ...
    for (; m && r && h !== p;) {
      let g = qn(m),
        ...
        x = y.top + (m.clientTop + parseFloat(w.paddingTop)) * g.y;
      ((a *= g.x),
        (c *= g.y),
        (d *= g.x),
        (u *= g.y),
  ...
  return vt({ width: d, height: u, x: a, y: c });
}
function Ji(t, e) {
  let n = Qr(t).scrollLeft;
  return e ? e.left + n : Zr(ct(t)).left + n;
}
function Xh(t, e) {
  let n = t.getBoundingClientRect(),
    r = n.left + e.scrollLeft - Ji(t, n),
    o = n.top + e.scrollTop;
  return { x: r, y: o };
}
function Ex(t) {
  ...
  let a = { scrollLeft: 0, scrollTop: 0 },
    ...
    d = Xe(0),
    u = dt(r);
  if ((u || (!u && !i)) && ((pn(r) !== 'body' || Kn(s)) && (a = Qr(r)), u)) {
    let h = Zr(r);
    ((c = qn(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop));
  }
  let f = s && !u && !i ? Xh(s, a) : Xe(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function Ox(t) {
  let e = ct(t),
    ...
    o = be(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth),
    i = be(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight),
    s = -n.scrollLeft + Ji(t),
    l = -n.scrollTop;
  return (
    Ue(r).direction === 'rtl' && (s += be(e.clientWidth, r.clientWidth) - o),
...
function Uh(t, e, n) {
  let r;
  if (e === 'viewport') r = Rx(t, n);
  else if (e === 'document') r = Ox(ct(t));
  else if (je(e)) r = Dx(e, n);
  else {
    let o = Gh(t);
...
function Yh(t, e) {
  let n = Mt(t);
  return n === e || !je(n) || mn(n) ? !1 : Ue(n).position === 'fixed' || Yh(n, e);
}
function Ix(t, e) {
  let n = e.get(t);
  if (n) return n;
  let r = Wi(t, [], !1).filter((l) => je(l) && pn(l) !== 'body'),
    o = null,
    i = Ue(t).position === 'fixed',
    s = i ? Mt(t) : t;
  for (; je(s) && !mn(s);) {
    let l = Ue(s),
      a = Ui(s);
...
function Px(t) {
  let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
    s = [...(n === 'clippingAncestors' ? (Yr(e) ? [] : Ix(e, this._c)) : [].concat(n)), r],
    l = Uh(e, s[0], o),
    a = l.top,
    c = l.right,
    d = l.bottom,
  ...
  for (let f = 1; f < s.length; f++) {
    let h = Uh(e, s[f], o);
    ((a = be(h.top, a)), (c = Ve(h.right, c)), (d = Ve(h.bottom, d)), (u = be(h.left, u)));
  }
  return { width: c - u, height: d - a, x: u, y: a };
}
function Lx(t) {
  let { width: e, height: n } = qh(t);
...
function Bx(t, e, n) {
  ...
  if (r || (!r && !i))
    if (((pn(e) !== 'body' || Kn(o)) && (l = Qr(e)), r)) {
      let h = Zr(e, !0, i, e);
      ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop));
    } else o && c();
  i && !r && o && c();
  let d = o && !r && !i ? Xh(o, l) : Xe(0),
...
function Kh(t, e) {
  if (!dt(t) || Ue(t).position === 'fixed') return null;
  if (e) return e(t);
  let n = t.offsetParent;
  return (ct(t) === n && (n = n.ownerDocument.body), n);
}
function Qh(t, e) {
  let n = Oe(t);
  if (Yr(t)) return n;
  if (!dt(t)) {
    let o = Mt(t);
    for (; o && !mn(o);) {
      if (je(o) && !Ha(o)) return o;
      o = Mt(o);
    }
    return n;
  }
  let r = Kh(t, e);
  for (; r && _h(r) && Ha(r);) r = Kh(r, e);
  return r && mn(r) && Ha(r) && !Ui(r) ? n : r || Vh(t) || n;
}
var zx = async function (t) {
  let e = this.getOffsetParent || Qh,
    n = this.getDimensions,
    r = await n(t.floating);
  return {
    reference: Bx(t.reference, await e(t.floating), t.strategy),
...
var ip = (t, e) => {
    Xn(
      ...
      e,
      { placement: 'bottom-start', strategy: 'absolute', middleware: [Jn(), Gn()] },
  ...
  sp = ({
    ...
    return {
      items: async ({ query: l }) => {
        ...
        return t.filter((c) => {
          let d = typeof c == 'string' ? c : (c?.label ?? c?.name ?? '');
      ...
      render: () => {
        ...
        let u = () => {
            ...
            return (
              (b.className = 'fi-dropdown-panel fi-dropdown-list fi-scrollable'),
          ...
          f = () => {
            ...
            if (((l.innerHTML = ''), d)) {
              ...
              M.className = 'fi-dropdown-header';
            ...
            if (b.length)
              b.forEach((k, M) => {
                let S = typeof k == 'string' ? k : (k?.label ?? k?.name ?? String(k?.id ?? '')),
                  P = typeof k == 'object' ? (k?.id ?? S) : S,
                  A = document.createElement('button');
                ((A.className = `fi-dropdown-list-item ${M === a ? 'fi-selected' : ''}`),
                  (A.type = 'button'),
                  A.addEventListener('click', () => p(P, S)));
                let v = document.createElement('span');
                ((v.className = 'fi-dropdown-list-item-label'),
                  (v.textContent = S),
                  A.appendChild(v),
                  l.appendChild(A));
              });
          ...
          m = () => {
            ...
            if (x) {
              ...
              (k.top < M.top || k.bottom > M.bottom) && x.scrollIntoView({ block: 'nearest' });
            }
          },
          g = () => {
            if (!c) return;
            let b = Array.isArray(c.items) ? c.items : [];
            b.length !== 0 && ((a = (a + b.length - 1) % b.length), f(), m());
          },
          y = () => {
            if (!c) return;
            let b = c.items || [];
          ...
          w = () => {
            ...
            let x = b[a],
              k = typeof x == 'string' ? x : (x?.label ?? x?.name ?? String(x?.id ?? '')),
              M = typeof x == 'object' ? (x?.id ?? k) : k;
            p(M, k);
          };
        return {
          onStart: (b) => {
            ((c = b),
              ...
              b.clientRect && ip(b.editor, l));
          },
          onUpdate: (b) => {
            ((c = b), (a = 0), f(), m(), b.clientRect && ip(b.editor, l));
          },
          onKeyDown: (b) =>
            b.event.key === 'Escape'
              ? (l && l.parentNode && l.parentNode.removeChild(l), !0)
              : b.event.key === 'ArrowUp'
                ? (g(), !0)
                : b.event.key === 'ArrowDown'
                  ...
                  : b.event.key === 'Enter'
                    ...
                    : !1,
          onExit: () => {
            (l && l.parentNode && l.parentNode.removeChild(l), (s = null));
          },
        };
      },
    };
  };
var Fx = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
    let r = new _(),
      o = e?.char ?? '@',
      i = e?.extraAttributes ?? {};
    return {
      ...
      command: ({ editor: s, range: l, props: a }) => {
        s.view.state.selection.$to.nodeAfter?.text?.startsWith(' ') && (l.to += 1);
        ...
        (s
          ...
          .run(),
          s.view.dom.ownerDocument.defaultView?.getSelection()?.collapseToEnd());
      },
        ...
        Backspace: () =>
          this.editor.commands.command(({ tr: t, state: e }) => {
            ...
            if (
              ...
              let a = s?.attrs?.char ?? '@';
              t.insertText(this.options.deleteTriggerWithBackspace ? '' : a, l, l + s.nodeSize);
            }
            return n;
          }),
      };
    ...
    addProseMirrorPlugins() {
      let t = async (e) => {
        ...
        if (typeof i == 'function')
          try {
            let s = o.map(({ id: a, char: c }) => ({ id: a, char: c })),
              l = await i(s);
      ...
      return [
        ...this.storage.suggestions.map(Hi),
        new B({ view: (e) => (setTimeout(() => t(e), 0), { update: (n) => t(n) }) }),
      ];
    },
    onBeforeCreate() {
      let t = (n) =>
          Array.isArray(n)
            ? n
            : n && typeof n == 'object'
              ? Object.entries(n).map(([r, o]) => ({ id: r, label: o }))
              : [],
        e = this.options.suggestions.length ? this.options.suggestions : [this.options.suggestion];
      ((this.storage.suggestions = e.map((n) => {
          ...
          c = {
            ...sp({
              items: async ({ query: h }) => {
                ...
                return m.filter((y) => {
                  let w = typeof y == 'string' ? y : (y?.label ?? y?.name ?? '');
        ...
        return Fx({ editor: this.editor, overrideSuggestionOptions: c, extensionName: this.name });
      })),
...
var Gi = '&nbsp;',
  ...
  _x = V.create({
    ...
    parseMarkdown: (t, e) => {
      ...
      return n.length === 1 &&
        n[0].type === 'text' &&
        (n[0].raw === Gi || n[0].text === Gi || n[0].raw === $a || n[0].text === $a) &&
        r.length === 1 &&
        r[0].type === 'text' &&
        (r[0].text === Gi || r[0].text === $a)
    ...
    renderMarkdown: (t, e, n) => {
      ...
      if (i.length === 0) {
        let s = Array.isArray((r = n?.previousNode) == null ? void 0 : r.content)
          ? n.previousNode.content
          : [];
        return ((o = n?.previousNode) == null ? void 0 : o.type) === 'paragraph' && s.length === 0
          ? Gi
          : '';
      }
...
var dp = te.create({
  ...
  parseHTML() {
    return [{ tag: 'span', getAttrs: (t) => t.classList?.contains('color') }];
  },
  renderHTML({ HTMLAttributes: t }) {
    let e = { ...t },
      n = t.class;
  ...
  addAttributes() {
    return {
      'data-color': {
        ...
        renderHTML: (t) => (t['data-color'] ? { 'data-color': t['data-color'] } : {}),
      },
    };
  },
  addCommands() {
...
var Vx = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
  ...
  jx = te.create({
    ...
    addInputRules() {
      return [De({ find: Vx, type: this.type })];
    },
    addPasteRules() {
      return [Te({ find: Wx, type: this.type })];
    },
  }),
  up = jx;
var Ux = te.create({
...
if (typeof WeakMap < 'u') {
  let t = new WeakMap();
  ((Va = (e) => t.get(e)), (Wa = (e, n) => (t.set(e, n), n)));
} else {
  let t = [],
    n = 0;
  ((Va = (r) => {
...
function qx(t) {
  ...
  for (let c = 0, d = 0; c < n; c++) {
    ...
    for (let p = 0; ; p++) {
      ...
      for (let b = 0; b < y; b++) {
        if (b + c >= n) {
          (i || (i = [])).push({ type: 'overlong_rowspan', pos: d, n: y - b });
          break;
        }
        let x = o + b * e;
        for (let k = 0; k < g; k++) {
          r[x + k] == 0
            ? (r[x + k] = d)
            : (i || (i = [])).push({ type: 'collision', row: c, pos: d, n: g - k });
          let M = w && w[k];
          if (M) {
            let S = ((x + k) % e) * 2,
              P = s[S];
...
function Gx(t, e, n) {
  ...
  for (let o = 0; o < t.map.length; o++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      d != null && (!a.colwidth || a.colwidth[c] != d) && ((l || (l = Xx(a)))[c] = d);
    }
    l && t.problems.unshift({ type: 'colwidth mismatch', pos: i, colwidth: l });
  }
}
function Xx(t) {
...
var Q = class Tt extends z {
  constructor(e, n = e) {
    ...
    let c = a.map((d) => {
      ...
      let f = i + d + 1;
      return new qt(l.resolve(f), l.resolve(f + u.content.size));
    });
    ...
    for (let a = o.top; a < o.bottom; a++) {
      ...
      for (let d = a * n.width + o.left, u = o.left; u < o.right; u++, d++) {
        ...
        if (m > 0 || g > 0) {
          let y = p.attrs;
          if (
            (m > 0 && (y = yn(y, 0, m)), g > 0 && (y = yn(y, y.colspan - g, g)), h.left < o.left)
          ) {
        ...
        if (h.top < o.top || h.bottom > o.bottom) {
          let y = { ...p.attrs, rowspan: Math.min(h.bottom, o.bottom) - Math.max(h.top, o.top) };
  ...
  replace(e, n = E.empty) {
    ...
    let i = z.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
    i && e.setSelection(i);
  }
  replaceWith(e, n) {
  ...
  forEachCell(e) {
    let n = this.$anchorCell.node(-1),
      ...
      i = r.cellsInRect(r.rectBetween(this.$anchorCell.pos - o, this.$headCell.pos - o));
    ...
    return (
      s.top <= l.top
        ? (s.top > 0 && (e = a.resolve(i + o.map[s.left])),
          l.bottom < o.height && (n = a.resolve(i + o.map[o.width * (o.height - 1) + l.right - 1])))
        : (l.top > 0 && (n = a.resolve(i + o.map[l.left])),
          s.bottom < o.height &&
            (e = a.resolve(i + o.map[o.width * (o.height - 1) + s.right - 1]))),
      new Tt(e, n)
    );
  }
  isRowSelection() {
    ...
    return (
      s.left <= l.left
        ? (s.left > 0 && (e = a.resolve(i + o.map[s.top * o.width])),
          l.right < o.width && (n = a.resolve(i + o.map[o.width * (l.top + 1) - 1])))
        : (l.left > 0 && (n = a.resolve(i + o.map[l.top * o.width])),
          s.right < o.width && (e = a.resolve(i + o.map[o.width * (s.top + 1) - 1]))),
      new Tt(e, n)
    );
  }
  toJSON() {
...
var tk = class Mp {
  ...
  map(e) {
    return new Mp(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
    let n = e.resolve(this.anchor),
...
function ik(t, e, n) {
  ...
  if (r instanceof L && (s = r.node.type.spec.tableRole)) {
    if (s == 'cell' || s == 'header_cell') i = Q.create(o, r.from);
    else if (s == 'row') {
      let l = o.resolve(r.from + 1);
      i = Q.rowSelection(l, l);
    } else if (!n) {
      let l = se.get(r.node),
        a = r.from + 1,
    ...
    r instanceof I && rk(r)
      ? (i = I.create(o, r.from))
      : r instanceof I && ok(r) && (i = I.create(o, r.$from.start(), r.$from.end()));
  return (i && (e || (e = t.tr)).setSelection(i), e);
}
var sk = new _('fix-tables');
function Tp(t, e, n, r) {
  let o = t.childCount,
    i = e.childCount;
...
function Ja(t, e) {
  let n,
    r = (o, i) => {
      o.type.spec.tableRole == 'table' && (n = lk(t, o, i, n));
    };
  return (e ? e.doc != t.doc && Tp(e.doc, t.doc, 0, r) : t.doc.descendants(r), n);
}
function lk(t, e, n, r) {
  let o = se.get(e);
  ...
  for (let a = 0; a < o.problems.length; a++) {
    ...
    if (c.type == 'collision') {
      ...
      r.setNodeMarkup(r.mapping.map(n + 1 + c.pos), null, yn(u, u.colspan - c.n, c.n));
      ...
      let d = e.nodeAt(c.pos);
      if (!d) continue;
      r.setNodeMarkup(r.mapping.map(n + 1 + c.pos), null, { ...d.attrs, colwidth: c.colwidth });
  ...
  for (let a = 0, c = n + 1; a < o.height; a++) {
    ...
    if (f > 0) {
      ...
      let p = [];
      for (let g = 0; g < f; g++) {
        let y = Ce(t.schema)[h].createAndFill();
        y && p.push(y);
      }
  ...
  return r.setMeta(sk, { fixTables: !0 });
}
function ut(t) {
  let e = t.selection,
    n = ts(t),
...
function Ap(t, { map: e, tableStart: n, table: r }, o) {
  let i = o > 0 ? -1 : 0;
  ek(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
  for (let s = 0; s < e.height; s++) {
    let l = s * e.width + o;
    if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
      let a = e.map[l],
        c = r.nodeAt(a);
      (t.setNodeMarkup(t.mapping.map(n + a), null, vp(c.attrs, o - e.colCount(a))),
        (s += c.attrs.rowspan - 1));
    } else {
      let a = i == null ? Ce(r.type.schema).cell : r.nodeAt(e.map[l + i]).type,
...
function ak(t, { map: e, table: n, tableStart: r }, o) {
  ...
  for (let s = 0; s < e.height;) {
    ...
    if ((o > 0 && e.map[l - 1] == a) || (o < e.width - 1 && e.map[l + 1] == a))
      t.setNodeMarkup(t.mapping.slice(i).map(r + a), null, yn(d, o - e.colCount(a)));
    else {
...
function ck(t, e, n) {
  var r;
  let o = Ce(e.type.schema).header_cell;
  for (let i = 0; i < t.width; i++)
    if (((r = e.nodeAt(t.map[i + n * t.width])) === null || r === void 0 ? void 0 : r.type) != o)
      return !1;
  return !0;
}
function Rp(t, { map: e, tableStart: n, table: r }, o) {
  let i = n;
  for (let c = 0; c < o; c++) i += r.child(c).nodeSize;
  let s = [],
    l = o > 0 ? -1 : 0;
  ck(e, r, o + l) && (l = o == 0 || o == e.height ? null : 0);
  for (let c = 0, d = e.width * o; c < e.width; c++, d++)
    if (o > 0 && o < e.height && e.map[d] == e.map[d - e.width]) {
      let u = e.map[d],
        f = r.nodeAt(u).attrs;
      (t.setNodeMarkup(n + u, null, { ...f, rowspan: f.rowspan + 1 }), (c += f.colspan - 1));
    } else {
      var a;
      let u =
          l == null
            ? Ce(r.type.schema).cell
            : (a = r.nodeAt(e.map[d + l * e.width])) === null || a === void 0
              ? void 0
              : a.type,
        f = u?.createAndFill();
      f && s.push(f);
    }
  return (t.insert(i, Ce(r.type.schema).row.create(null, s)), t);
}
function Dp(t, e) {
  if (!Qe(t)) return !1;
  if (e) {
...
function Ip(t, e) {
  ...
  if (e) {
    let n = ut(t);
    e(Rp(t.tr, n, n.bottom));
  }
  return !0;
}
function dk(t, { map: e, table: n, tableStart: r }, o) {
  let i = 0;
  ...
  for (let c = 0, d = o * e.width; c < e.width; c++, d++) {
    ...
    if (!a.has(u)) {
      if ((a.add(u), o > 0 && u == e.map[d - e.width])) {
        ...
        (t.setNodeMarkup(t.mapping.slice(l).map(u + r), null, { ...f, rowspan: f.rowspan - 1 }),
          (c += f.colspan - 1));
...
function Pp(t, e) {
  ...
  if (e) {
    ...
    for (let o = n.bottom - 1; dk(r, n, o), o != n.top; o--) {
      let i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
      if (!i) throw new RangeError('No table found');
      ((n.table = i), (n.map = se.get(n.table)));
    }
    e(r);
  }
  return !0;
...
function uk({ width: t, height: e, map: n }, r) {
  ...
  if (e) {
    ...
    if (
      (i.setNodeMarkup(a + r.tableStart, null, {
        ...vp(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
    ...
    (i.setSelection(new Q(i.doc.resolve(a + r.tableStart))), e(i));
  }
  return !0;
}
function Xa(t, e) {
  let n = Ce(t.schema);
  return fk(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function fk(t) {
  return (e, n) => {
    let r = e.selection,
    ...
    if (r instanceof Q) {
      ...
      var s;
      if (((o = Yx(r.$from)), !o)) return !1;
      i = (s = gn(r.$from)) === null || s === void 0 ? void 0 : s.pos;
    }
    ...
    if (n) {
      ...
      (u.setNodeMarkup(i, t({ node: o, row: d.top, col: d.left }), a[0]),
        r instanceof Q &&
          u.setSelection(new Q(u.doc.resolve(r.$anchorCell.pos), f ? u.doc.resolve(f) : void 0)),
        n(u));
    }
    return !0;
  };
...
function Lp(t, e) {
  return function (n, r) {
    ...
    if (r) {
      let i = n.tr;
      (n.selection instanceof Q
        ? n.selection.forEachCell((s, l) => {
            s.attrs[t] !== e && i.setNodeMarkup(l, null, { ...s.attrs, [t]: e });
          })
  ...
  return function (e, n) {
    ...
    if (n) {
      ...
      for (let a = 0; a < s.length; a++)
        l[a].type == r.header_cell && i.setNodeMarkup(o.tableStart + s[a], r.cell, l[a].attrs);
      if (i.steps.length === 0)
        for (let a = 0; a < s.length; a++)
          i.setNodeMarkup(o.tableStart + s[a], r.header_cell, l[a].attrs);
      n(i);
    }
    return !0;
  };
      ...
      : function (n, r) {
          ...
          if (r) {
            let o = Ce(n.schema),
              ...
              d =
                t == 'column'
                  ? { left: 0, top: c, right: 1, bottom: i.map.height }
                  : t == 'row'
                    ? { left: c, top: 0, right: i.map.width, bottom: 1 }
                    : i,
              u =
                t == 'column'
                  ? a
...
var gT = Yn('row', { useDeprecatedLogic: !0 }),
  yT = Yn('column', { useDeprecatedLogic: !0 }),
  Bp = Yn('cell', { useDeprecatedLogic: !0 });
function pk(t, e) {
  if (e < 0) {
    let n = t.nodeBefore;
...
function Ya(t) {
  return function (e, n) {
    ...
    if (n) {
      ...
      n(e.tr.setSelection(I.between(o, Zx(o))).scrollIntoView());
    }
    return !0;
  };
}
...
function Xi(t, e) {
  ...
  if (e) {
    let r = t.tr,
      o = Ce(t.schema).cell.createAndFill().content;
    (n.forEachCell((i, s) => {
      i.content.eq(o) ||
        r.replace(r.mapping.map(s + 1), r.mapping.map(s + i.nodeSize - 1), new E(o, 0, 0));
    }),
      r.docChanged && e(r));
  }
  return !0;
...
function mk(t) {
  ...
  if (i == 'row')
    for (let a = 0; a < e.childCount; a++) {
      ...
      ((d || u) && (c = Ua(Ce(s).row, new E(c, d, u)).content), l.push(c));
    }
  else if (i == 'cell' || i == 'header_cell')
    l.push(n || r ? Ua(Ce(s).row, new E(e, n, r)).content : e);
  else return null;
  return gk(s, l);
}
function gk(t, e) {
...
function Ua(t, e) {
  ...
  return new Ot(n).replace(0, n.content.size, e).doc;
}
function yk({ width: t, height: e, rows: n }, r, o) {
  if (t != r) {
    let i = [],
      s = [];
      ...
      for (let d = i[l] || 0, u = 0; d < r; u++) {
        ...
        (d + f.attrs.colspan > r &&
          (f = f.type.createChecked(
            yn(f.attrs, f.attrs.colspan, d + f.attrs.colspan - r),
            f.content,
          )),
          c.push(f),
          (d += f.attrs.colspan));
  ...
  if (e != o) {
    ...
    for (let s = 0, l = 0; s < o; s++, l++) {
      ...
      for (let d = 0; d < c.childCount; d++) {
        let u = c.child(d);
        (s + u.attrs.rowspan > o &&
          (u = u.type.create({ ...u.attrs, rowspan: Math.max(1, o - u.attrs.rowspan) }, u.content)),
          a.push(u));
      }
      i.push(C.from(a));
    }
...
function bk(t, e, n, r, o, i, s) {
  ...
  if (i > e.height) {
    ...
    for (let p = 0, m = (e.height - 1) * e.width; p < Math.max(e.width, o); p++) {
      let g = p >= e.width ? !1 : n.nodeAt(e.map[m + p]).type == a.header_cell;
      u.push(g ? d || (d = a.header_cell.createAndFill()) : c || (c = a.cell.createAndFill()));
    }
    let f = a.row.create(null, C.from(u)),
      h = [];
...
function gp(t, e, n, r, o, i, s, l) {
  ...
  for (let c = o; c < i; c++) {
    ...
    if (e.map[d - e.width] == u) {
      ...
      (t.setNodeMarkup(t.mapping.slice(l).map(u + r), null, { ...f.attrs, rowspan: s - h }),
        t.insert(
          t.mapping.slice(l).map(e.positionAt(s, p, n)),
          f.type.createAndFill({ ...f.attrs, rowspan: h + f.attrs.rowspan - s }),
        ),
        (c += f.attrs.colspan - 1));
    }
  }
...
function yp(t, e, n, r, o, i, s, l) {
  ...
  for (let c = o; c < i; c++) {
    ...
    if (e.map[d - 1] == u) {
      ...
      (t.setNodeMarkup(p, null, yn(f.attrs, s - h, f.attrs.colspan - (s - h))),
        t.insert(p + f.nodeSize, f.type.createAndFill(yn(f.attrs, 0, s - h))),
        (c += f.attrs.rowspan - 1));
    }
  }
  return a;
...
function bp(t, e, n, r, o) {
  ...
  let s = se.get(i),
    ...
    f = 0;
  function h() {
    if (((i = n ? u.doc.nodeAt(n - 1) : u.doc), !i)) throw new Error('No table found');
    ((s = se.get(i)), (f = u.mapping.maps.length));
  }
  (bk(u, s, i, n, c, d, f) && h(),
    gp(u, s, i, n, a, c, l, f) && h(),
    gp(u, s, i, n, a, c, d, f) && h(),
    yp(u, s, i, n, l, d, a, f) && h(),
    yp(u, s, i, n, l, d, c, f) && h());
  for (let p = l; p < d; p++) {
...
var wk = Sr({
  ...
  ArrowUp: Yi('vert', -1),
  ArrowDown: Yi('vert', 1),
  'Shift-ArrowLeft': Qi('horiz', -1),
  'Shift-ArrowRight': Qi('horiz', 1),
  'Shift-ArrowUp': Qi('vert', -1),
  'Shift-ArrowDown': Qi('vert', 1),
  Backspace: Xi,
  'Mod-Backspace': Xi,
  Delete: Xi,
  'Mod-Delete': Xi,
...
function Yi(t, e) {
  return (n, r, o) => {
    if (!o) return !1;
    let i = n.selection;
    if (i instanceof Q) return Zi(n, r, z.near(i.$headCell, e));
    if (t != 'horiz' && !i.empty) return !1;
    let s = Hp(o, t, e);
    if (s == null) return !1;
    if (t == 'horiz') return Zi(n, r, z.near(n.doc.resolve(i.head + e), e));
    {
      ...
      return (
        a
          ? (c = z.near(a, 1))
          : e < 0
            ? (c = z.near(n.doc.resolve(l.before(-1)), -1))
            : (c = z.near(n.doc.resolve(l.after(-1)), 1)),
        Zi(n, r, c)
      );
    }
  };
...
function Qi(t, e) {
  return (n, r, o) => {
    ...
    let i = n.selection,
      s;
    if (i instanceof Q) s = i;
    else {
      let a = Hp(o, t, e);
      if (a == null) return !1;
      s = new Q(n.doc.resolve(a));
    }
    let l = Cp(s.$headCell, t, e);
    return l ? Zi(n, r, new Q(s.$anchorCell, l)) : !1;
  };
}
function xk(t, e) {
  let n = t.state.doc,
...
function kk(t, e, n) {
  ...
  let r = mk(n),
    o = t.state.selection;
  if (o instanceof Q) {
    r || (r = { width: 1, height: 1, rows: [C.from(Ua(Ce(t.state.schema).cell, n))] });
    let i = o.$anchorCell.node(-1),
      s = o.$anchorCell.start(-1),
      l = se.get(i).rectBetween(o.$anchorCell.pos - s, o.$headCell.pos - s);
    return ((r = yk(r, l.right - l.left, l.bottom - l.top)), bp(t.state, t.dispatch, s, l, r), !0);
  } else if (r) {
    let i = ts(t.state),
      s = i.start(-1);
    return (bp(t.state, t.dispatch, s, se.get(i.node(-1)).findCell(i.pos - s), r), !0);
  } else return !1;
}
function Sk(t, e) {
  var n;
  ...
  if (e.shiftKey && t.state.selection instanceof Q)
    ...
    e.shiftKey &&
    r &&
    (o = gn(t.state.selection.$anchor)) != null &&
    ((n = _a(t, e)) === null || n === void 0 ? void 0 : n.pos) != o.pos
  )
  ...
  function s() {
    (t.root.removeEventListener('mouseup', s),
      ...
      _t.getState(t.state) != null && t.dispatch(t.state.tr.setMeta(_t, -1)));
  }
  function l(a) {
    let c = a,
    ...
    else if (wp(t, c.target) != r && ((u = _a(t, e)), !u)) return s();
    u && i(u, c);
  }
...
function Hp(t, e, n) {
  if (!(t.state.selection instanceof I)) return null;
...
function _a(t, e) {
  ...
  return (r >= 0 && gn(t.state.doc.resolve(r))) || gn(t.state.doc.resolve(o));
}
var Ck = class {
  constructor(t, e) {
    ((this.node = t),
      ...
      Ka(t, this.colgroup, this.table, e),
      (this.contentDOM = this.table.appendChild(document.createElement('tbody'))));
  }
  update(t) {
    return t.type != this.node.type
      ? !1
      : ((this.node = t), Ka(t, this.colgroup, this.table, this.defaultCellMinWidth), !0);
  }
  ignoreMutation(t) {
...
var Pe = new _('tableColumnResizing');
function $p({
  handleWidth: t = 5,
  cellMinWidth: e = 25,
  ...
  let i = new B({
    ...
    state: {
      init(s, l) {
        var a;
        let c =
            (a = i.spec) === null || a === void 0 || (a = a.props) === null || a === void 0
              ? void 0
              : a.nodeViews,
          d = Ce(l.schema).table.name;
        return (r && c && (c[d] = (u, f) => new r(u, n, f)), new vk(-1, !1));
      },
      apply(s, l) {
        return l.apply(s);
      },
    ...
    props: {
      ...
      decorations: (s) => {
        let l = Pe.getState(s);
        if (l && l.activeHandle > -1) return Dk(s, l.activeHandle);
      },
      nodeViews: {},
    },
  });
...
var vk = class es {
  ...
  apply(e) {
    let n = this,
      r = e.getMeta(Pe);
    if (r && r.setHandle != null) return new es(r.setHandle, !1);
    if (r && r.setDragging !== void 0) return new es(n.activeHandle, r.setDragging);
    if (n.activeHandle > -1 && e.docChanged) {
      let o = e.mapping.map(n.activeHandle, -1);
      return (ja(e.doc.resolve(o)) || (o = -1), new es(o, n.dragging));
    }
    return n;
  }
};
function Mk(t, e, n, r) {
  ...
  if (o && !o.dragging) {
    ...
    if (i) {
      ...
      e.clientX - l <= n
        ? (s = xp(t, e, 'left', n))
        : a - e.clientX <= n && (s = xp(t, e, 'right', n));
    }
    if (s != o.activeHandle) {
      if (!r && s !== -1) {
...
function Tk(t) {
  if (!t.editable) return;
  let e = Pe.getState(t.state);
  e && e.activeHandle > -1 && !e.dragging && Fp(t, -1);
}
function Ak(t, e, n, r) {
  var o;
  if (!t.editable) return !1;
  let i = (o = t.dom.ownerDocument.defaultView) !== null && o !== void 0 ? o : window,
    s = Pe.getState(t.state);
  if (!s || s.activeHandle == -1 || s.dragging) return !1;
  let l = t.state.doc.nodeAt(s.activeHandle),
    a = Ek(t, s.activeHandle, l.attrs);
  t.dispatch(t.state.tr.setMeta(Pe, { setDragging: { startX: e.clientX, startWidth: a } }));
  function c(u) {
    (i.removeEventListener('mouseup', c), i.removeEventListener('mousemove', d));
    let f = Pe.getState(t.state);
    f?.dragging &&
      (Ok(t, f.activeHandle, kp(f.dragging, u, n)),
      t.dispatch(t.state.tr.setMeta(Pe, { setDragging: null })));
  }
  function d(u) {
    if (!u.which) return c(u);
    let f = Pe.getState(t.state);
    if (f && f.dragging) {
      let h = kp(f.dragging, u, n);
      Sp(t, f.activeHandle, h, r);
    }
  }
  return (
    Sp(t, s.activeHandle, a, r),
...
function Ek(t, e, { colspan: n, colwidth: r }) {
...
function xp(t, e, n, r) {
  ...
  if (!i) return -1;
  let { pos: s } = i,
    l = gn(t.state.doc.resolve(s));
  if (!l) return -1;
  if (n == 'right') return l.pos;
  let a = se.get(l.node(-1)),
    c = l.start(-1),
...
function Ok(t, e, n) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    let p = f.colwidth ? f.colwidth.slice() : Rk(f.colspan);
...
function Sp(t, e, n, r) {
  let o = t.state.doc.resolve(e),
    i = o.node(-1),
    s = o.start(-1),
    l = se.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1,
    a = t.domAtPos(o.start(-1)).node;
  for (; a && a.nodeName != 'TABLE';) a = a.parentNode;
  a && Ka(i, a.firstChild, a, r, l, n);
}
function Rk(t) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    if (
      ...
      ((h.className = 'column-resize-handle'),
        !((a = Pe.getState(t)) === null || a === void 0) &&
          a.dragging &&
          n.push(re.node(s + u, s + u + o.nodeAt(u).nodeSize, { class: 'column-resize-dragging' })),
        n.push(re.widget(f, h)));
    }
  }
  return Z.create(t.doc, n);
}
function _p({ allowTableNodeSelection: t = !1 } = {}) {
  return new B({
    key: _t,
    state: {
      init() {
    ...
    props: {
      decorations: nk,
      handleDOMEvents: { mousedown: Sk },
      createSelectionBetween(e) {
        return _t.getState(e.state) != null ? e.state.selection : null;
      },
      handleTripleClick: xk,
      handleKeyDown: wk,
      handlePaste: kk,
    },
    appendTransaction(e, n, r) {
      return ik(r, Ja(r, n), t);
    },
  });
}
function rs(t) {
        ...
        colwidth: {
          ...
          parseHTML: (t) => {
            ...
            let r = t.getAttribute('colwidth'),
              o = r ? r.split(',').map((i) => parseInt(i, 10)) : null;
            if (!o) {
              let i =
                  (e = t.closest('table')) == null ? void 0 : e.querySelectorAll('colgroup > col'),
                s = Array.from(((n = t.parentElement) == null ? void 0 : n.children) || []).indexOf(
                  t,
                );
              if (s && s > -1 && i && i[s]) {
...
function Vp(t, e, n, r, o, i) {
      ...
      for (let g = 0; g < p; g += 1, h += 1) {
        ...
        if (((l += y || r), y || (a = !1), c)) {
          ...
          let b = document.createElement('col'),
            [x, k] = Qa(r, y);
          (b.style.setProperty(x, k), e.appendChild(b));
        }
      }
    }
  for (; c;) {
  ...
  let u = t.attrs.style && typeof t.attrs.style == 'string' && /\bwidth\s*:/i.test(t.attrs.style);
  a && !u
...
var Hk = class {
  constructor(t, e) {
    ((this.node = t),
      ...
      (this.colgroup = this.table.appendChild(document.createElement('colgroup'))),
      Vp(t, this.colgroup, this.table, e),
      (this.contentDOM = this.table.appendChild(document.createElement('tbody'))));
  }
  update(t) {
    return t.type !== this.node.type
      ? !1
      : ((this.node = t), Vp(t, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(t) {
    let e = t.target,
...
function _k(t, e, n, r, o) {
  ...
  for (let c = 0; c < n; c += 1) {
    let d = Wp(i.cell, o);
    if ((d && l.push(d), r)) {
      let u = Wp(i.header_cell, o);
      u && s.push(u);
    }
  }
  let a = [];
  for (let c = 0; c < e; c += 1) a.push(i.row.createChecked(null, r && c === 0 ? s : l));
...
var ns = ({ editor: t }) => {
    ...
    if (!Vk(e)) return !1;
    let n = 0,
      r = Ho(e.ranges[0].$from, (i) => i.type.name === 'table');
    return (
...
function Uk(t, e, n = {}) {
  var r;
  let o = (r = n.cellLineSeparator) != null ? r : Wk;
    ...
    (m.content &&
      m.content.forEach((y) => {
        ...
        y.content && Array.isArray(y.content) && y.content.length > 1
          ? (w = y.content.map((S) => e.renderChildren(S)).join(o))
          : (w = y.content ? e.renderChildren(y.content) : '');
        let b = jk(w),
          x = y.type === 'tableHeader',
          k = Pk(y.attrs);
        g.push({ text: b, isHeader: x, align: k });
      }),
      i.push(g));
  });
  ...
  let a = (m, g) => m + ' '.repeat(Math.max(0, g - m.length)),
    ...
    u = new Array(s).fill(null);
  i.forEach((m) => {
    var g;
    for (let y = 0; y < s; y += 1) !u[y] && (g = m[y]) != null && g.align && (u[y] = m[y].align);
  });
  let f = `
`,
    h = new Array(s).fill(0).map((m, g) => (d && c[g] && c[g].text) || '');
  return (
...
var Kk = Uk,
  qk = V.create({
    ...
    renderHTML({ node: t, HTMLAttributes: e }) {
      let { colgroup: n, tableWidth: r, tableMinWidth: o } = $k(t, this.options.cellMinWidth),
        i = e.style;
      function s() {
        return i || (r ? `width: ${r}` : `min-width: ${o}`);
      }
      let l = ['table', N(this.options.HTMLAttributes, e, { style: s() }), n, ['tbody', 0]];
      return this.options.renderWrapper ? ['div', { class: 'tableWrapper' }, l] : l;
    },
    parseMarkdown: (t, e) => {
      let n = [],
        r = Array.isArray(t.align) ? t.align : [];
      if (t.header) {
        let o = [];
        (t.header.forEach((i, s) => {
          var l;
          let a = rs((l = r[s]) != null ? l : i.align),
            c = a ? { align: a } : {};
          o.push(
    ...
    addCommands() {
      return {
        insertTable:
          ...
          ({ tr: r, dispatch: o, editor: i }) => {
            let s = _k(i.schema, t, e, n);
            if (o) {
              let l = r.selection.from + 1;
              r.replaceSelectionWith(s)
                .scrollIntoView()
                .setSelection(I.near(r.doc.resolve(l)));
            }
            return !0;
          },
        addColumnBefore:
        ...
        fixTables:
          () =>
          ({ state: t, dispatch: e }) => (e && Ja(t), !0),
        setCellSelection:
          (t) =>
          ({ tr: e, dispatch: n }) => {
            if (n) {
              let r = Q.create(e.doc, t.anchorCell, t.headCell);
              e.setSelection(r);
            }
            return !0;
          },
    ...
    addProseMirrorPlugins() {
      return [
        ...(this.options.resizable && this.editor.isEditable
          ...
          : []),
        _p({ allowTableNodeSelection: this.options.allowTableNodeSelection }),
      ];
    },
    addNodeView() {
      let t = this.options.resizable && this.editor.isEditable,
        e = this.options.View;
      return t || !e ? null : ({ node: n, view: r }) => new e(n, this.options.cellMinWidth, r);
    },
    extendNodeSchema(t) {
      let e = { name: t.name, options: t.options, storage: t.storage };
      return { tableRole: J($(t, 'tableRole', e)) };
    },
  }),
  Up = U.create({
    name: 'tableKit',
    addExtensions() {
      let t = [];
      return (
        this.options.table !== !1 && t.push(qk.configure(this.options.table)),
        this.options.tableCell !== !1 && t.push(Lk.configure(this.options.tableCell)),
        this.options.tableHeader !== !1 && t.push(Bk.configure(this.options.tableHeader)),
        this.options.tableRow !== !1 && t.push(zk.configure(this.options.tableRow)),
        t
      );
    },
  });
    ...
    addCommands() {
      return {
        ...
        unsetTextAlign:
          () =>
          ({ commands: t }) =>
            this.options.types.map((e) => t.resetAttributes(e, 'textAlign')).some((e) => e),
        toggleTextAlign:
          (t) =>
          ({ editor: e, commands: n }) =>
            this.options.alignments.includes(t)
...
var Xk = te.create({
    ...
    markdownTokenizer: {
      ...
      tokenize(t, e, n) {
        ...
        if (!o) return;
        let i = o[2].trim();
        return { type: 'underline', raw: o[0], text: i, tokens: n.inlineTokens(i) };
      },
    },
    addCommands() {
      return {
...
var Gp = (t, e) => {
  ...
  Xp = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
    items: ({ query: n }) =>
      Object.entries(t)
        .filter(
          ([r, o]) =>
            r.toLowerCase().replace(/\s/g, '').includes(n.toLowerCase()) ||
            o.toLowerCase().replace(/\s/g, '').includes(n.toLowerCase()),
        )
      ...
      let n,
        ...
        a = () => {
          ...
          if (f) {
            ...
            (h.top < p.top || h.bottom > p.bottom) && f.scrollIntoView({ block: 'nearest' });
          }
        },
        c = () => {
          if (!o) return;
          let f = o.items || [];
          f.length !== 0 && ((r = (r + f.length - 1) % f.length), s(), a());
        },
        d = () => {
          if (!o) return;
          let f = o.items || [];
      ...
      return {
        onStart: (f) => {
          ((o = f),
            ...
            f.clientRect && Gp(f.editor, n));
        },
        onUpdate: (f) => {
          ((o = f), (r = 0), s(), a(), f.clientRect && Gp(f.editor, n));
        },
        onKeyDown: (f) =>
          f.event.key === 'Escape'
...
var Yp = async ({
  ...
  let S = [
      ...
      If,
      Lf,
      Cf.configure({ class: 'fi-not-prose' }),
      vf,
      Bf,
      zf,
      Hf,
      ...
      jf.configure({
        inline: !0,
        resize: { enabled: d, alwaysPreserveAspectRatio: !0, allowBase64: !0 },
      }),
      Uf,
      sh.configure({
        autolink: !0,
      ...
      ...(Object.keys(y).length
        ? [
            wh.configure({
              deleteTriggerWithBackspace: !0,
              suggestion: Xp({ mergeTags: y, noMergeTagSearchResultsMessage: w }),
              mergeTags: y,
            }),
          ]
        : []),
      ...
      Oa,
      ap,
      Fa.configure({ placeholder: b }),
      dp.configure({ textColors: k }),
      cp,
      up,
      fp,
      hp,
      Up.configure({ table: { resizable: !0 } }),
      Kp,
      qp.configure({
    ...
    P = await Promise.all(
      o.map(async (A) => {
        new RegExp('^(?:[a-z+]+:)?//', 'i').test(A) || (A = new URL(A, document.baseURI).href);
        try {
          let R = (await import(A)).default;
          return typeof R == 'function' ? R() : R;
        } catch (R) {
          return (
            console.error(`Failed to load rich editor custom extension from [${A}]:`, R),
            null
          );
        }
      }),
  ...
  for (let A of P) {
    ...
    let v = S.findIndex((R) => R.name === A.name);
    (A.name === 'placeholder' && A.parent === null && (A = Fa.configure(A.options)),
      v !== -1 ? (S[v] = A) : S.push(A));
  }
  return S;
};
...
var Qk = class {
      ...
      ((this.preventHide = !1),
        ...
        (this.shouldShow = ({ view: u, state: f, from: h, to: p }) => {
          let { doc: m, selection: g } = f,
            { empty: y } = g,
            w = !m.textBetween(h, p).length && Hn(f.selection),
            b = this.element.contains(document.activeElement);
          return !(!(u.hasFocus() || b) || y || w || !this.editor.isEditable);
        }),
        ...
        (this.blurHandler = ({ event: u }) => {
          ...
          (u?.relatedTarget &&
            ...
            (u?.relatedTarget !== this.editor.view.dom && this.hide());
        }),
        (this.handleDebouncedUpdate = (u, f) => {
          let h = !f?.selection.eq(u.state.selection),
            p = !f?.doc.eq(u.state.doc);
          (!h && !p) ||
        ...
        (this.transactionHandler = ({ transaction: u }) => {
          ...
          f === 'updatePosition'
            ? this.updatePosition()
            : f && typeof f == 'object' && f.type === 'updateOptions'
              ? this.updateOptions(f.options)
              : f === 'hide'
                ? this.hide()
                : f === 'show' && (this.updatePosition(), this.show());
        }));
      var d;
      ((this.editor = t),
        (this.element = e),
    ...
    get middlewares() {
      ...
      return (
        ...
        this.floatingUIOptions.arrow && t.push(rp(this.floatingUIOptions.arrow)),
    ...
    get virtualElement() {
      ...
      let { selection: r } = this.editor.state,
        o = (t = this.getReferencedVirtualElement) == null ? void 0 : t.call(this);
      if (o) return o;
      if (!((n = (e = this.view) == null ? void 0 : e.dom) != null && n.parentNode)) return;
      let i = _l(this.view, r.from, r.to),
        s = { getBoundingClientRect: () => i, getClientRects: () => [i] };
      if (r instanceof L) {
        let l = this.view.nodeDOM(r.from),
          a = l.dataset.nodeViewWrapper ? l : l.querySelector('[data-node-view-wrapper]');
        (a && (l = a),
          l &&
            (s = {
      ...
      if (r instanceof Q) {
        ...
        let h =
          u === f
            ...
            : Yk(u.getBoundingClientRect(), f.getBoundingClientRect());
        s = { getBoundingClientRect: () => h, getClientRects: () => [h] };
      }
      return s;
    }
    updatePosition() {
    ...
    show() {
      ...
      let e = typeof this.appendTo == 'function' ? this.appendTo() : this.appendTo;
  ...
  Za = (t) =>
    new B({
      key: typeof t.pluginKey == 'string' ? new _(t.pluginKey) : t.pluginKey,
      view: (e) => new Qk({ view: e, ...t }),
    }),
  EA = U.create({
    name: 'bubbleMenu',
    addOptions() {
...
window.FilamentRichEditor.tiptap = { core: Qo, pmState: go, pmView: wl, pmModel: Fs };
function tS({
  acceptedFileTypes: t,
  ...
  livewireId: g,
  maxFileSize: y,
  maxFileSizeValidationMessage: w,
  mergeTags: b,
  mentions: x,
  getMentionSearchResultsUsing: k,
  getMentionLabelsUsing: M,
  ...
  return {
    ...
    async init() {
      D = new Zk({
        ...
        editorProps: { attributes: { ...(h ? { 'aria-label': h } : {}) } },
        extensions: await Yp({
          acceptedFileTypes: t,
          acceptedFileTypesValidationMessage: e,
          canAttachFiles: r,
          ...
          deleteCustomBlockButtonIconHtml: o,
          editCustomBlockButtonIconHtml: i,
          editCustomBlockUsing: (q, ft) =>
            this.$wire.mountAction(
              'customBlock',
              { editorSelection: this.editorSelection, id: q, config: ft, mode: 'edit' },
              { schemaComponent: f },
            ),
          floatingToolbars: l,
          hasResizableImages: a,
          insertCustomBlockUsing: (q, ft = null) =>
            this.$wire.mountAction(
              'customBlock',
              { id: q, dragPosition: ft, mode: 'insert' },
              { schemaComponent: f },
            ),
          key: f,
          linkProtocols: p,
      ...
      (Object.keys(l).forEach((q) => {
        let ft = this.$refs[`floatingToolbar::${q}`];
        if (!ft) {
        ...
        D.registerPlugin(
          Za({
            ...
            shouldShow: ({ editor: Ke }) =>
              q === 'paragraph'
                ? Ke.isFocused && Ke.isActive(q) && !Ke.state.selection.empty
                : W && !Ke.state.selection.empty && Ke.isActive('paragraph')
                  ? !1
                  : Ke.isFocused && Ke.isActive(q),
      ...
      (D.on('update', ({ editor: q }) =>
        ...
        D.on('selectionUpdate', ({ transaction: q }) => {
          H || ((this.editorUpdatedAt = Date.now()), (this.editorSelection = q.selection.toJSON()));
        }),
        D.on('transaction', () => {
          H || (this.editorUpdatedAt = Date.now());
        }),
        u &&
          D.on('blur', () => {
            H || this.$wire.commit();
        ...
        this.$watch('state', () => {
          if (!H) {
            ...
            D.commands.setContent(this.state);
          }
        }));
      let Y = (q) => {
        q.detail.livewireId === g && q.detail.key === f && this.runEditorCommands(q.detail);
      };
      (window.addEventListener('run-rich-editor-commands', Y),
        O.push(['run-rich-editor-commands', Y]));
      let F = (q) => {
        q.detail.livewireId === g &&
          q.detail.key === f &&
          ((this.isUploadingFile = !0), (this.fileValidationMessage = null), q.stopPropagation());
      };
      (window.addEventListener('rich-editor-uploading-file', F),
        O.push(['rich-editor-uploading-file', F]));
      let ce = (q) => {
        q.detail.livewireId === g &&
          q.detail.key === f &&
          ((this.isUploadingFile = !1), q.stopPropagation());
      };
      (window.addEventListener('rich-editor-uploaded-file', ce),
        O.push(['rich-editor-uploaded-file', ce]));
      let fe = (q) => {
        q.detail.livewireId === g &&
          q.detail.key === f &&
      ...
      (window.addEventListener('rich-editor-file-validation-message', fe),
        O.push(['rich-editor-file-validation-message', fe]),
        window.dispatchEvent(new CustomEvent(`schema-component-${g}-${f}-loaded`)));
    },
    getEditor() {
      return D;
    },
    ...
    setEditorSelection(W) {
      W &&
        ...
        D.chain()
          .command(
            ({ tr: X }) => (X.setSelection(eS.fromJSON(D.state.doc, this.editorSelection)), !0),
          )
          .run());
    },
    runEditorCommands({ commands: W, editorSelection: X }) {
      this.setEditorSelection(X);
      let Y = D.chain();
      (W.forEach((F) => (Y = Y[F.name](...(F.arguments ?? [])))), Y.run());
    },
    togglePanel(W = null) {
    ...
    isPanelActive(W = null) {
      return W === null ? this.activePanel !== null : this.activePanel === W;
    },
    insertMergeTag(W) {
      D.chain()
        .focus()
    ...
    destroy() {
      ((H = !0),
        O.forEach(([W, X]) => {
          window.removeEventListener(W, X);
        }),
        (O = []),
        D && (D.destroy(), (D = null)),
        (this.shouldUpdateState = !0));
