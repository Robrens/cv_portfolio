  ...
  return (
    i === void 0 && (i = {}),
    {
      ...
      async fn(t) {
        ...
        if (((W = [...W, { placement: o, overflows: _ }]), !_.every((B) => B <= 0))) {
          var V, tt;
          let B = (((V = s.flip) == null ? void 0 : V.index) || 0) + 1,
            Y = q[B];
          if (
            Y &&
            (!(d === 'alignment' ? w !== ht(Y) : !1) ||
              W.every((L) => (ht(L.placement) === w ? L.overflows[0] > 0 : !0)))
          )
            return { data: { index: B, overflows: W }, reset: { placement: Y } };
          let F =
              ...
              case 'bestFit': {
                ...
                let $ =
                  (z = W.filter((L) => {
                    ...
                    .map((L) => [
                      L.placement,
                      L.overflows.filter((et) => et > 0).reduce((et, ie) => et + ie, 0),
                    ])
                    .sort((L, et) => L[1] - et[1])[0]) == null
                    ? void 0
                    : z[0];
                $ && (F = $);
                break;
...
function un(i, t) {
  ...
  if (c <= 0) {
    let f = n.ownerDocument,
      ...
      p =
        (f.compatMode === 'CSS1Compat' && parseFloat(u.marginLeft) + parseFloat(u.marginRight)) ||
        0,
  ...
  _prepareDragStart: function (t, e, n) {
    ...
    if (n && !h && n.parentNode === s) {
      ...
      if (
        ...
        (de = r.group),
        (v.dragged = h),
        (Ct = { target: h, clientX: (e || t).clientX, clientY: (e || t).clientY }),
        ...
        Ci && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (h.draggable = !0)),
  ...
  _triggerDragStart: function (t, e) {
    ((e = e || (t.pointerType == 'touch' && t)),
      !this.nativeDraggable || e
        ...
        : (O(h, 'dragend', this), O(I, 'dragstart', this._onDragStart)));
    try {
      document.selection
        ? me(function () {
  ...
  _appendGhost: function () {
    if (!y) {
      ...
      if (he) {
        for (
          K = t;
          b(K, 'position') === 'static' && b(K, 'transform') === 'none' && K !== document;
        )
          K = K.parentNode;
        (K !== document.body && K !== document.documentElement
          ? (K === document && (K = dt()), (e.top += K.scrollTop), (e.left += K.scrollLeft))
          : (K = dt()),
          (Ne = Ti(K)));
      }
      ((y = h.cloneNode(!0)),
    ...
    (j('setupClone', this),
      ...
      e
        ...
        : (S(document, 'mouseup', n._onDrop),
          ...
          o && ((o.effectAllowed = 'move'), s.setData && s.setData.call(n, o, h)),
          O(document, 'drop', n),
    ...
    function w(L) {
      return (
        ...
        L &&
          ...
          g !== u &&
            (Q(h, H ? H.options.ghostClass : c.options.ghostClass, !1), Q(h, a.ghostClass, !0)),
          H !== g && g !== v.active ? (H = g) : g === v.active && H && (H = null),
          u === g && (g._ignoreWhileAnimating = n),
          g.animateAll(function () {
            (x('dragOverAnimationComplete'), (g._ignoreWhileAnimating = null));
          }),
          g !== u && (u.animateAll(), (u._ignoreWhileAnimating = null))),
        ((n === h && !h.animated) || (n === e && !n.animated)) && (Pt = null),
        !a.dragoverBubble &&
          !t.rootEl &&
          n !== document &&
    ...
    if (
      ...
      c &&
        ...
        (f
          ? d || (r = R !== I)
          : H === this ||
            ((this.lastPutMode = de.checkPull(this, c, h, t)) && l.checkPut(this, c, h, t))))
    ) {
      if (
      ...
      if (r)
        return (
          ...
          this._hideClone(),
          x('revert'),
          v.eventCanceled || (It ? I.insertBefore(h, It) : I.appendChild(h)),
          w(!0)
        );
      var E = Ye(e, a.draggable);
      if (!E || ($n(t, p, this) && !E.animated)) {
        if (E === h) return w(!1);
        if ((E && e === t.target && (n = E), n && (s = k(n)), ue(I, e, h, o, n, s, t, !!n) !== !1))
          return (
            D(),
            E && E.nextSibling ? e.insertBefore(h, E.nextSibling) : e.appendChild(h),
            (R = e),
            A(),
            w(!0)
          );
        ...
        if (((n = M), (s = k(n)), ue(I, e, h, o, n, s, t, !1) !== !1))
          return (D(), e.insertBefore(h, M), (R = e), A(), w(!0));
      } else if (n.parentNode === e) {
        s = k(n);
        var C = 0,
          q,
          J = h.parentNode !== e,
          _ = !Bn((h.animated && h.toRect) || o, (n.animated && n.toRect) || s, p),
          W = p ? 'top' : 'left',
          V = Ii(n, 'top', 'top') || Ii(h, 'top', 'top'),
          tt = V ? V.scrollTop : void 0;
        (Pt !== n && ((q = s[W]), (Zt = !1), (fe = (!_ && a.invertSwap) || J)),
          (C = Kn(
            t,
            n,
            s,
        ...
        if ($ !== !1)
          return (
            ...
            setTimeout(Vn, 30),
            D(),
            F && !Y ? e.appendChild(h) : n.parentNode.insertBefore(h, F ? Y : n),
    ...
    ((Mt = !1),
      ...
      t &&
        ...
        h &&
          ...
          ke(h),
          (h.style['will-change'] = ''),
          Yt && !Mt && Q(h, H ? H.options.ghostClass : this.options.ghostClass, !1),
          ...
          I !== R
            ? (Z >= 0 &&
                (X({ rootEl: R, name: 'add', toEl: R, fromEl: I, originalEvent: t }),
                X({ sortable: this, name: 'remove', toEl: R, originalEvent: t }),
                X({ rootEl: R, name: 'sort', toEl: R, fromEl: I, originalEvent: t }),
                X({ sortable: this, name: 'sort', toEl: R, originalEvent: t })),
              H && H.save())
            : Z !== Nt &&
              Z >= 0 &&
              (X({ sortable: this, name: 'update', toEl: R, originalEvent: t }),
              X({ sortable: this, name: 'sort', toEl: R, originalEvent: t })),
          v.active &&
            ((Z == null || Z === -1) && ((Z = Nt), (wt = Jt)),
            X({ sortable: this, name: 'end', toEl: R, originalEvent: t }),
            this.save()))),
      this._nulling());
  },
  _nulling: function () {
    ...
    if (t.scroll) {
      ...
      do {
        ...
        p === l
          ? ((M =
              A < q &&
              (_.overflowX === 'auto' || _.overflowX === 'scroll' || _.overflowX === 'visible')),
            (C =
              E < J &&
              (_.overflowY === 'auto' || _.overflowY === 'scroll' || _.overflowY === 'visible')))
          : ((M = A < q && (_.overflowX === 'auto' || _.overflowX === 'scroll')),
            (C = E < J && (_.overflowY === 'auto' || _.overflowY === 'scroll')));
          ...
          (tt != 0 || z != 0) &&
            ...
            (N[d].pid = setInterval(
              function () {
                ...
                var Y = N[this.layer].vy ? N[this.layer].vy * a : 0,
                  F = N[this.layer].vx ? N[this.layer].vx * a : 0;
                (typeof f == 'function' &&
                  f.call(v.dragged.parentNode[G], F, Y, i, xe, N[this.layer].el) !== 'continue') ||
...
var Ee = class {
  ...
  createRemoveButton(t, e) {
    ...
    return (
      ...
      n.addEventListener('keydown', (o) => {
        (o.key === ' ' || o.key === 'Enter') &&
          (o.preventDefault(), o.stopPropagation(), P(t) && this.selectOption(t));
      }),
      n
    );
  }
  ...
  async getLabelForSingleSelection() {
    ...
    if (
      ...
      bt(t) && P(this.initialOptionLabel) && this.state === this.initialState)
    )
      ((t = this.initialOptionLabel), P(this.state) && (this.labelRepository[this.state] = t));
    else if (bt(t) && this.getOptionLabelUsing)
      try {
        ((t = await this.getOptionLabelUsing()),
          P(t) && P(this.state) && (this.labelRepository[this.state] = t));
      } catch (e) {
        ...
        ((this.refreshOptionLabelListener = async (t) => {
          if (
            ...
            try {
              ...
              (P(n) && (this.isHtmlAllowed ? (n.innerHTML = e) : (n.textContent = e)),
  ...
  async addSingleBadge(t, e) {
    ...
    if (
      (bt(n) && ((n = this.getSelectedOptionLabel(t)), P(n) && (this.labelRepository[t] = n)),
