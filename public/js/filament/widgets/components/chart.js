...
var Nc = (s, t, e) =>
  t in s ? Rc(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (s[t] = e);
...
function Xc(s) {
  ...
  let n = ho(+t[2]),
    ...
    o = +t[4] / 100;
  return (
    t[1] === 'hwb' ? (i = qc(n, r, o)) : t[1] === 'hsv' ? (i = Gc(n, r, o)) : (i = Mn(n, r, o)),
    { r: i[0], g: i[1], b: i[2], a: e }
  );
}
function Jc(s, t) {
  var e = vn(s);
  ((e[0] = ho(e[0] + t)), (e = Mn(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]));
}
function Kc(s) {
  if (!s) return;
  let t = vn(s),
    ...
    i = ro(t[1]),
    n = ro(t[2]);
  return s.a < 255 ? `hsla(${e}, ${i}%, ${n}%, ${Wt(s.a)})` : `hsl(${e}, ${i}%, ${n}%)`;
}
var oo = {
    x: 'dark',
    Z: 'light',
...
function Qc() {
  ...
  for (i = 0; i < t.length; i++) {
    for (o = a = t[i], n = 0; n < e.length; n++) ((r = e[n]), (a = a.replace(r, oo[r])));
    ((r = parseInt(ao[o], 16)), (s[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]));
  }
  return s;
}
var ri;
...
function ih(s) {
  return (
    s && (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Wt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`)
  );
}
var wn = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
...
function lo(s) {
  ...
  return (
    Array.isArray(s)
      ? s.length >= 3 &&
        ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = Kt(s[3])))
...
var ms = class s {
  constructor(t) {
    ...
    let e = typeof t,
      i;
    (e === 'object' ? (i = lo(t)) : e === 'string' && (i = Bc(t) || th(t) || rh(t)),
      (this._rgb = i),
      (this._valid = !!i));
  }
  get valid() {
...
var Pn = (s, t) => (typeof s == 'string' && s.endsWith('%') ? parseFloat(s) / 100 : +s / t),
  di = (s, t) => (typeof s == 'string' && s.endsWith('%') ? (parseFloat(s) / 100) * t : +s);
function W(s, t, e) {
...
function N(s, t, e, i) {
  ...
  else if (E(s)) for (o = Object.keys(s), r = o.length, n = 0; n < r; n++) t.call(e, s[o[n]], o[n]);
}
function We(s, t) {
  let e, i, n, r;
...
function So(s, t, e) {
  ...
  let i = t[s],
    n = e[s];
  E(i) && E(n) ? pe(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = ys(n));
}
...
var Ss = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
  ...
  Vn = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
function ki(s, t, e) {
  let i = t.length,
    n = 0,
    r = i;
  if (s._sorted) {
    let { iScale: o, vScale: a, _parsed: l } = s,
      c = s.dataset && s.dataset.options ? s.dataset.options.spanGaps : null,
      h = o.axis,
      { min: u, max: d, minDefined: f, maxDefined: g } = o.getUserBounds();
    if (f) {
      if (((n = Math.min(Mt(l, h, u).lo, e ? i : Mt(t, h, o.getPixelForValue(u)).lo)), c)) {
        let m = l
          .slice(0, n + 1)
          .reverse()
...
var ai = (s) => s === 0 || s === 1,
  go = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * H) / e)),
  ...
  fe = {
    ...
    easeInOutCirc: (s) =>
      (s /= 0.5) < 1 ? -0.5 * (Math.sqrt(1 - s * s) - 1) : 0.5 * (Math.sqrt(1 - (s -= 2) * s) + 1),
    ...
    easeInOutBounce: (s) =>
      s < 0.5 ? fe.easeInBounce(s * 2) * 0.5 : fe.easeOutBounce(s * 2 - 1) * 0.5 + 0.5,
  };
function Si(s) {
...
function uh(s) {
  s.set('layout', { autoPadding: !0, padding: { top: 0, right: 0, bottom: 0, left: 0 } });
}
var po = new Map();
function dh(s, t) {
  t = t || {};
...
function Ao(s) {
  return !s || I(s.size) || I(s.family)
    ? null
    : (s.style ? s.style + ' ' : '') + (s.weight ? s.weight + ' ' : '') + s.size + 'px ' + s.family;
}
...
function Oi(s, t, e, i, n) {
  ...
  if (
    f &&
    typeof f == 'object' &&
    ((r = f.toString()), r === '[object HTMLImageElement]' || r === '[object HTMLCanvasElement]')
  ) {
    (s.save(),
      s.translate(e, i),
      s.rotate(p),
  ...
  if (!(isNaN(m) || m <= 0)) {
    switch ((s.beginPath(), f)) {
      default:
        (n ? s.ellipse(e, i, n / 2, m, 0, 0, H) : s.arc(e, i, m, 0, H), s.closePath());
        break;
      case 'triangle':
        ((h = n ? n / 2 : m),
      ...
      case 'rect':
        if (!g) {
          ((l = Math.SQRT1_2 * m), (h = n ? n / 2 : l), s.rect(e - h, i - l, 2 * h, 2 * l));
          break;
        }
        p += Qt;
      case 'rectRot':
      ...
      case 'line':
        ...
        break;
      case 'dash':
        (s.moveTo(e, i), s.lineTo(e + Math.cos(p) * (n ? n / 2 : m), i + Math.sin(p) * m));
        break;
      case !1:
        s.closePath();
        break;
...
var wh = (s, t) => (s ? s + ws(t) : t),
  jn = (s, t) =>
    E(t) && s !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Eo(s, t, e) {
...
function Un(s, t, e, i) {
  ...
  return l === null || (typeof r < 'u' && r !== e && ((l = bo(a, o, r, l, i)), l === null))
    ? !1
...
function Dh(s, t, e, i) {
  let n;
  for (let r of t)
    if (((n = Fo(wh(r, s), e)), typeof n < 'u')) return jn(s, n) ? Un(e, i, s, n) : n;
}
function Fo(s, t) {
  for (let e of t) {
    if (!e) continue;
...
function Pi(s, t, e, i) {
  let { iScale: n } = s,
    ...
    c,
    h;
  for (a = 0, l = i; a < l; ++a) ((c = a + e), (h = t[c]), (o[a] = { r: n.parse(Lt(h, r), c) }));
  return o;
}
...
function zo(s, t = 'x') {
  ...
  for (o = 0; o < i; ++o)
    if (((a = l), (l = c), (c = Ve(s, o + 1)), !!l)) {
      ...
      r[o] = a ? (c ? (yt(n[o - 1]) !== yt(n[o]) ? 0 : (n[o - 1] + n[o]) / 2) : n[o - 1]) : n[o];
    }
  (Ah(s, n, r), Ih(s, r, t));
}
function li(s, t, e) {
...
function Eh(s, t) {
  ...
  for (e = 0, i = s.length; e < i; ++e)
    ((o = r),
      ...
      r &&
        ((n = s[e]),
        o && ((n.cp1x = li(n.cp1x, t.left, t.right)), (n.cp1y = li(n.cp1y, t.top, t.bottom))),
        a && ((n.cp2x = li(n.cp2x, t.left, t.right)), (n.cp2y = li(n.cp2y, t.top, t.bottom)))));
}
function Yn(s, t, e, i, n) {
  ...
  if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
    ...
    for (r = 0, o = s.length; r < o; ++r)
      ((a = s[r]),
        (l = No(c, a, s[Math.min(r + 1, o - (i ? 0 : 1)) % o], t.tension)),
        (a.cp1x = l.previous.x),
        (a.cp1y = l.previous.y),
        (a.cp2x = l.next.x),
        (a.cp2y = l.next.y),
...
function Ut(s, t) {
  ...
  return (
    ...
    { x: Math.round((((l - u) / f) * e.width) / i), y: Math.round((((c - d) / g) * e.height) / i) }
  );
}
function Nh(s, t, e) {
  let i, n;
    ...
    ((y = t[M % o]),
      !y.skip &&
        ...
        b !== _ &&
          ...
          p !== null &&
            v() &&
            (g.push(xo({ start: p, end: M, loop: d, count: o, style: f })), (p = null)),
          (O = M),
          (_ = b))));
  return (p !== null && g.push(xo({ start: p, end: u, loop: d, count: o, style: f })), g);
}
function Ni(s, t) {
  let e = [],
    i = s.segments;
...
function Hh(s, t, e, i) {
  ...
  for (l = t + 1; l <= e; ++l) {
    ...
    (c.skip || c.stop
      ? a.skip ||
        ((i = !1), r.push({ start: t % n, end: (l - 1) % n, loop: i }), (t = o = c.stop ? l : null))
      : ((o = l), a.skip && (t = l)),
      (a = c));
  }
...
function $h(s, t, e, i) {
  ...
  function f(g, m, p, b) {
    ...
    if (g !== m) {
      ...
      for (; e[m % l].skip;) m += y;
      g % l !== m % l &&
        (c.push({ start: g % l, end: m % l, loop: p, style: b }), (h = b), (u = m % l));
    }
  }
  for (let g of t) {
    u = a ? u : g.start;
    ...
    _update(t = Date.now()) {
      ...
      (this._charts.forEach((i, n) => {
        ...
        (a && (n.draw(), this._notify(n, i, t, 'progress')),
          r.length || ((i.running = !1), this._notify(n, i, t, 'complete'), (i.initial = !1)),
          (e += r.length));
      }),
        (this._lastDate = t),
        e === 0 && (this._running = !1));
...
function Xh(s) {
  let t, e, i, n;
  return (
    E(s) ? ((t = s.top), (e = s.right), (i = s.bottom), (n = s.left)) : (t = e = i = n = s),
...
function $o(s, t, e, i = {}) {
  ...
  for (o = 0, a = n.length; o < a; ++o) {
    ...
    ((c = s.values[l]), Y(c) && (r || t === 0 || yt(t) === yt(c)) && (t += c));
  }
  return !h && !i.all ? 0 : t;
}
function Jh(s, t) {
  let { iScale: e, vScale: i } = t,
    ...
    c,
    h;
  for (l = 0, c = o.length; l < c; ++l) ((h = o[l]), (a[l] = { [n]: h, [r]: s[h] }));
  return a;
}
function Kn(s, t) {
...
var tr = (s) => s === 'reset' || s === 'none',
  ...
  iu = (s, t, e) => s && !t.hidden && t._stacked && { keys: Wa(e, !0), values: null },
  dt = class {
    constructor(t, e) {
      ((this.chart = t),
        (this._ctx = t.ctx),
    ...
    _dataCheck() {
      ...
      if (E(e)) {
        ...
        (e && Object.isExtensible(e) && Nn(e, this), (this._syncList = []), (this._data = e));
      }
    }
    addElements() {
      let t = this._cachedMeta;
    ...
    buildOrUpdateElements(t) {
      ...
      ((e._stacked = Kn(e.vScale, e)),
        ...
        (n || r !== e._stacked) && (Uo(this, e._parsed), (e._stacked = Kn(e.vScale, e))));
    }
    configure() {
    ...
    parse(t, e) {
      ...
      if (this._parsing === !1) ((i._parsed = n), (i._sorted = !0), (d = n));
        ...
        for (h = 0; h < e; ++h) ((i._parsed[h + t] = u = d[h]), l && (f() && (l = !1), (c = u)));
        i._sorted = l;
      }
      o && Uo(this, d);
    }
    parsePrimitiveData(t, e, i, n) {
      let { iScale: r, vScale: o } = t,
        ...
        g;
      for (d = 0, f = n; d < f; ++d)
        ((g = d + i), (u[d] = { [a]: h || r.parse(c[g], g), [l]: o.parse(e[g], g) }));
      return u;
    }
    ...
    parseObjectData(t, e, i, n) {
      let { xScale: r, yScale: o } = t,
        ...
        f;
      for (h = 0, u = n; h < u; ++h)
        ((d = h + i), (f = e[d]), (c[h] = { x: r.parse(Lt(f, a), d), y: o.parse(Lt(f, l), d) }));
      return c;
    }
    getParsed(t) {
    ...
    applyStack(t, e, i) {
      let n = this.chart,
        r = this._cachedMeta,
        o = e[t.axis],
        a = { keys: Wa(n, !0), values: e._stacks[t.axis]._visualValues };
    ...
    getAllParsedValues(t) {
      let e = this._cachedMeta._parsed,
        ...
        r,
        o;
      for (n = 0, r = e.length; n < r; ++n) ((o = e[n][t.axis]), Y(o) && i.push(o));
      return i;
    }
    getMaxOverflow() {
      return !1;
    ...
    _update(t) {
      ...
      (this.update(t || 'default'),
        (e._clip = Xh(P(this.options.clip, Gh(e.xScale, e.yScale, this.getMaxOverflow())))));
    }
    update(t) {}
    draw() {
      let t = this._ctx,
    ...
    getContext(t, e, i) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        ((r = this.$context || (this.$context = eu(this.chart.getContext(), this.index))),
          (r.dataset = n),
    ...
    _resolveElementOptions(t, e = 'default', i) {
      ...
      return (m.$shared && ((m.$shared = l), (r[o] = Object.freeze(Yo(m, l)))), m);
    }
    ...
    updateElement(t, e, i, n) {
      tr(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
    }
    ...
    _insertElements(t, e, i = !0) {
      ...
      (this._parsing && l(n._parsed), this.parse(t, e), i && this.updateElements(r, t, e, 'reset'));
    }
...
(S(dt, 'defaults', {}), S(dt, 'datasetElementType', null), S(dt, 'dataElementType', null));
function nu(s, t) {
  if (!s._cache.$bar) {
    let e = s.getMatchingVisibleMetas(t),
      i = [];
    for (let n = 0, r = e.length; n < r; n++) i = i.concat(e[n].controller.getAllParsedValues(s));
...
function ru(s) {
  let t = s.iScale,
    ...
    a,
    l = () => {
      o === 32767 || o === -32768 || (be(a) && (i = Math.min(i, Math.abs(o - a) || i)), (a = o));
    };
...
function ou(s, t, e, i) {
  let n = e.barThickness,
    ...
    o;
  return (
    I(n) ? ((r = t.min * e.categoryPercentage), (o = e.barPercentage)) : ((r = n * i), (o = 1)),
...
function Zo(s, t, e, i) {
  let n = s.iScale,
    ...
    d;
  for (c = e, h = e + i; c < h; ++c)
    ((d = t[c]), (u = {}), (u[n.axis] = a || n.parse(o[c], c)), l.push(Ba(d, u, r, c)));
  return l;
}
function er(s) {
...
function cu(s, t, e) {
  return s !== 0 ? yt(s) : (t.isHorizontal() ? 1 : -1) * (t.min >= e ? 1 : -1);
}
function hu(s) {
  let t, e, i, n, r;
  return (
...
var Ue = class extends dt {
  ...
  parseObjectData(t, e, i, n) {
    let { iScale: r, vScale: o } = t,
      ...
      m;
    for (d = i, f = i + n; d < f; ++d)
      ((m = e[d]), (g = {}), (g[r.axis] = r.parse(Lt(m, c), d)), u.push(Ba(Lt(m, h), g, o, d)));
    return u;
  }
  updateRangeFromParsed(t, e, i, n) {
  ...
  getLabelAndValue(t) {
    let e = this._cachedMeta,
      ...
      r = this.getParsed(t),
      o = r._custom,
      a = er(o) ? '[' + o.start + ', ' + o.end + ']' : '' + n.getLabelForValue(r[n.axis]);
  ...
  updateElements(t, e, i, n) {
    ...
    for (let f = e; f < e + i; f++) {
      let g = this.getParsed(f),
        m = r || I(g[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
        p = this._calculateBarIndexPixels(f, h),
        b = (g._stacks || {})[a.axis],
        y = {
          horizontal: c,
          base: m.base,
          enableBorderRadius: !b || er(g._custom) || o === b._top || o === b._bottom,
          x: c ? m.head : p.center,
          y: c ? p.center : m.head,
      ...
      (uu(y, _, b, o), fu(y, _, h.ratio), this.updateElement(t[f], f, y, n));
    }
  }
  _getStacks(t, e) {
    let { iScale: i } = this._cachedMeta,
      n = i.getMatchingVisibleMetas(this._type).filter((h) => h.controller.options.grouped),
      r = i.options.stacked,
      o = [],
    ...
    for (let h of n)
      if (
        !(e !== void 0 && c(h)) &&
        ((r === !1 || o.indexOf(h.stack) === -1 || (r === void 0 && h.stack === void 0)) &&
          o.push(h.stack),
        h.index === t)
      )
        break;
  ...
  _getAxis() {
    ...
    for (let i of this.chart.data.datasets)
      t[P(this.chart.options.indexAxis === 'x' ? i.xAxisID : i.yAxisID, e)] = !0;
    return Object.keys(t);
  }
  ...
  _calculateBarValuePixels(t) {
    ...
    if (
      (this.chart.getDataVisibility(t) ? (g = e.getPixelForValue(d + f)) : (g = b),
      (m = g - b),
      Math.abs(m) < o)
    ) {
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      let h = r ? this._getStackCount(t) : e.stackCount,
        u = n.barThickness === 'flex' ? au(t, e, n, h * c) : ou(t, e, n, h * c),
        d =
          this.chart.options.indexAxis === 'x'
            ? this.getDataset().xAxisID
            : this.getDataset().yAxisID,
        f = this._getAxis().indexOf(P(d, this.getFirstScaleIdForIndexAxis())),
        g = this._getStackIndex(this.index, this._cachedMeta.stack, r ? t : void 0) + f;
      ((a = u.start + u.chunk * g + u.chunk / 2), (l = Math.min(o, u.chunk * u.ratio)));
    } else
      ((a = i.getPixelForValue(this.getParsed(t)[i.axis], t)), (l = Math.min(o, e.min * e.ratio)));
  ...
  draw() {
    let t = this._cachedMeta,
      ...
      n = i.length,
      r = 0;
    for (; r < n; ++r) this.getParsed(r)[e.axis] !== null && !i[r].hidden && i[r].draw(this._ctx);
  }
};
(S(Ue, 'id', 'bar'),
  S(Ue, 'defaults', {
...
var Ye = class extends dt {
  ...
  parseArrayData(t, e, i, n) {
    ...
    for (let o = 0; o < r.length; o++) {
      let a = e[i + o];
      r[o]._custom = P(a[2], this.resolveDataElementOptions(o + i).radius);
    }
    return r;
  }
  parseObjectData(t, e, i, n) {
    ...
    for (let o = 0; o < r.length; o++) {
      let a = e[i + o];
      r[o]._custom = P(a && a.r && +a.r, this.resolveDataElementOptions(o + i).radius);
    }
    return r;
  }
  getMaxOverflow() {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let d = e; d < e + i; d++) {
      let f = t[d],
        ...
        m = {},
        p = (m[h] = r ? o.getPixelForDecimal(0.5) : o.getPixelForValue(g[h])),
        b = (m[u] = r ? a.getBasePixel() : a.getPixelForValue(g[u]));
      ((m.skip = isNaN(p) || isNaN(b)),
        c &&
          ((m.options = l || this.resolveDataElementOptions(d, f.active ? 'active' : n)),
  ...
  resolveDataElementOptions(t, e) {
    ...
    let r = n.radius;
    return (e !== 'active' && (n.radius = 0), (n.radius += P(i && i._custom, r)), n);
  }
};
(S(Ye, 'id', 'bubble'),
  S(Ye, 'defaults', {
  ...
  S(Ye, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }));
function gu(s, t, e) {
  let i = 1,
    n = 1,
    r = 0,
  ...
  if (t < H) {
    let a = s,
      ...
      u = Math.cos(l),
      d = Math.sin(l),
      f = (_, w, x) => (xe(_, a, l, !0) ? 1 : Math.max(w, w * e, x, x * e)),
      g = (_, w, x) => (xe(_, a, l, !0) ? -1 : Math.min(w, w * e, x, x * e)),
      m = f(0, c, u),
      p = f(q, h, d),
      b = g(F, c, u),
      y = g(F + q, h, d);
    ((i = (m - b) / 2), (n = (p - y) / 2), (r = -(m + b) / 2), (o = -(p + y) / 2));
  }
...
var qt = class extends dt {
  ...
  updateElements(t, e, i, n) {
    let r = n === 'reset',
      ...
      { sharedOptions: m, includeOptions: p } = this._getSharedOptions(e, n),
      b = this._getRotation(),
      y;
    ...
    for (y = e; y < e + i; ++y) {
      ...
      (p && (x.options = m || this.resolveDataElementOptions(y, w.active ? 'active' : n)),
        (b += _),
        ...
        labels: {
          generateLabels(t) {
            ...
            return e.labels.length && e.datasets.length
              ? e.labels.map((l, c) => {
                  let u = t.getDatasetMeta(0).controller.getStyle(c);
                  return {
                    text: l,
  ...
  updateElements(t, e, i, n) {
    ...
    for (let x = 0; x < _; ++x) {
      ...
      let M = this.getParsed(x),
        ...
        A = (v[f] =
          r || O ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, M, l) : M[f], x));
      ((v.skip = isNaN(D) || isNaN(A) || O),
        (v.stop = x > 0 && Math.abs(M[d] - w[d]) > p),
        m && ((v.parsed = M), (v.raw = c.data[x])),
        u && (v.options = h || this.resolveDataElementOptions(x, k.active ? 'active' : n)),
...
(S(Ze, 'id', 'line'),
  ...
  S(Ze, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
  ...
  updateElements(t, e, i, n) {
    ...
    for (g = e; g < e + i; g++) {
      let p = t[g],
        ...
        _ = o.getDataVisibility(g) ? c.getDistanceFromCenterForValue(this.getParsed(g).r) : 0;
      ((f = y), r && (l.animateScale && (_ = 0), l.animateRotate && (b = y = d)));
      let w = {
        x: h,
        y: u,
        innerRadius: 0,
        ...
        startAngle: b,
        endAngle: y,
        options: this.resolveDataElementOptions(g, p.active ? 'active' : n),
      };
          ...
          generateLabels(t) {
            ...
            if (e.labels.length && e.datasets.length) {
              ...
              return e.labels.map((r, o) => {
                let l = t.getDatasetMeta(0).controller.getStyle(o);
                return {
                  text: r,
...
(S(Rs, 'id', 'pie'),
  S(Rs, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
...
(S(qe, 'id', 'radar'),
  ...
  S(qe, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
  ...
  updateElements(t, e, i, n) {
    ...
    for (let w = e; w < e + i; ++w) {
      let x = t[w],
        ...
        D = (v[g] =
          r || M ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, k, l) : k[g], w));
      ((v.skip = isNaN(O) || isNaN(D) || M),
        (v.stop = w > 0 && Math.abs(k[f] - _[f]) > b),
        p && ((v.parsed = k), (v.raw = c.data[w])),
        d && (v.options = u || this.resolveDataElementOptions(w, x.active ? 'active' : n)),
...
(S(Ge, 'id', 'scatter'),
  S(Ge, 'defaults', { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
  S(Ge, 'overrides', {
      ...
      Zs(
        ...
        function (a, l, c) {
          (!n && !Tt(a, s.chartArea, 0)) ||
            (a.inRange(t.x, t.y, i) && r.push({ element: a, datasetIndex: l, index: c }));
        },
        !0,
      ),
    r
...
function ir(s, t, e, i, n, r) {
  return !r && !s.isPointInArea(t) ? [] : e === 'r' && !i ? yu(s, t, e, n) : xu(s, t, e, i, n, r);
}
function Xo(s, t, e, i, n) {
  ...
  return (
    Zs(s, e, t, (l, c, h) => {
      l[o] &&
        l[o](t[e], n) &&
        (r.push({ element: l, datasetIndex: c, index: h }), (a = a || l.inRange(t.x, t.y, n)));
    }),
    i && !a ? [] : r
  );
}
...
function Ns(s, t, e, i) {
  ...
  for (r = 0, o = s.length, c = 0; r < o; ++r) {
    ((a = s[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Ou(a.horizontal, t)));
...
var ot = {
    ...
    update(s, t, e, i) {
      ...
      let h =
          l.reduce((m, p) => (p.box.options && p.box.options.display === !1 ? m : m + 1), 0) || 1,
        u = Object.freeze({
          outerWidth: t,
          outerHeight: e,
          padding: n,
...
function Eu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver((r) => {
      let o = !1;
      for (let a of r) ((o = o || Gi(a.addedNodes, i)), (o = o && !Gi(a.removedNodes, i)));
      o && e();
    });
...
function Lu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver((r) => {
      let o = !1;
      for (let a of r) ((o = o || Gi(a.removedNodes, i)), (o = o && !Gi(a.addedNodes, i)));
      o && e();
    });
  return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
var fr = class extends qi {
  ...
  removeEventListener(t, e) {
    let i = t.$proxies || (t.$proxies = {}),
      n = i[e];
    if (!n) return;
    ((({ attach: nr, detach: nr, resize: nr })[e] || Au)(t, e, n), (i[e] = void 0));
  }
  getDevicePixelRatio() {
...
function Vu(s) {
  return !Cs() || (typeof OffscreenCanvas < 'u' && s instanceof OffscreenCanvas) ? dr : fr;
}
var ft = class {
  constructor() {
    S(this, 'x');
...
function Wi(s, t, e, i, n) {
  ...
  for (c = Math.max(r, 0); c < o; c++) c === h && (t.push(s[c]), a++, (h = Math.round(r + a * e)));
}
function Uu(s) {
  let t = s.length,
    e,
...
function Ku(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    ...
    } else e === 'center' ? (g = (c.bottom + c.top) / 2 + m - t) : (g = sa(s, e, t));
    d = a - r;
  } else {
    if (E(e)) {
      let b = Object.keys(e)[0],
    ...
    } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = sa(s, e, t));
...
var Ce = class s extends ft {
    ...
    getUserBounds() {
      ...
      return (
        ...
        { min: at(t, i), max: at(e, n), minDefined: Y(t), maxDefined: Y(e) }
      );
    }
    getMinMax(t) {
    ...
    update(t, e, i) {
      ...
      (this._convertTicksToLabels(l ? na(this.ticks, a) : this.ticks),
        ...
        o.display &&
          ...
          ((this.ticks = Wu(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    calculateLabelRotation() {
      ...
      ((a = t.offset ? this.maxWidth / i : f / (i - 1)),
        u + 6 > a &&
          ...
          (l = this.maxHeight - Ls(t.grid) - e.padding - ra(t.title, this.chart.options.font)),
          (c = Math.sqrt(u * u + d * d)),
          (o = ks(
            Math.min(
              Math.asin(K((h.highest.height + 6) / a, -1, 1)),
              Math.asin(K(l / c, -1, 1)) - Math.asin(K(d / c, -1, 1)),
            ),
          )),
    ...
    _convertTicksToLabels(t) {
      ...
      let e, i;
      for (e = 0, i = t.length; e < i; e++) I(t[e].label) && (t.splice(e, 1), i--, e--);
      ...
      for (u = 0; u < e; u += l) {
        if (
          ...
          for (d = 0, f = g.length; d < f; ++d)
            ((x = g[d]), !I(x) && !B(x) && ((_ = ze(n, b.data, b.gc, _, x)), (w += y)));
        (o.push(_), a.push(w), (c = Math.max(_, c)), (h = Math.max(w, h)));
      }
      qu(r, e);
      let k = o.indexOf(c),
        v = a.indexOf(h),
        M = (O) => ({ width: o[O] || 0, height: a[O] || 0 });
      return { first: M(0), last: M(e - 1), widest: M(k), highest: M(v), widths: o, heights: a };
    }
    getLabelForValue(t) {
      return t;
    }
    ...
    _computeGridLineItems(t) {
      ...
      if (o === 'top')
        ...
        ((y = b(this.top)), (A = t.top), (J = b(t.bottom) - p), (v = y + p), (O = this.top + d));
      else if (o === 'left')
        ((y = b(this.right)),
          (k = this.right - d),
          (M = y - p),
        ...
        ((y = b(this.left)), (D = t.left), (L = b(t.right) - p), (k = y + p), (M = this.left + d));
      else if (e === 'x') {
    ...
    _computeLabelItems(t) {
      let e = this.axis,
        ...
        L,
        J = 'middle';
      if (n === 'top') ((k = this.bottom - g), (v = this._getXAxisLabelAlignment()));
      else if (n === 'bottom') ((k = this.top + g), (v = this._getXAxisLabelAlignment()));
      else if (n === 'left') {
      ...
      for (b = 0, y = a.length; b < y; ++b) {
        ...
        o
          ? ((x = M),
            ...
            u && (L *= -1),
            m !== 0 && !V.showLabelBackdrop && (x += (D / 2) * Math.sin(m)))
          : ((k = M), (L = ((1 - A) * D) / 2));
        let ii;
    ...
    drawBorder() {
      ...
      let a = n.setContext(this.getContext(0)).lineWidth,
        ...
        d;
      (this.isHorizontal()
        ? ((c = Ht(t, this.left, o) - o / 2), (h = Ht(t, this.right, a) + a / 2), (u = d = l))
        : ((u = Ht(t, this.top, o) - o / 2), (d = Ht(t, this.bottom, a) + a / 2), (c = h = l)),
        e.save(),
        (e.lineWidth = r.width),
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || E(e)
        ? ((l += o.bottom), B(i.text) && (l += r.lineHeight * (i.text.length - 1)))
        : (l += o.top);
  ...
  Ke = class {
    ...
    register(t) {
      ...
      return (
        r in n || ((n[r] = t), Qu(t, o, i), this.override && j.override(t.id, t.overrides)),
        o
      );
    }
    get(t) {
    ...
    unregister(t) {
      let e = this.items,
        i = t.id,
        n = this.scope;
      (i in e && delete e[i], n && i in j[n] && (delete j[n][i], this.override && delete ie[i]));
    }
  };
function Qu(s, t, e) {
...
function nd(s, { plugins: t, localIds: e }, i, n) {
  ...
  for (let a of t) {
    let l = a.id,
      c = id(i[l], n);
    c !== null && r.push({ plugin: a, options: rd(s.config, { plugin: a, local: e[l] }, c, o) });
  }
  return r;
}
...
function br(s, ...t) {
  if (oa(s)) return s;
  for (let e of t) {
    let i = e.axis || ld(e.position) || (s.length > 1 && oa(s[0].toLowerCase()));
    if (i) return i;
  }
  throw new Error(
...
function cd(s, t) {
  if (t.data && t.data.datasets) {
    let e = t.data.datasets.filter((i) => i.xAxisID === s || i.yAxisID === s);
...
function hd(s, t) {
  ...
  return (
    Object.keys(i).forEach((o) => {
      let a = i[o];
      if (!E(a)) return console.error(`Invalid scale configuration for scale: ${o}`);
    ...
    s.data.datasets.forEach((o) => {
      ...
      Object.keys(h).forEach((u) => {
        let d = od(u, l),
          f = o[d + 'AxisID'] || d;
        ((r[f] = r[f] || Object.create(null)), pe(r[f], [{ axis: d }, i[f], h[u]]));
      });
    }),
...
var Fs = (s, t, e) => {
  ...
  yr = class {
    constructor(t) {
      ((this._config = ud(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map()));
    }
    get platform() {
    ...
    pluginScopeKeys(t) {
      let e = t.id,
        i = this.type;
      return Bi(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
    }
    _cachedScopes(t, e) {
    ...
    getOptionScopes(t, e, i) {
      ...
      let c = Array.from(l);
      return (c.length === 0 && c.push(Object.create(null)), qa.has(e) && o.set(e, c), c);
    }
    chartOptionScopes() {
...
function Ga(s) {
  return (
    Cs() && typeof s == 'string' ? (s = document.getElementById(s)) : s && s.length && (s = s[0]),
...
var xt = class {
  ...
  constructor(t, e) {
    ...
    ((this.platform = new (i.platform || Vu(n))()), this.platform.updateConfig(i));
    ...
    (e &&
      ...
      N(r, (o) => {
        let a = o.options,
          ...
          c = br(l, a),
          h = P(a.type, o.dtype);
        ((a.position === void 0 || ha(a.position, c) !== ha(o.dposition)) &&
    ...
    for (this._removeUnreferencedMetasets(), i = 0, n = e.length; i < n; i++) {
      ...
      if (
        ...
        let l = Nt.getController(a),
          { datasetElementType: c, dataElementType: h } = j.datasets[a];
        (Object.assign(l, {
  ...
  _updateDataset(t, e) {
    ...
    this.notifyPlugins('beforeDatasetUpdate', n) !== !1 &&
      (i.controller._update(e), (n.cancelable = !1), this.notifyPlugins('afterDatasetUpdate', n));
  }
  render() {
  ...
  bindResponsiveEvents() {
    ...
    let t = this._responsiveListeners,
      ...
      o,
      a = () => {
        (n('attach', a), (this.attached = !0), this.resize(), i('resize', r), i('detach', o));
      };
    ((o = () => {
      ((this.attached = !1), n('resize', r), this._stop(), this._resize(0, 0), i('attach', a));
    }),
  ...
  setActiveElements(t) {
    ...
    !We(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
  }
  notifyPlugins(t, e, i) {
...
function xd(s, t, e) {
  let { startAngle: i, x: n, y: r, outerRadius: o, innerRadius: a, options: l } = t,
...
function _d(s, t, e) {
  ...
  (s.beginPath(),
    s.arc(r, o, a, i - c, e + c),
    l > n ? ((c = n / l), s.arc(r, o, l, e + c, i - c, !0)) : s.arc(r, o, n, e + q, i - q),
    s.closePath(),
    s.clip());
}
function wd(s) {
...
function Xi(s, t, e, i, n, r) {
  ...
  let m = Math.max(0.001, g * u - e / F) / u,
    ...
    b = l + p + f,
    y = n - p - f,
    { outerStart: _, outerEnd: w, innerStart: x, innerEnd: k } = kd(t, d, u, y - b),
    v = u - _,
    M = u - w,
    O = b + _ / v,
    D = y - w / M,
  ...
  if ((s.beginPath(), r)) {
    ...
    let G = (y - k / d + (b + x / d)) / 2;
    if ((s.arc(o, a, d, y - k / d, G, !0), s.arc(o, a, d, G, b + x / d, !0), x > 0)) {
      let rt = je(A, J, o, a);
...
(S(Me, 'id', 'arc'),
  ...
  S(Me, 'descriptors', { _scriptable: !0, _indexable: (e) => e !== 'borderDash' }));
function Xa(s, t, e = t) {
...
function Td(s) {
  return s.stepped ? Bn : s.tension || s.cubicInterpolationMode === 'monotone' ? Hn : Md;
}
function Ja(s, t, e = {}) {
  let i = s.length,
...
function Od(s, t, e, i) {
  ...
  for (f = 0; f <= c; ++f)
    ((g = n[(a + (d ? c - f : f)) % o]),
      !g.skip && (u ? (s.moveTo(g.x, g.y), (u = !1)) : h(s, m, g, d, r.stepped), (m = g)));
  return (l && ((g = n[(a + (d ? c : 0)) % o]), h(s, m, g, d, r.stepped)), !!l);
}
function Dd(s, t, e, i) {
  let n = t.points,
...
function Cd(s) {
  return s.stepped ? Gn : s.tension || s.cubicInterpolationMode === 'monotone' ? Xn : Bt;
}
function Pd(s, t, e, i) {
  let n = t._path;
...
var zt = class extends ft {
  ...
  get segments() {
    return this._segments || (this._segments = Jn(this, this.options.segment));
  }
  first() {
    let t = this.segments,
      e = this.points;
  ...
  draw(t, e, i, n) {
    let r = this.options || {};
    ((this.points || []).length && r.borderWidth && (t.save(), Ed(t, this, i, n), t.restore()),
...
(S(zt, 'id', 'line'),
  ...
  S(zt, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
  S(zt, 'descriptors', { _scriptable: !0, _indexable: (t) => t !== 'borderDash' && t !== 'fill' }));
function ma(s, t, e, i) {
  let n = s.options,
    { [e]: r } = s.getProps([e], i);
...
(S(Xe, 'id', 'point'),
  ...
  S(Xe, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
function Ka(s, t) {
  let {
      x: e,
      y: i,
...
(S(Je, 'id', 'bar'),
  ...
  S(Je, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
...
function $d(s) {
  ...
  return (e, i) => {
    ...
    n instanceof qt ? (t = Bd(e, t)) : n instanceof Oe ? (t = Hd(e, t)) : n && (t = Wd(e, t));
  };
}
function ba(s) {
  let t;
...
function Zd(s, t, e, i, n) {
  ...
  for (o[l++] = s[h], u = 0; u < r - 2; u++) {
    ...
    let k = Math.floor(u * a) + 1 + t,
      ...
      { x: M, y: O } = s[h];
    for (f = g = -1, y = k; y < v; y++)
      ((g = 0.5 * Math.abs((M - p) * (s[y].y - O) - (M - s[y].x) * (b - O))),
        g > f && ((f = g), (d = s[y]), (m = y)));
    ((o[l++] = d), (h = m));
  }
  return ((o[l++] = s[c]), o);
...
function qd(s, t, e, i) {
  ...
  for (o = t; o < t + e; ++o) {
    ...
    let x = l | 0;
    if (x === h)
      (c < g ? ((g = c), (u = o)) : c > m && ((m = c), (d = o)), (n = (r * n + a.x) / ++r));
    else {
      let k = o - 1;
      if (!I(u) && !I(d)) {
        let v = Math.min(u, d),
      ...
      (o > 0 && k !== f && p.push(s[k]), p.push(a), (h = x), (r = 0), (g = m = c), (u = d = f = o));
    }
  }
  return p;
}
  ...
  beforeElementsUpdate: (s, t, e) => {
    ...
    s.data.datasets.forEach((n, r) => {
      let { _data: o, indexAxis: a } = n,
        ...
        c = o || n.data;
      if (ke([a, s.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
...
function wr(s, t, e, i) {
  ...
  let n = t[s],
    r = e[s];
  return (s === 'angle' && ((n = tt(n)), (r = tt(r))), { property: s, start: n, end: r });
}
function Kd(s, t) {
...
function sl(s, t) {
  ...
  return (
    ...
    e.length ? new zt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i }) : null
  );
}
function _a(s) {
  return s && s.fill !== !1;
...
var Ji = class {
  ...
  pathSegment(t, e, i) {
    ...
    return ((e = e || { start: 0, end: H }), t.arc(n, r, o, e.end, e.start, !0), !i.bounds);
  }
  interpolate(t) {
...
function gf(s) {
  ...
  if (i.grid.circular) {
    ...
    return new Ji({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(o) });
  }
...
function ar(s, t, e) {
  ...
  i &&
    o.points.length &&
    (He(s, e),
    mf(s, { line: o, target: i, above: d, below: f, area: e, scale: a, axis: l, clip: m }),
    $e(s));
}
function mf(s, t) {
  let { line: e, target: i, above: n, below: r, area: o, scale: a, clip: l } = t,
  ...
  (r !== n &&
    (c === 'x'
      ? (wa(s, i, o.top),
        lr(s, { line: e, target: i, color: n, scale: a, property: c, clip: l }),
        s.restore(),
        s.save(),
        wa(s, i, o.bottom))
      : c === 'y' &&
        (ka(s, i, o.left),
        lr(s, { line: e, target: i, color: r, scale: a, property: c, clip: l }),
        s.restore(),
        s.save(),
        ka(s, i, o.right),
        (h = n))),
...
function ka(s, t, e) {
  ...
  for (let a of i) {
    let { start: l, end: c } = a,
      h = n[l],
      u = n[Qi(l, c, n)];
    (r ? (s.moveTo(h.x, h.y), (r = !1)) : (s.lineTo(e, h.y), s.lineTo(h.x, h.y)),
      (o = !!t.pathSegment(s, a, { move: o })),
...
function lr(s, t) {
  ...
  for (let { source: c, target: h, start: u, end: d } of l) {
    let { style: { backgroundColor: f = r } = {} } = c,
      g = i !== !0;
    (s.save(), (s.fillStyle = f), pf(s, o, a, g && wr(n, u, d)), s.beginPath());
...
var bf = {
    ...
    afterDatasetsUpdate(s, t, e) {
      ...
      for (o = 0; o < i; ++o)
        ((r = s.getDatasetMeta(o)),
          ...
          n.push(l));
      for (o = 0; o < i; ++o)
        ((l = n[o]), !(!l || l.fill === !1) && (l.fill = Qd(n, o, e.propagate)));
    },
    beforeDraw(s, t, e) {
      ...
      for (let o = n.length - 1; o >= 0; --o) {
        let a = n[o].$filler;
        a && (a.line.updateControlPoints(r, a.axis), i && a.fill && ar(s.ctx, a, r));
      }
    },
    ...
    beforeDatasetDraw(s, t, e) {
      let i = t.meta.$filler;
      !_a(i) || e.drawTime !== 'beforeDatasetDraw' || ar(s.ctx, i, s.chartArea);
    },
  ...
  Ki = class extends ft {
    ...
    fit() {
      ...
      ((e.font = n.string),
        this.isHorizontal()
          ...
          : ((h = this.maxHeight), (c = this._fitCols(o, n, a, l) + 10)),
    ...
    _fitCols(t, e, i, n) {
      ...
      return (
        this.legendItems.forEach((p, b) => {
          ...
          (b > 0 &&
            f + _ + 2 * a > h &&
            ((u += d + a), c.push({ width: d, height: f }), (g += d + a), m++, (d = f = 0)),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (let c of e)
          (a !== c.row &&
            ((a = c.row), (l = et(i, this.left + n, this.right - this.lineWidths[a]))),
            (c.top += this.top + t + n),
            (c.left = o.leftForLtr(o.x(l), c.width)),
            (l += c.width + n));
      } else {
        let a = 0,
          l = et(i, this.top + t + n, this.bottom - this.columnSizes[a].height);
        for (let c of e)
          (c.col !== a &&
            ((a = c.col), (l = et(i, this.top + t + n, this.bottom - this.columnSizes[a].height))),
            (c.top = l),
            (c.left += this.left + n),
    ...
    _draw() {
      ...
      (_
        ? (f = { x: et(r, this.left + h, this.right - i[0]), y: this.top + h + w, line: 0 })
        : (f = {
            x: this.left + h,
      ...
      (this.legendItems.forEach((k, v) => {
        ...
        (l.setWidth(this.width),
          _
            ? v > 0 &&
              A + D + h > this.right &&
              ((L = f.y += x), f.line++, (A = f.x = et(r, this.left + h, this.right - i[f.line])))
            : v > 0 &&
              L + x > this.bottom &&
              ((A = f.x = A + e[f.line].width + h),
              f.line++,
              (L = f.y = et(r, this.top + w + h, this.bottom - e[f.line].height))));
        let J = l.x(A);
        if ((b(J, L, k), (A = Vn(O, A + g + d, _ ? A + D : this.right, t.rtl)), y(l.x(A), L, k), _))
          f.x += D + h;
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        let g = this.columnSizes.reduce((m, p) => Math.max(m, p.height), 0);
        h =
          c +
          et(t.align, this.top, this.bottom - g - t.labels.padding - this._computeTitleHeight());
      }
      let f = et(a, u, u + d);
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Dt(t, this.left, this.right) && Dt(e, this.top, this.bottom)) {
        for (r = this.legendHitBoxes, i = 0; i < r.length; ++i)
          if (((n = r[i]), Dt(t, n.left, n.left + n.width) && Dt(e, n.top, n.top + n.height)))
...
function _f(s, t, e, i) {
  let n = s.text;
  return (
    n && typeof n != 'string' && (n = n.reduce((r, o) => (r.length > o.length ? r : o))),
...
var vf = {
    ...
    defaults: {
      ...
      title: { color: (s) => s.chart.options.color, display: !1, position: 'center', text: '' },
    },
    descriptors: {
      _scriptable: (s) => !s.startsWith('on'),
...
var $s = class extends ft {
  ...
  getContext() {
    return this.$context || (this.$context = Ef(this.chart.getContext(), this, this._tooltipItems));
  }
  getTitle(t, e) {
    let { callbacks: i } = e,
    ...
    for (
      ...
      for (
        b = n[w],
          ...
          N(b.before, m),
          _ = b.lines,
          a && _.length && (this._drawColorBox(e, t, w, g, i), (d = Math.max(u.lineHeight, l))),
          x = 0,
          v = _.length;
        x < v;
        ++x
  ...
  drawBackground(t, e, i, n) {
    let { xAlign: r, yAlign: o } = this,
      { x: a, y: l } = t,
      { width: c, height: h } = i,
      { topLeft: u, topRight: d, bottomLeft: f, bottomRight: g } = jt(n.cornerRadius);
    ((e.fillStyle = n.backgroundColor),
      (e.strokeStyle = n.borderColor),
      (e.lineWidth = n.borderWidth),
      e.beginPath(),
  ...
  _updateAnimationTarget(t) {
    let e = this.chart,
      ...
      r = i && i.y;
    if (n || r) {
      let o = zs[t.position].call(this, this._active, this._eventPosition);
      if (!o) return;
...
var Lf = {
    ...
    afterDraw(s) {
      ...
      if (t && t._willRender()) {
        let e = { tooltip: t };
        if (s.notifyPlugins('beforeTooltipDraw', { ...e, cancelable: !0 }) === !1) return;
...
var Vs = class extends Ce {
  ...
  parse(t, e) {
    ...
    let i = this.getLabels();
    return (
      (e = isFinite(e) && i[e] === t ? e : Nf(i, t, P(e, t), this._addedLabels)),
      zf(e, i.length - 1)
    );
  }
  determineDataLimits() {
    ...
    (this.options.bounds === 'ticks' && (t || (i = 0), e || (n = this.getLabels().length - 1)),
      (this.min = i),
      (this.max = n));
  }
  buildTicks() {
...
function Vf(s, t) {
  ...
  ((O = Math.ceil(p / x) - Math.floor(m / x)),
    ...
    n === 'ticks' ? ((v = Math.floor(m / x) * x), (M = Math.ceil(p / x) * x)) : ((v = m), (M = p)),
    b && y && r && En((a - o) / r, x / 1e3)
      ? ((O = Math.round(Math.min((a - o) / x, h))), (x = (a - o) / O), (v = o), (M = a))
      : _
        ? ((v = b ? o : v), (M = y ? a : M), (O = c - 1), (x = (M - v) / O))
        : ((O = (M - v) / x),
          ye(O, Math.round(O), x / 1e3) ? (O = Math.round(O)) : (O = Math.ceil(O))));
  let D = Math.max(pi(x), pi(v));
  ((k = Math.pow(10, I(l) ? D : l)), (v = Math.round(v * k) / k), (M = Math.round(M * k) / k));
  let A = 0;
  for (
    b &&
    (d && v !== o
...
(S(Ws, 'id', 'linear'), S(Ws, 'defaults', { ticks: { callback: Ms.formatters.numeric } }));
...
var Bs = class extends Ce {
  ...
  determineDataLimits() {
    ...
    ((this.min = Y(t) ? Math.max(0, t) : null),
      ...
      this._zero &&
        ...
        !Y(this._userMin) &&
        (this.min = t === Se(this.min, 0) ? Se(this.min, -1) : Se(this.min, 0)),
  ...
  getLabelForValue(t) {
    return t === void 0 ? '0' : _e(t, this.chart.options.locale, this.options.ticks.format);
  }
  configure() {
    let t = this.min;
...
(S(Bs, 'id', 'logarithmic'),
  S(Bs, 'defaults', { ticks: { callback: Ms.formatters.logarithmic, major: { enabled: !0 } } }));
function kr(s) {
  let t = s.ticks;
...
function Hf(s, t, e) {
  return ((e = B(e) ? e : [e]), { w: Wn(s, t.string, e), h: e.length * t.lineHeight });
}
...
function Zf(s, t, e) {
  ...
  for (let h = 0; h < n; h++) {
    ...
    let u = Uf(s, h, l);
    (i.push(u), a === 'auto' && ((u.visible = Yf(u, c)), u.visible && (c = u)));
  }
  return i;
}
function qf(s) {
...
function Jf(s, t, e) {
  ...
  if (!I(a)) {
    ...
    Object.values(l).some((g) => g !== 0)
      ? (s.beginPath(), we(s, { x: h, y: u, w: d, h: f, radius: l }), s.fill())
      : s.fillRect(h, u, d, f);
  }
}
function Kf(s, t) {
...
var Te = class extends Qe {
  ...
  fit() {
    let t = this.options;
    t.display && t.pointLabels.display ? $f(this) : this.setCenterPoint(0, 0, 0, 0);
  }
  ...
  drawBackground() {
    ...
    if (t) {
      ...
      (i.save(),
        i.beginPath(),
        rl(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
        i.closePath(),
        (i.fillStyle = t),
        i.fill(),
        i.restore());
...
function Ra(s, t) {
  ...
  return (
    ...
    o === null
      ? null
      : (n &&
          (o = n === 'week' && (se(r) || r === !0) ? e.startOf(o, 'isoWeek', r) : e.startOf(o, n)),
        +o)
  );
}
function Na(s, t, e, i) {
...
function sg(s) {
  for (let t = ct.indexOf(s) + 1, e = ct.length; t < e; ++t) if (tn[ct[t]].common) return ct[t];
}
function za(s, t, e) {
  if (!e) s[t] = !0;
  else if (e.length) {
...
var De = class extends Ce {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (i.autoSkip
          ? Na(e.minUnit, this.min, this.max, this._getLabelCapacity(r))
          : eg(this, a.length, e.minUnit, this.min, this.max))),
      (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : sg(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
  ...
  _getLabelCapacity(t) {
    let e = this.options.time,
      ...
      r = this._tickFormatFunction(t, 0, Va(this, [t], this._majorUnit), n),
...
function ji(s, t, e) {
  let i = 0,
    ...
    l;
  e
    ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = Mt(s, 'pos', t)),
      ({ pos: r, time: a } = s[i]),
      ({ pos: o, time: l } = s[n]))
    : (t >= s[i].time && t <= s[n].time && ({ lo: i, hi: n } = Mt(s, 'time', t)),
      ({ time: r, pos: a } = s[i]),
      ({ time: o, pos: l } = s[n]));
  let c = o - r;
...
var Xt = class extends Error {},
  ...
  Ql = { year: T, month: pt, day: T, hour: T, minute: T, second: T, timeZoneName: At },
  tc = { year: T, month: pt, day: T, weekday: pt, hour: T, minute: T, timeZoneName: pt },
  ec = { year: T, month: pt, day: T, weekday: pt, hour: T, minute: T, second: T, timeZoneName: pt },
  Le = class {
    get type() {
      throw new Vt();
    }
...
function zr(s, t = {}) {
  let e = JSON.stringify([s, t]),
    i = Nr.get(e);
  return (i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), Nr.set(e, i)), i);
}
var Vr = new Map();
function dg(s, t = {}) {
  let e = JSON.stringify([s, t]),
    i = Vr.get(e);
  return (i === void 0 && ((i = new Intl.NumberFormat(s, t)), Vr.set(e, i)), i);
}
var Wr = new Map();
function fg(s, t = {}) {
  let { base: e, ...i } = t,
    ...
    r = Wr.get(n);
  return (r === void 0 && ((r = new Intl.RelativeTimeFormat(s, t)), Wr.set(n, r)), r);
}
var Gs = null;
function gg() {
...
function sc(s) {
  let t = Br.get(s);
  return (t === void 0 && ((t = new Intl.DateTimeFormat(s).resolvedOptions()), Br.set(s, t)), t);
}
var Hr = new Map();
function mg(s) {
  let t = Hr.get(s);
...
function bg(s, t, e) {
  return (
    (e || t) && (s.includes('-u-') || (s += '-u'), e && (s += `-ca-${e}`), t && (s += `-nu-${t}`)),
    s
  );
}
function yg(s) {
...
var $r = class {
    constructor(t, e, i) {
      ...
      if (!e || Object.keys(o).length > 0) {
        ...
        (i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = dg(t, a)));
      }
    }
    format(t) {
      if (this.inf) {
  ...
  Ur = class {
    constructor(t, e, i) {
      ((this.opts = { style: 'long', ...i }), !e && hc() && (this.rtf = fg(t, i)));
    }
    format(t, e) {
      return this.rtf
        ? this.rtf.format(t, e)
  ...
  $ = class s {
    static fromOpts(t) {
      return s.create(t.locale, t.numberingSystem, t.outputCalendar, t.weekSettings, t.defaultToEN);
    }
    ...
    static resetCache() {
      ((Gs = null), Nr.clear(), Vr.clear(), Wr.clear(), Br.clear(), Hr.clear());
    }
    static fromObject({ locale: t, numberingSystem: e, outputCalendar: i, weekSettings: n } = {}) {
    ...
    get fastNumbers() {
      return (
        this.fastNumbersCached == null && (this.fastNumbersCached = _g(this)),
    ...
    months(t, e = !1) {
      return en(this, t, mc, () => {
        ...
        if (!this.monthsCache[r][t]) {
          let o = i ? (a) => this.dtFormatter(a, n).format() : (a) => this.extract(a, n, 'month');
    ...
    weekdays(t, e = !1) {
      return en(this, t, yc, () => {
        let i = e ? { weekday: t, year: 'numeric', month: 'long', day: 'numeric' } : { weekday: t },
          n = e ? 'format' : 'standalone';
        return (
          this.weekdaysCache[n][t] ||
            (this.weekdaysCache[n][t] = xg((r) => this.extract(r, i, 'weekday'))),
          this.weekdaysCache[n][t]
        );
      });
    }
      ...
      return en(
        ...
        () => {
          if (!this.meridiemCache) {
            ...
            this.meridiemCache = [R.utc(2016, 11, 13, 9), R.utc(2016, 11, 13, 19)].map((e) =>
    ...
    eras(t) {
      return en(this, t, _c, () => {
        ...
        return (
          this.eraCache[t] ||
            (this.eraCache[t] = [R.utc(-40, 1, 1), R.utc(2017, 1, 1)].map((i) =>
    ...
    getWeekSettings() {
      return this.weekSettings ? this.weekSettings : uc() ? mg(this.locale) : ic;
    }
    getStartOfWeek() {
  ...
  vt = class s extends Le {
    ...
    get ianaName() {
      return this.fixed === 0 ? 'Etc/UTC' : `Etc/GMT${Ks(-this.fixed, 'narrow')}`;
    }
    offsetName() {
      return this.name;
    }
...
function dn(s, t = 4, e = 1) {
  let { year: i, month: n, day: r } = s,
    ...
    c;
  return (
    l < 1 ? ((c = i - 1), (l = Qs(c, t, e))) : l > Qs(i, t, e) ? ((c = i + 1), (l = 1)) : (c = i),
...
function bl(s, t = 4, e = 1) {
  let { weekYear: i, weekNumber: n, weekday: r } = s,
    ...
    l = n * 7 + r - o - 7 + t,
    c;
  l < 1 ? ((c = i - 1), (l += ns(c))) : l > a ? ((c = i + 1), (l -= ns(i))) : (c = i);
...
function xl(s, t) {
  if (!C(s.localWeekday) || !C(s.localWeekNumber) || !C(s.localWeekYear)) {
    if (!C(s.weekday) || !C(s.weekNumber) || !C(s.weekYear))
      throw new le('Cannot mix locale-based week fields with ISO-based week fields');
    return (
...
function lc(s) {
  ...
  return t ? (e ? (i ? !1 : wt('day', s.day)) : wt('month', s.month)) : wt('year', s.year);
}
function cc(s) {
...
function fn(s, t) {
  let e = Pg(t - 1, 12) + 1,
    i = s + (t - e) / 12;
  return e === 2 ? (ti(i) ? 29 : 28) : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e - 1];
}
function bn(s) {
...
var pc = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
  ...
  gt = class s {
    ...
    static parseFormat(t) {
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        a === "'"
          ? ((i.length > 0 || n) &&
              r.push({ literal: n || /^\s+$/.test(i), val: i === '' ? "'" : i }),
            (e = null),
            (i = ''),
            (n = !n))
          : n || a === e
            ? (i += a)
            : (i.length > 0 && r.push({ literal: /^\s+$/.test(i), val: i }), (i = a), (e = a));
      }
        ...
        o = (f) =>
          t.isOffsetFixed && t.offset === 0 && f.allowZ
            ...
            : t.isValid
              ...
              : '',
        a = () => (i ? Ng(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
        l = (f, g) => (i ? Vg(t, f) : r(g ? { month: f } : { month: f, day: 'numeric' }, 'month')),
        c = (f, g) =>
          i
            ? zg(t, f)
            : r(g ? { weekday: f } : { weekday: f, month: 'long', day: 'numeric' }, 'weekday'),
        h = (f) => {
    ...
    formatDurationFromString(t, e) {
      let i = this.opts.signMode === 'negativeLargestOnly' ? -1 : 1,
        ...
        r = (h, u) => (d) => {
          let f = n(d);
          if (f) {
            let g = u.isNegativeDuration && f !== u.largestUnit ? i : 1,
              m;
            return (
              this.opts.signMode === 'negativeLargestOnly' && f !== u.largestUnit
                ? (m = 'never')
        ...
        o = s.parseFormat(e),
        a = o.reduce((h, { literal: u, val: d }) => (u ? h : h.concat(d)), []),
        l = t.shiftTo(...a.map(n).filter((h) => h)),
        c = { isNegativeDuration: l < 0, largestUnit: Object.keys(l.values)[0] };
      return kl(o, r(l, c));
    }
  },
  wc = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
function ls(...s) {
...
var nt = class s {
    ...
    static fromISO(t, e) {
      ...
      return i
        ? s.fromObject(i, e)
        : s.invalid('unparsable', `the input "${t}" can't be parsed as ISO 8601`);
    }
    ...
    toFormat(t, e = {}) {
      ...
      return this.isValid ? gt.create(this.loc, i).formatDurationFromString(this, t) : Sl;
    }
    toHuman(t = {}) {
      ...
      let e = t.showZeros !== !1,
        i = Ee.map((n) => {
          ...
          return C(r) || (r === 0 && !e)
            ? null
            : this.loc
                .numberFormatter({ style: 'unit', unitDisplay: 'long', ...t, unit: n.slice(0, -1) })
                .format(r);
        }).filter((n) => n);
      return this.loc
    ...
    plus(t) {
      ...
      let e = s.fromDurationLike(t),
        i = {};
      for (let n of Ee) (as(e.values, n) || as(this.values, n)) && (i[n] = e.get(n) + this.get(n));
    ...
    mapUnits(t) {
      if (!this.isValid) return this;
      let e = {};
      for (let i of Object.keys(this.values)) e[i] = fc(t(this.values[i], i));
...
var os = class s {
    ...
    static fromISO(t, e) {
      ...
      return s.invalid('unparsable', `the input "${t}" can't be parsed as ISO 8601`);
    }
    static isInterval(t) {
    ...
    splitBy(t) {
      ...
      for (; i < this.e;) {
        ...
        ((r = +a > +this.e ? this.e : a), o.push(s.fromDateTimes(i, r)), (i = r), (n += 1));
      }
      return o;
    }
    divideEqually(t) {
    ...
    static merge(t) {
      let [e, i] = t
        ...
        .reduce(
          ([n, r], o) =>
            r ? (r.overlaps(o) || r.abutsStart(o) ? [n, r.union(o)] : [n.concat([r]), o]) : [n, o],
          [[], null],
        );
      return (i && e.push(i), e);
    }
    static xor(t) {
      ...
      for (let l of a)
        ((i += l.type === 's' ? 1 : -1),
          i === 1
            ? (e = l.time)
            : (e && +e != +l.time && n.push(s.fromDateTimes(e, l.time)), (e = null)));
      return s.merge(n);
    }
    difference(...t) {
      return s
    ...
    toString() {
      return this.isValid ? `[${this.s.toISO()} \u2013 ${this.e.toISO()})` : es;
    }
    [Symbol.for('nodejs.util.inspect.custom')]() {
      return this.isValid
    ...
    toLocaleString(t = hn, e = {}) {
      return this.isValid ? gt.create(this.s.loc.clone(e), t).formatInterval(this) : es;
    }
    toISO(t) {
      return this.isValid ? `${this.s.toISO(t)}/${this.e.toISO(t)}` : es;
    }
    toISODate() {
      return this.isValid ? `${this.s.toISODate()}/${this.e.toISODate()}` : es;
    }
    toISOTime(t) {
      return this.isValid ? `${this.s.toISOTime(t)}/${this.e.toISOTime(t)}` : es;
    }
    toFormat(t, { separator: e = ' \u2013 ' } = {}) {
      return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : es;
    }
    toDuration(t, e) {
      return this.isValid ? this.e.diff(this.s, t, e) : nt.invalid(this.invalidReason);
    }
    mapEndpoints(t) {
...
function Pm(s, t, e) {
  ...
  for (let [l, c] of i)
    e.indexOf(l) >= 0 &&
      ...
      (n[l] = c(s, t)),
      (a = r.plus(n)),
      a > t ? (n[l]--, (s = r.plus(n)), s > t && ((a = s), n[l]--, (s = r.plus(n)))) : (s = a));
  return [s, n, a, o];
}
function Am(s, t, e, i) {
...
function Rm(s, t) {
  let e = Ct(t),
    ...
    u = Ct(t, '{2,4}'),
    d = Ct(t, '{4,6}'),
    f = (p) => ({ regex: RegExp(Fm(p.val)), deser: ([b]) => b, literal: !0 }),
    m = ((p) => {
...
var mn = class {
  ...
  explainFromTokens(t) {
    if (this.isValid) {
      ...
      if (as(i, 'a') && as(i, 'H'))
        throw new le("Can't include meridiem when specifying 24-hour format");
      return {
        input: t,
        tokens: this.tokens,
        regex: this.regex,
...
function jm(s, t, e) {
  let { result: i, zone: n, specificOffset: r, invalidReason: o } = Ic(s, t, e);
  return [i, n, r, o];
}
function Ec(s, t) {
  if (!s) return null;
...
function Ar(s) {
  return (
    s.localWeekData === null &&
      (s.localWeekData = dn(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())),
    s.localWeekData
  );
}
function Ie(s, t) {
...
function Al(s, t) {
  let e = s.o,
    ...
    r = {
      ...
      year: i,
      month: n,
      day: Math.min(s.c.day, fn(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7,
    },
    o = nt
      .fromObject({
...
function ss(s, t, e, i, n, r) {
  ...
  } else return R.invalid(new mt('unparsable', `the input "${n}" can't be parsed as ${i}`));
}
function rn(s, t, e = !0) {
  return s.isValid
    ? gt.create($.create('en-US'), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(s, t)
    : null;
}
function Ir(s, t, e) {
  let i = s.c.year > 9999 || s.c.year < 0,
    n = '';
  if ((i && s.c.year >= 0 && (n += '+'), (n += Q(s.c.year, i ? 6 : 4)), e === 'year')) return n;
  if (t) {
...
function Il(s, t, e, i, n, r, o) {
  ...
  switch (o) {
    ...
    default:
      ...
      if (o === 'second') break;
      a && (!i || s.c.millisecond !== 0) && ((l += '.'), (l += Q(s.c.millisecond, 3)));
  }
  return (
    n &&
...
var Fc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  Um = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Gm(s) {
  if ((Js === void 0 && (Js = Z.now()), s.type !== 'iana')) return s.offset(Js);
  let t = s.name,
    e = Xr.get(t);
  ...
  R = class s {
    constructor(t) {
      ...
      if (!i)
        if (t.old && t.old.ts === this.ts && t.old.zone.equals(e)) [n, r] = [t.old.c, t.old.o];
          ...
          ((n = nn(this.ts, a)),
            (i = Number.isNaN(n.year) ? new mt('invalid input') : null),
            (n = i ? null : n),
            (r = i ? null : a));
        }
      ((this._zone = e),
    ...
    static local() {
      let [t, e] = Rl(arguments),
        [i, n, r, o, a, l, c] = e;
      return Ll({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t);
    }
    static utc() {
      let [t, e] = Rl(arguments),
        [i, n, r, o, a, l, c] = e;
      return (
        ...
        Ll({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
      );
    }
    static fromJSDate(t, e = {}) {
      ...
      return n.isValid ? new s({ ts: i, zone: n, loc: $.fromObject(e) }) : s.invalid(Xs(n));
    }
    static fromMillis(t, e = {}) {
      if (ce(t))
        return t < -Pl || t > Pl
          ? s.invalid('Timestamp out of range')
          : new s({ ts: t, zone: ae(e.zone, Z.defaultZone), loc: $.fromObject(e) });
      throw new it(
    ...
    static fromSeconds(t, e = {}) {
      if (ce(t))
        return new s({ ts: t * 1e3, zone: ae(e.zone, Z.defaultZone), loc: $.fromObject(e) });
    ...
    static fromObject(t, e = {}) {
      ...
      if ((f || h) && g)
        throw new le("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
    ...
    static fromFormat(t, e, i = {}) {
      if (C(t) || C(e)) throw new it('fromFormat requires an input string and a format');
      let { locale: n = null, numberingSystem: r = null } = i,
        o = $.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 }),
        [a, l, c, h] = jm(o, t, e);
    ...
    get weeksInLocalWeekYear() {
      return this.isValid
        ? Qs(this.localWeekYear, this.loc.getMinDaysInFirstWeek(), this.loc.getStartOfWeek())
        : NaN;
    }
    ...
    toLocaleString(t = hn, e = {}) {
      return this.isValid ? gt.create(this.loc.clone(e), t).formatDateTime(this) : Cr;
    }
    toLocaleParts(t = {}) {
    ...
    toISO({
      ...
      let a = t === 'extended',
        l = Ir(this, a, o);
      return (an.indexOf(o) >= 3 && (l += 'T'), (l += Il(this, a, e, i, n, r, o)), l);
    }
    ...
    toISOTime({
      ...
      return this.isValid
        ? ((a = ln(a)),
          (n && an.indexOf(a) >= 3 ? 'T' : '') + Il(this, o === 'extended', e, t, i, r, a))
        : null;
    }
    toRFC2822() {
    ...
    toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: i = !0 } = {}) {
      let n = 'HH:mm:ss.SSS';
      return ((e || t) && (i && (n += ' '), e ? (n += 'z') : t && (n += 'ZZ')), rn(this, n, !0));
    }
    toSQL(t = {}) {
    ...
    diff(t, e = 'milliseconds', i = {}) {
      if (!this.isValid || !t.isValid) return nt.invalid('created by diffing an invalid DateTime');
    ...
    toRelative(t = {}) {
      ...
      return (
        ...
        Fl(e, this.plus(i), { ...t, numeric: 'always', units: n, unit: r })
      );
    }
    ...
    static min(...t) {
      if (!t.every(s.isDateTime)) throw new it('min requires all arguments be DateTimes');
      return _l(t, (e) => e.valueOf(), Math.min);
    }
    static max(...t) {
      if (!t.every(s.isDateTime)) throw new it('max requires all arguments be DateTimes');
    ...
    static buildFormatParser(t, e = {}) {
      let { locale: i = null, numberingSystem: n = null } = e,
        r = $.fromOpts({ locale: i, numberingSystem: n, defaultToEN: !0 });
      return new mn(r, t);
    }
    static fromFormatParser(t, e, i = {}) {
      if (C(t) || C(e))
        throw new it('fromFormatParser requires an input string and a format parser');
      let { locale: n = null, numberingSystem: r = null } = i,
        o = $.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 });
    ...
    return s === null || i === 'undefined'
      ...
      : (i === 'number'
          ...
          : i === 'string'
            ...
            : s instanceof Date
              ? (s = R.fromJSDate(s, e))
              : i === 'object' && !(s instanceof R) && (s = R.fromObject(s, e)),
...
function Jm({ cachedData: s, options: t, type: e }) {
  return {
    ...
    init() {
      (this.$wire.$on('updateChartData', ({ data: i }) => this.updateChartData(i)),
        Alpine.effect(() => {
          (Alpine.store('theme'), this.$nextTick(() => this.updateChartTheme()));
        }),
        (this.systemThemeMediaQuery = window.matchMedia('(prefers-color-scheme: dark)')),
        (this.systemThemeListener = () => {
          Alpine.store('theme') === 'system' && this.$nextTick(() => this.updateChartTheme());
        }),
    ...
    initChart() {
      var r, o, a, l, c, h, u, d, f, g, m, p, b, y, _, w, x, k, v, M, O, D;
      if (
        !this.$refs.canvas ||
      ...
      (t ?? (t = {}),
        ...
        ['doughnut', 'pie', 'polarArea'].includes(e) &&
          ...
          (k = t.plugins.legend.labels).generateLabels ??
            (k.generateLabels = (A) => {
              let L = Pe.overrides[e].plugins.legend.labels.generateLabels(A);
              for (let J of L) J.strokeStyle = _n(J.fillStyle, 0.2);
              return L;
            })),
        e === 'polarArea' &&
          ((v = t.scales).r ?? (v.r = {}),
          ...
          (D = t.scales.r.ticks).backdropColor ?? (D.backdropColor = 'transparent')),
    ...
    normalizeDatasets(i) {
      for (let n of i?.datasets ?? [])
        (e === 'bar' &&
          ...
          (n.borderColor ?? (n.borderColor = _n(n.backgroundColor, 0.2)),
          n.hoverBorderColor ?? (n.hoverBorderColor = _n(n.backgroundColor, 0.3))),
          e === 'scatter' &&
            n.backgroundColor !== void 0 &&
            (n.borderColor ?? (n.borderColor = n.backgroundColor)),
          ['line', 'scatter'].includes(e) &&
            n.borderColor !== void 0 &&
            (n.pointBackgroundColor ?? (n.pointBackgroundColor = n.borderColor)));
    },
    updateChartTheme() {
      let i = this.getChart();
    ...
    applyChartColors(i) {
      ...
      ((i.backgroundColor = this.userBackgroundColor ?? n),
        ...
        ['doughnut', 'pie', 'polarArea'].includes(e) &&
          ...
          (i.elements.arc.borderColor = this.getSurroundingBackgroundColor())),
    ...
    handleDprChange() {
      let i = this.getChart();
      i && i.currentDevicePixelRatio !== window.devicePixelRatio && i.resize();
    },
    getChart() {
    ...
    getSurroundingBackgroundColor() {
      ...
      for (; i;) {
        ...
        if (n && n !== 'rgba(0, 0, 0, 0)' && n !== 'transparent') return n;
        i = i.parentElement;
      }
      return '#ffffff';
    },
