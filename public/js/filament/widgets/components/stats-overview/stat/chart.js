...
var Zo = (i, t, e) =>
  t in i ? Jo(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (i[t] = e);
...
function da(i) {
  ...
  let n = Hs(+t[2]),
    ...
    a = +t[4] / 100;
  return (
    t[1] === 'hwb' ? (s = ca(n, o, a)) : t[1] === 'hsv' ? (s = ha(n, o, a)) : (s = Ri(n, o, a)),
    { r: s[0], g: s[1], b: s[2], a: e }
  );
}
function ua(i, t) {
  var e = Ti(i);
  ((e[0] = Hs(e[0] + t)), (e = Ri(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]));
}
function fa(i) {
  if (!i) return;
  let t = Ti(i),
...
function ga() {
  ...
  for (s = 0; s < t.length; s++) {
    for (a = r = t[s], n = 0; n < e.length; n++) ((o = e[n]), (r = r.replace(o, Bs[o])));
    ((o = parseInt(Vs[a], 16)), (i[r] = [(o >> 16) & 255, (o >> 8) & 255, o & 255]));
  }
  return i;
}
var Xe;
...
function xa(i) {
  return (
    i && (i.a < 255 ? `rgba(${i.r}, ${i.g}, ${i.b}, ${mt(i.a)})` : `rgb(${i.r}, ${i.g}, ${i.b})`)
  );
}
var Oi = (i) => (i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055),
...
function Ws(i) {
  ...
  return (
    Array.isArray(i)
      ? i.length >= 3 &&
        ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = St(i[3])))
...
var ye = class i {
  constructor(t) {
    ...
    let e = typeof t,
      s;
    (e === 'object' ? (s = Ws(t)) : e === 'string' && (s = ia(t) || pa(t) || ya(t)),
      (this._rgb = s),
      (this._valid = !!s));
  }
  get valid() {
...
var en = (i, t) => (typeof i == 'string' && i.endsWith('%') ? parseFloat(i) / 100 : +i / t),
  zi = (i, t) => (typeof i == 'string' && i.endsWith('%') ? (parseFloat(i) / 100) * t : +i);
function F(i, t, e) {
...
function E(i, t, e, s) {
  ...
  else if (T(i)) for (a = Object.keys(i), o = a.length, n = 0; n < o; n++) t.call(e, i[a[n]], a[n]);
}
function we(i, t) {
  let e, s, n, o;
...
function Ma(i, t, e) {
  ...
  let s = t[i],
    n = e[i];
  T(s) && T(n) ? te(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ze(n));
}
...
function Xi(i, t, e) {
  ...
  if (i._sorted) {
    let { iScale: a, vScale: r, _parsed: l } = i,
      ...
      h = a.axis,
      { min: d, max: u, minDefined: f, maxDefined: g } = a.getUserBounds();
    if (f) {
      if (((n = Math.min(ct(l, h, d).lo, e ? s : ct(t, h, a.getPixelForValue(d)).lo)), c)) {
        let p = l
          .slice(0, n + 1)
          .reverse()
...
var qe = (i) => i === 0 || i === 1,
  Us = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * B) / e)),
  ...
  Jt = {
    ...
    easeInOutBounce: (i) =>
      i < 0.5 ? Jt.easeInBounce(i * 2) * 0.5 : Jt.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
  };
function qi(i) {
...
function oe(i, t) {
  ...
  (i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * R, R, !0),
    ...
    i.arc(e + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, H, 0, !0),
...
var $a = (i, t) => (i ? i + ii(t) : t),
  es = (i, t) =>
    T(t) && i !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function _n(i, t, e) {
...
function is(i, t, e, s) {
  ...
  return l === null || (typeof o < 'u' && o !== e && ((l = qs(r, a, o, l, s)), l === null))
    ? !1
...
function Ja(i, t, e, s) {
  let n;
  for (let o of t)
    if (((n = vn($a(o, i), e)), typeof n < 'u')) return es(i, n) ? is(e, s, i, n) : n;
}
function vn(i, t) {
  for (let e of t) {
    if (!e) continue;
...
function ss(i, t, e, s) {
  let { iScale: n } = i,
    ...
    c,
    h;
  for (r = 0, l = s; r < l; ++r) ((c = r + e), (h = t[c]), (a[r] = { r: n.parse(_t(h, o), c) }));
  return a;
}
...
function nr(i, t) {
  ...
  for (e = 0, s = i.length; e < s; ++e)
    ((a = o),
      ...
      o &&
        ((n = i[e]),
        a && ((n.cp1x = Ge(n.cp1x, t.left, t.right)), (n.cp1y = Ge(n.cp1y, t.top, t.bottom))),
        r && ((n.cp2x = Ge(n.cp2x, t.left, t.right)), (n.cp2y = Ge(n.cp2y, t.top, t.bottom)))));
}
function kn(i, t, e, s, n) {
  ...
  if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
    ...
    for (o = 0, a = i.length; o < a; ++o)
      ((r = i[o]),
        (l = tr(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
    ...
    ((x = t[S % a]),
      !x.skip &&
        ...
        b !== v &&
          ...
          m !== null &&
            w() &&
            (g.push(Js({ start: m, end: S, loop: u, count: a, style: f })), (m = null)),
          (P = S),
          (v = b))));
  return (m !== null && g.push(Js({ start: m, end: d, loop: u, count: a, style: f })), g);
}
function cs(i, t) {
  let e = [],
    s = i.segments;
...
function gr(i, t, e, s) {
  ...
  for (l = t + 1; l <= e; ++l) {
    ...
    (c.skip || c.stop
      ? r.skip ||
        ((s = !1), o.push({ start: t % n, end: (l - 1) % n, loop: s }), (t = a = c.stop ? l : null))
      : ((a = l), r.skip && (t = l)),
      (r = c));
  }
...
var Ms = class {
    ...
    _notify(t, e, s, n) {
      let o = e.listeners[n],
        a = e.duration;
      o.forEach((r) =>
        r({ chart: t, initial: e.initial, numSteps: a, currentStep: Math.min(s - e.start, a) }),
      );
    }
    _refresh() {
      this._request ||
...
function Mr(i) {
  let t, e, s, n;
  return (
    T(i) ? ((t = i.top), (e = i.right), (s = i.bottom), (n = i.left)) : (t = e = s = n = i),
...
function kr(i, t) {
  let { iScale: e, vScale: s } = t,
    ...
    c,
    h;
  for (l = 0, c = a.length; l < c; ++l) ((h = a[l]), (r[l] = { [n]: h, [o]: i[h] }));
  return r;
}
function ds(i, t) {
...
var fs = (i) => i === 'reset' || i === 'none',
  ...
  Or = (i, t, e) => i && !t.hidden && t._stacked && { keys: Ao(e, !0), values: null },
  it = class {
    constructor(t, e) {
      ((this.chart = t),
        (this._ctx = t.ctx),
    ...
    _dataCheck() {
      ...
      if (T(e)) {
        ...
        (e && Object.isExtensible(e) && dn(e, this), (this._syncList = []), (this._data = e));
      }
    }
    addElements() {
      let t = this._cachedMeta;
    ...
    buildOrUpdateElements(t) {
      ...
      ((e._stacked = ds(e.vScale, e)),
        ...
        (n || o !== e._stacked) && (En(this, e._parsed), (e._stacked = ds(e.vScale, e))));
    }
    configure() {
    ...
    parseObjectData(t, e, s, n) {
      let { xScale: o, yScale: a } = t,
        ...
        f;
      for (h = 0, d = n; h < d; ++h)
        ((u = h + s), (f = e[u]), (c[h] = { x: o.parse(_t(f, r), u), y: a.parse(_t(f, l), u) }));
      return c;
    }
    getParsed(t) {
    ...
    applyStack(t, e, s) {
      let n = this.chart,
        o = this._cachedMeta,
        a = e[t.axis],
        r = { keys: Ao(n, !0), values: e._stacks[t.axis]._visualValues };
    ...
    _update(t) {
      ...
      (this.update(t || 'default'),
        (e._clip = Mr(D(this.options.clip, vr(e.xScale, e.yScale, this.getMaxOverflow())))));
    }
    update(t) {}
    draw() {
      let t = this._ctx,
    ...
    getContext(t, e, s) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        ((o = this.$context || (this.$context = Dr(this.chart.getContext(), this.index))),
          (o.dataset = n),
    ...
    _resolveElementOptions(t, e = 'default', s) {
      ...
      return (p.$shared && ((p.$shared = l), (o[a] = Object.freeze(In(p, l)))), p);
    }
    ...
    updateElement(t, e, s, n) {
      fs(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s);
    }
...
(M(it, 'defaults', {}), M(it, 'datasetElementType', null), M(it, 'dataElementType', null));
function Ar(i, t) {
  if (!i._cache.$bar) {
...
function Tr(i) {
  let t = i.iScale,
    ...
    r,
    l = () => {
      a === 32767 || a === -32768 || (ee(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
    };
...
function Lr(i, t, e, s) {
  let n = e.barThickness,
    ...
    a;
  return (
    A(n) ? ((o = t.min * e.categoryPercentage), (a = e.barPercentage)) : ((o = n * s), (a = 1)),
...
function Fn(i, t, e, s) {
  let n = i.iScale,
    ...
    u;
  for (c = e, h = e + s; c < h; ++c)
    ((u = t[c]), (d = {}), (d[n.axis] = r || n.parse(a[c], c)), l.push(To(u, d, o, c)));
  return l;
}
function gs(i) {
...
var le = class extends it {
  ...
  parseObjectData(t, e, s, n) {
    let { iScale: o, vScale: a } = t,
      ...
      p;
    for (u = s, f = s + n; u < f; ++u)
      ((p = e[u]), (g = {}), (g[o.axis] = o.parse(_t(p, c), u)), d.push(To(_t(p, h), g, a, u)));
    return d;
  }
  updateRangeFromParsed(t, e, s, n) {
  ...
  getLabelAndValue(t) {
    let e = this._cachedMeta,
      ...
      o = this.getParsed(t),
      a = o._custom,
      r = gs(a) ? '[' + a.start + ', ' + a.end + ']' : '' + n.getLabelForValue(o[n.axis]);
  ...
  updateElements(t, e, s, n) {
    ...
    for (let f = e; f < e + s; f++) {
      let g = this.getParsed(f),
        p = o || A(g[r.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
        m = this._calculateBarIndexPixels(f, h),
        b = (g._stacks || {})[r.axis],
        x = {
          horizontal: c,
          base: p.base,
          enableBorderRadius: !b || gs(g._custom) || a === b._top || a === b._bottom,
          x: c ? p.head : m.center,
          y: c ? m.center : p.head,
      ...
      (zr(x, v, b, a), Vr(x, v, h.ratio), this.updateElement(t[f], f, x, n));
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    if (
      (this.chart.getDataVisibility(t) ? (g = e.getPixelForValue(u + f)) : (g = b),
      (p = g - b),
      Math.abs(p) < a)
    ) {
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      let h = o ? this._getStackCount(t) : e.stackCount,
        d = n.barThickness === 'flex' ? Rr(t, e, n, h * c) : Lr(t, e, n, h * c),
        u =
...
(M(ce, 'id', 'bubble'),
  ...
  M(ce, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }));
function Wr(i, t, e) {
  let s = 1,
    n = 1,
    o = 0,
  ...
  if (t < B) {
    let r = i,
      ...
      d = Math.cos(l),
      u = Math.sin(l),
      f = (v, y, _) => (se(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e)),
      g = (v, y, _) => (se(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e)),
      p = f(0, c, d),
      m = f(H, h, u),
      b = g(R, c, d),
      x = g(R + H, h, u);
        ...
        labels: {
          generateLabels(t) {
            ...
            return e.labels.length && e.datasets.length
              ? e.labels.map((l, c) => {
                  let d = t.getDatasetMeta(0).controller.getStyle(c);
                  return {
                    text: l,
  ...
  updateElements(t, e, s, n) {
    ...
    for (let _ = 0; _ < v; ++_) {
      ...
      let S = this.getParsed(_),
        ...
        O = (w[f] =
          o || P ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, S, l) : S[f], _));
      ((w.skip = isNaN(C) || isNaN(O) || P),
        (w.stop = _ > 0 && Math.abs(S[u] - y[u]) > m),
        p && ((w.parsed = S), (w.raw = c.data[_])),
        d && (w.options = h || this.resolveDataElementOptions(_, k.active ? 'active' : n)),
...
(M(he, 'id', 'line'),
  ...
  M(he, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
...
(M(Re, 'id', 'pie'),
  M(Re, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
...
(M(de, 'id', 'radar'),
  ...
  M(de, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
  ...
  updateElements(t, e, s, n) {
    ...
    for (let y = e; y < e + s; ++y) {
      let _ = t[y],
        ...
        C = (w[g] =
          o || S ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, k, l) : k[g], y));
...
(M(ue, 'id', 'scatter'),
  M(ue, 'defaults', { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
  M(ue, 'overrides', {
...
function ms(i, t, e, s, n, o) {
  return !o && !i.isPointInArea(t) ? [] : e === 'r' && !s ? Yr(i, t, e, n) : Ur(i, t, e, s, n, o);
}
function Vn(i, t, e, s, n) {
  ...
  return (
    $e(i, e, t, (l, c, h) => {
      l[a] &&
        l[a](t[e], n) &&
        (o.push({ element: l, datasetIndex: c, index: h }), (r = r || l.inRange(t.x, t.y, n)));
    }),
    s && !r ? [] : o
  );
}
...
function Ee(i, t, e, s) {
  ...
  for (o = 0, a = i.length, c = 0; o < a; ++o) {
    ((r = i[o]), (l = r.box), l.update(r.width || t.w, r.height || t.h, tl(r.horizontal, t)));
...
function al(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (let r of o) ((a = a || ki(r.addedNodes, s)), (a = a && !ki(r.removedNodes, s)));
      a && e();
    });
...
function rl(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (let r of o) ((a = a || ki(r.removedNodes, s)), (a = a && !ki(r.addedNodes, s)));
      a && e();
    });
  return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
var Ps = class extends Mi {
  ...
  removeEventListener(t, e) {
    let s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    ((({ attach: bs, detach: bs, resize: bs })[e] || nl)(t, e, n), (s[e] = void 0));
  }
  getDevicePixelRatio() {
...
function ul(i) {
  return !hi() || (typeof OffscreenCanvas < 'u' && i instanceof OffscreenCanvas) ? Ss : Ps;
}
var st = class {
  constructor() {
    M(this, 'x');
...
function Sl(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    ...
    } else e === 'center' ? (f = (c.left + c.right) / 2 - m + t) : (f = Yn(i, e, t));
...
var Xt = class i extends st {
    ...
    getUserBounds() {
      ...
      return (
        ...
        { min: Z(t, s), max: Z(e, n), minDefined: N(t), maxDefined: N(e) }
      );
    }
    getMinMax(t) {
    ...
    update(t, e, s) {
      ...
      (this._convertTicksToLabels(l ? Xn(this.ticks, r) : this.ticks),
        ...
        a.display &&
          ...
          ((this.ticks = fl(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    calculateLabelRotation() {
      ...
      ((r = t.offset ? this.maxWidth / s : f / (s - 1)),
        d + 6 > r &&
          ...
          (l = this.maxHeight - Te(t.grid) - e.padding - Kn(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (a = si(
            Math.min(
    ...
    _convertTicksToLabels(t) {
      ...
      let e, s;
      for (e = 0, s = t.length; e < s; e++) A(t[e].label) && (t.splice(e, 1), s--, e--);
    ...
    _computeLabelSizes(t, e, s) {
      ...
      for (d = 0; d < e; d += l) {
        if (
          ...
          for (u = 0, f = g.length; u < f; ++u)
            ((_ = g[u]), !A(_) && !z(_) && ((v = ke(n, b.data, b.gc, v, _)), (y += x)));
      ...
      return { first: S(0), last: S(e - 1), widest: S(k), highest: S(w), widths: a, heights: r };
    }
    getLabelForValue(t) {
      return t;
    }
    ...
    _computeLabelItems(t) {
      let e = this.axis,
        ...
        L,
        U = 'middle';
      if (n === 'top') ((k = this.bottom - g), (w = this._getXAxisLabelAlignment()));
      else if (n === 'bottom') ((k = this.top + g), (w = this._getXAxisLabelAlignment()));
      else if (n === 'left') {
      ...
      for (b = 0, x = r.length; b < x; ++b) {
        ...
        a
          ? ((_ = S),
            ...
            d && (L *= -1),
            p !== 0 && !I.showLabelBackdrop && (_ += (C / 2) * Math.sin(p)))
          : ((k = S), (L = ((1 - O) * C) / 2));
        let Ye;
    ...
    drawTitle() {
      ...
      e === 'bottom' || e === 'center' || T(e)
        ? ((l += a.bottom), z(s.text) && (l += o.lineHeight * (s.text.length - 1)))
        : (l += a.top);
      let { titleX: c, titleY: h, maxWidth: d, rotation: u } = Sl(this, l, e, r);
      At(t, s.text, 0, 0, o, {
        color: s.color,
        maxWidth: d,
        rotation: u,
  ...
  pe = class {
    ...
    register(t) {
      ...
      return (
        o in n || ((n[o] = t), Pl(t, a, s), this.override && V.override(t.id, t.overrides)),
        a
      );
    }
    get(t) {
    ...
    unregister(t) {
      let e = this.items,
        s = t.id,
        n = this.scope;
      (s in e && delete e[s], n && s in V[n] && (delete V[n][s], this.override && delete Ct[s]));
    }
  };
function Pl(i, t, e) {
...
function As(i, ...t) {
  if (qn(i)) return i;
  for (let e of t) {
    let s = e.axis || Il(e.position) || (i.length > 1 && qn(i[0].toLowerCase()));
    if (s) return s;
  }
  throw new Error(
...
function zl(i, t) {
  ...
  return (
    Object.keys(s).forEach((a) => {
      let r = s[a];
      if (!T(r)) return console.error(`Invalid scale configuration for scale: ${a}`);
    ...
    i.data.datasets.forEach((a) => {
      ...
      Object.keys(h).forEach((d) => {
        let u = Rl(d, l),
          f = a[u + 'AxisID'] || u;
        ((o[f] = o[f] || Object.create(null)), te(o[f], [{ axis: u }, s[f], h[d]]));
      });
    }),
...
var Le = (i, t, e) => {
  ...
  Ts = class {
    constructor(t) {
      ((this._config = Bl(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map()));
    }
    get platform() {
    ...
    pluginScopeKeys(t) {
      let e = t.id,
        s = this.type;
      return pi(`${s}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
    }
    _cachedScopes(t, e) {
    ...
    getOptionScopes(t, e, s) {
      ...
      let c = Array.from(l);
      return (c.length === 0 && c.push(Object.create(null)), Bo.has(e) && a.set(e, c), c);
    }
    chartOptionScopes() {
...
function Vo(i) {
  return (
    hi() && typeof i == 'string' ? (i = document.getElementById(i)) : i && i.length && (i = i[0]),
...
var at = class {
  ...
  _initialize() {
    return (
      ...
      this.options.responsive ? this.resize() : ns(this, this.options.devicePixelRatio),
      this.bindEvents(),
    ...
    (e &&
      ...
      E(o, (a) => {
        let r = a.options,
          ...
          c = As(l, r),
          h = D(r.type, a.dtype);
        ((r.position === void 0 || Qn(r.position, c) !== Qn(a.dposition)) &&
...
function Ul(i, t, e) {
  let { startAngle: s, x: n, y: o, outerRadius: a, innerRadius: r, options: l } = t,
...
function Xl(i, t, e) {
  ...
  (i.beginPath(),
    i.arc(o, a, r, s - c, e + c),
    l > n ? ((c = n / l), i.arc(o, a, l, e + c, s - c, !0)) : i.arc(o, a, n, e + H, s - H),
    i.closePath(),
    i.clip());
}
function Kl(i) {
...
function wi(i, t, e, s, n, o) {
  ...
  let p = Math.max(0.001, g * d - e / R) / d,
    ...
    b = l + m + f,
    x = n - m - f,
    { outerStart: v, outerEnd: y, innerStart: _, innerEnd: k } = ql(t, u, d, x - b),
    w = d - v,
    S = d - y,
    P = b + v / w,
    C = x - y / S,
  ...
  if ((i.beginPath(), o)) {
    ...
    let j = (x - k / u + (b + _ / u)) / 2;
    if ((i.arc(a, r, u, x - k / u, j, !0), i.arc(a, r, u, j, b + _ / u, !0), _ > 0)) {
      let G = re(O, U, a, r);
...
function Jl(i, t, e, s, n) {
  let { fullCircles: o, startAngle: a, circumference: r, options: l } = t,
    { borderWidth: c, borderJoinStyle: h, borderDash: d, borderDashOffset: u, borderRadius: f } = l,
...
(M(jt, 'id', 'arc'),
  ...
  M(jt, 'descriptors', { _scriptable: !0, _indexable: (e) => e !== 'borderDash' }));
function Wo(i, t, e = t) {
...
function Ql(i) {
  return i.stepped ? mn : i.tension || i.cubicInterpolationMode === 'monotone' ? bn : Zl;
}
function No(i, t, e = {}) {
  let s = i.length,
...
function ic(i) {
  return i.stepped ? Pn : i.tension || i.cubicInterpolationMode === 'monotone' ? Dn : Pt;
}
function sc(i, t, e, s) {
  let n = t._path;
...
var pt = class extends st {
  ...
  get segments() {
    return this._segments || (this._segments = On(this, this.options.segment));
  }
  first() {
    let t = this.segments,
      e = this.points;
  ...
  draw(t, e, s, n) {
    let o = this.options || {};
    ((this.points || []).length && o.borderWidth && (t.save(), ac(t, this, s, n), t.restore()),
...
(M(pt, 'id', 'line'),
  ...
  M(pt, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
  M(pt, 'descriptors', { _scriptable: !0, _indexable: (t) => t !== 'borderDash' && t !== 'fill' }));
function no(i, t, e, s) {
  let n = i.options,
    { [e]: o } = i.getProps([e], s);
...
(M(fe, 'id', 'point'),
  ...
  M(fe, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
function Ho(i, t) {
  let {
      x: e,
      y: s,
...
(M(ge, 'id', 'bar'),
  ...
  M(ge, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
...
function mc(i) {
  ...
  return (e, s) => {
    ...
    n instanceof kt ? (t = gc(e, t)) : n instanceof Yt ? (t = pc(e, t)) : n && (t = fc(e, t));
  };
}
function ao(i) {
  let t;
...
function yc(i, t, e, s, n) {
  ...
  for (a[l++] = i[h], d = 0; d < o - 2; d++) {
    ...
    let k = Math.floor(d * r) + 1 + t,
      ...
      { x: S, y: P } = i[h];
    for (f = g = -1, x = k; x < w; x++)
      ((g = 0.5 * Math.abs((S - m) * (i[x].y - P) - (S - i[x].x) * (b - P))),
        g > f && ((f = g), (u = i[x]), (p = x)));
    ((a[l++] = u), (h = p));
  }
  return ((a[l++] = i[c]), a);
  ...
  beforeElementsUpdate: (i, t, e) => {
    ...
    i.data.datasets.forEach((n, o) => {
      let { _data: a, indexAxis: r } = n,
        ...
        c = a || n.data;
      if (ae([r, i.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
...
function Es(i, t, e, s) {
  ...
  let n = t[i],
    o = e[i];
  return (i === 'angle' && ((n = X(n)), (o = X(o))), { property: i, start: n, end: o });
}
function Sc(i, t) {
...
function Uo(i, t) {
  ...
  return (
    ...
    e.length ? new pt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
  );
}
function co(i) {
  return i && i.fill !== !1;
...
var Si = class {
  ...
  pathSegment(t, e, s) {
    ...
    return ((e = e || { start: 0, end: B }), t.arc(n, o, a, e.end, e.start, !0), !s.bounds);
  }
  interpolate(t) {
...
function Wc(i) {
  ...
  if (s.grid.circular) {
    ...
    return new Si({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(a) });
  }
...
function ys(i, t, e) {
  ...
  s &&
    a.points.length &&
    (Pe(i, e),
    Nc(i, { line: a, target: s, above: u, below: f, area: e, scale: r, axis: l, clip: p }),
    De(i));
}
function Nc(i, t) {
  let { line: e, target: s, above: n, below: o, area: a, scale: r, clip: l } = t,
  ...
  (o !== n &&
    (c === 'x'
      ? (ho(i, s, a.top),
        vs(i, { line: e, target: s, color: n, scale: r, property: c, clip: l }),
        i.restore(),
        i.save(),
        ho(i, s, a.bottom))
      : c === 'y' &&
        (uo(i, s, a.left),
        vs(i, { line: e, target: s, color: o, scale: r, property: c, clip: l }),
        i.restore(),
        i.save(),
        uo(i, s, a.right),
        (h = n))),
...
function vs(i, t) {
  ...
  for (let { source: c, target: h, start: d, end: u } of l) {
    let { style: { backgroundColor: f = o } = {} } = c,
      g = s !== !0;
    (i.save(), (i.fillStyle = f), Hc(i, a, r, g && Es(n, d, u)), i.beginPath());
...
var jc = {
    ...
    beforeDraw(i, t, e) {
      ...
      for (let a = n.length - 1; a >= 0; --a) {
        let r = n[a].$filler;
        r && (r.line.updateControlPoints(o, r.axis), s && r.fill && ys(i.ctx, r, o));
      }
    },
    ...
    beforeDatasetDraw(i, t, e) {
      let s = t.meta.$filler;
      !co(s) || e.drawTime !== 'beforeDatasetDraw' || ys(i.ctx, s, i.chartArea);
    },
  ...
  Pi = class extends st {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (let c of e)
          (r !== c.row && ((r = c.row), (l = K(s, this.left + n, this.right - this.lineWidths[r]))),
            (c.top += this.top + t + n),
            (c.left = a.leftForLtr(a.x(l), c.width)),
            (l += c.width + n));
      } else {
        let r = 0,
          l = K(s, this.top + t + n, this.bottom - this.columnSizes[r].height);
        for (let c of e)
          (c.col !== r &&
            ((r = c.col), (l = K(s, this.top + t + n, this.bottom - this.columnSizes[r].height))),
            (c.top = l),
            (c.left += this.left + n),
    ...
    _draw() {
      ...
      (v
        ? (f = { x: K(o, this.left + h, this.right - s[0]), y: this.top + h + y, line: 0 })
        : (f = { x: this.left + h, y: K(o, this.top + y + h, this.bottom - e[0].height), line: 0 }),
      ...
      (this.legendItems.forEach((k, w) => {
        ...
        (l.setWidth(this.width),
          v
            ? w > 0 &&
              O + C + h > this.right &&
              ((L = f.y += _), f.line++, (O = f.x = K(o, this.left + h, this.right - s[f.line])))
            : w > 0 &&
              L + _ > this.bottom &&
              ((O = f.x = O + e[f.line].width + h),
              f.line++,
              (L = f.y = K(o, this.top + y + h, this.bottom - e[f.line].height))));
        let U = l.x(O);
        if ((b(U, L, k), (O = fn(P, O + g + u, v ? O + C : this.right, t.rtl)), x(l.x(O), L, k), v))
          f.x += C + h;
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        h =
          c + K(t.align, this.top, this.bottom - g - t.labels.padding - this._computeTitleHeight());
      }
      let f = K(r, d, d + u);
...
var We = class extends st {
  ...
  drawBackground(t, e, s, n) {
    let { xAlign: o, yAlign: a } = this,
      { x: r, y: l } = t,
      { width: c, height: h } = s,
      { topLeft: d, topRight: u, bottomLeft: f, bottomRight: g } = Tt(n.cornerRadius);
    ((e.fillStyle = n.backgroundColor),
      (e.strokeStyle = n.borderColor),
      (e.lineWidth = n.borderWidth),
      e.beginPath(),
  ...
  _updateAnimationTarget(t) {
    let e = this.chart,
      ...
      o = s && s.y;
    if (n || o) {
      let a = Ie[t.position].call(this, this._active, this._eventPosition);
      if (!a) return;
...
var Fe = class extends Xt {
  ...
  parse(t, e) {
    ...
    let s = this.getLabels();
    return (
      (e = isFinite(e) && s[e] === t ? e : ch(s, t, D(e, t), this._addedLabels)),
      hh(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
function dh(i, t) {
  ...
  ((P = Math.ceil(m / _) - Math.floor(p / _)),
    ...
    b && x && o && an((r - a) / o, _ / 1e3)
      ? ((P = Math.round(Math.min((r - a) / _, h))), (_ = (r - a) / P), (w = a), (S = r))
      : v
        ? ((w = b ? a : w), (S = x ? r : S), (P = c - 1), (_ = (S - w) / P))
        : ((P = (S - w) / _),
          ie(P, Math.round(P), _ / 1e3) ? (P = Math.round(P)) : (P = Math.ceil(P))));
...
(M(ze, 'id', 'linear'), M(ze, 'defaults', { ticks: { callback: Se.formatters.numeric } }));
...
(M(Be, 'id', 'logarithmic'),
  M(Be, 'defaults', { ticks: { callback: Se.formatters.logarithmic, major: { enabled: !0 } } }));
function Is(i) {
  let t = i.ticks;
...
function gh(i, t, e) {
  return ((e = z(e) ? e : [e]), { w: pn(i, t.string, e), h: e.length * t.lineHeight });
}
...
function _h(i, t, e) {
  ...
  for (let h = 0; h < n; h++) {
    ...
    let d = bh(i, h, l);
    (s.push(d), r === 'auto' && ((d.visible = xh(d, c)), d.visible && (c = d)));
  }
  return s;
}
function yh(i) {
...
function kh(i, t, e) {
  ...
  if (!A(r)) {
    ...
    Object.values(l).some((g) => g !== 0)
      ? (i.beginPath(), oe(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill())
      : i.fillRect(h, d, u, f);
  }
}
function wh(i, t) {
...
var $t = class extends me {
  ...
  drawBackground() {
    ...
    if (t) {
      ...
      (s.save(),
        s.beginPath(),
        qo(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
        s.closePath(),
        (s.fillStyle = t),
        s.fill(),
        s.restore());
...
function Po(i, t) {
  ...
  return (
    ...
    a === null
      ? null
      : (n &&
          (a = n === 'week' && (Vt(o) || o === !0) ? e.startOf(a, 'isoWeek', o) : e.startOf(a, n)),
        +a)
  );
}
function Do(i, t, e, s) {
...
function Ch(i) {
  for (let t = tt.indexOf(i) + 1, e = tt.length; t < e; ++t) if (Ci[tt[t]].common) return tt[t];
}
function Co(i, t, e) {
  if (!e) i[t] = !0;
  else if (e.length) {
...
var Ut = class extends Xt {
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (s.autoSkip
          ? Do(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
          : Dh(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit = !s.major.enabled || this._unit === 'year' ? void 0 : Ch(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
  ...
  _getLabelCapacity(t) {
    let e = this.options.time,
      ...
      o = this._tickFormatFunction(t, 0, Oo(this, [t], this._majorUnit), n),
