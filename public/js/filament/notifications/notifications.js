(() => {
      ...
      configureTransitions() {
        let i = this.computedStyle.display,
          ...
          u = d(
            (n) => (n ? e() : a()),
            (n) => {
              this.$el._x_toggleAndCascadeWithTransitions(this.$el, n, e, a);
            },
          );
        s.effect(() => u(this.isShown));
      },
      configureAnimations() {
        let i;
        this.unsubscribeLivewireHook = Livewire.hook(
          'commit',
          ({ component: e, commit: a, succeed: u, fail: n, respond: m }) => {
            e.snapshot.data.isFilamentNotificationsComponent &&
  ...
  var o = class {
          ...
          this.id(
            crypto.randomUUID?.() ??
              '10000000-1000-4000-8000-100000000000'.replace(/[018]/g, (t) =>
                (+t ^ (crypto.getRandomValues(new Uint8Array(1))[0] & (15 >> (+t / 4)))).toString(
                  16,
                ),
              ),
          ),
      ...
      send() {
        return (
          window.dispatchEvent(
            new CustomEvent('notificationSent', { detail: { notification: this.toJSON() } }),
          ),
          this
        );
      }
    ...
    r = class {
      ...
      dispatchSelf(t, i) {
        return (this.dispatch(t, i), (this._dispatchDirection = 'self'), this);
      }
      dispatchTo(t, i, e) {
        return (
          this.dispatch(i, e),
      ...
      grouped() {
        return (this.view('filament::components.dropdown.list.item'), this);
      }
      iconButton() {
  ...
  window.FilamentNotificationAction = r;
  window.FilamentNotificationActionGroup = h;
  window.FilamentNotification = o;
