...
async function ni(i, t) {
  ...
  let { x: n, y: o, platform: s, rects: r, elements: a, strategy: l } = i,
    ...
    g = ei(p),
    x = a[h ? (d === 'floating' ? 'reference' : 'floating') : d],
    D = Ot(
      await s.getClippingRect({
        element:
          (e = await (s.isElement == null ? void 0 : s.isElement(x))) == null || e
            ? x
            : x.contextElement ||
    ...
    w =
      d === 'floating'
        ? { x: n, y: o, width: r.floating.width, height: r.floating.height }
        : r.reference,
  ...
  return {
    top: (D.top - N.top + g.top) / E.y,
    bottom: (N.bottom - D.bottom + g.bottom) / E.y,
    left: (D.left - N.left + g.left) / E.x,
    right: (N.right - D.right + g.right) / E.x,
  };
}
var nn = 50,
  oi = async (i, t, e) => {
    let { placement: n = 'bottom', strategy: o = 'absolute', middleware: s = [], platform: r } = e,
      ...
      c = await r.getElementRects({ reference: i, floating: t, strategy: o }),
      { x: f, y: d } = ii(c, n, l),
      h = n,
      p = 0,
      g = {};
        ...
        C &&
          ...
          typeof C == 'object' &&
            ...
            C.rects &&
              (c =
                C.rects === !0
                  ? await r.getElementRects({ reference: i, floating: t, strategy: o })
                  : C.rects),
            ({ x: f, y: d } = ii(c, h, l))),
          (m = -1)));
    }
    ...
    i === void 0 && (i = {}),
    {
      ...
      async fn(t) {
        ...
        let D = yt(o),
          ...
          N = h || (A || !m ? [Ft(a)] : Ze(a)),
          C = g !== 'none';
        !h && C && N.push(...ti(a, m, g, E));
        let q = [a, ...N],
          J = await l.detectOverflow(t, x),
          R = [],
          z = ((n = s.flip) == null ? void 0 : n.overflows) || [];
        if ((f && R.push(J[D]), d)) {
          let H = Qe(o, r, E);
          R.push(J[H[0]], J[H[1]]);
        }
        if (((z = [...z, { placement: o, overflows: R }]), !R.every((H) => H <= 0))) {
          var L, Y;
          let H = (((L = s.flip) == null ? void 0 : L.index) || 0) + 1,
            Q = q[H];
          if (
            Q &&
            (!(d === 'alignment' ? w !== ut(Q) : !1) ||
              z.every((T) => (ut(T.placement) === w ? T.overflows[0] > 0 : !0)))
          )
            return { data: { index: H, overflows: z }, reset: { placement: Q } };
          let W =
            (Y = z
              .filter((K) => K.overflows[0] <= 0)
              .sort((K, T) => K.overflows[1] - T.overflows[1])[0]) == null
              ? void 0
              : Y.placement;
          if (!W)
            switch (p) {
              case 'bestFit': {
                ...
                let K =
                  (F = z
                    ...
                    .map((T) => [
                      T.placement,
                      T.overflows.filter((et) => et > 0).reduce((et, ie) => et + ie, 0),
                    ])
                    .sort((T, et) => T[1] - et[1])[0]) == null
                    ? void 0
                    : F[0];
                K && (W = K);
                break;
    ...
    return (
      i === void 0 && (i = {}),
      {
        ...
        async fn(t) {
          ...
          let x = l.fn({ ...t, [p]: g, [h]: m });
          return { ...x, data: { x: x.x - e, y: x.y - n, enabled: { [p]: r, [h]: a } } };
        },
      }
    );
  };
...
function lt(i) {
  var t;
  return (t = (ci(i) ? i.ownerDocument : i.document) || window.document) == null
    ? void 0
    : t.documentElement;
}
function ci(i) {
...
function ae() {
  return (
    Ie == null &&
      (Ie = typeof CSS < 'u' && CSS.supports && CSS.supports('-webkit-backdrop-filter', 'none')),
    Ie
  );
}
function At(i) {
...
function ui(i) {
  let t = ht(i);
  return At(t) ? (i.ownerDocument ? i.ownerDocument.body : i.body) : ct(t) && Tt(t) ? t : ui(t);
}
function oe(i, t, e) {
  var n;
...
function dn(i) {
  ...
  if ((d || (!d && !s)) && ((Dt(n) !== 'body' || Tt(r)) && (l = Kt(n)), d)) {
    let p = Xt(n);
    ((c = _t(n)), (f.x = p.x + n.clientLeft), (f.y = p.y + n.clientTop));
  }
  let h = r && !d && !s ? yi(r, l) : st(0);
  return {
    width: e.width * c.x,
    height: e.height * c.y,
    x: e.x * c.x - l.scrollLeft * c.x + f.x + h.x,
    y: e.y * c.y - l.scrollTop * c.y + f.y + h.y,
  };
}
function fn(i) {
...
function un(i) {
  let t = lt(i),
    ...
    a = -e.scrollTop;
  return (
    nt(n).direction === 'rtl' && (r += vt(t.clientWidth, n.clientWidth) - o),
...
function hn(i, t) {
  ...
  if (c <= 0) {
    let f = n.ownerDocument,
      ...
      p =
        (f.compatMode === 'CSS1Compat' && parseFloat(h.marginLeft) + parseFloat(h.marginRight)) ||
        0,
...
function mn(i) {
  let { element: t, boundary: e, rootBoundary: n, strategy: o } = i,
    r = [...(e === 'clippingAncestors' ? ($t(t) ? [] : gn(t, this._c)) : [].concat(e)), n],
    a = pi(t, r[0], o),
    l = a.top,
    c = a.right,
    f = a.bottom,
...
function vn(i, t, e) {
  ...
  let f = o && !n && !s ? yi(o, a) : st(0),
    ...
    h = r.top + a.scrollTop - l.y - f.y;
  return { x: d, y: h, width: r.width, height: r.height };
}
function Te(i) {
...
function On(i, t) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (n = 0; n < s.length; n++)
      ((e = s[n]), t.indexOf(e) === -1 && {}.propertyIsEnumerable.call(i, e) && (o[e] = i[e]));
  }
  return o;
}
function En(i, t) {
...
function at(i, t, e, n) {
  if (i) {
    ...
    do {
      if (
        (t != null && (t[0] === '>' ? i.parentNode === e && ve(i, t) : ve(i, t))) ||
        (n && i === e)
      )
        return i;
      if (i === e) break;
    ...
    if (
      ...
      do
        if (
          ...
          ((r -= h.top + parseInt(b(o, 'border-top-width'))),
            (a -= h.left + parseInt(b(o, 'border-left-width'))),
            (l = r + s.height),
            (c = a + s.width));
          break;
        }
...
function ot(i, t) {
  ...
  for (; (i = i.previousElementSibling);)
    i.nodeName.toUpperCase() !== 'TEMPLATE' && i !== v.clone && (!t || ve(i, t)) && e++;
  return e;
}
function Ti(i) {
  var t = 0,
...
function xt(i, t) {
  ...
  do
    if (e.clientWidth < e.scrollWidth || e.clientHeight < e.scrollHeight) {
      var o = b(e);
      if (
        (e.clientWidth < e.scrollWidth && (o.overflowX == 'auto' || o.overflowX == 'scroll')) ||
        (e.clientHeight < e.scrollHeight && (o.overflowY == 'auto' || o.overflowY == 'scroll'))
      ) {
  ...
  return (
    Array.from(i.children).forEach(function (o) {
      ...
      if (!(!at(o, t.draggable, i, !1) || o.animated || o === e)) {
        var c = B(o);
        ((n.left = Math.min((s = n.left) !== null && s !== void 0 ? s : 1 / 0, c.left)),
          (n.top = Math.min((r = n.top) !== null && r !== void 0 ? r : 1 / 0, c.top)),
          (n.right = Math.max((a = n.right) !== null && a !== void 0 ? a : -1 / 0, c.right)),
          (n.bottom = Math.max((l = n.bottom) !== null && l !== void 0 ? l : -1 / 0, c.bottom)));
      }
    }),
  ...
  ee = {
    ...
    pluginEvent: function (t, e, n) {
      ...
      Rt.forEach(function (r) {
        e[r.pluginName] &&
          (e[r.pluginName][s] && e[r.pluginName][s](ft({ sortable: e }, n)),
  ...
  Xi = function (t) {
    function e(s, r) {
      return function (a, l, c, f) {
        ...
        var h = (r ? a : l).options.group.name;
...
function v(i, t) {
  ...
  ((this.nativeDraggable = t.forceFallback ? !1 : kn),
    ...
    t.supportPointer
      ...
      : (O(i, 'mousedown', this._onTapStart), O(i, 'touchstart', this._onTapStart)),
    this.nativeDraggable && (O(i, 'dragover', this), O(i, 'dragenter', this)),
    we.push(this.el),
...
v.prototype = {
  ...
  _onTapStart: function (t) {
    if (t.cancelable) {
      ...
      if (
        (Un(n),
        !u &&
          !((/mousedown|pointerdown/.test(r) && t.button !== 0) || o.disabled) &&
          !c.isContentEditable &&
          !(!this.nativeDraggable && Gt && l && l.tagName.toUpperCase() === 'SELECT') &&
          ((l = at(l, o.draggable, n, !1)), !(l && l.animated) && pe !== l))
      ) {
        if (((Nt = ot(l)), (Jt = ot(l, o.draggable)), typeof f == 'function')) {
          if (f.call(this, t, l, this)) {
            (X({ sortable: e, rootEl: c, name: 'filter', targetEl: l, toEl: n, fromEl: n }),
              j('filter', e, { evt: t }),
              s && t.preventDefault());
            return;
          }
          ...
          ((f = f.split(',').some(function (d) {
            if (((d = at(c, d.trim(), n, !1)), d))
              return (
                X({ sortable: e, rootEl: d, name: 'filter', targetEl: l, fromEl: n, toEl: n }),
                j('filter', e, { evt: t }),
                !0
              );
          })),
  ...
  _prepareDragStart: function (t, e, n) {
    ...
    if (n && !u && n.parentNode === s) {
      ...
      if (
        ...
        (de = r.group),
        (v.dragged = u),
        (Ct = { target: u, clientX: (e || t).clientX, clientY: (e || t).clientY }),
        (_i = Ct.clientX - c.left),
        (Ri = Ct.clientY - c.top),
        ...
        (l = function () {
          ...
          (o._disableDelayedDragEvents(),
            !Ci && o.nativeDraggable && (u.draggable = !0),
        ...
        Ci && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (u.draggable = !0)),
        j('delayStart', this, { evt: t }),
        r.delay && (!r.delayOnTouchOnly || e) && (!this.nativeDraggable || !(te || mt)))
      ) {
        if (v.eventCanceled) {
          this._onDrop();
          return;
        ...
        (r.supportPointer
          ? (O(a, 'pointerup', o._disableDelayedDrag), O(a, 'pointercancel', o._disableDelayedDrag))
          ...
          r.supportPointer && O(a, 'pointermove', o._delayedDragTouchMoveHandler),
  ...
  _disableDelayedDrag: function () {
    (u && ke(u), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents());
  },
  ...
  _triggerDragStart: function (t, e) {
    ((e = e || (t.pointerType == 'touch' && t)),
      !this.nativeDraggable || e
        ...
        : (O(u, 'dragend', this), O(I, 'dragstart', this._onDragStart)));
    try {
      document.selection
        ? me(function () {
  ...
  _emulateDragOver: function () {
    if (rt) {
      ...
      for (
        ...
        t && t.shadowRoot && ((t = t.shadowRoot.elementFromPoint(rt.clientX, rt.clientY)), t !== e);
      )
        e = t;
      if ((u.parentNode[G]._isOutsideThisEl(t), e))
        do {
          if (e[G]) {
            var n = void 0;
            if (
  ...
  _appendGhost: function () {
    if (!y) {
      ...
      if (ue) {
        for (
          $ = t;
          b($, 'position') === 'static' && b($, 'transform') === 'none' && $ !== document;
        )
          $ = $.parentNode;
        ($ !== document.body && $ !== document.documentElement
          ? ($ === document && ($ = dt()), (e.top += $.scrollTop), (e.left += $.scrollLeft))
          : ($ = dt()),
          (Ne = Ti($)));
      }
      ((y = u.cloneNode(!0)),
        ...
        b(y, 'height', e.height),
        b(y, 'opacity', '0.8'),
        b(y, 'position', ue ? 'absolute' : 'fixed'),
        b(y, 'zIndex', '100000'),
        ...
        b(
          y,
          'transform-origin',
          (_i / parseInt(y.style.width)) * 100 + '% ' + (Ri / parseInt(y.style.height)) * 100 + '%',
        ));
    }
  },
  _onDragStart: function (t, e) {
    ...
    (j('setupClone', this),
      ...
      (n.cloneId = me(function () {
        (j('clone', n),
          !v.eventCanceled &&
            (n.options.removeCloneOnHide || I.insertBefore(_, u),
            n._hideClone(),
      ...
      e
        ...
        : (S(document, 'mouseup', n._onDrop),
          ...
          o && ((o.effectAllowed = 'move'), s.setData && s.setData.call(n, o, u)),
          O(document, 'drop', n),
        ...
        ft(
          {
            ...
            onMove: function (Ge, qi) {
              return he(I, e, u, o, Ge, B(Ge), t, qi);
            },
            changed: A,
          },
          et,
    ...
    function w(T) {
      return (
        ...
        T &&
          ...
          g !== h &&
            (Z(u, V ? V.options.ghostClass : c.options.ghostClass, !1), Z(u, a.ghostClass, !0)),
          V !== g && g !== v.active ? (V = g) : g === v.active && V && (V = null),
          h === g && (g._ignoreWhileAnimating = n),
        ...
        ((n === u && !u.animated) || (n === e && !n.animated)) && (Pt = null),
        !a.dragoverBubble &&
          !t.rootEl &&
          n !== document &&
          (u.parentNode[G]._isOutsideThisEl(t.target), !T && Lt(t)),
    ...
    if (
      ...
      c &&
        ...
        (f
          ? d || (r = P !== I)
          : V === this ||
            ((this.lastPutMode = de.checkPull(this, c, u, t)) && l.checkPut(this, c, u, t))))
    ) {
      if (
      ...
      if (r)
        return (
          ...
          this._hideClone(),
          x('revert'),
          v.eventCanceled || (It ? I.insertBefore(u, It) : I.appendChild(u)),
          w(!0)
        );
      var E = Ye(e, a.draggable);
      if (!E || ($n(t, p, this) && !E.animated)) {
        if (E === u) return w(!1);
        if ((E && e === t.target && (n = E), n && (s = B(n)), he(I, e, u, o, n, s, t, !!n) !== !1))
          return (
            D(),
            E && E.nextSibling ? e.insertBefore(u, E.nextSibling) : e.appendChild(u),
            (P = e),
            A(),
            w(!0)
          );
        ...
        var N = Bt(e, 0, a, !0);
        if (N === u) return w(!1);
        if (((n = N), (s = B(n)), he(I, e, u, o, n, s, t, !1) !== !1))
        ...
        var C = 0,
          q,
          J = u.parentNode !== e,
          R = !Bn((u.animated && u.toRect) || o, (n.animated && n.toRect) || s, p),
          z = p ? 'top' : 'left',
          L = Ii(n, 'top', 'top') || Ii(u, 'top', 'top'),
          Y = L ? L.scrollTop : void 0;
        (Pt !== n && ((q = s[z]), (Zt = !1), (fe = (!R && a.invertSwap) || J)),
          (C = Kn(
            t,
            n,
            s,
        ...
        if (C !== 0) {
          var H = ot(u);
          do ((H -= C), (F = P.children[H]));
          while (F && (b(F, 'display') === 'none' || F === y));
        }
        if (C === 0 || F === n) return w(!1);
        ((Pt = n), (Qt = C));
        var Q = n.nextElementSibling,
          W = !1;
        W = C === 1;
        var K = he(I, e, u, o, n, s, t, W);
        if (K !== !1)
          return (
            (K === 1 || K === -1) && (W = K === 1),
            (Ve = !0),
            setTimeout(Vn, 30),
            D(),
            W && !Q ? e.appendChild(u) : n.parentNode.insertBefore(u, W ? Q : n),
            L && Wi(L, 0, Y - L.scrollTop),
            (P = u.parentNode),
            q !== void 0 && !fe && (ge = Math.abs(q - B(n)[z])),
            A(),
            w(!0)
          );
      }
  ...
  _onDrop: function (t) {
    ...
    ((Mt = !1),
      ...
      b(u, 'transform', ''),
      t &&
        (Yt && (t.cancelable && t.preventDefault(), !n.dropBubble && t.stopPropagation()),
        y && y.parentNode && y.parentNode.removeChild(y),
        (I === P || (V && V.lastPutMode !== 'clone')) &&
          _ &&
          _.parentNode &&
        ...
        u &&
          ...
          ke(u),
          (u.style['will-change'] = ''),
          Yt && !Mt && Z(u, V ? V.options.ghostClass : this.options.ghostClass, !1),
          ...
          I !== P
            ? (tt >= 0 &&
                (X({ rootEl: P, name: 'add', toEl: P, fromEl: I, originalEvent: t }),
                X({ sortable: this, name: 'remove', toEl: P, originalEvent: t }),
                X({ rootEl: P, name: 'sort', toEl: P, fromEl: I, originalEvent: t }),
                X({ sortable: this, name: 'sort', toEl: P, originalEvent: t })),
              V && V.save())
            : tt !== Nt &&
              tt >= 0 &&
              (X({ sortable: this, name: 'update', toEl: P, originalEvent: t }),
              X({ sortable: this, name: 'sort', toEl: P, originalEvent: t })),
          v.active &&
            ((tt == null || tt === -1) && ((tt = Nt), (wt = Jt)),
            X({ sortable: this, name: 'end', toEl: P, originalEvent: t }),
            this.save()))),
      this._nulling());
  },
  _nulling: function () {
  ...
  toArray: function () {
    for (var t = [], e, n = this.el.children, o = 0, s = n.length, r = this.options; o < s; o++)
      ((e = n[o]),
        at(e, r.draggable, this.el, !1) && t.push(e.getAttribute(r.dataIdAttr) || Yn(e)));
    return t;
  },
  sort: function (t, e) {
    var n = {},
  ...
  _hideClone: function () {
    if (!St) {
      ...
      (b(_, 'display', 'none'),
        this.options.removeCloneOnHide && _.parentNode && _.parentNode.removeChild(_),
        (St = !0));
    }
  },
    ...
    if (St) {
      ...
      (u.parentNode == I && !this.options.group.revertClone
        ...
        : It
          ? I.insertBefore(_, It)
          : I.appendChild(_),
        this.options.group.revertClone && this.animate(u, _),
        b(_, 'display', ''),
        (St = !1));
    }
  },
...
function $n(i, t, e) {
  var n = B(Ye(e.el, e.options.draggable)),
    ...
    s = 10;
  return t
    ? i.clientX > o.right + s || (i.clientY > n.bottom && i.clientX > n.left)
    : i.clientY > o.bottom + s || (i.clientX > n.right && i.clientY > n.top);
}
...
var He = Hi(function (i, t, e, n) {
    if (t.scroll) {
      var o = (i.touches ? i.touches[0] : i).clientX,
        ...
        f;
      $e !== e &&
        (($e = e), be(), (Ut = t.scroll), (f = t.scrollFn), Ut === !0 && (Ut = xt(e, !0)));
      var d = 0,
        h = Ut;
      do {
        var p = h,
        ...
        p === l
          ? ((N =
              A < q &&
              (R.overflowX === 'auto' || R.overflowX === 'scroll' || R.overflowX === 'visible')),
            (C =
              E < J &&
              (R.overflowY === 'auto' || R.overflowY === 'scroll' || R.overflowY === 'visible')))
          : ((N = A < q && (R.overflowX === 'auto' || R.overflowX === 'scroll')),
            (C = E < J && (R.overflowY === 'auto' || R.overflowY === 'scroll')));
        var Y = N && (Math.abs(w - o) <= r && z + A < q) - (Math.abs(D - o) <= r && !!z),
          F = C && (Math.abs(x - s) <= r && L + E < J) - (Math.abs(m - s) <= r && !!L);
        if (!k[d]) for (var H = 0; H <= d; H++) k[H] || (k[H] = {});
        ((k[d].vx != Y || k[d].vy != F || k[d].el !== p) &&
          ((k[d].el = p),
          (k[d].vx = Y),
          (k[d].vy = F),
          ...
          (Y != 0 || F != 0) &&
            ...
            (k[d].pid = setInterval(
              function () {
                ...
                var Q = k[this.layer].vy ? k[this.layer].vy * a : 0,
                  W = k[this.layer].vx ? k[this.layer].vx * a : 0;
                (typeof f == 'function' &&
                  f.call(v.dragged.parentNode[G], W, Q, i, xe, k[this.layer].el) !== 'continue') ||
                  Wi(k[this.layer].el, W, Q);
              }.bind({ layer: d }),
              24,
            )))),
          d++);
      } while (t.bubbleScroll && h !== l && (h = xt(h, !1)));
      Ke = c;
    }
  }, 30),
  ji = function (t) {
...
var Ee = class {
  constructor({
    ...
    searchDebounce: W = 1e3,
    searchingMessage: K = 'Searching...',
    ...
    ((this.canOptionLabelsWrap = t),
      ...
      (this.searchDebounce = W),
      (this.searchingMessage = K),
      (this.searchPrompt = T),
      (this.state = et),
      (this.statePath = ie),
    ...
    if (!(!t || !Array.isArray(t)))
      for (let e of t)
        e.options && Array.isArray(e.options)
          ...
          : e.value !== void 0 && e.label !== void 0 && (this.labelRepository[e.value] = e.label);
  }
  render() {
    (this.populateLabelRepositoryFromOptions(this.options),
      ...
      this.canOptionLabelsWrap ||
        this.container.classList.add('fi-select-input-ctn-option-labels-not-wrapped'),
      ...
      this.isMultiple && this.dropdown.setAttribute('aria-multiselectable', 'true'),
      this.isSearchable &&
        ...
        this.searchInput.addEventListener('keydown', (t) => {
          if (!this.isDisabled) {
            if (t.key === 'Tab') {
              ...
              (t.shiftKey ? (this.selectedIndex = e.length - 1) : (this.selectedIndex = 0),
                e.forEach((n) => {
              ...
              if ((t.preventDefault(), t.stopPropagation(), this.getVisibleOptions().length === 0))
                return;
              ...
              ((this.selectedIndex = e.length - 1),
                ...
                e[this.selectedIndex].id &&
                  this.dropdown.setAttribute('aria-activedescendant', e[this.selectedIndex].id),
                this.scrollOptionIntoView(e[this.selectedIndex]));
            } else if (t.key === 'Enter') {
              if ((t.preventDefault(), t.stopPropagation(), this.isSearching)) return;
              let e = this.getVisibleOptions();
              if (e.length === 0) return;
              let n = e.find((s) => {
                let r = s.getAttribute('aria-disabled') === 'true',
      ...
      if (a.options && Array.isArray(a.options)) {
        ...
        if (
          (this.isMultiple &&
            ...
            this.state.length > 0 &&
            (l = a.options.filter((c) => !this.state.includes(c.value))),
          l.length > 0)
        ) {
    ...
    t === 0
      ? (this.searchQuery
          ...
          : this.hasInitialNoOptionsMessage || this.hasDynamicOptions
            ...
            : this.isMultiple && this.isOpen && !this.isSearchable && this.closeDropdown(),
  ...
  async updateSelectedDisplay() {
    ...
    if (this.isMultiple) {
      ...
      t === this.selectedDisplayVersion &&
        (this.selectedDisplay.replaceChildren(e), this.isOpen && this.positionDropdown());
      return;
    }
    ...
    t === this.selectedDisplayVersion &&
      ...
      t === this.selectedDisplayVersion && this.selectedDisplay.replaceChildren(e));
  }
  ...
  createBadgeElement(t, e) {
    ...
    ((n.className =
      ...
      M(t) && n.setAttribute('data-value', t));
    let o = document.createElement('span');
  ...
  createRemoveButton(t, e) {
    ...
    return (
      ...
      n.setAttribute(
        'aria-label',
        'Remove ' + (this.isHtmlAllowed ? e.replace(/<[^>]*>/g, '') : e),
      ),
      ...
      n.addEventListener('keydown', (o) => {
        (o.key === ' ' || o.key === 'Enter') &&
          (o.preventDefault(), o.stopPropagation(), M(t) && this.selectOption(t));
      }),
      n
    );
  }
  ...
  async getLabelForSingleSelection() {
    ...
    if (
      ...
      bt(t) && M(this.initialOptionLabel) && this.state === this.initialState)
    )
      ((t = this.initialOptionLabel), M(this.state) && (this.labelRepository[this.state] = t));
    else if (bt(t) && this.getOptionLabelUsing)
      try {
        ((t = await this.getOptionLabelUsing()),
          M(t) && M(this.state) && (this.labelRepository[this.state] = t));
      } catch (e) {
  ...
  addSingleSelectionDisplay(t, e = this.selectedDisplay) {
    ...
    ((o.type = 'button'),
      ...
      o.addEventListener('keydown', (s) => {
        (s.key === ' ' || s.key === 'Enter') &&
          (s.preventDefault(), s.stopPropagation(), this.selectOption(''));
      }),
  ...
  setUpEventListeners() {
    ((this.buttonClickListener = () => {
      ...
      this.selectButton.addEventListener('keydown', this.buttonKeydownListener),
        ...
        ((this.refreshOptionLabelListener = async (t) => {
          if (
            ...
            try {
              ...
              (M(n) && (this.isHtmlAllowed ? (n.innerHTML = e) : (n.textContent = e)),
  ...
  handleSelectButtonKeydown(t) {
    switch (t.key) {
      ...
      case 'ArrowUp':
        (t.preventDefault(),
          t.stopPropagation(),
          this.isOpen ? this.focusPreviousOption() : this.openDropdown());
        break;
      case ' ':
      ...
      default:
        if (
          ...
          (this.isOpen || this.openDropdown(),
            this.searchInput &&
              (this.searchInput.focus(),
              (this.searchInput.value = (this.searchInput.value || '') + e),
              this.searchInput.dispatchEvent(new Event('input', { bubbles: !0 }))));
        }
        break;
    }
  }
    ...
    for (let t of this.options)
      if (t.options && Array.isArray(t.options)) {
        for (let e of t.options)
          if (!Array.isArray(this.state) || !this.state.includes(e.value)) return !0;
  ...
  async openDropdown() {
    ...
    let t =
      this.selectButton.closest('.fi-fixed-positioning-context') !== null &&
      this.selectButton.closest('.fi-absolute-positioning-context') === null;
    if (
    ...
    if (this.isSearchable && this.searchInput) this.searchInput.focus();
      ...
      if (this.isMultiple) {
        if (Array.isArray(this.state) && this.state.length > 0) {
          for (let n = 0; n < e.length; n++)
            if (this.state.includes(e[n].getAttribute('data-value'))) {
      ...
      (this.selectedIndex === -1 && e.length > 0 && (this.selectedIndex = 0),
  ...
  closeDropdown() {
    ((this.dropdown.style.display = 'none'),
      this.selectButton.setAttribute('aria-expanded', 'false'),
      (this.isOpen = !1),
      this.searchTimeout && (clearTimeout(this.searchTimeout), (this.searchTimeout = null)),
      this.activeSearchId++,
      (this.isSearching = !1),
      this.hideLoadingState(),
      this.resizeListener &&
        (window.removeEventListener('resize', this.resizeListener), (this.resizeListener = null)),
      this.scrollListener &&
  ...
  focusNextOption() {
    ...
    if (t.length !== 0) {
      if (
        ...
        this.selectedIndex === t.length - 1 && this.isSearchable && this.searchInput)
      ) {
        ((this.selectedIndex = -1),
          this.searchInput.focus(),
          this.dropdown.removeAttribute('aria-activedescendant'));
      ...
      ((this.selectedIndex = (this.selectedIndex + 1) % t.length),
        ...
        t[this.selectedIndex].id &&
          this.dropdown.setAttribute('aria-activedescendant', t[this.selectedIndex].id),
  ...
  focusPreviousOption() {
    ...
    if (t.length !== 0) {
      ...
      ((this.selectedIndex = (this.selectedIndex - 1 + t.length) % t.length),
        t[this.selectedIndex].classList.add('fi-selected'),
        t[this.selectedIndex].focus(),
        t[this.selectedIndex].id &&
          this.dropdown.setAttribute('aria-activedescendant', t[this.selectedIndex].id),
  ...
  getVisibleOptions() {
    ...
    this.optionsList.classList.contains('fi-dropdown-list')
      ? (t = Array.from(this.optionsList.querySelectorAll(':scope > li[role="option"]')))
      : (t = Array.from(
          this.optionsList.querySelectorAll(':scope > ul.fi-dropdown-list > li[role="option"]'),
        ));
    let e = Array.from(
      this.optionsList.querySelectorAll('li.fi-select-input-option-group > ul > li[role="option"]'),
    );
    return [...t, ...e];
  }
  ...
  handleSearch(t) {
    ...
    if (
      ((this.searchQuery = e), this.searchTimeout && clearTimeout(this.searchTimeout), e === '')
    ) {
  ...
  showLoadingState(t = !1) {
    (this.optionsList.parentNode === this.dropdown && this.dropdown.removeChild(this.optionsList),
      this.hideLoadingState());
    ...
    if (e.includes(t)) {
      ...
      if (M(o)) {
        ...
        M(s) && s.children.length === 1
          ? ((e = e.filter((r) => r !== t)), (this.state = e), this.updateSelectedDisplay())
          : (o.remove(), (e = e.filter((r) => r !== t)), (this.state = e));
  ...
  async addSingleBadge(t, e) {
    ...
    if (
      (bt(n) && ((n = this.getSelectedOptionLabel(t)), M(n) && (this.labelRepository[t] = n)),
  ...
  disable() {
    this.isDisabled ||
      ((this.isDisabled = !0), this.applyDisabledState(), this.isOpen && this.closeDropdown());
  }
  enable() {
  ...
  applyDisabledState() {
    if (this.isDisabled) {
      if (
        ...
        this.isMultiple &&
          this.container.querySelectorAll('.fi-select-input-badge-remove').forEach((e) => {
  ...
  destroy() {
    (this.selectButton &&
      this.buttonClickListener &&
      this.selectButton.removeEventListener('click', this.buttonClickListener),
      this.documentClickListener &&
        document.removeEventListener('click', this.documentClickListener),
      this.selectButton &&
        this.buttonKeydownListener &&
        this.selectButton.removeEventListener('keydown', this.buttonKeydownListener),
      this.dropdown &&
        this.dropdownKeydownListener &&
        this.dropdown.removeEventListener('keydown', this.dropdownKeydownListener),
      this.resizeListener &&
        (window.removeEventListener('resize', this.resizeListener), (this.resizeListener = null)),
      this.scrollListener &&
        (window.removeEventListener('scroll', this.scrollListener, !0),
    ...
    init() {
      (d ||
        ...
        (this.unsubscribeLivewireHook = Livewire.hook(
          'commit',
          ({ component: L, commit: Y, succeed: F, fail: H, respond: Q }) => {
            F(({ snapshot: W, effect: K }) => {
              this.$nextTick(() => {
                if (
                  this.isLoading ||
                  L.id !== this.$root.closest('[wire\\:id]')?.attributes['wire:id'].value
                )
                  return;
                let T = this.getServerState();
                T === void 0 || this.getNormalizedState() === T || (this.state = T);
              });
            });
          },
        )),
        this.$watch('state', async (L) => {
          ...
          this.isLoading = !0;
          let F = await this.$wire.updateTableColumnState(g, N, this.state);
          ((this.error = F?.error ?? void 0),
            !this.error &&
