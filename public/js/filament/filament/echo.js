  ...
  var Ei = (l, h, a, c) => {
    if ((h && typeof h == 'object') || typeof h == 'function')
      for (let s of Pi(h))
        !Oi.call(l, s) &&
          s !== a &&
          he(l, s, { get: () => h[s], enumerable: !(c = Ti(h, s)) || c.enumerable });
    return l;
  };
  var Li = (l, h, a) => (
    (a = l != null ? Ci(xi(l)) : {}),
    ...
    (function (h, a) {
      ...
      return (function (l) {
        ...
        return (
          ...
          (a.t = function (c, s) {
            if (
              (s & 1 && (c = a(c)), s & 8 || (s & 4 && typeof c == 'object' && c && c.__esModule))
            )
              return c;
          ...
          var c =
            ...
            (function () {
              ...
              return function (v, y) {
                ...
                v.prototype =
                  y === null ? Object.create(y) : ((w.prototype = y.prototype), new w());
              };
            })();
              ...
              if (C & 128) {
                ...
                if (C < 224) {
                  ...
                  var b = P[++S],
                    v = P[++S],
                    y = P[++S];
                  if ((b & 192) !== 128 || (v & 192) !== 128 || (y & 192) !== 128)
                    throw new Error(s);
        ...
        function (l, h, a) {
                      ...
                      i(
                        new B(
                          ...
                          'Unable to retrieve auth string from ' +
                            r.toString() +
                            ' endpoint - ' +
                            ('received status: ' + o.status + ' from ' + n.endpoint + '. ' + k),
                        ),
                        null,
                      );
                    }
            ...
            return (function r(i, o) {
              ...
              switch (typeof i) {
                case 'object':
                  ...
                  if (
                    (t.push(i), n.push(o), Object.prototype.toString.apply(i) === '[object Array]')
                  )
          ...
          function gt(e, t) {
            var n = '/app/' + e,
              r =
                '?protocol=' + d.PROTOCOL + '&client=js&version=' + d.VERSION + (t ? '&' + t : '');
            return n + r;
          }
          var tn = {
              ...
              return (
                ...
                (t.prototype.trigger = function (n, r) {
                  ...
                  if (!this.subscribed) {
                    ...
                    A.warn(
                      "Client event triggered before channel 'subscription_succeeded' event . " + i,
                    );
                  }
                  ...
                  try {
                    ...
                    switch (((i = 0), o && (g = [g[0] & 2, o.value]), g[0])) {
                      ...
                      default:
                        if (
                          ((o = n.trys),
                          !(o = o.length > 0 && o[o.length - 1]) && (g[0] === 6 || g[0] === 2))
                        ) {
                          n = 0;
                          continue;
                        }
                ...
                (t.prototype.authorize = function (n, r) {
                  ...
                  e.prototype.authorize.call(this, n, function (o, u) {
                    ...
                    if (!p) {
                      r(
                        new Error(
                          'No shared_secret key in auth payload for encrypted channel: ' + i.name,
                        ),
                        null,
                      );
                      return;
                    ...
                    _ = function (g, k) {
                      k
                        ...
                        : ((o = o + 1),
                          ...
                          o < i.length
                            ? (u &&
                                ((u = u * 2), r.timeoutLimit && (u = Math.min(u, r.timeoutLimit))),
                              (p = r.tryStrategy(i[o], t, { timeout: u, failFast: r.failFast }, _)))
                            : n(!0));
                    };
                  return (
              ...
              return (
                ...
                (e.prototype.sendRaw = function (t) {
                  if (this.readyState === $.OPEN)
                    try {
                      return (
                        m.createSocketRequest('POST', Kt(Tr(this.location, this.session))).start(t),
                        !0
                      );
                    } catch {
                      return !1;
            ...
            ee = (function () {
              ...
              return (
                ...
                (e.prototype.connect = function () {
                  if (
                    (this.connection.connect(), this.timelineSender && !this.timelineSenderTimer)
                  ) {
      ...
      return (
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                s ? this.subscription.unbind_global(s) : this.subscription.unbind_global(),
                this
              );
            },
          },
        ...
        R(a, [
          {
            ...
            value: function (s, f) {
              return (
                this.pusher.channels.channels[this.name].trigger('client-'.concat(s), f),
                this
              );
            },
          },
