...
class SeoSettingResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Référencement';

    protected static ?string $modelLabel = 'référencement';

    protected static ?string $pluralModelLabel = 'référencement';
    ...
    /**
     * Empêche la création de plusieurs configurations SEO.
     */
    ...
    /**
     * Le menu ouvre directement la création ou la modification.
     */
    public static function getNavigationUrl(): string
    {
        ...
        return $seoSetting
            ? static::getUrl('edit', ['record' => $seoSetting])
